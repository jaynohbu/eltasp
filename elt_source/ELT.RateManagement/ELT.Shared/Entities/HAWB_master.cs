...
namespace ELT.Shared.Entities
{
    ...
    public partial class HAWB_master
    {
        ...
        public Nullable<decimal> af_cost { get; set; }
        ...
        public Nullable<decimal> shipper_cod_amount { get; set; }
        public string bill_to_party { get; set; }
        public string danger_good { get; set; }
        public string show_weight_charge_rate { get; set; }
        public string show_other_charge_rate { get; set; }
