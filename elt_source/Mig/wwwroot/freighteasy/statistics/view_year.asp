...
<tr>
	<td style="word-break:break-all;padding:5px;color:#ffffff;"><b>All Years </b></td>
</tr>
</table>
<br>
...
<tr align="center">
	...
	<tr>
	  <td width="48" style="font-family:Arial;font-size:8pt;color:gray" nowrap align="center"><strong>Y</strong></td>
	</tr>
	</table></td>
	<td width="364">
	...
	<tr>
	  <td width="362" style="font-family:Arial;font-size:8pt;color:gray" nowrap align="center"><strong>%</strong></td>
	</tr>
	</table></td>
	<td width="70">
...
%>
<%
		SQL1="SELECT count(s_date) from IFF_statistics where left(convert(varchar(20), s_date, 120),4) = '"&cint(db_year)&"'"
