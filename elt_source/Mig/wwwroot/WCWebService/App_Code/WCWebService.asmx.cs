...
namespace WCWebService
{
	...
	public class WCWebService : System.Web.Services.WebService
	{
        ...
        private QuickBase qb = new QuickBase();
        private IAuthentication authenticator = (IAuthentication)new QuickBaseAuthentication();
		...
		public string clientVersion(string strVersion)
		{
            ...
            if (doLogging)
            {
                evLogTxt = "WebMethod: clientVersion() has been called " +
                    "by QBWebconnector" + "\r\n\r\n";
		...
		public string[] authenticate(string strUserName, string strPassword)
		{
            ...
            if (doLogging)
            {
                evLogTxt = "WebMethod: authenticate() has been called by QBWebconnector" + "\r\n\r\n";
                evLogTxt = evLogTxt + "Parameters received:\r\n";
            ...
            Session sess = new Session(ticket, strUserName, strPassword);

			try
            {
                authenticator.authenticate(strUserName, strPassword, qb);
                ...
                // NOTE: Should notify an administrator (i.e. log it somewhere with IMPORTANT flag)
                authReturn[1] = "none";
            }
		...
		public string connectionError(string ticket, string hresult, string message)
		{
            ...
            if (sess.getProperty("ce_counter") != null)
            {
            ...
            if (doLogging)
            {
                evLogTxt = "WebMethod: connectionError() has been called by QBWebconnector" + "\r\n\r\n";
                evLogTxt = evLogTxt + "Parameters received:\r\n";
			...
			string qbXMLCountry, int qbXMLMajorVers, int qbXMLMinorVers)
		{
            ...
            if (doLogging)
            {
                evLogTxt = "WebMethod: sendRequestXML() has been called by QBWebconnector" + "\r\n\r\n";
                evLogTxt = evLogTxt + "Parameters received:\r\n";
                evLogTxt = evLogTxt + "string ticket = " + ticket + "\r\n";
		...
		public int receiveResponseXML(string ticket, string response, string hresult, string message)
		{
            ...
            if (doLogging)
            {
                ...
                evLogTxt = "WebMethod: receiveResponseXML() has been called by QBWebconnector" + "\r\n\r\n";
                evLogTxt = evLogTxt + "Parameters received:\r\n";
                evLogTxt = evLogTxt + "string ticket = " + ticket + "\r\n";
			...
			if(!hresult.ToString().Equals("")){
                ...
                retVal = controller.processLastAction(sess, response);
			}
		...
		public string getLastError(string ticket)
		{
            ...
            if (doLogging)
            {
                evLogTxt = "WebMethod: getLastError() has been called by QBWebconnector" + "\r\n\r\n";
                evLogTxt = evLogTxt + "Parameters received:\r\n";
                evLogTxt = evLogTxt + "string ticket = " + ticket + "\r\n";
                evLogTxt = evLogTxt + "\r\n";
            }
		...
		public string closeConnection(string ticket)
        {
            ...
            if (doLogging)
            {
                evLogTxt = "WebMethod: closeConnection() has been called by QBWebconnector" + "\r\n\r\n";
                evLogTxt = evLogTxt + "Parameters received:\r\n";
                evLogTxt = evLogTxt + "string ticket = " + ticket + "\r\n";
                evLogTxt = evLogTxt + "\r\n";
            }
