...
.style17 {color: #FF0000}
    ...
    <script type="text/javascript" language="javascript">
       ...
       function convertChargeKG_LB(arg)
        {
	        var scale,index;
	        ...
	        if(charge_weight=="")
	        {
	            charge_weight = document.getElementsByName("txtDimension")[arg].value;
	        }
	        if(scale == "LB")
	        {
	            charge_weight = charge_weight * 2.2046226218488;
	        }
	        if(scale == "KG")
	        {
	            charge_weight = charge_weight / 2.2046226218488;
	        }
	        document.getElementsByName("txtDimension")[arg].value = charge_weight.toFixed(2);
        }
        ...
        function displayScreen(req,field,tmpVal,tWidth,tMaxLength,url)
        {
            ...
            {   
		        if (req.status == 200){
                    ...
                    setSelectField("dimension_scale","lstDimScale",xmlObj,1);
        ...
        function saveForm(){
            try{
                ...
                var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_delivery_order.asp?mode=update&type=" + typeValue + "&import=A&" + noValue;
        ...
        function deleteThis(){
            ...
            if(typeValue == "none" && noValue != "" && noValue != "Select One"){
                ...
                try{
                    ...
                    var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_delivery_order.asp?mode=delete&type=" 
                        + typeValue + "&export=A&" + noValue;
    ...
    <script type="text/javascript">
        ...
        function searchNumFill(obj,iType,changeFunction,vHeight){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                url = "/IFF_MAIN/asp/ajaxFunctions/ajax_delivery_order.asp?mode=list&import=" + iType 
        ...
        function searchNumFillAll(objName,iType,changeFunction,vHeight){
            ...
            var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_delivery_order.asp?mode=list&type=" + typeValue 
                + "&import=" + iType;
...
// Start of list change effect //////////////////////////////////////////////////////////////////
        ...
        function lstSearchNumChange(argV,argL){
            ...
            var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_delivery_order.asp?mode=view&type=" + typeValue
                + "&import=A&" + argV;
    ...
    <form id="form1" onkeydown="docModified(1);">
                    ...
                    <td width="36%" rowspan="2" align="right" valign="bottom">
                        <div id="print" class="bodycopy">
                            <img src="/iff_main/ASP/Images/icon_printer.gif" align="absbottom"><a href="javascript:;"
                                onclick="viewPDF(); return false;" style="cursor: hand;">Delivery Order Form</a></div>
                    </td>
                </tr>
                <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" autocomplete="off" id="lstSearchNum" name="lstSearchNum" value=""
                                                    ...
                                                    border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="docModified(-1); searchNumFill(this,'A','lstSearchNumChange',200);"
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="ba9590"
            ...
            <tr bordercolor="ba9590" class="border1px">
                <td>
                    <input type="hidden" name="hIType" value="A" />
                    <input type="hidden" name="did" value="" />
                    <input type="hidden" name="hSecNum" value="" />
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#ba9590"
                        bgcolor="#ba9590">
                        <tr bordercolor="#ba9590">
                            <td>
                                <table width="100%" border="0" cellpadding="2" cellspacing="0" bordercolor="#ba9590">
                                    <tr bgcolor="#edd3cf">
                                            ...
                                            <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="13%" align="right" valign="middle">
                                                        <!-- <a href="/iff_main/ASP/air_import/delivery_order.asp">
                                                            <img src="/iff_main/ASP/Images/button_new.gif" border="0" style="cursor: hand"></a> -->
                                                    </td>
                                                    <td width="13%" align="right" valign="middle">
                                    ...
                                    <tr align="center">
                                        <td valign="middle" bgcolor="#f3f3f3" class="bodycopy">
                                                    ...
                                                    <td width="57%" height="28" align="left" valign="middle">
                                                        <label id="txtFileNameLabel">
                                                            <strong><span class="bodyheader">
                                                                <img src="/iff_main/ASP/Images/required.gif" align="absmiddle"></span>File Name&nbsp;
                                            ...
                                            <table width="86%" border="0" cellpadding="0" cellspacing="0" bordercolor="#ba9590"
                                                class="border1px">
                                                <tr align="left" valign="middle" bgcolor="#efe1df" class="bodycopy">
                                                    <td width="52%" colspan="3" valign="top" bgcolor="#f3f3f3">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-right: #ba9590 solid 1px">
                                                            <tr>
                                                                <td width="2%" bgcolor="#efe1df">
                                                                    &nbsp;
                                                                </td>
                                                                <td height="20" colspan="2" align="center" valign="middle" bgcolor="#efe1df" class="bodyheader style14">
                                                                    PICKUP FROM
                                                                </td>
                                                            </tr>
                                                            <tr align="left" valign="middle" bgcolor="#ba9590" class="bodycopy">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="78%" height="18" bgcolor="#f3f3f3" class="bodyheader">
                                                                    <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Pickup From
                                                                </td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text" autocomplete="off" id="lstPickupName" name="lstPickupName" value=""
                                                                                    ...
                                                                                    border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="organizationFill(this,'CarrierWarehouse','lstPickupNameChange')"
                                                                                    onfocus="initializeJPEDField(this);" /></td>
                                                                            <td>
                                                                                <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstPickupName','CarrierWarehouse','lstPickupNameChange')"
                                                                                    style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                                                                    border-left: 0px solid #7F9DB9; cursor: hand;" /></td>
                                                                            <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="8" valign="top" bgcolor="#FFFFFF" class="bodycopy">
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="18" bgcolor="#f3f3f3" class="bodyheader">
                                                                    <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Consignee
                                                                </td>
                                                                <td bgcolor="#f3f3f3">
                                                                    &nbsp;
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td height="1" colspan="3" bgcolor="#ba9590">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="18" colspan="2" bgcolor="#FFFFFF" class="bodyheader">
                                                                    <textarea name="txtHandling" wrap="hard" cols="50" rows="3" style="width: 280px"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="18" colspan="2" bgcolor="#FFFFFF" class="bodyheader">
                                                                    <textarea name="txtRoute" wrap="hard" id="txtRoute" cols="50" style="width: 280px"
                                                                        rows="5" class="multilinetextfield"></textarea></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="8" bgcolor="#FFFFFF">
                                                                </td>
                                                                <td height="92" colspan="2" bgcolor="#FFFFFF" class="bodyheader">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td width="48%" valign="top" bgcolor="#FFFFFF" class="bodycopy">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td height="20" align="center" valign="middle" bgcolor="#efe1df" class="bodyheader style14">
                                                                    &nbsp;
                                                                </td>
                                                                <td bgcolor="#efe1df">
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="txtUpdateDate" type="text" class="m_shorttextfield" value="<%=Date() %>"
                                                                        size="16" preset="shortdate" /></td>
                                                                <td>
                                                                    <input name="txtRefNoOur" type="text" maxlength="32" class="m_shorttextfield" value=""
                                                                        style="width: 140px" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="2" colspan="3" bgcolor="#ba9590">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="#f3f3f3">
                                                                ...
                                                                <td colspan="2" bgcolor="#f3f3f3" class="bodycopy">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2" bgcolor="#f3f3f3" class="bodyheader">
                                                                    Local delivery or Transfer Reference No.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td colspan="2">
                                                                    <input name="txtDeliveryRefNum" maxlength="32" type="text" class="shorttextfieldBold"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="18" bgcolor="#f3f3f3" class="bodyheader">
                                                                    <span class="style8">Master AWB No.</span></td>
                                                                <td bgcolor="#f3f3f3" class="bodyheader">
                                                                    <span class="style8">House AWB No.</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    &nbsp;
                                                                ...
                                                                <td>
                                                                    <input name="txtMAWB" type="text" class="shorttextfieldBold" value="" style="width: 140px" /></td>
                                                                <td>
                                                                    <input name="txtHAWB" type="text" class="shorttextfieldBold" value="" style="width: 140px" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="#f3f3f3">
                                                                    &nbsp;
                                                                ...
                                                                <td height="18" bgcolor="#f3f3f3">
                                                                    <span class="bodylistheader"><strong>Entry-AWB No.</strong></span></td>
                                                                <td bgcolor="#f3f3f3">
                                                                    <span class="bodylistheader"><strong>Sub AWB No.</strong></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    &nbsp;
                                                                ...
                                                                <td>
                                                                    <span class="bodylistheader">
                                                                        <input name="txtEntryBilling" maxlength="32" type="text" class="shorttextfield" value=""
                                                                            style="width: 140px" />
                                                                    </span>
                                                                </td>
                                                                <td>
                                                                    <span class="bodylistheader">
                                                                        <input name="txtSubHAWB" maxlength="32" type="text" class="shorttextfield" value=""
                                                                            style="width: 140px" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="txtArrDate" type="text" class="m_shorttextfield" value="" size="16"
                                                                        preset="shortdate" />
                                                                    <input name="txtDepDate" type="hidden" class="m_shorttextfield" value="" size="16"
                                                                        preset="shortdate" />
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="18" bgcolor="#f3f3f3">
                                                                    <span class="bodylistheader">Origin Port </span>
                                                                </td>
                                                                <td bgcolor="#f3f3f3">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="bodylistheader">
                                                                        <input name="hDepPortCode" type="hidden" />
                                                                ...
                                                                <td>
                                                                    <span class="bodylistheader">
                                                                        <input name="hArrPortCode" type="hidden" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="18" bgcolor="#f3f3f3">
                                                                    <span class="bodylistheader"><strong>Carrier</strong></span></td>
                                                                <td bgcolor="#f3f3f3">
                                                                    &nbsp;
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td height="1px" colspan="3" bgcolor="#ba9590">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="#f3f3f3">
                                                                ...
                                                                <td height="18" bgcolor="#f3f3f3">
                                                                    <span class="bodyheader">Importer<span class="bodyheader style17"></span></span></td>
                                                                <td bgcolor="#f3f3f3">
                                                                    &nbsp;
                                                                </td>
                                                            </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text" autocomplete="off" id="lstImporterName" name="lstImporterName"
                                                                                    value="" class="shorttextfield" style="width: 285px; border-top: 1px solid #7F9DB9;
                                                                                    border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;"
                                                                                    onkeyup="organizationFill(this,'Importer','lstImporterNameChange')" onfocus="initializeJPEDField(this);" /></td>
                                                                            <td>
                                                                                <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstImporterName','Cosignee','lstImporterNameChange')"
                                                                                    style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                                                                    border-left: 0px solid #7F9DB9; cursor: hand;" /></td>
                                                                            <td>
                                                                                <img src="/ig_common/Images/combobox_addnew.gif" alt="" border="0" style="cursor: hand"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <span class="bodylistheader">
                                                                        <input name="txtCustomerRef" maxlength="32" type="text" class="shorttextfield" value=""
                                                                            style="width: 140px" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                            ...
                                            <table width="86%" border="0" cellpadding="2" cellspacing="0" bordercolor="#ba9590"
                                                class="border1px">
                                                <tr bgcolor="#efe1df">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        <textarea name="txtPieces" wrap="hard" cols="16" rows="7" class="multilinetextfield"></textarea></td>
                                                    ...
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        ...
                                                        <input name="txtGrossWt" type="text" class="shorttextfield" style="behavior: url(../include/igNumDotChkLeft.htc)"
                                                            onkeydown="resetWeight();" value="" size="13" /></td>
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        <select id="lstDimScale" name="lstDimScale" class="smallselect" onchange="convertChargeKG_LB(0)">
                                                            <option value="KG">KG</option>
                                                            <option value="LB">LB</option>
                                                        </select>
                                                        <input id="txtDimension" name="txtDimension" type="text" size="13" class="shorttextfield"
                                                            style="behavior: url(../include/igNumDotChkLeft.htc)" onkeydown="resetChargeWeight();" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="8" bgcolor="#FFFFFF">
                                                ...
                                                <tr>
                                                    <td height="1" colspan="5" bgcolor="#ba9590">
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr bgcolor="#FFFFFF">
                                                    ...
                                                    <td colspan="2" align="left" valign="top">
                                                        <input type="radio" name="chInlandChargeType" value="P" onclick="chInlandChargeType_click('P');" />
                                                        PREPAID &nbsp;
                                                ...
                                                <tr>
                                                    <td height="19" bgcolor="#efe1df">
                                                        &nbsp;
                                                    </td>
                                                    <td align="left" valign="top" bgcolor="#efe1df">
                                                        &nbsp;
                                                    </td>
                                                    <td width="48%" align="right" bgcolor="#efe1df">
                                            ...
                                            <table width="86%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="30" align="right" valign="middle">
                                                        ...
                                                        <input name="txtEmployee" type="text" class="shorttextfield" value="<%=GetUserFLName(user_id) %>"
                                                            size="32" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr align="center">
                                        <td height="1" valign="middle" bgcolor="#ba9590" class="bodycopy">
                                        </td>
                                    </tr>
                                    <tr align="center">
                                        <td height="8" valign="middle" bgcolor="#edd3cf" class="bodycopy">
                                            <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="26%">
                                                        &nbsp;
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="32" align="right" valign="bottom">
                    <div id="print" class="bodycopy">
                        <img src="/iff_main/ASP/Images/icon_printer.gif" align="absbottom"><b style="cursor: hand;"
