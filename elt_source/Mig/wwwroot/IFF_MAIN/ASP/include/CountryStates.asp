<%
Dim AllCountryCode(),AllCountryDesc(),countryIndex
...
rsCountry.Open SQLContry, eltConn, adOpenForwardOnly, , adCmdText
Set rsCountry.activeConnection = Nothing

reDim AllCountryCode(rsCountry.RecordCount)
reDim AllCountryDesc(rsCountry.RecordCount)
