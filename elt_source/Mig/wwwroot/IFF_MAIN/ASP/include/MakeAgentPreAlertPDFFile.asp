...
Sub InsertSTMTIntoPDF(MAWB,AgentNo)
    ...
    Dim aOrgInfo(5)
    Dim vAgentName
    Dim aHAWB(128),aRCVL(128),aPYBL(128),aPS(128),aDebit(128),aCredit(128),aOCarrier(128),aOAgent(128)
    Dim aAgentChg(128),aCarrierChg(128),aTotalDue(128)
    Dim rs, SQL
    Dim i
...
Sub InsertManifestIntoPDF(vMAWB,AgentName,vAgent,MasterAgentNo,MAsterAgentName,MasterAgentPhone)
	Dim aHAWB(128),aShipperInfo(128),aAgentInfo(128)
...
'////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Dim aConsigneeInfo(128),aCBM(128)
    Dim vOwner,vConcolidator,vFlightNo,vDateArrival
    Dim aPiece(128),aGrossWeight(128),vWeightScale
    Dim aDesc(128)
    Dim tIndex
