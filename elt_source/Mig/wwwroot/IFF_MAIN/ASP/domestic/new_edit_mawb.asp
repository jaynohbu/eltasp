...
<script language='JavaScript'> alert('Could not find the MAWB'); history.go(-1);</script>
...
// Start of list change effect //////////////////////////////////////////////////////////////////
    ...
    function getIATARate(index){
	    ...
	    if (req) {
		    ...
		    req.open("GET","../ajaxFunctions/ajax_iata_rate.asp?Unit="+ Unit+ "&airline="+ airline+"&arp="+arp+"&dep="+dep+"&wgt="+wgt, true);	
		    req.send();		
	    }
    }
        ...
        <table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr>
                <td width="46%" height="32" align="left" valign="middle" class="pageheader">
                    New/Edit MASTER AIR WAYBILL</td>
            ...
            <table width="95%" height="40" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="select" style="height: 12px">
                        <img src="/iff_main/ASP/Images/required.gif" align="absbottom" alt="" />Select Master
                        AWB No.
                    </td>
                    <td rowspan="2" align="right" valign="bottom">
                        <div id="print" style="width: 180px">
                            <img src="/iff_main/ASP/Images/icon_printer_preview.gif" align="absbottom" alt="" /><a
                                href="javascript:;" onclick="NewPrintVeiw();return false;">Master Air Waybill</a></div>
                    </td>
                </tr>
                <tr>
                    <td>
                                ...
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="10%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/domestic/new_edit_mawb.asp" target="_self">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
                                    ...
                                    <tr align="left" valign="middle" bgcolor="#f3d9a8" class="bodycopy">
                                        <td width="31%" height="18" bgcolor="#f3f3f3">
                                            <strong>Shipper's Name and Address</strong></td>
                                    ...
                                    <tr align="left" valign="top" bgcolor="#FFFFFF">
                                        ...
                                        <td valign="middle" bgcolor="#f3f3f3" class="bodyheader">
                                            <strong>Items Under 16 Ounces</strong></td>
                                        <td>
                                            ...
                                            <textarea name="txtDesc1" cols="22" rows="9" wrap="hard" class="hiddenfield" tabindex="3"
                                                onkeydown="return checkMaxRows(this);"><%= vDesc1 %></textarea></td>
                                    </tr>
                                    <tr align="left" valign="top" bgcolor="#FFFFFF">
                                        <td>
                                    ...
                                    <tr align="left" valign="top" bgcolor="#FFFFFF">
                                        <td height="18" colspan="2" valign="middle" bgcolor="#f3f3f3">
                                            &nbsp;<strong>Airport of Departure (Addr. of First Carrier) and Requested Routing</strong></td>
                                        <td valign="middle" bgcolor="#FFFFFF">
                                            &nbsp;</td>
                                    </tr>
                                    <tr align="left" valign="top" bgcolor="#FFFFFF">
                                    ...
                                    <tr align="left" valign="middle">
                                        <td colspan="5" valign="top">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                ...
                                                <tr align="left" valign="middle">
                                                    <td>
                                                        <input name="txtTo" class="shorttextfield" value="<%= vTo %>" size="12" maxlength="12"></td>
                                                    <td>
                                                ...
                                                <tr align="left" valign="middle">
                                                    <td>
                                                        <input name="txtDeclaredValueCarriage" class="shorttextfield" value="<%=vDeclaredValueCarriage %>"
                                                            size="18" id="txtDeclaredValueCarriage"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#f3d9a8">
                                                    <td height="20" bgcolor="#f3f3f3">
                                                        &nbsp;<strong>Airport of Destination</strong><strong></strong></td>
                                                    <td bgcolor="#f3f3f3">
                                                ...
                                                <tr align="left" valign="middle">
                                                    <td>
                                                        <input name="txtDestAirport" class="shorttextfield" value="<%= vDestAirport %>" size="24"
                                                            maxlength="24"></td>
                                                    <td>
                                                        <input name="txtFlightDate1" class="shorttextfield" preset="shortdate" value="<%= vFlightDate1 %>"
                                                            size="17" maxlength="17" /></td>
                                                    <td>
                                                        <input name="txtFlightDate2" class="shorttextfield" preset="shortdate" value="<%= vFlightDate2 %>"
                                                            size="17" maxlength="17" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                                ...
                                                <tr>
                                                    <td align="left" valign="middle">
                                                        <input type="text" name="txtServiceLevel" class="shorttextfield" size="30" value="<%=vServiceLevel %>"
                                                            id="txtServiceLevel" style="background-color: #cccccc" readonly="readOnly" /></td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th width="125" height="20" align="left" bgcolor="#f3f3f3">
                                    <strong>House AWB No.</strong></th>
                                <th width="84" bgcolor="#f3f3f3">
                                    <strong>Coloadee</strong></th>
                                <th width="196" bgcolor="#f3f3f3">
                                    <strong>Agent</strong></th>
                                <th width="172" bgcolor="#f3f3f3">
                                    <strong>Shipper</strong></th>
                                <th width="144" bgcolor="#f3f3f3">
                                    <strong>Consignee</strong></th>
                                <th width="35" bgcolor="#f3f3f3">
                                    <strong>Pieces</strong></th>
                        ...
                        <tr align="left" valign="middle">
                            ...
                            <td>
                                <input name="txtsConsignee<%= i %>" type="text" class="d_shorttextfield" value="<%= sConsignee(i) %>"
                                    size="21" readonly><input name="txtWeightTran<%= i %>" type="hidden" value="<%= aWeightTran(i) %>"></td>
                            <td>
                        ...
                        <tr align="left" valign="middle">
                            ...
                            <td>
                                <input name="txtChargeableWeight<%= i %>" class="shorttextfield" id="ChargeableWeight"
                                    value="<%= aChargeableWeight(i) %>" size="12" maxlength="7" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                            <td>
                                <input name="txtRateCharge<%= i %>" class="shorttextfield" id="RateCharge" value="<% if aRateCharge(i)="0" then response.Write("N/A")else response.Write(aRateCharge(i))end if  %>"
                            ...
                            <td>
                                <img src="../images/button_cal.gif" width="37" height="18" name="bCal<%= i %>" onclick="bCalClick(<%= i %>)"
                                    value="Cal" style="cursor: hand"></td>
                            <td width="171" align="left">
                                <input name="txtTotal<%= i %>" class="shorttextfield" id="TotalCharge" value="<%=formatNumber(aTotal(i),2) %>"
                                    size="16" maxlength="12" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                        </tr>
                        <% next %>
                    </table>
                    <table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF"
                        ...
                        <tr align="left" valign="top" bgcolor="#FFFFFF">
                            <td bgcolor="f3f3f3" height="20" colspan="1">
                                <textarea name="txtDesc2" cols="34" rows="14" wrap="hard" class="monotextarea" tabindex="3"
                                    onkeyup="Desc2KeyUp()"><%= vDesc2 %></textarea></td>
                            <td bgcolor="f3f3f3" height="20" colspan="1">
                                &nbsp;
                            </td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
                        ...
                        <tr align="center" valign="middle" bgcolor="eec983">
                            <td height="22" colspan="10" bgcolor="#f3d9a8">
                                <strong><a name="add_oc"></a><font color="c16b42">OTHER CHARGE</font></strong></td>
                        </tr>
                        <tr>
                            <td colspan="6">
                                    ...
                                    <tr id="aRow<%=i %>">
                                        ...
                                        <td>
                                            <select tabindex="<%= i*7+6 %>" id="ChargeItem" size="1" name="lstChargeCode<%= i %>"
                                                onchange="ChargeItemChange(<%= i %>)" class="smallselect" style="width: 270px">
                                        ...
                                        <td>
                                            <input tabindex="<%= i*7+7 %>" id="ItemDesc" name="txtChargeDesc<%= i %>" size="45"
                                                value="<%= aDesc(i) %>" class="shorttextfield"></td>
                                        <td>
                                            <input tabindex="<%= i*7+8 %>" id="ChargeAmt" name="txtChargeAmt<%= i %>" size="12"
                                                ...
                                                class="numberalign" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                        ...
                        <tr align="center" valign="middle">
                            <td width="50%" height="22" align="left" valign="top" bgcolor="#FFFFFF">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    ...
                                    <tr align="center" valign="middle">
                                        <td colspan="2" bgcolor="#f3f3f3">
                                            Total Other Charges Due Carrier</td>
                                    </tr>
                                    <tr align="center">
                                        <td>
                                    ...
                                    <tr align="center">
                                        ...
                                        <td bgcolor="#f3f3f3">
                                            <input name="txtCODAmount" class="shorttextfield" value="<%=FormatNumberPlus(ConvertAnyValue(vCODAmount,"Amount",0),2) %>"
                                                ...
                                                width: 70px; text-align: right" /></td>
                                    </tr>
                                    <tr align="center">
                                    ...
                                    <tr align="center">
                                        <td height="20" bgcolor="#f3f3f3">
                                            Currency Conversion Rates</td>
                                        <td height="20" align="center" bgcolor="#f3f3f3">
                                            CC Charges in Dest. Currency</td>
                                    </tr>
                                    <tr align="center">
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="txtPickupCharge" class="shorttextfield" size="16" value="<%=formatNumberPlus(ConvertAnyValue(vPickupCharge,"Amount",0),2) %>"
                                                id="txtPickupCharge" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                        <td>
                                            <input type="text" name="txtOriginAdvCharge" class="shorttextfield" size="16" value="<%=formatNumberPlus(ConvertAnyValue(vOriginAdvCharge,"Amount",0),2) %>"
                                                id="txtOriginAdvCharge" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                        <td>
                                            <input type="text" name="txtOriginAdvChargeDesc" class="shorttextfield" size="32"
                                                value="<%=vOriginAdvChargeDesc %>" id="txtOriginAdvChargeDesc" /></td>
                                        <td>
                                            <input type="text" name="txtItemPrepaid" class="shorttextfield" size="12" value="<%=vItemPrepaid %>"
                                                id="txtItemPrepaid" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                    </tr>
                                    <tr class="bodyheader">
                                        <td height="20" colspan="4" align="center" bgcolor="#f3d9a8" class="bodyheader style15">
                                            Delivery Zone</td>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="txtDeliveryCharge" class="shorttextfield" value="<%=formatNumberPlus(ConvertAnyValue(vDeliveryCharge,"Amount",0),2) %>"
                                                size="16" maxlength="16" id="txtDeliveryCharge" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="height: 20px">
                                            <input name="txtCODFee" type="text" class="shorttextfield" value="<%=formatNumberPlus(ConvertAnyValue(vCODFee,"Amount",0),2) %>"
                                                size="16" maxlength="16" id="txtCODFee" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                        <td colspan="3" style="height: 20px">
                                            <input type="text" name="txtOtherCharge" class="shorttextfield" size="71" value="<%=formatNumberPlus(ConvertAnyValue(vOtherCharge,"Amount",0),2) %>"
                                                id="txtOtherCharge" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="bodycopy">
                                            ...
                                            <textarea name="txtExecute" cols="50" rows="3" wrap="hard" class="hiddenfield"><%= vExecute %></textarea></td>
                                        <td align="center">
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="32" align="right" valign="bottom">
                    <div id="print">
                        <img src="/iff_main/ASP/Images/icon_printer_preview.gif" width="45" height="29" align="absbottom"><a
                            href="javascript:;" onclick="NewPrintVeiw();return false;">Air Waybill</a></div>
                </td>
            </tr>
        </table>
    </form>
...
function close_mawb(mawb) {
	...
	var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_mawb_close.asp" 
				+"?n="+mawb;
...
function search_mawb(jobNo) {
	...
	var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_mawb_search.asp" +"?j="+jobNo;
...
DIM mIndex, existMJob, JobNo, mFile,last_Chr10_Index,MAWB,fileno
	...
	if NOT TRIM(JobNo) = "" and NOT fileno = "Search Here" then
		...
		if existMJob then
				...
				document.frmMAWB.action="new_edit_mawb.asp?Edit=yes&mawb=" & MAWB  & "&WindowName=" & window.name				
				document.frmMAWB.method="POST"
				document.frmMAWB.target = "_self"
				frmMAWB.submit()
		else
...
if sindex = 0 then
   msgbox "Please select a Master AWB No."
exit sub	
end if
...
if sindex>0 then
	for i=1 to WC
		...
		//Scale=document.all("lstKgLb").item(i).value
		//if Not Scale=document.all("KgLb").item(i).value then
		//	MsgBox "UOM mismatch!"
		//	OK=False
		//	exit for
		//end if
...
////////////////////////////////////////	
		...
		document.frmMAWB.action="new_edit_mawb.asp?Save=yes" & "&MAWB=" & vMAWB & "&WindowName=" & window.name
		document.frmMAWB.method="POST"
		document.frmMAWB.target = "_self"		
		frmMAWB.submit()
	end if
...
Dim mDepartureAirportCode,mDepartureAirport, mTo, mBy, mTo1, mBy1, mTo2, mBy2,mDestAirport
Dim mFlightDate1,mFlightDate2,IssuedBy,AccountInfo,mServiceLevel, mFile
...
if Mid(Agent,1,11) = "AS AGENT OF" then
	...
	document.frmMAWB.txtExecute.Value= Agent & chr(10) & "AS AGENT OF " & Carrier & chr(10) & "<%= vExecutionDatePlace %>"
end if

'// Modified by Joon on Jan/30/2007 ////////////////////////////////////////////////////////////////

If arg = "new" Then
    document.frmMAWB.action="new_edit_mawb.asp?Edit=yes&MAWB=" & vMAWB   & "&WindowName=" & window.name
    document.frmMAWB.method="POST"
    document.frmMAWB.target = "_self"
    frmMAWB.submit()
End If
...
document.frmMAWB.action="new_edit_mawb.asp?DeleteHAWB=yes&dHAWB=" & HAWB & "&delELTAcct=" & delELTAcct & "#selected_hawb"  & "&WindowName=" & window.name
document.frmMAWB.method="POST"
document.frmMAWB.target = "_self"
frmMAWB.submit()
End Sub

Sub AdjustWeight(sCount)
...
Dim ItemNo
If Not isnull(i) or isnumeric(i) Then
    ItemNo = CInt(i)
Else
    ItemNo = 0
End If

Pieces=document.all("Pieces").item(ItemNo).value
...
if RateCharge="" Then document.all("RateCharge").item(ItemNo+1).Value = 0
...
if sindex>0 then
	MAWB=document.frmMAWB.lstMAWB.item(sindex).text
	ok=MsgBox ("Do you really want to delete Master AWB NO. '" & MAWB & " '?" & chr(13) & "Continue?",36,"Message")
	if ok=6 then	
		////////////////////////////////////////	
		...
		END IF
		////////////////////////////////////////	
		document.frmMAWB.action="new_edit_mawb.asp?DeleteMAWB=yes&MAWB=" & MAWB  & "&WindowName=" & window.name
		document.frmMAWB.method="POST"
		document.frmMAWB.target = "_self"
		frmMAWB.submit()
	end if
...
Sub EditHAWB(HAWB,COLODee)
	if Not cLng(COLODee)=cLng(<%= elt_account_number %>) then
		window.open "view_print.asp?hawb=" & HAWB & "&sType=house&COLODee=" & COLODee,"popupNew", "<%=StrWindow %>"
	else
		'// window.open "new_edit_hawb.asp?mode=search&HAWB=" & HAWB,"popupNew", "<%=StrWindow %>"
		window.location.href =  "new_edit_hawb.asp?mode=search&HAWB=" & HAWB
	end if
End Sub
