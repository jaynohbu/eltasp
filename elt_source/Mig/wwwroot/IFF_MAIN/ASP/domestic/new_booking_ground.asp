...
<%
    ...
    Sub save_booking_info()
        ...
        dataTable.Add "mawb_ num", Request.Form.Item("txtMAWBNum")
    ...
    <input type="image" style="visibility:hidden; position:absolute" onclick="return false;" />
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr style="height: 24px">
                <td><img src="/iff_main/ASP/Images/required.gif" align="absbottom" alt="" /><span class="select">Select or type booking number</span></td>
            </tr>
            <tr>
                                ...
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="13%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/domestic/new_booking_ground.asp" target="_self">
                                ...
                                <table width="70%" border="0" cellpadding="2" cellspacing="0" bordercolor="#997132"
                                    ...
                                    <tr align="left" valign="middle" bgcolor="#F2DEBF" class="bodycopy">
                                        ...
                                        <td height="20" bgcolor="#f3d9a8" class="bodycopy">
                                            <img src="/iff_main/ASP/Images/required.gif" align="absbottom"><strong><font color="c16b42">Bill
                                    ...
                                    <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                        ...
                                        <td valign="top" class="bodycopy">
                                            ...
                                            <span class="goto" id="gotoSpan" style="visibility: hidden"><br />
                                                <img src="/iff_main/ASP/Images/icon_goto.gif" width="36" height="21" align="absbottom"><b
                                        ...
                                        <td colspan="2" valign="top">
                                            ...
                                            <input name="txtFileNo" class='d_shorttextfield' style='width: 110px' tabindex="6"
                                                value="" size='20' readonly="readonly" />
                                            <% Else %>
                                                <input type="hidden" name="lstFILEPrefix" value="" />
                                                <input name="txtFileNo" class='shorttextfield' style='width: 110px' tabindex="6"
                                                value="" size='20' />
                                            <% End If %>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <tr bgcolor="#F3f3f3" class="bodyheader">
                                            ...
                                            <tr bgcolor="#Ffffff">
                                                ...
                                                <td colspan="2">
                                                    <input name="txtTo" class="d_shorttextfield" tabindex="8" value="" size="24" style="width: 230px"
                                                        readonly="readonly" /></td>
                                                <td colspan="2">
                                                    <input name="txtServiceLevel" class="shorttextfield" maxlength="64" value="" size="51"></td>
                                                <tr align="left" valign="middle" bgcolor="#F3f3f3" class="bodycopy">
                                                    <td>
                                                        &nbsp;
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span class="bodyheader">
                                                            <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Arrival Date</span></td>
                                                </tr>
                                    <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                        <td>
                                            &nbsp;
                                        ...
                                        <td>
                                            <input name="txtDeptDate1" class="m_shorttextfield" preset="shortdate" tabindex="16"
                                                value="" size="20"></td>
                                        <td>
                                            <input name="txtArrivalDate1" class="m_shorttextfield" preset="shortdate" tabindex="17"
                                                value="" size="20"></td>
                                        <tr align="left" valign="middle" bgcolor="#f3f3f3" class="bodycopy">
                                            <td>
                                                &nbsp;
                                    ...
                                    <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                        ...
                                        <td bgcolor="#FFFFFF" class="bodycopy">
                                            <input name="txtWeightReserved" class="m_shorttextfield" maxLength=7 tabindex="21" value="" size="24"
                                                style="behavior: url(../include/igNumChkRight.htc)"></td>
                                        <td bgcolor="#FFFFFF">
                                            <input name="txtPieces" maxLength=6 class="m_shorttextfield" value="0" size="20" style="behavior: url(../include/igNumChkRight.htc)" />
                                        <td colspan="2" bgcolor="#FFFFFF">
                                            <input name="txtAirLineStaff" type="text" class="shorttextfield" maxlength="64" tabindex="23" value=""
                                                size="20"></td>
                                    </tr>
                                </table>
                                <br>
