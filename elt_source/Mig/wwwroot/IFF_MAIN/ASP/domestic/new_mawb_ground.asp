...
.style15 {font-size: 9px; font-weight: bold; left: 6px; font-family: Verdana, Arial, Helvetica, sans-serif;}
    ...
    <script type="text/javascript">
        ...
        function searchNumFillAll(objName,changeFunction,vHeight){
            ...
            var url = "/IFF_MAIN/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=DGB&qStr=";
    ...
    <form method="post" name="frmMAWB" id="frmMAWB">
        ...
        <div class="selectarea">
            <table width="95%" height="40" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td class="select">
                        <img src="/iff_main/ASP/Images/required.gif" align="absbottom" alt="" />Select Bill
                        of Lading No.
                    </td>
                    <td rowspan="2" align="right" valign="bottom">
                        <div id="print" style="width: 180px">
                            <img src="/iff_main/ASP/Images/icon_printer_preview.gif" align="absbottom" alt="" /><a
                                href="javascript:;" onclick="NewPrintVeiw();return false;">Bill of Lading </a>
                        </div>
                    </td>
                </tr>
                <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td height="23" class="leftpadding">
                                            <input name="txtBillDate" class="shorttextfield" value="" size="24" id="" /></td>
                                        <td colspan="2">
                                            <span class="bodycopy">
