...
'//-------------------------- Main Sub --------------------------------------------------------------
    ...
    Sub get_pickup_order()
        ...
        SQL = "SELECT Shipper_Name,Shipper_account_number,Shipper_Info,Desc2," _
            ...
            & "Handling_Info,Total_Gross_Weight,Total_Gross_Weight AS Total_Chargeable_Weight,Weight_Scale " _
        ...
        function setSelectField(xmlTag,htmlTag,xmlObj){
            ...
            if(xmlObj.getElementsByTagName(xmlTag)[0] != null 
                ...
                for(var i=0;i<htmlObj.options.length;i++){
                    if(htmlObj.options(i).value == xmlObj.getElementsByTagName(xmlTag)[0].childNodes[0].nodeValue){
    ...
    // Event Controllers
        ...
        function MAWBEditClick(){
            ...
            if(vMAWB != ""){
                ...
                */
                window.location.href = "new_edit_mawb.asp?WindowName=popUpWindow&Edit=yes&mawb=" + vMAWB;
            }
        }
    ...
    // Editable drop-down controllers
        ...
        function searchNumFill(obj,changeFunction,vHeight){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                var url = "/IFF_MAIN/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=DUB&qStr=" + qStr;
        ...
        function searchNumFillAll(objName,changeFunction,vHeight){
            ...
            var url = "/IFF_MAIN/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=DUB";
        ...
        <table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr>
                ...
                <td width="55%" colspan="5" align="right" valign="middle">
                    ...
                    <input name="txtqHAWB" class="lookup" value="Search Here" onkeydown="javascript: if(event.keyCode == 13) { lookup(); }"
                    ...
                    <td width="55%" align="right" valign="bottom">
                        <div id="print">
                            <span id="spnAddInfoTop" style="visibility:hidden">
                                ...
                                <img src="/iff_main/ASP/Images/spacer.gif" width="40" height="15" /></span><img src="../Images/icon_printer_preview.gif"
                                    align="absbottom" style="margin-right: 1em" /><a href="javascript:;" onclick="NewPrintVeiw();return false;">House
                                        Air Waybill</a>
                        </div>
                    </td>
                </tr>
                                ...
                                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="13%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/domestic/new_edit_hawb.asp" target="_self">
                                ...
                                <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#997132"
                                    ...
                                    <tr bgcolor="#ffffff">
                                        ...
                                        <td height="24">
                                            ...
                                            <input name="txtHAWBNum" class="readonlybold" value="" size="22" readonly="readonly"></td>
                                        <td>
                                            &nbsp;
                                        </td>
                                        <td>
                                            <input name="txtExecutedDate" type="text" class="m_shorttextfield" size="18" preset="shortdate" /></td>
                                    </tr>
                                    <tr>
                ...
                <tr align="center" valign="middle">
                    <td bgcolor="#FFFFFF">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <input name="txtDeclaredValueCarriage" class="shorttextfield" size="28" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                <td colspan="1">
                                    <input name="txtInsuranceAmt" class="shorttextfield" size="28" maxlength="17" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" autocomplete="off" id="lstNotifyName" name="lstNotifyName" value=""
                                                    class="shorttextfield" style="width: 285px; border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9;
                                                    border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="organizationFill(this,'All','lstNotifyNameChange')"
                                                    onfocus="initializeJPEDField(this);" /></td>
                                            <td>
                                                <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstNotifyName','All','lstNotifyNameChange')"
                                                    style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                                    border-left: 0px solid #7F9DB9; cursor: hand;" /></td>
                                            <td>
                                                <img src="/ig_common/Images/combobox_addnew.gif" alt="" border="0" style="cursor: hand"
                            ...
                            <tr>
                                <td height="24" valign="top" style="padding-left: 10px">
                                    <input name="txtDepartureAirport" class="d_shorttextfield" value="" size="24" maxlength="27"
                                        readonly="readonly" /></td>
                                <td valign="top">
                                    <input name="txtDestAirport" class="d_shorttextfield" value="" size="24" maxlength="27"
                                        readonly="readonly" /></td>
                                <td valign="top">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                    ...
                                    <tr>
                                        <td colspan="7">
                                            ...
                                            <!------------------------------------------------------------------>
                                            <table id="tblOtherCharege" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr class="bodyheader" style="visibility: hidden">
                                                    <td width="260" height="20" bgcolor="#FFFFFF" class="leftpadding" style="padding-left: 10px">
                                                        <select tabindex="6" size="1" name="lstChargeCode" onchange="ChargeItemChange(this)"
                                                            class="smallselect" style="width: 220px">
                                                            <option value=""></option>
                                                ...
                                                <% For j=0 To aOtherCharge.Count-1 %>
                                                <tr class="bodyheader">
                ...
                <td align="right" valign="bottom">
                    <div id="print">
                        <span id="spnAddInfoBot" style="visibility:hidden">
                            <img src="../Images/icon_additional_info.gif" alt="go to additional House Airbill info "
                                align="absbottom" style="margin-right: 1em" /><a href="javascript:;" onclick="GoToAddition();return false;">Additional
                                    House Airbill Info</a><img src="/iff_main/ASP/Images/spacer.gif" width="40" height="15" /></span><img
                                        src="/iff_main/ASP/Images/icon_printer_preview.gif" width="29" height="29" style="margin-right: 1em"
                                        align="absbottom"><a href="javascript:;" onclick="NewPrintVeiw();return false;">House
                                            Air Waybill</a></div>
                </td>
            </tr>
        </table>
