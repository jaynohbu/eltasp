...
<head>
    ...
    If vMode = "upload" Then
        ...
        If objUpload.Fields("filePath").Length < vFileSizeLimit Then
            SQL= "select * from user_files where elt_account_number =" _
                & elt_account_number & " and org_no=" & vOrgNo & " and file_name=N'" & Replace(vFileName,"'","''") & "'"
    ...
    <script type="text/jscript">
        ...
        function DeleteFile(arg){
            var vFileName = document.getElementById("chkAttach" + arg).value;
            document.form1.action = "upload_file.asp?WindowName=" + window.name + "&OrgNo=<%=vOrgNo %>&mode=delete&file=" + encodeURIComponent(vFileName);
            document.form1.method = "POST";
        ...
        <center>
            <table style="width: 90%" cellpadding="1" cellspacing="0" border="0" class="bodycopy">
                ...
                <tr>
                    ...
                    <td align="left" valign="middle" class="bodycopy">
                        <input id="filePath" name="filePath" type="File" class="bodycopy" size="50" onkeydown="return false" />
                    </td>
                </tr>
                <tr>
                    <td class="bodyheader" style="width: 60px">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <img src="../../images/button_upload.gif" onclick="UpLoadClick()" style="cursor: hand"
                            alt="" />
                    </td>
                </tr>
            </table>
            <table style="width: 90%" cellpadding="1" cellspacing="0" border="0" class="bodycopy">
                ...
                <tr>
                    ...
                    <td>
                        <img src="../images/button_delete.gif" onclick="DeleteFile(<%=i %>);"
                ...
                <tr>
                    <td colspan="5" align="right">
                        <img src="../images/button_upload.gif" onclick="AttachClick()" style="cursor: hand"
                            alt="" />
                    </td>
                </tr>
            </table>
