...
<%
    Dim vHAWB, costItemList, i, vMode
    ...
    Sub UpdateTotalOtherCost
        ...
        SQL = "UPDATE hawb_master SET total_other_cost=" _
            & "(SELECT SUM(cost_amt) FROM hawb_other_cost WHERE elt_account_number=" _
            & elt_account_number & " AND hawb_num=N'" & vHAWB & "') WHERE elt_account_number=" _
            & elt_account_number & " AND hawb_num=N'" & vHAWB & "'"
    ...
    Sub GetAllCostItems
        ...
        SQL = "SELECT * FROM hawb_other_cost a LEFT OUTER JOIN organization b ON " _
            ...
            & " AND a.hawb_num=N'" & vHAWB & "' ORDER BY a.auto_uid"
    ...
    Sub AddCostItem
        ...
        SQL = "INSERT INTO hawb_other_cost(elt_account_number,hawb_num,vendor_no,cost_amt,item_no,cost_desc) " _
            & " VALUES(" &  elt_account_number & ",N'" & Request.Form("hHAWBNum") _
    ...
    <script type="text/javascript">
        ...
        function addNewItem(){
            if(document.getElementById("hAgentAcct").value == "" 
                ...
                document.getElementById("form1").action = "new_edit_hawb_cost_items.asp?mode=add";
        ...
        function removeItem(arg){
            document.getElementById("form1").action = "new_edit_hawb_cost_items.asp?mode=delete&did=" + arg;
            document.getElementById("form1").method = "post";
            document.getElementById("form1").submit();
        }
    </script>
...
<body style="margin: 0px 0px 0px 0px">
    <form id="form1" runat="server">
        <input type="hidden" id="hHAWBNum" name="hHAWBNum" value="<%=vHAWB %>" />
        <br />
        <div style="text-align: center">
            <table cellpadding="2" cellspacing="0" border="0" width="95%" style="text-align: left"
                ...
                <tr>
                    ...
                    <td>
                        <%=FormatNumberPlus(costItemList(i)("cost_amt"),2) %>
                    </td>
                    <td>
