...
<%
    ...
    Sub GetAllCreditItems
        ...
        SQL = "SELECT * FROM hawb_agent_credit WHERE hawb_num=N'" & vHAWB & "'"
    ...
    Sub AddCreditItem
        ...
        SQL = "INSERT INTO hawb_agent_credit(elt_account_number,hawb_num,charge_code,charge_desc,credit_amt,remark) " _
    ...
    Sub DeleteCreditItem
        ...
        SQL = "DELETE FROM hawb_agent_credit WHERE elt_account_number=" & elt_account_number _
    ...
    <script type="text/javascript">
        ...
        function addNewItem(){
            ...
            if(document.getElementById("hChargeItem").value == "" 
                ...
                document.getElementById("form1").action = "new_edit_hawb_agent_credit.asp?mode=add";
        ...
        function removeItem(arg){
            document.getElementById("form1").action = "new_edit_hawb_agent_credit.asp?mode=delete&did=" + arg;
            document.getElementById("form1").method = "post";
            document.getElementById("form1").submit();
        }
