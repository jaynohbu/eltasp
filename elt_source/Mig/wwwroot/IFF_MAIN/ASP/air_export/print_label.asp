...
//	                return false;
//	            }
	           // alert('vPrintPortWithOption' + vPrintPortWithOption);
...
<body style="margin: 0px 0px 0px 0px;" onload="LoadPage()">
    ...
    <form id="form1" name="form1" accept-charset="UTF-8" action="">
        ...
        <div style="text-align: center">
            <table style="width: 95%; border: solid 1px #a0829c" cellpadding="5" cellspacing="0"
                class="bodycopy">
                <tr style="background-color: #e5d4e3">
                ...
                <tr>
                    <td>
                        <table style="width: 100%" cellpadding="2" cellspacing="0" border="0" class="bodycopy">
                            <tr style="background-color: #f0e7ef; height: 20px" class="bodyheader">
                                <td>
                            ...
                            <tr id="trHouse<%=i %>">
                                ...
                                <td>
                                    <input id="txtLabelNo<%=i %>" name="txtLabelNo" type="text" size="12" class="d_shorttextfield"
                                        value="<%=aAllData(i)("label_no") %>" readonly="readonly" />
                ...
                <tr style="background-color: #e5d4e3; height: 2px">
                    <td>
                    </td>
                </tr>
                <tr style="background-color: #e5d4e3">
