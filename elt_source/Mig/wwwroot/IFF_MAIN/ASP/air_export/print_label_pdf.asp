...
<% 
    ...
    Sub print_pdf_label(flag)
        Dim i, j, k, num, vLabelCount, vLabelStart, vShipperInfo, vConsigneeInfo
            ...
            For j=1 To Request.Form("txtHouse").Count
                If Request.Form("chkHouse")(i) = Request.Form("txtHouse")(j) Then
                    ...
                    For k=0 To vLabelCount-1
						...
						vShipperInfo = GetBusinessAddress(Request.Form("hShipperAcct")(j))
                        PDF.SetFormFieldData "shipper" & num, vShipperInfo, 0
                        PDF.SetFormFieldData "consigneeName" & num, GetBusinessName(Request.Form("hConsigneeAcct")(j)), 0
						vConsigneeInfo = GetBusinessAddress(Request.Form("hConsigneeAcct")(j))
                        PDF.SetFormFieldData "consignee" & num, vConsigneeInfo, 0
