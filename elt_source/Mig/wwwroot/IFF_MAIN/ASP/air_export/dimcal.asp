...
<head>
    ...
    function closeAndUpdate(){
        ...
        if(self.opener.document.frmHAWB.lstKgLb<%=itemNum %>.value == "K"){
            totalDimension = parseFloat(document.getElementById("txtCBM").value);
            //factor = 5997.0691
        }
        if(self.opener.document.frmHAWB.lstKgLb<%=itemNum %>.value == "L"){
        ...
        if(totalDimension == ""){
            ...
            if(ans) { 
				self.opener.document.frmHAWB.hDimDetail<%=itemNum %>.value = "";
				self.opener.document.frmHAWB.txtDimension<%=itemNum %>.value = "0";
				self.opener.document.frmHAWB.dimtext.value = "";
				self.opener.setChargeableWeight(<%=itemNum %>);
                window.close(); 
            }
        }
        else {
            ...
            //self.opener.document.frmHAWB.txtDimension<%=itemNum %>.value = Math.round(totalDimension/factor) 
            
            self.opener.document.frmHAWB.txtDimension<%=itemNum %>.value=totalDimension.toFixed(0);
