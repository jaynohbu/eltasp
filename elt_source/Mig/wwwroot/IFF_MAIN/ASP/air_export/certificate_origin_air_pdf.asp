...
<% 
    ...
    Sub get_param_values(PDF)
        ...
        PDF.SetFormFieldData "awbnum", checkBlank(Request.Form("txtHawbNum").Item,Request.Form("txtMawbNum").Item) & "", 0
        PDF.SetFormFieldData "docnum", Request.Form("txtDocNum").Item & "", 0
	    PDF.SetFormFieldData "exportref", Request.Form("txtExportRef").Item & "", 0
	    PDF.SetFormFieldData "state", Request.Form("txtUsState").Item & "", 0
	    PDF.SetFormFieldData "exportInstr", Request.Form("txtExportInstr").Item & "", -998
	    ...
	    PDF.SetFormFieldData "loadingtermial", Request.Form("txtLoadingTerminal").Item & "", 0
