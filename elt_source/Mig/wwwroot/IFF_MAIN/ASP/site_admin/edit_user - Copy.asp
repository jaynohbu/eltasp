...
reDim aOrgName(rs.RecordCount+1)
reDim aOrgAcct(rs.RecordCount+1)
...
<body link="336699" vlink="336699" topmargin="0">
    <form name="form1" method="post" action="edit_user.asp" webbot-action="--WEBBOT-SELF--">
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="9190A5"
                    ...
                    <table width="100%" border="0" cellpadding="2" cellspacing="0">
                        ...
                        <tr align="left" bgcolor="DDDDED">
                            ...
                            <td colspan="2" valign="middle" bgcolor="DDDDED" class="bodyheader">
                                ...
                                <select name="lstUser" size="1" class="smallselect" style="width: 127px" onchange="ChangeUser()"
                            ...
                            <td class="bodycopy">
                                <select name="lstUserType" size="1" class="smallselect" style="width: 140px" <% if NOT isAdmin then response.write "style='visibility:hidden'" %>
                                    <% if trim(LCASE(selectedID)) = "admin" then response.write " disabled='disabled'" %>>
                                    <option value="1" <%  if vUserType=1 then response.write("selected") %>>Customer</option>
          ...
          -->
                            ...
                            <td class="bodycopy">
                                <%if isAdmin then %>
                                <span class="bodyheader">Organization</span>
                                <% end if%>
                            </td>
                            <td width="281" colspan="2" class="bodycopy">
                                <select name="lstUserOrg" size="1" class="smallselect" style="width: 210px" <% if NOT isAdmin then response.write "style='visibility:hidden'" %>>
                                    <% for i=0 to oIndex-1 %>
                        ...
                        <tr align="left" bgcolor="#f3f3f3" class="bodycopy">
                            ...
                            <td colspan="2" valign="middle">
                                <b><font color="#36255a">
                                    <input name="txtFirstName" class="bodyheader" value="<%= vFirstName %>" size="23">
                                </font></b>
                            </td>
                            <td valign="middle">
                                Last Name</td>
                            <td width="261" valign="middle">
                                <b><font color="#36255a">
                                    <input name="txtLastName" class="bodyheader" value="<%= vLastName %>" size="20">
                                </font></b>
                            </td>
                            ...
                            <td colspan="2" valign="middle">
                                <b><font color="#36255a">
                                    <input name="txtTitle" class="shorttextfield" value="<%= vTitle %>" size="24">
                                </font></b>
                            </td>
                        </tr>
                        <tr align="left" bgcolor="#FFFFFF" class="bodycopy">
                            ...
                            <td colspan="2" valign="middle">
                                <b><font color="#36255a">
                                    <input name="txtarr_LoginID" class="shorttextfield" value="<%= varr_LoginID %>" size="23">
                                </font></b>
                            </td>
                            <td valign="middle">
                                Password</td>
                            <td valign="middle">
                                <b><font color="#36255a">
                                    <input name="txtPassword1" type="password" class="shorttextfield" value="<%= vPassword1 %>"
                                        size="20">
                                </font></b>
                            </td>
                            <td valign="middle">
                            ...
                            <td colspan="2" valign="middle">
                                <b><font color="#36255a">
                                    <input name="txtPassword2" type="password" class="shorttextfield" value="<%= vPassword2 %>"
                                        size="24">
                                </font></b>
                            </td>
                        </tr>
                        <tr align="left" bgcolor="#f3f3f3" class="bodycopy">
                            ...
                            <td colspan="2" valign="middle">
                                <b>
                                    <input name="txtIg_user_ssn" type="text" class="shorttextfield" value="<%= vIg_user_ssn %>"
                                        size="23">
                                </b>
                            </td>
                            <td valign="middle">
                            ...
                            <td valign="middle">
                                <b>
                                    <input name="txtIg_user_dob" type="text" class="m_shorttextfield" preset="shortdate"
                            ...
                            <td colspan="2" valign="middle">
                                <b><font size="2">
                                    <% if isAdmin then %>
                                    <input name="btnCountry" type="button" class="formbody" value="Go" onclick="javascript:GoPageSet();"
                                        style="cursor: hand">
                                    <% end if %>
                                </font></b>
                            </td>
                        ...
                        <tr align="left" bgcolor="#FFFFFF" class="bodycopy">
                            ...
                            <td colspan="2" valign="middle">
                                <b><font color="#36255a">
                                    <input name="txtAddress" class="shorttextfield" value="<%= vAddress %>" size="36">
                                </font></b>
                            </td>
                            <td valign="middle">
                                City</td>
                            <td colspan="4" valign="middle">
                                <b><font color="#36255a">
                                    <input name="txtCity" class="shorttextfield" value="<%= vCity %>" size="20">
                                </font></b>
                            </td>
                        </tr>
                        <tr align="left" bgcolor="#F3f3f3" class="bodycopy">
...
<!--
Sub DeleteClick()
sIndex=cint(form1.lstUser.selectedindex)
UserName=document.form1.lstUser.item(sIndex).Text
if (UserName = "admin") then
	msgbox "You can not delete the user [Admin]"
	exit sub
end if

UserID=clng(document.form1.lstUser.Value)
if sIndex>0 then
	ok=MsgBox ("Do you really want to delete " & UserName & "?" & chr(13) & "",36,"Message")
	if ok=6 then	
...
function check_max_user()
	DIM v_curUsre, v_maxUser
	v_curUser = "<%=v_curUser%>"
	v_maxUser = "<%=v_maxUser%>"
	
	if cInt(v_curUser) >= cInt(v_maxUser) then
		msgbox "Accessed the maximum users limit."&chr(10)&"Please contact support center to create new user."	
...
Sub AddClick(TranNo)
	if not check_max_user() then
		exit sub
	end if	
	
	NoItem=Cint(document.form1.hNoItem.Value)
	arr_LoginID=LCase(document.form1.txtarr_LoginID.Value)
	sindex=Document.form1.lstUserOrg.Selectedindex
	OrgAcct=Document.form1.lstUserOrg.item(sindex).value
	sindex1=Document.form1.lstUserType.Selectedindex
	UserType=Document.form1.lstUserType.item(sindex1).value
	dob=Document.form1.txtIg_user_dob.value

	if arr_LoginID = "admin" Or arr_LoginID = "system" then
		Exit sub
	end If
	
	if trim(arr_LoginID)="" then
		MsgBox "Please enter a Login ID!"
		Exit sub
	end If

for i=0 to NoItem
	if arr_LoginID=LCase(document.form1.lstUser.item(i).Text) then
		msgBox "Login ID: " & arr_LoginID & " exists already."
		Exit sub
	end if
Next

if not form1.txtPassword1.Value=form1.txtPassword2.Value then
	MsgBox "The second password doesn't march the first password!"
	Exit sub
end If
...
arr_LoginID=LCase(form1.txtarr_LoginID.Value)
if trim(arr_LoginID) = "" then
	MsgBox "Please enter the login ID!"
	Exit Sub
end if
...
if "<%=isAdmin%>" = "True" then
	...
	NoItem=Cint(document.form1.hNoItem.Value)
	sIndex=cint(form1.lstUser.selectedindex)
	UserID=cint(document.form1.lstUser.item(sIndex).Value)
	UserName =  document.form1.lstUser.item(sIndex).Text

	if sIndex = 0 and ( arr_LoginID = "admin" Or arr_LoginID = "system") then
		msgbox "ID: admin exists already!"
		exit sub
	end if

	if NOT LCase(UserName) = "admin" and ( arr_LoginID = "admin" Or arr_LoginID = "system") then
		msgbox "ID: admin exists already!"
		exit sub
	end if

	if LCase(UserName) = "admin" and NOT arr_LoginID = "admin" then
		msgbox "You can't change admin ID!"
		exit sub
	end if
...
DIM iCnt
	...
	if NOT LCase(arr_LoginID) = LCase(UserName) then
		iCnt = 0	
		for i=0 to NoItem
			if LCase(arr_LoginID)=LCase(document.form1.lstUser.item(i).Text) then
				iCnt = iCnt + 1
			end if
		next
		
		if iCnt > 0 then
			MsgBox "ID: " & arr_LoginID & " exists already."
			exit sub
		end if
	end if
	
	sindex2=Document.form1.lstUserOrg.Selectedindex
	OrgAcct=cLng(Document.form1.lstUserOrg.item(sindex2).value)
	sindex1=Document.form1.lstUserType.Selectedindex
	UserType=cLng(Document.form1.lstUserType.item(sindex1).value)


//dob=Document.form1.txtIg_user_dob.value

//'if Not IsDate(dob) then
//'		MsgBox "Please enter correct Date for dob (MM/DD/YY)"
//'		Exit Sub
//'end if

//'if UserType=1 and OrgAcct=0 then
//'	MsgBox "Please select a ORGANIZATION for this user!"
//'	Exit Sub
//'end if
...
Sub ChangeUser()
sIndex=form1.lstUser.selectedindex
UserID=cint(document.form1.lstUser.item(sIndex).Value)
