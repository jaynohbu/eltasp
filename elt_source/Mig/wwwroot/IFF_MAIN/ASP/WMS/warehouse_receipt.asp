...
<head>
    ...
    <script type="text/javascript" language="javascript">
		...
		function getWRShipInfo(vWRNum){
            ...
            var url="/IFF_MAIN/ASP/ajaxFunctions/ajax_warehouse_receipt.asp?mode=shipCheck&qstr=" + encodeURIComponent(vWRNum);
           ...
           var Item_QTY =  document.getElementById("txtItemPieces").value;
            ...
            else
            {
                ...
                try{
                    ...
                    var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_warehouse_receipt.asp?mode=update&uid=" + encodeURIComponent(noValue);
        ...
        function deleteThis(){
            ...
            if(noValue != "" && noValue != "Select One")
            {
                ...
                try{
                    ...
                    var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_warehouse_receipt.asp?mode=delete&uid=" + encodeURIComponent(noValue);
        ...
        function lstSearchNumChange(argV,argL){
            ...
            var url = "/IFF_MAIN/ASP/ajaxFunctions/ajax_warehouse_receipt.asp?mode=view&uid=" + encodeURIComponent(argV);
...
<body onload="<%  If reloadPage="Y" then %> lstSearchNumChange('<%=vOrg%>','<%=vOrgN%>')<% end if%>">
                                            ...
                                            <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="48%" align="center" valign="middle">
                                                        <img src="/IFF_MAIN/ASP/images/button_save_medium.gif" width="46" height="18" name="bSave"
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-right: #9e816e solid 1px;
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text" autocomplete="off" id="lstReceivedFromName" name="lstReceivedFromName"
                                                                                    ...
                                                                                    onkeyup="organizationFill(this,'All','lstReceivedFromNameChange')" onfocus="initializeJPEDField(this);" /></td>
                                                                            <td>
                                                            ...
                                                            <tr>
                                                                <td height="20" colspan="2" align="center" valign="middle" bgcolor="#f4e9e0" class="bodyheader">
                                                                    <span class="style8">
                                                                        <img src="/iff_main/ASP/Images/required.gif" align="absbottom">FOR ACCOUNT OF (CUSTOMER)
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <tr align="left" valign="middle" bgcolor="#9e816e" class="bodycopy">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" bgcolor="#FFFFFF" class="bodycopy">
                                                                    ...
                                                                    <input name="txtAccountOfContact" type="text" class="shorttextfield" value="" style="width: 300px;" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2" bgcolor="#FFFFFF" class="bodycopy">
                                                                    <!-- Start JPED -->
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="8" bgcolor="#FFFFFF" class="bodycopy">
                                                                    <input type="hidden" name="txtReceivedFromContact" class="shorttextfield" style="width: 300px;" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <table width="92%" border="0" cellpadding="2" cellspacing="0" bordercolor="#9e816e"
                                                ...
                                                <tr bgcolor="#f4e9e0"">
                                                    <td width="5%" height="19" bgcolor="#f4e9e0">
                                                        <span class="bodyheader">
                                                            <img src="/iff_main/ASP/Images/required.gif" align="absbottom">QTY</span></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top" bgcolor="#FFFFFF">
                                                        <textarea name="txtItemDesc" id="" wrap="" cols="50" rows="7" class="multilinetextfield"
                                                            style="width: 265px"></textarea></td>
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        <input name="txtGrossWeight" type="text" class="txtunitbox" style="behavior: url(../include/igNumDotChkLeft.htc)" onkeydown="resetWeight();"
                                                            value="" size="10" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="48%" align="center" valign="middle">
                                                        <img src="/IFF_MAIN/ASP/images/button_save_medium.gif" width="46" height="18" name="bSave"
                                                            onclick="saveForm();" style="cursor: hand" /></td>
                                                    <td width="13%" align="right" valign="middle">
                                                        <a href="/IFF_MAIN/ASP/WMS/warehouse_receipt.asp" target="_self">
                                                            <img src="/iff_main/ASP/Images/button_new.gif" width="42" height="17" border="0"
                                                                style="cursor: hand"></a></td>
                                                    <td width="13%" align="right" valign="middle">
                                                        <img src="/IFF_MAIN/ASP/images/button_delete_medium.gif" style="cursor: hand" onclick="deleteThis();"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
