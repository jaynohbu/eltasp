...
'// ---------------------------------------------------------------------------------------------
    ...
    Sub get_all_info()
        ...
        uid = checkBlank(Request.QueryString("uid"),0)
    ...
    Function update_warehouse_receipt
        ...
        For i=0 To WRTableList.Count-1
            ...
            If vMode = "Update" Then
                vTmpPiece = CInt(WRTableList(i)("item_piece_shipout")) - CInt(WRTableList(i)("item_piece_shipped"))
            Else
                '// Inserting case
                vTmpPiece = CInt(WRTableList(i)("item_piece_shipout"))
            End If
            ...
            If NOT WRRS.EOF AND NOT WRRS.BOF Then
                WRRS("item_piece_remain") = CInt(WRRS("item_piece_remain"))-vTmpPiece
                
                If CInt(WRRS("item_piece_remain").value) < 0 Then
                    resVal = False
                Else
                    WRRS.Update()
                    WRRS.Close()
    ...
    Function update_warehouse_history
        ...
        For i=0 To WRTableList.Count-1
            ...
            For j=0 To WRDBTableList.Count-1
                ...
                If j < WRDBTableList.Count Then
                    If j < WRDBTableList.Count And WRTableList(i)("wr_num") = WRDBTableList(j)("wr_num") Then
                        '// Edit Case
                        tmpChangeVal = CInt(WRTableList(i)("item_piece_shipout")) - CInt(WRDBTableList(j)("item_piece_shipout"))
            ...
            If j = WRDBTableList.Count Then
                '// Add Case OK
                tmpChangeVal = CInt(WRTableList(i)("item_piece_shipout"))
        ...
        For j=0 To WRDBTableList.Count-1
            ...
            tmpChangeVal = CInt(WRDBTableList(j)("item_piece_shipout"))
    ...
    Sub insert_warehouse_history(vWRTable,vChangeVal)
        ...
        tempTable.Add "item_piece_remain", CInt(vWRTable("item_piece_remain")) - vChangeVal
        ...
        DO While NOT historyRS.EOF AND NOT historyRS.BOF
            historyRS("item_piece_remain") = CInt(historyRS("item_piece_remain")) - vChangeVal
            historyRS.update()
            historyRS.MoveNext()
        Loop
    ...
    Sub edit_warehouse_history(vWRTable,vChangeVal)
        ...
        tempTable.Add "history_type", "Ship-out Made"
        tempTable.Add "item_piece_origin", vWRTable("item_piece_origin")
        tempTable.Add "item_piece_shipout", CInt(vWRTable("item_piece_shipout")) + vChangeVal
        tempTable.Add "item_piece_remain", CInt(vWRTable("item_piece_remain")) - vChangeVal
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function saveForm(){
            ...
            {
                if (so_num == "" ){	    
                    document.form1.action = "/IFF_MAIN/ASP/WMS/shipout_detail.asp?mode=SaveAsNew";
                }
                else{
                    document.form1.action = "/IFF_MAIN/ASP/WMS/shipout_detail.asp?mode=Update";
                }
        ...
        function GoDetail() {
            ...
            if (Search_id == "" || Search_id == 0){
                ...
                document.form1.action="shipout_list_update.asp?orgAcct=" + Search_id 
...
// Ajax relared functions ---------------------------------------------------------------------    
    
        function displayScreen(req,field,tmpVal,tWidth,tMaxLength,url){
        
            var xmlObj = req.responseXML;
            try{
            var soNum = xmlObj.getElementsByTagName("so_num")[0].childNodes[0].nodeValue;
            if(soNum != ""){
                setField("so_num","txtSoNum",xmlObj);
                ...
                setField("other_info","txtRemarks",xmlObj);
                setField("consignee_acct","hShipToAcct",xmlObj);                        
			    setField("shipper_name","lstShipToName",xmlObj);
                setField("shipper_info","txtShipToInfo",xmlObj);
                ...
                setField("shipout_date","txtShipOutDate",xmlObj);
                setField("customer_contact","txtAccountOfContact",xmlObj);
                setField("created_date","txtSODate",xmlObj); 
                xmlObj = null;
            }
            }catch(error){}
        }
        
        function GetWarehouseList(soNum){
            ...
            var url="/IFF_MAIN/ASP/ajaxFunctions/shipout_detail.asp?soNum=" + encodeURIComponent(soNum);
        ...
        function LoadScreen(){
            ...
            document.getElementById("lstSearchNum").value = "<%=dataTable("so_num") %>";
            document.getElementById("hSearchNum").value = "<%=dataTable("auto_uid") %>";
            
            document.getElementById("txtSONum").value = "<%=dataTable("so_num") %>";
            document.getElementById("txtCarrierRefNo").value = "<%=dataTable("carrier_ref_no") %>";
            document.getElementById("txtCustomerRefNo").value = "<%=dataTable("customer_ref_no") %>";
            document.getElementById("txtPONO").value = "<%=dataTable("PO_NO") %>";            
            document.getElementById("txtSODate").value = "<%=checkBlank(dataTable("created_date"),Date()) %>";
            document.getElementById("hAccountOfAcct").value = "<%=dataTable("customer_acct") %>";
            lstAccountOfChange(<%=checkBlank(dataTable("customer_acct"),0) %>,"<%=GetBusinessName(dataTable("customer_acct")) %>");
            document.getElementById("hTruckerAcct").value = "<%=dataTable("trucker_acct") %>";
            lstTruckerNameChange(<%=checkBlank(dataTable("trucker_acct"),0) %>,"<%=GetBusinessName(dataTable("trucker_acct")) %>");
            document.getElementById("txtRemarks").value = "<%=MakeJavaString(dataTable("other_info")) %>";
            document.getElementById("hShipToAcct").value = "<%=dataTable("consignee_acct") %>";
            lstShipToNameChange(<%=checkBlank(dataTable("consignee_acct"),0) %>,"<%=GetBusinessName(dataTAble("consignee_acct")) %>");
            document.getElementById("txtAccountOfContact").value = "<%=dataTable("customer_contact") %>";
            document.getElementById("txtShipOutDate").value = "<%=checkBlank(dataTable("shipout_date"),Date()) %>";
            document.getElementById("txtReceivedDate").value = "<%=dataTable("received_date") %>";
        ...
        function deleteThis(){
            ...
            if(noValue != "" && noValue != "Select One"){
                ...
                document.form1.action = "shipout_detail.asp?mode=delete";
                document.form1.method = "POST";
                document.form1.target = "_self";
                document.form1.submit();
            }
...
// editable dropdown event controllers ------------------------------------------------------------

        function lstSearchNumChange(argV,argL){
   
            document.form1.action = "/IFF_MAIN/ASP/WMS/shipout_detail.asp?mode=view&uid=" + argV + "&so=" + encodeURIComponent(argL);
            document.form1.method = "POST";
            document.form1.target = "_self";
            document.form1.submit();
        }
        ...
        function getOrganizationInfo(orgNum,infoFormat){
            ...
            var url="/IFF_MAIN/ASP/ajaxFunctions/ajax_get_org_address_info.asp?type=" + infoFormat + "&org=" + encodeURIComponent(orgNum);
        ...
        function CreateBill(){
            ...
            if(resVal){
                if(resVal[0] == "air_house"){
                    window.location.href = "../air_export/new_edit_hawb.asp?DataTransfer=SO&SONum=" + document.getElementById("txtSONum").value;
                }
                if(resVal[0] == "air_master"){
                    window.location.href = "../air_export/new_edit_mawb.asp?fBook=yes&Edit=yes&MAWB=" + resVal[1] + "&DataTransfer=SO&SONum=" + document.getElementById("txtSONum").value;
                }
                if(resVal[0] == "ocean_house"){
                    window.location.href = "../ocean_export/new_edit_hbol.asp?DataTransfer=SO&SONum=" + document.getElementById("txtSONum").value;
                }
                if(resVal[0] == "ocean_master"){
                    window.location.href = "../ocean_export/new_edit_mbol.asp?ChangeBookingNum=yes&Edit=yes&BookingNum=" + resVal[1] + "&DataTransfer=SO&SONum=" + document.getElementById("txtSONum").value;
                }
                if(resVal[0] == "domestic_house"){
                    parent.document.frames['topFrame'].changeTopModule("Domestic");
                    window.location.href = "../domestic/new_edit_hawb.asp?mode=transfer&SONum=" + document.getElementById("txtSONum").value;
                }
            }
        }
...
<body onload=" LoadScreen(); ">
    <form id="form1" name="form1" action="">
                    ...
                    <td width="55%" rowspan="2" align="right" valign="bottom">
                        <div id="print">
                            <a href="javascript:CreateBill();">
                                <img src="/iff_main/ASP/Images/icon_createhouse.gif" alt=""
                            ...
                            <a href="/IFF_MAIN/ASPX/WMS/ShipoutManager.aspx">
                                <img src="/iff_main/ASP/Images/icon_detailwindow.gif" alt="" style="margin-right: 10px" />Ship
                                Out List</a>
                            <img src="/iff_main/ASP/Images/button_devider.gif" alt="" />
                            <a href="javascript:;" onclick="viewPDF(); return false;">
                                <img src="/iff_main/ASP/Images/icon_printer.gif" alt="" style="margin-right: -5px" />Ship Out Report</a>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td width="45%" valign="bottom">
                        <!-- Start JPED -->
                        <input type="hidden" id="hSearchNum" name="hSearchNum" value="" />
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#9e816e"
                    ...
                    <table width="98%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="48%" align="center" valign="middle">
                                <img src="/IFF_MAIN/ASP/images/button_save_medium.gif" name="bSaveTop" width="46"
                                    height="18" id="bSaveTop" style="cursor: hand" onclick="saveForm()" /></td>
                            <td width="13%" align="right" valign="middle">
                                <a href="/iff_main/ASP/WMS/shipout_detail.asp" target="_self">
                                    <img src="/IFF_MAIN/ASP/Images/button_new.gif" border="0" style="cursor: hand" /></a></td>
                            <td width="13%" align="right" valign="middle">
                                <img src="/IFF_MAIN/ASP/images/button_delete_medium.gif" style="cursor: hand" onclick="deleteThis()" />
                            </td>
                        </tr>
                    </table>
                </td>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-right: #9e816e solid 1px">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" bgcolor="#FFFFFF" class="bodycopy">
                                            <!-- Start JPED -->
                                            <input type="hidden" id="hShipToAcct" name="hShipToAcct" value="" />
                                                ...
                                                <tr>
                                                    <td style="height: 20px">
                                                        <input type="text" autocomplete="off" id="lstShipToName" name="lstShipToName" value=""
                                                            ...
                                                            border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="organizationFill(this,'All','lstShipToNameChange')"
                                                            onfocus="initializeJPEDField(this);" /></td>
                                                    <td style="height: 20px">
                                                        <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstShipToName','All','lstShipToNameChange')"
                                                            style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                                            border-left: 0px solid #7F9DB9; cursor: hand;" /></td>
                                                    <td style="height: 20px">
                                            ...
                                            <textarea wrap="hard" id="txtShipToInfo" name="txtShipToInfo" class="multilinetextfield"
                                                cols="" rows="5" value="vshiperoutinfo" style="width: 300px"></textarea>
                                            <!-- End JPED -->
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td height="20" colspan="3" align="center" valign="middle" bgcolor="#f4e9e0" class="bodyheader">
                                            <span class="style8">
                                                <img src="/iff_main/ASP/Images/required.gif" align="absbottom">FOR ACCOUNT OF </span>
                                        </td>
                                    </tr>
                                    <tr align="left" valign="middle" bgcolor="#9e816e" class="bodycopy">
                                        <td height="1" colspan="4">
                                    ...
                                    <tr>
                                        ...
                                        <td height="18" colspan="3" bgcolor="#FFFFFF" class="bodycopy">
                                            ...
                                            <input name="txtAccountOfContact" id="txtAccountOfContact" maxlength="128" type="text"
                                                class="shorttextfield" value="" style="width: 300px;" /></td>
                                    </tr>
                                    <tr>
                                        <td bgcolor="#FFFFFF">
                                        </td>
                                                ...
                                                <tr>
                                                    <td style="height: 20px">
                                                        <input type="text" autocomplete="off" id="lstAccountOfName" name="lstAccountOfName"
                                                            ...
                                                            onkeyup="organizationFill(this,'','lstAccountOfChange')" onfocus="initializeJPEDField(this);" /></td>
                                                    <td style="height: 20px">
                                                        <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstAccountOfName','','lstAccountOfChange')"
                                                            style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td height="18" bgcolor="#FFFFFF">
                                            <input name="txtSODate" type="text" class="m_shorttextfield" value="" size="16" style="width: 70px;
                                                height: 16px" preset="shortdate" /></td>
                                        <td bgcolor="#FFFFFF">
                                            <input name="txtSONum" id="txtSONum" type="text" class="readonlybold" value="" size="20"
                                    ...
                                    <tr>
                                        ...
                                        <td height="18" colspan="2" bgcolor="#FFFFFF">
                                            <!-- Start JPED -->
                                            <input type="hidden" id="hTruckerAcct" name="hTruckerAcct" value="" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtReceivedDate" name="txtReceivedDate" type="hidden" class="m_shorttextfield"
                                                value="" style="width: 140px" preset="shortdate" /></td>
                                    </tr>
                                    <tr>
                                        <td style="height:4px" colspan="3">
                                        </td>
            ...
            <tr>
                <td style="height:1px; background-color:#9e816e" colspan="9">
                </td>
            </tr>
            <tr>
                <td style="height: 12px">
                    <div id="WRListDiv">
                        <!--  #INCLUDE VIRTUAL="/IFF_MAIN/ASP/WMS/shipout_list.asp" -->
                    </div>
                </td>
            </tr>
            <tr>
                    ...
                    <table width="98%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="48%" align="center" valign="middle" style="height: 19px">
                                <img src="/IFF_MAIN/ASP/images/button_save_medium.gif" name="bSaveBottom" width="46"
...
<!-- #INCLUDE VIRTUAL="/IFF_MAIN/ASP/include/StatusFooter.asp" -->
