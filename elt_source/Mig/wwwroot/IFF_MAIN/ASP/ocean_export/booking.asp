                ...
                <td width="70%" align="right" valign="baseline">
                    ...
                    <input name="txtJobNum" type="text" class="lookup" size="22" value="Search Here"
                        ...
                        tabindex="1"><img src="../images/icon_search.gif" name="B1" width="33" height="27"
                            align="absmiddle" style="cursor: hand" onclick="lookupFile()"></td>
            </tr>
        </table>
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="45%" valign="bottom">
                        ...
                        <script language="javascript"> function <%=iMoonComboBoxName%>_OnChangePlus() { BookingChange(); } </script>
                        ...
                        <tr>
                            <td height="24" align="center" valign="middle" bgcolor="BFD0C9">
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="24%">
                                            <img src="/iff_main/ASP/Images/spacer.gif" width="70" height="5"></td>
                                        ...
                                        <td width="12%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/ocean_export/booking.asp" target="_self" tabindex="-1">
                                ...
                                <table width="75%" border="0" cellpadding="2" cellspacing="0" bordercolor="6D8C80"
                                    ...
                                    <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                        ...
                                        <td height="20" bgcolor="f3f3f3" class="bodyheader">
                                            <img src="/iff_main/ASP/Images/required.gif" align="absbottom">New Ocean Booking
                                            No.</td>
                                    ...
                                    <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                        ...
                                        <td class="bodyheader">
                                            <% If IsMasterExist Or IsHouseExist Then %>
                                                <input name="txtBookingNum" value="<%= vBookingNum %>" size="27" class="d_shorttextfield" readonly="readonly" />
                                            <% Else %>
                                    ...
                                    <tr align="left" valign="middle" bgcolor="#F3f3f3" class="bodycopy">
                                        ...
                                        <td width="26%" class="bodyheader">
                                            &nbsp;</td>
                                        <td width="12%">
                                            <span class="bodyheader">Consolidator</span></td>
	    ...
	    window.location.href = "new_edit_mbol.asp?ChangeBookingNum=yes&Edit=yes&BookingNum=<%=Server.URLEncode(vBookingNum) %>&WindowName=<%=WindowName %>";
					  ...
					  %>>
                                            ...
                                            <div id="<%=iMoonComboBoxName%>_NewDiv" style="display: none; position: absolute;
                                                top: 0; left: 0; width: 17px">
                                                <img id="<%=iMoonComboBoxName%>_AddNewButton" src="/ig_common/Images/combobox_addnew.gif"
                                                    border="0" alt="Quick Add Consolidator" /></div>
                                            <!-- /End of Combobox/ -->
                                        </td>
                                    </tr>
                                    <tr align="left" valign="middle" bgcolor="#F3f3f3" class="bodycopy">
                                    ...
                                    <tr align="left" valign="middle" bgcolor="#F3f3f3" class="bodycopy">
                                        ...
                                        <td height="20" class="bodyheader">
                                            <img src="/iff_main/ASP/Images/required.gif" align="absbottom">ETD</td>
                                        <td class="bodyheader">
                                            Place of Receipt</td>
                                        <td>
                                            &nbsp;</td>
                                    ...
                                    <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                        ...
                                        <td class="bodycopy">
                                            <input name="txtETD" class="m_shorttextfield" preset="shortdate" value="<%= vDeptDate %>"
                                                size="19"></td>
                                        <td colspan="2">
                                        ...
                                        <tr align="left" valign="middle" bgcolor="#F3f3f3" class="bodycopy">
                                            <td>
                                                &nbsp;</td>
                                            <td class="bodyheader">
                                                Port of Unloading</td>
                                            <td height="20" class="bodyheader">
                                                <img src="/iff_main/ASP/Images/required.gif" align="absbottom">ETA</td>
                                            <td class="bodyheader">
                                                <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Cut-Off Date</td>
                                            <td class="bodyheader">
                                                Time</td>
                                            <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                                <td>
                                                ...
                                                <td class="bodycopy">
                                                    <input name="txtETA" class="m_shorttextfield" preset="shortdate" value="<%= vArrivalDate %>"
                                                        size="19" /></td>
                                                <td>
                                                    <input name="txtCutOff" class="m_shorttextfield" preset="shortdate" value="<%= vCutOff %>"
                                                        size="19" /></td>
                                                <td>
                                                    <input name="txtCutOff_Time" class="m_shorttextfield" preset="maxsize" value="<%= vCutOff_Time %>"
                                                        size="19" /></td>
                                                <tr align="left" valign="middle" bgcolor="#f3f3f3" class="bodycopy">
                                                    <td>
                                                        &nbsp;</td>
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                                    ...
                                                    <td class="bodycopy">
                                                        ...
                                                        <input type="text" value="<%= vContainerType %>" name="txtContainerType" class="shorttextfield"
                                                            style="width: 80px; visibility: <% if Not vFCLLCL="FCL" then response.write("hidden") %>"></td>
                                                    <td colspan="2" valign="top">
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#Ffffff" class="bodycopy">
                                                    ...
                                                    <td height="20" colspan="2" class="bodycopy">
                                                        <input name="txtMBOLNum" class="shorttextfieldBold" maxlength="16" value="<%= vMBOL %>"
                                                            size="28">
                                                        <select name="lstMBOL" size="1" class="smallselect" style="width: 148px; visibility: hidden">
                                                            <% for i=0 to mIndex-1 %>
                                    ...
                                    <tr>
                                        ...
                                        <td width="52%" align="center" valign="middle">
                                            <input type="image" src="../images/button_save_medium.gif" width="46" height="18"
                                                ...
                                                style="cursor: hand" /></td>
                                        <td width="12%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/ocean_export/booking.asp" target="_self">
                                                <img src="/iff_main/ASP/Images/button_new.gif" width="42" height="17" border="0"
                                                    style="cursor: hand"></a></td>
                                        <td width="12%" align="right" valign="middle">
...
////////////////////
	...
	Set lstBookingObj = Document.getElementById("lstBookingNum")
	sIndex = lstBookingObj.selectedIndex
    mIndex = lstBookingObj.size
	
    BookNum = trim(document.form1.txtBookingNum.value)
    
    If TRIM(BookNum) = "" then
        msgbox "Please enter a Ocean Booking Number."
	    Exit sub
    End if
    ...
    if sIndex = 0 then
		BookNum = TRIM(UCASE(document.form1.txtBookingNum.value))
		existBookNum = false
		
		For i=0 to mIndex-1
			if BookNum = TRIM(UCASE(lstBookingObj.item(i).text)) then
				existBookNum = true
				exit for
			end if
		Next		
		if existBookNum then		
			msgbox "Booking No # " & document.form1.txtBookingNum.value & " exists already."
			exit sub
		end if
    else
		BookNum = TRIM(lstBookingObj.item(sindex).Text)
    end if
    
    '// If Not CheckBookingNo(TRIM(UCASE(document.form1.txtBookingNum.value))

    If Not CheckMBOLNo(TRIM(UCASE(document.form1.txtMBOLNum.value)),BookNum) Then
        Exit Sub
    End If

	DeptDate=document.form1.txtETD.Value
	ArrivalDate=document.form1.txtETA.Value
	CutOff=document.form1.txtCutOff.Value
	if IsDate(DeptDate)=False then
		MsgBox "Please enter Departure Date in MM/DD/YYYY format!"
	elseif IsDate(ArrivalDate)=False then
		MsgBox "Please enter Arrival Date in MM/DD/YYYY format!"
	elseif IsDate(CutOff)=False then
		MsgBox "Please enter Cutoff Date in MM/DD/YYYY HH:MM:SS format!"
	else
...
Sub LCLChange()
    sindex=document.form1.lstFCLLCL.selectedindex
    if Not document.form1.lstFCLLCL.item(sindex).Text="FCL" then
