...
<body link="#336699" vlink="#336699" style="margin: 0px 0px 0px 0px" onload="self.focus()">
                ...
                <div id="print">
                    <img src="/iff_main/ASP/Images/icon_submit.gif" align="absbottom"><a href="javascript:;"
                        onclick="AESClick();return false;">Submit to AES Weblink</a><img src="/iff_main/ASP/Images/button_devider.gif"><a
                            href="/IFF_MAIN/ASPX/Misc/ManageOceanSED.aspx">Manage AES</a><img src="/iff_main/ASP/Images/button_devider.gif"
                                alt="" /><a href="javascript:void(viewPop2('PopWin','http://www.aesdirect.gov'));">AES
                                    Direct Homepage</a><img src="/iff_main/ASP/Images/button_devider.gif"><a href="javascript:;"
                                ...
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="13%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/ocean_export/sed.asp" target="_self">
    ...
    End If
                                    ...
                                    <tr align="left" valign="middle">
                                        ...
                                        <td bgcolor="#E0EDE8">
                                            <img src="/iff_main/ASP/Images/required.gif" align="absbottom"><strong>15. Shipment Reference No.</strong></td>
                                    </tr>
                                    <tr align="left" valign="middle">
                            ...
                            <td colspan="2" bgcolor="#FFFFFF">
                                <table width="100%" border="0" cellpadding="1" cellspacing="2" bgcolor="#FFFFFF"
                                    ...
                                    <tr align="left" valign="top" bgcolor="#E0EDE8">
                                        ...
                                        <td>
                                            <a href="javascript:void(viewPop3('PopWinX','../code/export_code.txt'));" class="style1">
                                                Export Code</a></td>
                                        <td>
                                            <a href="javascript:void(viewPop3('PopWinX','../code/license_code.txt'));" class="style1">
                                                License Type</a></td>
                                        <td>
                                            &nbsp;</td>
                                        <td>
...
//	{
		...
		xmlHTTP.open(encodeURI("get","/IFF_MAIN/asp/include/get_schedule_b.asp?" + param) ,false); 
...
ShipperInfo = get_organization_info_sed(encodeURI("../ajaxFunctions/ajax_get_org_address_info.asp?org=" & Document.form1.lstShipper.item(sindex).value) & "&type=sed_s")
...
ConsigneeInfo = get_organization_info_sed(encodeURI("../ajaxFunctions/ajax_get_org_address_info.asp?org=" & Document.form1.lstConsignee.item(sindex).value & "&type=sed_c"))
...
Sub newScheduleB()
		...
		window.open encodeURI("../../ASPX/Onlines/ScheduleB/ScheduleBCreate.aspx?ff=" & ShipperAcct & "&nn=" & ShipperName), "Dimension_Calculation", props
End Sub
...
if sssindex = 0 then
	...
	if sIndex=1 then
        ShipperInfo= get_organization_info_sed(encodeURI("../ajaxFunctions/ajax_get_org_address_info.asp?org="& Document.form1.lstShipper.item(sssindex).value & "&type=sed_s"))
