        ...
        <table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr>
                ...
                <td width="57%" align="right" valign="middle">
                    <div id="print">
                        <img src="/iff_main/ASP/Images/icon_printer.gif" width="40" height="27" align="absbottom"><a
            ...
            <tr>
                        ...
                        <tr valign="middle" bgcolor="#E7F0E2">
                            <td colspan="10" align="left" bgcolor="#f3f3f3" class="bodycopy">
                                    ...
                                    <tr align="left" valign="middle" bgcolor="E7F0E2">
                                        ...
                                        <td width="57%" colspan="-2" bgcolor="#FFFFFF">
                                            <input name="txtAcctBalance" class="readonlyboldright" value="<%= FormatNumberPlus(vAcctBalance,2) %>"
                                                size="18" style="behavior: url(../include/igNumChkRight.htc)"><input type="hidden"
                                                    name="hVendorName" value="<%= VendorName %>"></td>
                                    </tr>
                                    <tr align="left" valign="middle" bgcolor="E7F0E2">
                                        <td height="20" bgcolor="#f3f3f3" class="bodycopy">
                                            &nbsp;</td>
                                        <td height="20" bgcolor="#f3f3f3">
                                            <img src="/iff_main/ASP/Images/required.gif" align="absbottom"><span class="bodyheader">Company
                                                Name</span></td>
                                ...
                                <table width="648" height="261" border="0" align="center" cellpadding="0" cellspacing="0"
                                    bordercolor="#89A979" background='/iff_main/Images/<%
			  if check_void then response.write "checkback_void.gif" else response.write "checkback.gif"%>'>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="61%" align="left" valign="bottom">
                                                        <input name="txt_print_check_as" type="text" id="txt_print_check_as" class="shorttextfield"
                                                            autocomplete="off" style="width: 98%; vertical-align: middle" value="<%=v_print_check_as%>" /></td>
                                                    <td width="4%" align="left" valign="bottom">
                                                        &nbsp;</td>
                                                    <td width="22%" align="left" valign="bottom">
                                                        <input name="txtAmount" class="readonlyboldright" value="<%=vAmount %>" size="15"
                                                            readonly>
                                                        <input type="hidden" name="txtOldAmount" value="<%= vLastAmount %>"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                            ...
                                            <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="94%" align="left" valign="bottom">
                                                        <input name="txtMoney" type="text" class="readonly" size="95" readonly>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    <td align="left" valign="top">
                                                        &nbsp;</td>
                                                    <td align="left" valign="top">
                                                        <textarea name="txtVendorInfo" cols="45" rows="4" class="multilinetextfield"><%= vVendorInfo %></textarea></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                        ...
                        <tr valign="middle" bgcolor="#FFFFFF">
                            <td align="center">
                                <input type="checkbox" id="BillCheck" name="cBillCheck<%= i %>" onclick="CheckClick(<%= i+1 %>)"
                                    <% if BillCheck(i)="Y" then response.write("checked") %> value="Y">
                                <input type="hidden" id="hBillNo" name="hBillNo<%= i %>" value="<%= BillNo(i) %>"></td>
                            <td align="left">
                            ...
                            <td align="left">
                                <input name="txtBillInvoiceNo<%= i %>" class="shorttextfield" id="txtBillInvoiceNo<%= i %>"
                                    ...
                                    style="behavior: url(../include/igNumChkLeft.htc)"></td>
                            <td align="left">
                                <input id="BillAmt" name="txtBillAmt<%= i %>" size="14" value="<%=ConvertAnyValue(BillAmt(i),"Amount","0.00") %>"
                                    class="numberfield" style="behavior: url(../include/igNumChkRight.htc); width: 70px"></td>
                            <td align="left">
                                &nbsp;</td>
                            <td align="left">
                                <input id="BillAmtDue" name="txtBillAmtDue<%= i %>" size="14" value="<%=ConvertAnyValue(BillAmtDue(i),"Amount","0.00") %>"
                                    onchange="BillChange(<%= i+1 %>)" class="numberfield" style="behavior: url(../include/igNumChkRight.htc);
                                    width: 70px"></td>
                            <td align="left">
                        ...
                        <tr valign="middle" bgcolor="#F3f3f3">
                            ...
                            <td align="left" class="bodyheader">
                                <input name="txtTotalAmtDue" class="readonlyboldright" value="<%= TotalBillAmtDue %>"
                                    size="14" style="behavior: url(../include/igNumChkRight.htc); width: 70px" readonly="readonly"></td>
                            <td align="left" class="bodyheader">
...
<script type="text/vbscript">
    ...
    Sub PageLoad
	    ...
	    if not "<%=EditCheck%>" = "yes" then
		    ...
		    if document.form1.txtCheck.Value="" or document.form1.txtCheck.Value="0" then
        ...
        DIM tmpMoney
        tmpMoney = "<%= vAmount %>"
        tmpMoney = Replace(tmpMoney,",","")
        document.form1.txtMoney.Value=ToMoney(tmpMoney)
    End Sub
    
    Sub make_money_string()
	    NoItem=cint(document.form1.hNoItem.Value)
	    Amt=0
	    for i=1 to NoItem
		    If document.all("BillCheck").item(i).checked=true then
			
			    If document.getElementById("hCostExpenseItemName" & (i-1)).value = "" Then
				    MsgBox "Please select an ITEM!"
				    exit sub
			    end if
			    BillAmtDue=cdbl(document.all("BillAmtDue").item(i).Value)
			    if document.all("BillAmtPaid").item(i).Value=0 then
				    document.all("BillAmtPaid").item(i).Value=BillAmtDue
			    end if
			    Amt=Amt+cDbl(document.all("BillAmtPaid").item(i).Value)
		    end if
	    next
	    document.form1.txtAmount.Value=formatnumber(Amt,2,,,0)
	    document.form1.txtTotalAmtPaid.Value=formatnumber(Amt,2,,,0)
	    Money=ToMoney(Amt)
    ...
    Sub BalChange()
        ...
        If Bal <> "" Then
            document.form1.txtAcctBalance.Value = formatnumber(Bal,2,,,0)
        Else
        ...
        if not document.form1.cToBePrint.checked Then
    ...
    Sub IVChange( nL, str )
        document.all("hBillNo").item(nL+1).value = str.value
    End Sub

    Sub docModified(dummy)
    End Sub
    
    Sub IV_CustomerChange()
        Dim strPrintAs

        Document.form1.hVendorName.value = Document.form1.lstVendorName.value
        VendorInfo = get_organization_info_for_check(Document.form1.hVendorAcct.value)  
        pos2=0
        pos2=instr(VendorInfo,"@@@")

        if pos2>0 then
	        strPrintAs=Mid(VendorInfo,pos2+3)
        end if

        pos=0
        pos=instr(VendorInfo,"-")

        if pos>0 then
	        VendorInfo=Mid(VendorInfo,pos+1,pos2-6)
        end if
    ...
    Sub ToBePrintClick()
	    if document.form1.cToBePrint.checked=true then
	    <% if EditCheck = "yes" and Trim(vCheck) <> "0" then %>
		    ok=MsgBox ("This check has been printed as Check# : " & "[<%=vCheck%>]" & chr(13) & "Do you really want to print this check again?" & chr(13) &_
		     "",36,"Message")
		    if ok=6 then	
    ...
    Sub CheckClick(k)
	    NoItem=cint(document.form1.hNoItem.Value)
	    if not k-1= NoItem then
		    If document.all("BillCheck").item(k).checked=true then
			    document.all("BillCheck").item(k).Value="Y"
			    BillAmtDue=cdbl(document.all("BillAmtDue").item(k).Value)
			    document.all("BillAmtPaid").item(k).Value=BillAmtDue
		    else
			    document.all("BillCheck").item(k).Value="N"
			    Amt=document.form1.txtAmount.Value
			    BillAmtDue=cdbl(document.all("BillAmtDue").item(k).Value)
			    document.all("BillAmtPaid").item(k).Value=0
		    end if
		    TotalAmtPaid=0
		    for i= 1 to NoItem
			    if document.all("BillCheck").item(i).checked=true then
				    Amt=cdbl(document.all("BillAmtPaid").item(i).Value)
				    TotalAmtPaid=TotalAmtPaid+Amt
			    end if
		    next
		    document.form1.txtAmount.Value=formatNumber(TotalAmtPaid,2,,,0)
		    document.form1.txtTotalAmtPaid.Value=formatNumber(TotalAmtPaid,2,,,0)
	    end if
	    Money=ToMoney(TotalAmtPaid)
	    document.form1.txtMoney.Value=Money
    End Sub

    Sub SaveClick(SaveorPrint,TranNo)

        call make_money_string()

        if SaveorPrint = "PrintNow" then

	        if document.form1.cToBePrint.checked=true then
		        document.form1.cToBePrint.checked=false
		        CALL ToBePrintClick()
		        tmpCheckNo = inputbox("Please confirm the Check No.","Check No. Confirm",document.form1.txtCheck.Value)
		        if tmpCheckNo = "" then
			        exit sub
		        else
	        ...
	        if document.form1.txtCheck.Value="" then
        ...
        vVendorNo = Document.form1.hVendorAcct.value
        
        if vVendorNo = "" Or vVendorNo = "0" then
	        MsgBox "Please select a Company Name!"
        elseif NoItem=0 then
	        MsgBox "Nothing to pay!"
        elseif document.form1.cToBePrint.checked=false and document.form1.txtCheck.value="" then
	        MsgBox "Please enter a check number!"
        else
	        for k=1 to NoItem
		        if document.all("BillCheck").item(k).checked=true then
		        ...
		        aItem(k)="INV#: " & document.all("hBillNo").item(k).Value & ": " & "$" & FormatNumber(document.all("BillAmt").item(k).Value,2,,,0)

	        next
	        for k=1 to NoItem

		        if trim(document.all("BillAmtPaid").item(k).Value) = "" then document.all("BillAmtPaid").item(k).Value = "0.00"
		        if trim(document.all("BillAmtDue").item(k).Value) = "" then document.all("BillAmtDue").item(k).Value = "0.00"
		        if trim(document.all("BillAmt").item(k).Value) = "" then document.all("BillAmt").item(k).Value = "0.00"

		        if cdbl(document.all("BillAmtPaid").item(k).Value)>cdbl(document.all("BillAmtDue").item(k).Value) then
			        MsgBox "Amt Paid is more than Amt Due. Please correct it."
			        exit sub
		        end if
		        if cdbl(document.all("BillAmt").item(k).Value) = 0 then
			        document.all("BillAmt").item(k).Value = document.all("BillAmtDue").item(k).Value
		        end if
	        next
	        if save="yes" then
		        CheckNo=""
		        if pPrint="now" then
			        ...
			        CheckDate=document.form1.txtDate.Value
			        Vendor=document.form1.txtVendorInfo.Value
			        CheckAmt=document.form1.txtAmount.Value
			        Money=document.form1.txtMoney.Value
			        vPrintPort=document.form1.hPrintPort.VAlue
			        ClientOS=document.form1.hClientOS.Value
			        vMemo=document.form1.txtMemo.Value
        ...
        ///////////////////////////////////////////////// New logic of Check Printing  by iMoon Nov-13-2006
			        ...
			        popUpCheck = showModalDialog("check_Dialog_frame.asp?PostBack=false&cType=one&aItem="&iCnt,self, wOptions)
        //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Sub BillChange(k)
        NoItem=cint(document.form1.hNoItem.Value)
        if IsNumeric(document.all("BillAmtPaid").item(k).Value)=False then
	        MsgBox "Please enter a numeric value!"
	        document.all("BillAmtPaid").item(k).Value=0
        end if
	    for i= 1 to NoItem
		    AmtPaid=cdbl(document.all("BillAmtPaid").item(i).Value)
		    AmtDue=cdbl(document.all("BillAmtDue").item(i).Value)
		    if document.all("BillCheck").item(i).checked=true then
			    TotalAmtPaid=TotalAmtPaid+AmtPaid
		    end if
		    TotalAmtDue=TotalAmtDue+AmtDue	
	    next
	    document.form1.txtAmount.Value=TotalAmtPaid
	    document.form1.txtTotalAmtPaid.Value=TotalAmtPaid
	    document.form1.txtTotalAmtDue.Value=TotalAmtDue
	    Money=ToMoney(TotalAmtPaid)
	    document.form1.txtMoney.Value=Money
    End Sub
    ...
    Sub AddItem()
        NoItem=Cint(document.form1.hNoItem.Value)
        if document.all("BillAmt").item(NoItem+1).Value="" then
	        MsgBox "Please enter the bill amt!"
        elseif document.all("BillAmtDue").item(NoItem+1).Value="" then
	        MsgBox "Please enter the bill due amt!"
        Elseif document.getElementById("hCostExpenseItemName" & NoItem).value = "" Then
	        MsgBox "Please select an ITEM!"
        else
