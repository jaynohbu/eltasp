                                ...
                                <table width="60%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="89A979"
                                    ...
                                    <tr>
                                        <td height="20" bgcolor="D5E8CB">
                                            <strong>HAWB</strong></td>
                                        <td bgcolor="D5E8CB">
                                            <strong>Frt Cost</strong></td>
                                        <td bgcolor="D5E8CB">
                                            <strong>Adjusted Cost</strong></td>
                                        <td bgcolor="D5E8CB">
                                            <strong>P/S</strong></td>
                                        <td bgcolor="D5E8CB">
                                            <strong>Adjusted P/S</strong></td>
                                        <td bgcolor="D5E8CB">
                                            <strong>O/C Carrier</strong></td>
                                        <td bgcolor="D5E8CB">
                                            <strong>O/C Agent</strong></td>
                                    </tr>
                                    ...
                                    <tr bgcolor="#FFFFFF">
                                        ...
                                        <td>
                                            <input name="txtCost<%= i %>" type="text" class="d_shorttextfield" value="<%= aCost(i) %>"
                                                size="12" readonly /></td>
                                        <td>
                                            <input name="txtADJCost<%= i %>" type="text" class="numberfield" id="ADJCost" onchange="CostChange(<%= i+1 %>)"
                                                value="<%= aAdjCost(i) %>" size="12" /></td>
                                        <td>
                                            <input name="txtPS<%= i %>" type="text" class="d_shorttextfield" value="<%= aPS(i) %>"
                                                size="12" readonly /></td>
                                        <td>
                                            <input name="txtADJPS<%= i %>" type="text" class="numberfield" id="ADJPS" value="<%= aADJPS(i) %>"
                                                size="12" /></td>
                                        <td>
                                            <input name="txtOCarrier<%= i %>" type="text" class="numberfield" id="OCarrier" value="<%= aOCarrier(i) %>"
                                                size="12" /></td>
                                        <td>
                                            <input name="txtOAgent<%= i %>" type="text" class="numberfield" id="OAgent" value="<%= aOAgent(i) %>"
                                                size="12" /></td>
