...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript" src="/IFF_MAIN/ASP/include/JPED.js"></script>
    ...
    <script type="text/javascript">
        ...
        function searchNumFill(obj,changeFunction,vHeight){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                url = "/IFF_MAIN/asp/ajaxFunctions/ajax_booking_confirm.asp?mode=list&qStr=" + qStr;
        ...
        function searchNumFillAll(objName,changeFunction,vHeight){
            ...
            url = "/IFF_MAIN/asp/ajaxFunctions/ajax_booking_confirm.asp?mode=list&qStr=";
            FillOutJPED(obj,url,changeFunction,vHeight);
        }
		...
		{
			var url = "/IFF_MAIN/ASP/ocean_export/booking_confirm_pdf.asp?uid=" + arg;
                    ...
                    <table style="width: 95%; text-align: left; border: none 0px" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td align="right" valign="bottom">
                                <div id="print">
                                    <asp:ImageButton ID="btn_print" runat="server" OnClick="btn_print_Click" ImageUrl="/iff_main/ASP/Images/icon_printer.gif" />
                                                    ...
                                                    <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="width: 48%" align="center" valign="middle">
                                                                <asp:ImageButton runat="server" ImageUrl="~/ASP/images/button_save_medium.gif" ID="img_SaveBC"
                                                                    OnClick="img_SaveBC_Click" /></td>
                                                            <td style="width: 13%" align="right" valign="middle">
                                                                <asp:ImageButton runat="server" ImageUrl="~/ASP/Images/button_new.gif" ID="img_NewBC"
                                                ...
                                                <td style="background-color: #BFD0C9; height: 24px" align="center" valign="middle"
                                                    ...
                                                    <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="width: 48%" align="center" valign="middle">
                                                                <asp:ImageButton runat="server" ImageUrl="~/ASP/images/button_save_medium.gif" ID="img_SaveBC2"
                                                                    OnClick="img_SaveBC_Click" /></td>
                                                            <td style="width: 13%" align="right" valign="middle">
                                                                <asp:ImageButton runat="server" ImageUrl="~/ASP/Images/button_new.gif" ID="img_NewBC2"
                                                                    OnClick="img_NewBC_Click" /></td>
                                                            <td style="width: 13%" align="right" valign="middle">
