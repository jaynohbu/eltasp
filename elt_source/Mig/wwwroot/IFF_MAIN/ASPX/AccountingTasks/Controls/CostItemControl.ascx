<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CostItemControl.ascx.cs" Inherits="ASPX_AccountingTasks_Controls_CostItemControl" %>
...
<asp:GridView ID="GridViewCostItem" runat="server" AutoGenerateColumns="False" BackColor="White"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Amount">
            <ItemTemplate>
                <asp:TextBox ID="txtCostAmount" runat="server" Width="80px" onKeyup="checkLimit(this,10000000000,10)" onKeyPress="checkNum()" CssClass="numberalign" ForeColor="Black">0.00</asp:TextBox>
            </ItemTemplate>
...
<script type="text/javascript" language="javascript">
 ...
 function ddlCostItemsChange(ddl,dsc,amt)
    ...
    function validateVendorList(){    
       ...
       var itemDDLs=document.getElementById("CostItemControl1_hItemIDs").value;
