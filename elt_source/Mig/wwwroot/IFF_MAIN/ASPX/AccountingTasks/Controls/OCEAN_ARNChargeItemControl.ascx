<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OCEAN_ARNChargeItemControl.ascx.cs" Inherits="ASPX_AccountingTasks_Controls_OCEAN_ARNChargeItemControl" %>
...
<asp:GridView ID="GridViewChargeItem" runat="server" AutoGenerateColumns="False"
    ...
    <Columns>
        <asp:TemplateField HeaderText="Charge Item">
            ...
            <HeaderStyle CssClass="bodyheader" HorizontalAlign="Left" BackColor="#dfe1e6"/>
        ...
        <asp:TemplateField HeaderText="Amount">
            <ItemTemplate>
                <asp:TextBox ID="txtChAmount" runat="server" Width="50px" onKeyup="checkLimit(this,10000000000,10)" onKeyPress="checkNum()" CssClass="grid_numberfield" ForeColor="Black">0.00</asp:TextBox>
            </ItemTemplate>
            <FooterTemplate>
                Total Amount<br />
...
<asp:HiddenField ID="hDefaultAF" runat="server" />
<asp:HiddenField ID="hDefaultOF" runat="server" />
<br />
...
<script  type="text/javascript" language="javascript">
        ...
        if(item_no[0] ==-1)
         {
            ...
            item_no=item_no[0];        
           var arrDsc=document.getElementById("OCEAN_ARNChargeItemControl1_hChItemsDefaultDscArray").value;
           var arrNo=document.getElementById("OCEAN_ARNChargeItemControl1_hChItemsItemNoArray").value;
            var arrAmt=document.getElementById("OCEAN_ARNChargeItemControl1_hChItemsDefaultAmtArray").value;
    ...
    function ChargeAmountList(){    
       ...
       var arrAmt=document.getElementById("OCEAN_ARNChargeItemControl1_hAmtIDs").value;
       var ItemNos=document.getElementById("OCEAN_ARNChargeItemControl1_hChItemIDs").value;
       arrAmt=arrAmt.split("^^");
