<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AIR_ ARNCostItemControl.ascx.cs" Inherits="ASPX_AccountingTasks_Controls_AIR_ARNCostItemControl" %>
...
<asp:GridView ID="GridViewCostItem" runat="server" AutoGenerateColumns="False" BackColor="White"
    ...
    <Columns>
        <asp:TemplateField HeaderText="Cost Item">
            ...
            <HeaderStyle CssClass="bodyheader" HorizontalAlign="Left" BackColor="#efe1df" Height="18px" Width="22%" />
        ...
        <asp:TemplateField HeaderText="Description">
            ...
            <HeaderStyle CssClass="bodyheader" HorizontalAlign="Left" BackColor="#efe1df" Width="22%" />
            <FooterStyle CssClass="bodyheader" Width="22%" />
            <ItemStyle HorizontalAlign="Left" />
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Amount">
            <ItemTemplate>
                <asp:TextBox ID="txtCostAmount" runat="server" Width="80px" onKeyup="checkLimit(this,10000000000,10)" onKeyPress="return checkNum();" CssClass="numberalign" ForeColor="Black">0.00</asp:TextBox>
            </ItemTemplate>
            <HeaderStyle CssClass="bodyheader" HorizontalAlign="Left" BackColor="#efe1df" Width="11%" />
        ...
        <asp:TemplateField ShowHeader="False">
            ...
            <ItemStyle HorizontalAlign="Left" />
            <HeaderStyle HorizontalAlign="Left" BackColor="#efe1df" />
        </asp:TemplateField>
        <asp:TemplateField>
            <ItemTemplate>
 ...
 function ddlCostItemsChange(ddl,dsc,amt)
    {
        ...
        item_no=item_no[0];
        var arrDsc=document.getElementById("AIR_ARNCostItemControl1_hCostItemsDefaultDscArray").value;
        var arrNo=document.getElementById("AIR_ARNCostItemControl1_hCostItemsItemNoArray").value;
        var arrAmt=document.getElementById("AIR_ARNCostItemControl1_hCostItemsDefaultAmtArray").value;
    ...
    function validateVendorList(){    
       ...
       var arrAmt=document.getElementById("AIR_ARNCostItemControl1_hAmtIDs").value;       
       var vendorDDLs=document.getElementById("AIR_ARNCostItemControl1_hVendorIDs").value;  
       var itemDDLs=document.getElementById("AIR_ARNCostItemControl1_hItemIDs").value;
