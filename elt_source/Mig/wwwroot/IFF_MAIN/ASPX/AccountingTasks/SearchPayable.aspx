<%@ Page language="c#" Inherits="IFF_MAIN.ASPX.Reports.Accounting.SearchPayable" trace="false" CodeFile="SearchPayable.aspx.cs" %>
            ...
            <td align="center" bgcolor="#f3f3f3"><br>
                ...
                <tr align="left" valign="middle" bgcolor="#E7F0E2">
                    <td width="10" bgcolor="#E7F0E2">&nbsp;</td>
                                                    ...
                                                    <td width="35%" class="bodyheader">From</td>
                                                    <td width="37%">
                ...
                <tr align="left" valign="middle" bgcolor="#ffffff">
                    <td>&nbsp;</td>
                                                    ...
                                                    <td><igtxt:webdatetimeedit id=Webdatetimeedit1 accessKey=e runat="server" ForeColor="black" 
                ...
                <tr align="left" valign="middle" bgcolor="#f3f3f3">
                    <td class="bodycopy"></td>
                                                    <td height="20" colspan="3"><span>
                                                        <asp:Label ID=Label8 runat="server" Width="87%" CssClass="bodyheader">Vendor</asp:Label>                                                      </td>
                    </tr>
                <tr align="left" valign="middle" bgcolor="#ffffff">
                    <td class="bodycopy">&nbsp;</td>
                                                    <td colspan="3">
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <td><input type="hidden" id="txtVendorInfo" name="txtVendorInfo"/></td>
                                                                </tr>
                                                        </table>
                    ...
                    <tr align="left" bgcolor="#ffffff" valign="middle">
                        <td class="bodycopy" style="height: 16px">                        </td>
                        <td style="height: 16px">
                            <strong>Check#</strong></td>
                        <td style="height: 16px">&nbsp;<strong>Memo</strong></td>
                        <td style="height: 16px">&nbsp;</td>
                    </tr>
                    <tr align="left" bgcolor="#ffffff" valign="middle">
                        <td class="bodycopy">                        </td>
                        <td>
                            <strong><asp:TextBox ID="txtCheckNo" runat="server"></asp:TextBox></strong></td>
            ...
            <td height="18" bgcolor="#E7F0E2"><asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" Width="100%" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" Height="100%"  >
                <Columns>
					...
					<asp:BoundField DataField="print_date" HeaderText="Date" >
						<HeaderStyle CssClass="bodyheader" HorizontalAlign="Left" Width="12%" Height="20px" />
					</asp:BoundField>
					<asp:BoundField DataField="vendor_name" HeaderText="Vendor" >
						<HeaderStyle CssClass="bodyheader" Width="25%" HorizontalAlign="Left" />            
						<ItemStyle Width="25%" Height="18px" CssClass="bodycopy" />                
					</asp:BoundField>
					<asp:BoundField HeaderText="Reference/Memo" DataField="memo">
						<HeaderStyle CssClass="bodyheader" Width="25%" HorizontalAlign="Left" />            
						<ItemStyle Width="25%" HorizontalAlign="Left" CssClass="bodycopy" />
					</asp:BoundField>
					<asp:BoundField DataField="check_amt" HeaderText="Amount" >
						<HeaderStyle CssClass="bodyheader" Width="12%" HorizontalAlign="Left" />                
					</asp:BoundField>
					<asp:TemplateField Visible="False">
						<ItemTemplate>
							<asp:ImageButton ID="btnDelete" runat="server" CommandName="Delete"  
								CommandArgument='<%#DataBinder.Eval(Container,"RowIndex")%>' ImageUrl="~/ASP/Images/button_cancel.gif" OnCommand="Delete" />                    </ItemTemplate>
					</asp:TemplateField>
					...
					<asp:HyperLinkField DataNavigateUrlFields="url" HeaderText="Link" Target="_blank" Text="View">
						<HeaderStyle CssClass="bodyheader" HorizontalAlign="Left" />                
					</asp:HyperLinkField>
                </Columns>
