...
{
    public partial class CancelReceivable : System.Web.UI.Page
    {
        ...
        protected void searchData()
        {
            ...
            dtReceivables = pMngr.getPaymentDTwithinPeriod(start, end, vendorID, this.txtRefNo.Text, Int32.Parse(this.ddlBankAcct.SelectedValue), this.ddlPaymethod.SelectedValue, money);
