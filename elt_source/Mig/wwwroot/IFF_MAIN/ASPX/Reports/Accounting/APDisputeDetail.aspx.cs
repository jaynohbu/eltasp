...
public partial class ASPX_Reports_Accounting_APDisputeDetail : System.Web.UI.Page
{
    ...
    protected void UltraWebGrid1_InitializeRow(object sender, Infragistics.WebUI.UltraWebGrid.RowEventArgs e)
    {
        try
        {
            e.Row.Cells.FromKey("print_id").TargetURL = "javascript:viewPop('/IFF_MAIN/ASP/acct_tasks/pay_bills.asp?WindowName=popupNew&EditCheck=yes&CheckQueueID=" + e.Row.Cells.FromKey("print_id") + "');";
            e.Row.Cells.FromKey("bill_number").TargetURL = "javascript:viewPop('/IFF_MAIN/ASP/acct_tasks/enter_bill.asp?WindowName=popupNew&ViewBill=yes&BillNo=" + e.Row.Cells.FromKey("bill_number") + "');";
        }
        catch { }
    }
