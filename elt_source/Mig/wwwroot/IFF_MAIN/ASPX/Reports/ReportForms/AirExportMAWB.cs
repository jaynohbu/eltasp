...
namespace IFF_MAIN.ASPX.Reports.ReportForms {
    ...
    public class AirExportMAWB : ReportClass {
    ...
    public class CachedAirExportMAWB : Component, ICachedReport {
        
        public CachedAirExportMAWB() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AirExportMAWB rpt = new AirExportMAWB();
            rpt.Site = this.Site;
            return rpt;
        }
