...
namespace IFF_MAIN.ASPX.Reports.Operation
{
    ...
    /// </summary>
    public partial class AirExportOperationSelection : System.Web.UI.Page
    {
        ...
        protected void iBtnGo_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("OperationResult.aspx?Part=Air-Export&" + "WindowName=" + windowName);
        ...
        private bool performSearch()
        {
           ...
           @"SELECT 
            ...
            "' AND  d.ETD_DATE1 < DATEADD(day, 1,'" + timeEnd +
             "')) and (select COUNT(hawb_num) from hawb_master WHERE elt_account_number="
            + elt_account_number + " AND mawb_num=c.mawb_num)=0 and c.is_dome='N'";
