...
<head runat="server">
    ...
    <script type="text/jscript">
        ...
        {
            var vURL = "/IFF_MAIN/ASP/aes/tran_get_itn_no.asp?WindowName=AESDIRECT&AESID=" + aesNo;
        ...
        <center>
            ...
            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Width="95%"
                ...
                <DisplayLayout Name="UltraWebGrid1" BorderCollapseDefault="Separate" RowHeightDefault="20px"
                    ...
                    <FrameStyle BorderWidth="1px" BorderStyle="Solid" Width="95%" BorderColor="#a0829c" TextOverflow="Ellipsis">
                    </FrameStyle>
                    <GroupByBox>
