...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function EditClick(iType,MAWB,Sec,AgentOrgAcct,HAWB){
            url = "/IFF_MAIN/ASP/ocean_import/arrival_notice.asp?iType=" + iType + "&Edit=yes&AgentOrgAcct=" + AgentOrgAcct 
            + "&MAWB=" + encodeURIComponent(MAWB) + "&HAWB=" + encodeURIComponent(HAWB) + "&Sec=" + Sec;
            openWindowFromSearch(url);
        }	
				
        function EditClickMAWB(iType,MAWB,Sec,AgentOrgAcct){
            url = "/IFF_MAIN/ASP/ocean_import/ocean_import2.asp?iType=" + iType + "&Edit=yes&MAWB=" + encodeURIComponent(MAWB) 
            + "&Sec=" + Sec + "&AgentOrgAcct=" + AgentOrgAcct + "&WindowName=popUpWindow";
            openWindowFromSearch(url);
        }
        
        function EditClickFILE(iType,FILE){
            url = "/IFF_MAIN/ASP/ocean_import/ocean_import2.asp?iType=" + iType + "&Edit=yes&JOB=" + encodeURIComponent(FILE) + "&WindowName=popUpWindow";
            openWindowFromSearch(url);
        }
