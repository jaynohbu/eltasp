...
if Not rs.EOF then
	for i = 0 to rs.fields.count - 1
		...
		response.write encodeXMLCode(rs(i).value)
		response.write "</itemdesc>"
		response.write "</item>"
	next 
end if
