========================================================================
    ACTIVEX CONTROL DLL : ClientTrack Project Overview
========================================================================

ControlWizard has created this project for your ClientTrack ActiveX Control
...
that make up your ClientTrack ActiveX Control DLL.
...
ClientTrack.ico
    ...
    is included by the main resource file ClientTrack.rc.

/////////////////////////////////////////////////////////////////////////////
CClientTrackCtrl control:

ClientTrackCtrl.h
    This file contains the declaration of the CClientTrackCtrl C++ class.

ClientTrackCtrl.cpp
    This file contains the implementation of the CClientTrackCtrl C++ class.

ClientTrackPropPage.h
    This file contains the declaration of the CClientTrackPropPage C++ class.

ClientTrackPropPage.cpp
    This file contains the implementation of the CClientTrackPropPage C++ class.

CClientTrackCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CClientTrackCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file ClientTrack.rc.
...
stdafx.h, stdafx.cpp
    ...
    named ClientTrack.pch and a precompiled types (PCT) file named stdafx.obj.
