<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarrierMaster.aspx.cs" Inherits="SiteAdmin_CarrierMaster" %>
...
<head runat="server">
    ...
    <script type="text/jscript">
        ...
        {
            var vURL = "../Common/SearchCarrier.aspx";
            var vWinArg = "dialogWidth:400px; dialogHeight:285px; help:no; status:no; scroll:no; center:yes";
        ...
        function go_carrier(cid)
        {
            var vURL = "../Common/EditCarrier.aspx?CID=" + cid;
            var vWinArg = "dialogWidth:400px; dialogHeight:275px; help:no; status:no; scroll:no; center:yes";
            var vReturn = showModalDialog(vURL, "popWindow", vWinArg);
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 95%">
            <tr>
                ...
                <td id="print" style="text-align: right">
                    <a href="javascript:;" onclick="javascript:go_carrier('')">
                        <img src="../Images/icon_createhouse.gif" style="border: none 0px; margin-right: 10px"
                            alt="" />Add New Carrier</a><img src="../Images/button_devider.gif" alt="" /><a href="javascript:;"
                                onclick="javascript:code_lookup()"><img src="../Images/icon_search.gif" alt="" />
                                &nbsp; IATA Code Lookup</a><img src="../Images/button_devider.gif" alt="" /><a href="https://www.aesdirect.gov/users/scac.txt"
                                    target="_blank">SCAC Codes</a>
                </td>
            </tr>
        </table>
