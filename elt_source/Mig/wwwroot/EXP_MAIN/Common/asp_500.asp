...
<head>
    ...
    <%
        ...
        If Request.QueryString("mode") = "save" Then
            ...
            eltConn.Close()
            Set eltConn = Nothing
            Response.Write("<script>parent.window.location.href='/EXP_MAIN/Main.aspx?T=';</script>")
            Response.End()
        Else
...
<body>
    <div style="width: 100%; text-align: center">
        ...
        <form id="form1" action="/EXP_MAIN/Common/asp_500.asp?mode=save" method="post">
        <table cellpadding="4" cellspacing="0" border="0" class="bodycopy">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtAspCode" name="txtAspCode" class="shorttextfield" size="40"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtNumber" name="txtNumber" class="shorttextfield" size="40"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtSource" name="txtSource" class="shorttextfield" size="70"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtFile" name="txtFile" class="shorttextfield" size="70"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtLine" name="txtLine" class="shorttextfield" size="20"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtDesc" name="txtDesc" class="shorttextfield" size="80"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtDate" name="txtDate" class="shorttextfield" size="25"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtELTNumber" name="txtELTNumber" class="shorttextfield" size="25"
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="txtUserId" name="txtUserId" class="shorttextfield" size="25"
