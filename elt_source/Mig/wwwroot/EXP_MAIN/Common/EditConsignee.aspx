<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditConsignee.aspx.cs" Inherits="Common_EditConsignee" %>
...
<head runat="server">
    <title>Add/Update Consignee</title>
    <base target="_self" />
        ...
        <div style="text-align: center">
            ...
            <div style="width: 95%; text-align: left; margin: 10px 0px 10px 0px">
                <table cellpadding="2" cellspacing="0" border="0" class="bodycopy" style="width: 100%;
                    ...
                    <tr>
                        <td>
                            <img src="../Images/required.gif" align="absbottom" alt="" />Name (DBA)
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <img src="../Images/required.gif" align="absbottom" alt="" />Address
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <img src="../Images/required.gif" align="absbottom" alt="" />City
                        </td>
                        <td>
                    ...
                    <tr style="background-color:#eeeeee">
                        <td>
                            <img src="../Images/required.gif" align="absbottom" alt="" />Country
                        </td>
                        <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:;" onclick="javascript:close_window();">
                                            <img src="../Images/button_closebooking.gif" alt="" /></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
