<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchUS.aspx.cs" Inherits="Ports_SearchUS" %>
                            ...
                            <table cellpadding="2" cellspacing="0" border="0" style="width: 100%">
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <asp:ListBox runat="server" ID="lstScheD" Width="330px" CssClass="bodycopy" Rows="10"></asp:ListBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
