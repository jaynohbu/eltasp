CREATE TABLE [dbo].[certificate_origin_ocean_items] (
    ...
    [gross_weight]      FLOAT (53)     CONSTRAINT [DF_certificate_origin_items_gross_weight] DEFAULT ((0)) NULL,
    [measurement]       FLOAT (53)     CONSTRAINT [DF_certificate_origin_items_measurement] DEFAULT ((0)) NULL,
