<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewAccount.aspx.cs" Inherits="OnlineRequest_NewAccount"
    CodePage="65001" %>
...
<body>
    <form id="form1" runat="server">
        <div style="text-align: center">
            <div style="width: 95%; text-align: left; margin-top:20px">
            ...
            <table cellspacing="0" cellpadding="4" border="0" class="bodycopy" style="width: 95%">
                ...
                <tr valign="middle">
                    ...
                    <td align="left">
                        <img alt="" src="/ASP/Images/required.gif" align="absbottom" />Name (DBA)</td>
                ...
                <tr valign="middle">
                    ...
                    <td align="left">
                        <img alt="" src="/ASP/Images/required.gif" align="absbottom" />Address 1</td>
                    <td colspan="3" align="left">
                    ...
                    <td align="left">
                        <img alt="" src="/ASP/Images/required.gif" align="absbottom" />City</td>
                    <td colspan="4" align="left">
                ...
                <tr>
                    ...
                    <td colspan="9" align="left"><asp:TextBox ID="txtAddressAdd" runat="server" CssClass="shorttextfield" Width="250px" /></td>
                </tr>
                <tr valign="middle">
                    <td align="left">
                    </td>
                    ...
                    <td colspan="3" align="left">
                        ...
                        <asp:TextBox ID="txtProvince" CssClass="shorttextfield" runat="server" />
                        </td>
                    <td align="left">
                    </td>
                    <td align="left">
                        Zip/Postal Code</td>
                    <td colspan="4" align="left">
                        <asp:TextBox ID="txtZip" runat="server" CssClass="shorttextfield" Width="100px"></asp:TextBox></td>
                </tr>
                <tr valign="middle">
                    <td align="left">
                    </td>
                    <td align="left">
                        <img alt="" src="/ASP/Images/required.gif" align="absbottom" />Country</td>
                    <td colspan="3" align="left">
                ...
                <tr valign="middle">
                    ...
                    <td align="left">
                        <img alt="" src="/ASP/Images/required.gif" align="absbottom" />Phone Number</td>
                    <td colspan="3" align="left">
                ...
                <tr valign="middle">
                    ...
                    <td align="left">
                        User ID</td>
                    <td colspan="3" align="left">
                        <asp:TextBox ID="txtAdminID" runat="server" CssClass="shorttextfield" Width="150px" Text="admin" BackColor="#cdcdcd" ReadOnly="true" /></td>
                    <td align="left">
                    </td>
                    <td align="left">
                        <img alt="" src="/ASP/Images/required.gif" align="absbottom" />Password</td>
                    <td colspan="4" align="left">
                        <asp:TextBox ID="txtAdminPassword" runat="server" CssClass="shorttextfield" Width="150px"></asp:TextBox><asp:RequiredFieldValidator
                            ID="rfv_AdminPass" runat="server" ControlToValidate="txtAdminPassword" ErrorMessage="*" SetFocusOnError="true" /></td>
                </tr>
                <tr>
                    <td colspan="11" align="left" valign="top" style="background-color: #999999" class="bodyheader">
                    </td>
                ...
                <tr valign="middle">
                    ...
                    <td align="left">
                        <img alt="" src="/ASP/Images/required.gif" align="absbottom" />First Name</td>
                    <td colspan="3" align="left">
                    ...
                    <td align="left">
                        <img alt="" src="/ASP/Images/required.gif" align="absbottom" />Last Name</td>
                    <td colspan="4" align="left">
                ...
                <tr valign="middle">
                    ...
                    <td align="left">
                        <img alt="" src="/ASP/Images/required.gif" align="absbottom" />Email
                    </td>
                    <td colspan="4" align="left">
                ...
                <tr valign="middle">
                    ...
                    <td colspan="9" align="left">
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td>-->
                                    <asp:RadioButtonList ID="rlAcType" runat="server" RepeatDirection="Horizontal" Visible="false">
                                        <asp:ListItem Value="F" Selected="True">Standard</asp:ListItem>
                ...
                -->
                <tr>
                    <td colspan="11" align="left" valign="top" style="height:5px">
                    </td>
                </tr>
                <tr>
