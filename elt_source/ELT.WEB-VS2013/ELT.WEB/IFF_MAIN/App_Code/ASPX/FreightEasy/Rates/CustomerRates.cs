...
{
    public class CustomerRates : FreightEasyData
    {
        public CustomerRates()
        {
        }

        public CustomerRates GetAllRecords(string elt_account_number, string rate_type)
        {
            string RoutesSQL = @"select distinct a.elt_account_number,a.rate_type,a.customer_no,
            ...
            and a.customer_no=b.org_account_number) where a.elt_account_number="
                + elt_account_number + " and a.rate_type='" + rate_type + "'";
            string AirlineSQL = @"select distinct a.elt_account_number,a.rate_type,a.customer_no,a.origin_port,
            ...
            and a.airline=b.carrier_code where a.elt_account_number="
                + elt_account_number + " and a.rate_type='" + rate_type + "'";
            string WeightSQL = @"select a.elt_account_number,a.rate_type,a.customer_no,a.origin_port,
            a.dest_port,a.kg_lb,a.airline,a.share,a.fl_rate,a.sec_rate,a.include_fl_rate,a.include_sec_rate,
            ...
            this.AddRelation("Rate31", "Routes", "origin_port,dest_port,kg_lb,customer_no", "Airline",
                "origin_port,dest_port,kg_lb,customer_no");
            this.AddRelation("Rate32", "Airline", "origin_port,dest_port,kg_lb,customer_no,airline",
                "Weight Breaks", "origin_port,dest_port,kg_lb,customer_no,airline");
        ...
        public void InsertRecord(RateEntity re)
        {
            ...
            if (re.elt_account_number > 0 && re.item_no >= 0 && re.rate_type > 0 && re.airline != null
                ...
                re.weight_break != null &&  re.customer_no > 0)
            {
