...
<head runat="server">
    ...
    <script type="text/jscript">
        function TransferData()
        {
            ...
            oForm.action = "/ASP/air_export/new_edit_hawb.asp";
            oForm.target = 
            oForm.method = "post";
            // oForm.submit();
        ...
        <center>
            ...
            <table width="95%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="width:15%">
                        <a href="javascript:;" onclick="TransferData()"><img src="/ASP/Images/button_next_bold.gif" alt="" style="border:none 0px" /></a>
                    </td>
                    <td style="width:15%">
                        <a href="javascript:window.close();"><img src="/ASP/Images/button_closebooking.gif" alt="" style="border:none 0px" /></a>
                    </td>
                    <td style="width:35%"></td>
                </tr>
            </table>
