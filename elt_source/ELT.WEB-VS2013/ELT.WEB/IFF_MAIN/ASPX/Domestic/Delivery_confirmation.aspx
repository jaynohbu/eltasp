    ...
    <script type="text/jscript">
        ...
        else if (document.getElementById("txtEmail").value == "")
        {
	    ...
	    else
	       {
	        ...
	        //var url = "/ASP/docmestic/delivery_confirmOK.asp?Send=yes"
	  ...
	  function UpLoadFile(Rnum)
	  {
        ...
        var url = "/ASP/ajaxFunctions/ajax_get_Domestic_EMAIL_list.asp?mode=Updata&OrgNO=" + OrgNo + "&FileName=" + fileName +"&FileType=" + fileType + "&FileContent=" + fileContent+ "&FileSize=" + fileSize;
        ...
        function DeleteFile(FileName,ShipperNo)
        {
            ...
            if(FileName != "" && FileName != "Select One"){
                ...
                try{
                    ...
                    var url = "/ASP/ajaxFunctions/ajax_get_Domestic_EMAIL_list.asp?mode=Delete&OrgNO=" + ShipperNo + "&FileName=" + FileName;
                    new ajax.xhr.Request('GET','',url,lstSearchNumChange3,'','','','');
                }catch(err){}
            }
            else
                                                                ...
                                                                <table width="100%">
                                                                    ...
                                                                    <tr align="left" valign="middle" bgcolor="#FFFFFF">
                                                                        ...
                                                                        <td width="4" align="left" valign="middle" class="bodyheader">
                                                                            <img src="/ASP/Images/required.gif" align="absbottom">TO </td>
                                                                        <td width="528" align="left" valign="middle" class="bodycopy">
