...
<%@ Page language="c#" Inherits="IFF_MAIN.ASPX.Reports.Accounting.APAgingDetailUnPost" CodeFile="APAgingDetailUnpost.aspx.cs" %>
...
<asp:label id=Label1 runat="server" Width="100%" Height="8px" Font-Size="Larger" ForeColor="Black" Font-Bold="True"> A/P Aging - Unposted</asp:label></TD>
  ...
  <TR>
    <TD style="HEIGHT: 4px; width: 20px;"></TD>
...
<asp:label id=lblNoData runat="server" Width="100%" ForeColor="Navy" Font-Bold="True" Font-Italic="True" Font-Underline="True">...</asp:label></TD>
  ...
  <TR>
    <TD style="HEIGHT: 3px; width: 20px;"></TD>
      <td bgcolor="whitesmoke" style="height: 3px" valign="top">
      </td>
  ...
  <TR>
    <TD height=5 style="width: 20px"></TD>
      <td bgcolor="#d5e8cb" height="10" valign="top">
      </td>
    <TD vAlign=top bgcolor="D5E8CB" height=10px></TD>
