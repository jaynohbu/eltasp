<%@ Page Language="C#" AutoEventWireup="true" CodeFile="APDisputeDetail.aspx.cs"
    Inherits="ASPX_Reports_Accounting_APDisputeDetail" %>
        ...
        <center>
            ...
            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="400px" Width="95%"
                ...
                <DisplayLayout Name="UltraWebGrid1" BorderCollapseDefault="Separate" RowHeightDefault="20px"
                    ...
                    <FrameStyle BorderWidth="1px" BorderStyle="Solid" Height="400px" Width="95%" BorderColor="#89A979">
                    </FrameStyle>
                    ...
                    <RowStyleDefault Font-Names="Verdana,Arial,Helvetica,Sans-serif" Font-Size="9px"
                        BorderWidth="1px" BorderColor="#89A979" BorderStyle="Solid" BackColor="Window"
                    ...
                    <HeaderStyleDefault HorizontalAlign="Left" BorderStyle="Solid" BackColor="#D5E8CB"
