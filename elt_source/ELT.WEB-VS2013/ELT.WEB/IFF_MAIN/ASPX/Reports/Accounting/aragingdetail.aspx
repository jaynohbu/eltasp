...
function formRest(tr,id) {
    ...
    function goFindURL(argType,argHouseVal,argInvoiceVal){
        ...
        switch(argType){
            case "AI":
                vURL = "/ASP/air_import/arrival_notice.asp?iType=A&Edit=yes&InvoiceNo=" + argInvoiceVal;
                break;
            case "OI":
                vURL = "/ASP/ocean_import/arrival_notice.asp?iType=O&Edit=yes&InvoiceNo="  + argInvoiceVal;
                break;
            case "AE":
                vURL = "/ASP/air_export/new_edit_hawb.asp?Edit=yes&HAWB=" + argHouseVal;
                break;
            case "OE":
                vURL = "/ASP/ocean_export/new_edit_hbol.asp?Edit=yes&HBOL=" + argHouseVal;  
                break;
            case "ARN":
                // go to invoice
                vURL = "/ASP/acct_tasks/edit_invoice.asp?edit=yes&InvoiceNo=" + argInvoiceVal;
                break;
            case "INV":
                // go to invoice
                vURL = "/ASP/acct_tasks/edit_invoice.asp?edit=yes&InvoiceNo=" + argInvoiceVal;
            ...
            case "CRN":
                // go to invoice
                vURL = "/ASP/acct_tasks/edit_credit_note.asp?edit=yes&InvoiceNo=" + argInvoiceVal;
                break;
            case "PMT":
                // go to Pay Receivable
                vURL = "/ASP/acct_tasks/receiv_pay.asp?PaymentNo=" + argInvoiceVal;
                break;
            case "GJE":
                 vURL = "/ASP/acct_tasks/gj_entry.asp?View=yes&EntryNo="  + argInvoiceVal;
