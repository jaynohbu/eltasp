...
namespace IFF_MAIN.ASPX.Reports.Accounting
{
	...
	/// </summary>
	public partial class APAgingDetailUnPost2 : System.Web.UI.Page
	{
...
// (by iMoon...)
                ...
                bField[13, bIndex] = "/ASP/acct_tasks/edit_invoice.asp?edit=yes&InvoiceNo=" + bField[3, bIndex].ToString();
...
//			string strMode = "Write_Schema_XML"; // You can change if you want to write Schema and XML separately. 
        ...
        protected void UltraWebGrid1_InitializeLayout1(object sender, LayoutEventArgs e)
        {
            ...
            e.Layout.Bands[0].Columns.FromKey("Vendor Name").CellStyle.BackColor = Color.FromArgb(207, 221, 240);
            ...
            e.Layout.Bands[0].Columns.FromKey("Type").Width = new Unit("35px");
            e.Layout.Bands[0].Columns.FromKey("I/V Date").Width = new Unit("70px");
            e.Layout.Bands[0].Columns.FromKey("I/V No.").Width = new Unit("50px");
            e.Layout.Bands[0].Columns.FromKey("Aging").Width = new Unit("40px");
