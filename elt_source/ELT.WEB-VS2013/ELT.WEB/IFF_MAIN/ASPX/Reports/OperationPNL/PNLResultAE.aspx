<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PNLResultAE.aspx.cs" Inherits="ASPX_Reports_OperationPNL_PNLResultAE" %>
            ...
            <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" Width="95%"
                ...
                <DisplayLayout Name="UltraWebGrid1" BorderCollapseDefault="Separate" RowHeightDefault="20px"
                    ...
                    <Pager AllowPaging="True" StyleMode="PrevNext" QuickPages="3" PageSize="25" Alignment="Center">
                        <Style BorderWidth="3px" BorderStyle="Solid" BackColor="#f0e7ef" BorderColor="#f0e7ef" CssClass="bodycopy" Height="30px" />
                    </Pager>
                </DisplayLayout>
            </igtbl:UltraWebGrid>
        </center>
