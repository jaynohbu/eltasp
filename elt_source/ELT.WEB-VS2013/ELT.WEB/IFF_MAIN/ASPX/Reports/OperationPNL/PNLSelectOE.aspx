<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PNLSelectOE.aspx.cs" Inherits="ASPX_Reports_OperationPNL_PNLSelectOE" %>
    ...
    <script type="text/javascript">
        ...
        function Button1_ClientClick(){
            if(document.getElementById("hSearchNum").value == "" || document.getElementById("hSearchNum").value == "0"){
                alert("Please, select a master B/L.");
                return false;
            }
            else{
                return true;
    ...
    <form id="form1" runat="server">
        ...
        <center>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width: 95%; border-color: #6D8C80"
                class="border1px">
                <tr>
                    <td style="height: 8px; background-color: #E0EDE8">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center"><br />
                        <table cellpadding="2" cellspacing="0" border="0" style="width:60%; border-color:#6D8C80; text-align:left" class="border1px">
                            <tr>
                                <td>
                ...
                <tr>
                    <td style="height: 25px; background-color: #E0EDE8">
                    </td>
                </tr>
            </table>
        </center>
