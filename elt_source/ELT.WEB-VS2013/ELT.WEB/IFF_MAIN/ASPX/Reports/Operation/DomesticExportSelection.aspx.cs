...
public partial class ASPX_Reports_Operation_DomesticExportSelection : System.Web.UI.Page
{
        ...
        private bool performSearch()
        {
            ...
            //Response.Write(DateTime.Parse(Webdatetimeedit1.Text).ToShortDateString()+" ---   ");
            string timeStart = DateTime.Parse(Webdatetimeedit1.Text).ToShortDateString();
            string timeEnd = DateTime.Parse(Webdatetimeedit2.Text).ToShortDateString();
