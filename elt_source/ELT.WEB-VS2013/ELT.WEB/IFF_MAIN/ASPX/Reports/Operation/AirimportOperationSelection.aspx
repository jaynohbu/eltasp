<%@ Page language="c#" Inherits="IFF_MAIN.ASPX.Reports.Operation.AirImportOperationSelection" trace="false" 
CodeFile="AirimportOperationSelection.aspx.cs" CodePage="65001" %>
...
<HTML>
  ...
  <tr>
      <td align="left"><asp:Label ID=Label4 runat="server" Width="100%" CssClass="pageheader">Air Import Operation Report (HOUSE AWB)</asp:Label></td>
  </tr>
</table>				
          ...
          <tr align="center" bgcolor="e8d9e6"> 
            <td colspan="6" valign="middle" bgcolor="#f3f3f3"><br> 
                ...
                <tr align="left" valign="middle">
                    ...
                    <td width="31%" height="22" bgcolor="#f0f0dc" class="bodyheader"><asp:Label CssClass="bodyheader" ID=Label2 runat="server">Selection Period</asp:Label></td>
                    <td width="30%" height="22" bgcolor="#f0f0dc"><asp:Label CssClass="bodyheader" ID=Label6 runat="server">From</asp:Label></td>
                    <td width="38%" height="22" bgcolor="#f0f0dc"><asp:Label CssClass="bodyheader" ID=Label1 runat="server" designtimedragdrop="3572">To</asp:Label></td>
                    </tr>
                <tr align="left" valign="middle">
                ...
                <tr align="left" valign="middle" bgcolor="f3f3f3">
                    ...
                    <td height="22" bgcolor="#FFFFFF"><select id="sltWtScale" class="smallselect" name="sltWtScale">
						...
						<td height="22" align="center" bgcolor="#FFFFFF"><asp:ImageButton ID=iBtnGo runat="server" ImageUrl="../../../images/button_go.gif" OnClick="iBtnGo_Click
									"></asp:ImageButton></td>
						</tr>
              </table>
              <br></td>
