<%@ Page language="c#" Inherits="IFF_MAIN.ASPX.Reports.Operation.OceanImportOperationSelection" trace="false" 
CodeFile="OceanimportOperationSelection.aspx.cs" CodePage="65001" %>
...
<HTML>
  <HEAD>
		<title>AirImportOperationSelection</title>
		...
		<SCRIPT src="/IFF_MAIN/ASPX/jScripts/WebDateSet2.js" type=text/javascript></SCRIPT>
  ...
  <tr>
      <td align="left"><asp:Label ID=Label4 runat="server" Width="100%" CssClass="pageheader">Ocean Import Operation Report (HOUSE B/L)</asp:Label></td>
  </tr>
</table>				
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td align="left" valign="middle"><table width="100%" border="0" cellpadding="2" cellspacing="0" bordercolor="#939259" class="border1px">
          ...
          <tr align="center" bgcolor="e8d9e6"> 
            <td colspan="6" valign="middle" bgcolor="#f3f3f3"><br>                <table width="60%" border="0" cellpadding="2" cellspacing="0" bordercolor="#939259" class="border1px">
                <tr align="left" valign="middle">
                    <td width="1%" height="22" bgcolor="#f0f0dc">&nbsp;</td>
                    <td width="30%" height="22" bgcolor="#f0f0dc" class="bodyheader"><asp:Label CssClass="bodyheader" ID=Label2 runat="server">Selection Period</asp:Label></td>
                    <td height="22" colspan="2" bgcolor="#f0f0dc"><asp:Label CssClass="bodyheader" ID=Label6 runat="server">From</asp:Label></td>
                    <td width="38%" bgcolor="#f0f0dc"><asp:Label CssClass="bodyheader" ID=Label1 runat="server" designtimedragdrop="3572">To</asp:Label></td>
                </tr>
                <tr align="left" valign="middle">
                    ...
                    <td height="22" colspan="2" bgcolor="#FFFFFF"><igtxt:webdatetimeedit id=Webdatetimeedit1 accessKey=e runat="server" Width="150px" ForeColor="BLACK"
                    ...
                    <td bgcolor="#FFFFFF"><igtxt:webdatetimeedit id=Webdatetimeedit2 accessKey=e runat="server" Width="150px" ForeColor="BLACK"
                ...
                <tr align="left" valign="middle">
                    <td height="2" colspan="5" bgcolor="#939259"></td>
                </tr>
                <tr align="left" valign="middle">
                    ...
                    <td colspan="3" bgcolor="#F3f3f3" class="bodycopy" style="height: 22px">&nbsp;</td>
                </tr>
                <tr align="left" valign="middle">
                    <td bgcolor="#FFFFFF" style="height: 22px">&nbsp;</td>
                    <td colspan="4" bgcolor="#FFFFFF" class="bodycopy" style="height: 22px"><input id="chkGW" type="checkbox" name="chkGW" value="Gross Wt."  onClick="checkAnalOn(this)" checked="CHECKED" />
    Gross Weight &nbsp;&nbsp;
                ...
                <tr align="left" valign="middle" bgcolor="f3f3f3">
                    ...
                    <td width="17%" height="22"><span class="bodyheader">Weight Scale</span></td>
                    <td height="22" colspan="2"><span class="bodyheader">Measurement Scale</span></td>
                    </tr>
                <tr align="left" valign="middle" bgcolor="f3f3f3">
                    <td height="22" bgcolor="#FFFFFF">&nbsp;</td>
                    ...
                    <td width="14%" height="22" bgcolor="#FFFFFF"><select id="sltMeasureScale" class="smallselect" name="sltMeasureScale">
                        <option selected="selected" value="CBM">CBM</option>
                        <option value="CFT">CFT</option>
                    </select></td>
                    <td align="center" bgcolor="#FFFFFF" class="bodyheader"><asp:ImageButton ID=iBtnGo runat="server" ImageUrl="../../../images/button_go.gif" OnClick="iBtnGo_Click
									"></asp:ImageButton></td>
                    </tr>
            </table>
                <br></td>
