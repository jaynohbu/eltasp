<%@ Control Language="c#" Inherits="IFF_MAIN.ASPX.Reports.SelectionControls.rdSelectDateControl1" CodeFile="rdselectdatecontrol1_j.ascx.cs" %>


<asp:dropdownlist id="rdDateSet1" Width="99%" runat="server" BackColor="#FFFFC0" ForeColor="#000040" Font-Names="Verdana" Font-Size="9px">
