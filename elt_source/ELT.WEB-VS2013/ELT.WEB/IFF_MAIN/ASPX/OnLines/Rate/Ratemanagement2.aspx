...
<%@ Page Language="c#" Inherits="IFF_MAIN.ASPX.OnLines.Rate.Ratemanagement2" CodeFile="Ratemanagement2.aspx.cs" CodePage="65001" %>
...
<head>
    ...
    <script language='javascript' type="text/jscript">
        ...
        function SetCombo(q) {
            ...
            if (s == 1 || s == 3) {
                document.form1.lstCompanyName.disabled = true;
                $("#lstCompanyName_Button").attr("onclick", "void(0)");
                $("#lstCompanyName_Button").attr("src", "/ig_common/Images/ig_tblSortDesc.gif");
                
                //ig_cmboDown2
                document.form1.lstCompanyName.value = "";
                //document.form1.lstCompanyName.value = "";
                document.form1.lstCompanyName.style.backgroundColor = "#E0E0E0";

            }
            else {
                if (!q) {
                    document.form1.lstCompanyName.value = "";
                    //document.form1.lstCompanyName_Text.value = "";	        
                }
               // document.form1.lstCompanyName_Text.style.backgroundColor = "#FFFFC0";
                document.form1.lstCompanyName.style.backgroundColor = "#FFFFC0";
                document.form1.lstCompanyName.disabled = false;
                document.form1.lstCompanyName_Button.display = "inline";
                $("#lstCompanyName_Button").attr("src", "/ig_common/Images/combobox_drop_over.gif");
                $("#lstCompanyName_Button").attr("onclick", "organizationFillAll('lstCompanyName','All','lstCompanyNameChange')");
               // document.getElementById("lstCompanyName_Button").style = ;
        ...
        function ReqDataCheck() {
            if (document.form1.lstCompanyName.value != "") {
                document.form1.txtNum.value = document.form1.lstCompanyName.selectedIndex;
                return true;
            }
        }
        ...
        */
        ...
        function arih(gridName, rowId) {
            ...
            if (band.Key == 'RateHeader') {
                ...
                if (document.form1.lstCompanyName_Text.value != "") {
                    row.getCellFromKey('Company Name').setValue(document.form1.lstCompanyName_Text.value);
                    row.getCellFromKey('Code').setValue(document.form1.lstCompanyName.value);
                }
                else {
                    ...
                    <table width="75%" border="0" cellpadding="4" cellspacing="0" bordercolor="73beb6" bgcolor="#FFFFFF" class="border1px">
                        <tr bgcolor="ecf7f8">
                            ...
                            <td width="31%" bgcolor="ecf7f8">
                                <asp:DropDownList CssClass="bodycopy" ID="DropDownList1" ClientIDMode="Static" runat="server" Width="140px">
                            ...
                            <td width="1" bgcolor="ecf7f8" class="smallselect" valign="middle">
                                ...
                                <script type="text/javascript">
                                    ...
                                    <div id="lstCompanyNameDiv" style="top:76px; z-index:999;">
                                </div>
                            </td>
                             <td width="200" bgcolor="ecf7f8" class="smallselect" valign="middle" style="padding-right:0;">
                            
                                <asp:TextBox runat="server" autocomplete="off" ID="lstCompanyName" name="lstCompanyName" ClientIDMode="Static"
                                    value="" class="shorttextfield" Style="width: 200px; border-top: 1px solid #7F9DB9;
                                    border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; 
                            ...
                            <td bgcolor="ecf7f8" valign="middle" style="padding-left:0;">
                                <img src="/ig_common/Images/combobox_drop_over.gif" alt="" onclick="" id="lstCompanyName_Button" name="lstCompanyName_Button" style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9; border-left: 0px solid #7F9DB9; cursor: hand; width:14px; height:14px;" />
                            </td>
