...
namespace IFF_MAIN.ASPX.OnLines.Rate
{
	...
	public partial class Ratemanagement2 : System.Web.UI.Page
	{
...
//***********************************************************//
		...
		{
			this.lstCompanyName.Text = p_Name;
			this.hCompanyAcct.Value = p_Code;
			if(p_Code!="")
			{
...
//			string strMode = "Write_Schema_XML"; // You can change if you want to write Schema and XML separately. 
		...
		private void PerformSearch()
		{
			...
			if( lstCompanyName.Text != "" && txtNum.Text != "")
			{
		...
		private void PerformSearchNew()
		{
			...
			dr = dt.NewRow();
			if(lstCompanyName.Text != "") 
			{
				dr[2] = lstCompanyName.Text;
			}
			else
			{
				dr[2] = "Dbl Click...";
        ...
        protected void btnSave_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (PerformSave())
            {
                ...
                PerformDataBind();
                this.UltraWebGrid1.ExpandAll();
                string sUrl = "/IFF_MAIN/ASPX/OnLines/Rate/RateManagement.aspx?ff=" + hCompanyAcct.Value + "&nn=" + lstCompanyName.Text;
                PerformRecentDB(sUrl, lstCompanyName.Text, "Change AE Rate", "MD->AE Rate");
            }
        }
        ...
        protected void ImageButton1_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            this.txtSavedOrg.Text = this.hCompanyAcct.Value.ToString();
