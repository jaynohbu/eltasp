<%@ Page Language="C#" AutoEventWireup="true" CodeFile="2EditAES.aspx.cs" Inherits="ASPX_Misc_2EditAES" %>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width: 95%; text-align: left">
                <tr>
                    ...
                    <td style="text-align: right" id="print">
                        <img src="/iff_main/ASP/Images/icon_submit.gif" alt="" /><a href="javascript:;" onclick="AESSubmitClick();">Submit
                            to AES Weblink</a>
<%--                        <img src="/IFF_MAIN/ASP/Images/button_devider.gif" alt="" />
                        <img src="/IFF_MAIN/ASP/Images/icon_detailwindow.gif" alt="" />&nbsp;&nbsp;&nbsp;<a
                            href="ManageSED.aspx">Show AES List</a>--%>
                    </td>
                </tr>
            </table>
            <asp:Label runat="server" ID="txtResultBox" Width="95%" Visible="false" />
            <table cellpadding="2" cellspacing="0" border="0" style="width: 95%; text-align: left; border: solid 1px #a0829c"
                class="bodycopy">
                ...
                <tr>
                    <td>
                        <table cellpadding="2" cellspacing="0" border="0" style="width: 100%" class="bodycopy">
                            <tr>
                                <td style="width: 25%">Shipment Reference Number</td>
                                <td style="width: 25%">
                                ...
                                <td style="width: 25%">Transportation Reference Number</td>
                                <td style="width: 25%">
                            ...
                            <tr style="background-color: #eeeeee">
                                ...
                                <td>Routed Export Transaction</td>
                                <td>
                            ...
                            <tr>
                                <td>Inbond Type (Requires Inbond Number & FTZ)
                                </td>
                                <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox runat="server" autocomplete="off" ID="lstShipperName" Width="280px"
                                                    Text="" CssClass="shorttextfield" Style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;"
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox runat="server" autocomplete="off" ID="lstConsigneeName" Width="280px"
                                                    Text="" CssClass="shorttextfield" Style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;"
                                                    onkeyup="organizationFill(this,'Consignee','lstConsigneeNameChange')"
                                                    onfocus="initializeJPEDField(this);" /></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:TextBox runat="server" autocomplete="off" ID="lstInterConsigneeName" Width="280px"
                                                    Text="" CssClass="shorttextfield" Style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;"
                                                    onkeyup="organizationFill(this,'Consignee','lstInterConsigneeNameChange')"
                                                    onfocus="initializeJPEDField(this);" /></td>
                                            <td>
                ...
                <tr>
                    <td style="text-align: center; background-color: #E5D4E3">
                         ...
                         <asp:ImageButton runat="server" ImageUrl="../../Images/button_save.gif" ID="btnSaveAESBot" OnClick="btnSaveAES_Click"  />
