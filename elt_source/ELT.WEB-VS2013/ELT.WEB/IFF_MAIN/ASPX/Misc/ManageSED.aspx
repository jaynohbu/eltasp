<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageSED.aspx.cs" Inherits="ASPX_Misc_ManageSED" %>
...
<head runat="server">
    ...
    <script type="text/jscript">
        ...
        function OpenAES(AESID) {
            window.open('./EditAES.aspx?AESID=' + AESID, 'popUpWindow', 'menubar=0,toolbar=0,hotkeys=1,status=1,location=0,scrollbars=1,resizable=1,width=900,height=600');
        }
    </script>
    ...
    <style type="text/css">
        ...
        #G_UltraWebGrid1 thead tr th img
        {
            display: none;
        }
    </style>
    ...
    <center>
        <table cellpadding="0" cellspacing="0" border="0" style="width: 95%">
                ...
                <igtbl:UltraGridBand>
                    ...
                    <Columns>
                        <igtbl:TemplatedColumn Width="41" AllowGroupBy="No" SortIndicator="Disabled">
                            ...
                            <CellTemplate>
                                <asp:ImageButton ID="btnEdit" OnClick="btnEdit_Click" ImageUrl="/ASP/Images/button_edit.gif" runat="server"
                                     CommandName="Edit" CommandArgument="<%#Container.Cell.Row.Index %>"
                        ...
                        <igtbl:TemplatedColumn Width="53" AllowGroupBy="No" SortIndicator="Disabled">
                            ...
                            <CellTemplate>
                                <asp:ImageButton ID="btnDelete" ImageUrl="/ASP/Images/button_delete.gif" runat="server"
                                    ...
                                    CssClass="no-overflow" CommandArgument="<%#Container.Cell.Row.Index %>" />
                            </CellTemplate>
                        </igtbl:TemplatedColumn>
                    </Columns>
                </igtbl:UltraGridBand>
            ...
            <DisplayLayout Name="UltraWebGrid1" BorderCollapseDefault="Separate" RowHeightDefault="20px"
                ...
                <FrameStyle BorderWidth="1px" BorderStyle="Solid" Width="95%" BorderColor="#a0829c"
