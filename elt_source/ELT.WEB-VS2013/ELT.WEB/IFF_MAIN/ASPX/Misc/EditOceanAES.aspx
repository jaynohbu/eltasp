    ...
    <script id="main" type="text/javascript">
        ...
        function UpdateItems() {
            ...
            if (update_link.length > 0) {
                update_link.each(function () { if ($(this).attr("onclick").indexOf("aspxGVScheduleCommand('gridBatchAES',['UpdateEdit'],") > -1) { alert("Please Update or Cacel selected Line Item!"); return; } })
            }
            __doPostBack('btnSaveAES', null);
        }
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width: 95%; text-align: left">
                <tr>
                    ...
                    <td style="text-align: right" id="print">
                        <img src="/ASP/Images/icon_submit.gif"  alt="" /><a href="javascript:;"
                            onclick="AESSubmitClick();">Submit to AES Weblink</a>
                       <%-- <img src="/ASP/Images/button_devider.gif" alt="" />
                        <img src="/ASP/Images/icon_detailwindow.gif" alt="" />&nbsp;&nbsp;&nbsp;<a href="ManageOceanSED.aspx">Show AES List</a>--%>
                    </td>
                </tr>
            </table>
                                ...
                                <dx:GridViewDataSpinEditColumn FieldName="Qty1" Caption="Qty 1" PropertiesSpinEdit-ClientInstanceName="spinQty1">
                                 ...
                                 <dx:GridViewDataComboBoxColumn FieldName="Unit1" Caption="Unit 1" PropertiesComboBox-ClientInstanceName ="comboUnit1">
                                    <PropertiesComboBox DataSourceID="ComboBoxDataSourceUnit1" 
                                         ClientSideEvents-SelectedIndexChanged="onComboBoxSelectedIndexChanged2"
                          ...
                          <asp:ObjectDataSource ID="ObjectDataSourceAES" TypeName="ELT.BL.AESManager" DataObjectTypeName="ELT.CDT.AESLineItem"
                            ...
                            <SelectParameters>
                                ...
                                <asp:Parameter Name="HAWB" Type="String" />
                                  <asp:Parameter Name="FileType" Type="String"  DefaultValue="OE"/>
                            </SelectParameters>
