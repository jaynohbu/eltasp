<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OceanImportSearch.aspx.cs"
    Inherits="ASPX_Search_OceanImportSearch" %>
    ...
    <script type="text/javascript">
        ...
        function searchNumFill(obj,changeFunction,vHeight){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                url = "/ASP/ajaxFunctions/ajax_get_international_mawb_list.asp?mode=OI&qStr=" + qStr;
        ...
        function searchNumFillAll(objName,changeFunction,vHeight){
            ...
            url = "/ASP/ajaxFunctions/ajax_get_international_mawb_list.asp?mode=OI";
            FillOutJPED(obj,url,changeFunction,vHeight);
        }
        ...
        function EditClick(iType,MAWB,Sec,AgentOrgAcct,HAWB){
            url = "/ASP/ocean_import/arrival_notice.asp?iType=" + iType + "&Edit=yes&AgentOrgAcct=" + AgentOrgAcct 
            + "&MAWB=" + encodeURIComponent(MAWB) + "&HAWB=" + encodeURIComponent(HAWB) + "&Sec=" + Sec;
            openWindowFromSearch(url);
        }	
				
        function EditClickMAWB(iType,MAWB,Sec,AgentOrgAcct){
            url = "/ASP/ocean_import/ocean_import2.asp?iType=" + iType + "&Edit=yes&MAWB=" + encodeURIComponent(MAWB) 
            + "&Sec=" + Sec + "&AgentOrgAcct=" + AgentOrgAcct + "&WindowName=popUpWindow";
            openWindowFromSearch(url);
        }
        
        function EditClickFILE(iType,FILE){
            url = "/ASP/ocean_import/ocean_import2.asp?iType=" + iType + "&Edit=yes&JOB=" + encodeURIComponent(FILE) + "&WindowName=popUpWindow";
            openWindowFromSearch(url);
        }
...
<body style="margin: 0px 0px 0px 0px">
    <form id="form1" runat="server">
        <div align="center">
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width: 95%; border-color: #909EB0"
                class="border1px">
                <tr>
                    <td style="height: 8px; background-color: #CFD6DF">
                    </td>
                </tr>
                <tr>
                    <td style="height: 1px; background-color: #909EB0">
                    </td>
                </tr>
                <tr>
                    <td align="center">
                ...
                <tr>
                    <td style="height: 25px; background-color: #CFD6DF">
                    </td>
                </tr>
            </table>
        </div>
