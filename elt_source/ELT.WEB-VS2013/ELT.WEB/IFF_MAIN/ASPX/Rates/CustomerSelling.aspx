<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerSelling.aspx.cs"
    Inherits="ASPX_OnLines_Rate_CustomerSelling" CodePage="65001" %>
        ...
        function UltraWebGrid1_AfterRowInsertHandler(gridName, rowId, index){
            ...
            else 
            {
                ...
                if(parentBand.Key == "Routes"){
                    ...
                    currentRow.getCellFromKey("customer_no").setValue(parentRow.getCellFromKey("customer_no").getValue());
                }
