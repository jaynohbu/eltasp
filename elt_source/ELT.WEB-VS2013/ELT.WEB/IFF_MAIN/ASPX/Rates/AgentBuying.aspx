<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgentBuying.aspx.cs" 
Inherits="ASPX_OnLines_Rate_AgentBuying" CodePage="65001" %>
        ...
        function UltraWebGrid1_AfterRowInsertHandler(gridName, rowId, index){
            ...
            else 
            {
                ...
                if(parentBand.Key == "Routes"){
                    ...
                    currentRow.getCellFromKey("agent_no").setValue(parentRow.getCellFromKey("agent_no").getValue());
                }
