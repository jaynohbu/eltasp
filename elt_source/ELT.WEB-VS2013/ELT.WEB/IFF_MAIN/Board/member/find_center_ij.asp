...
<form name="inno" method="POST" action="find_center_ij.asp" ID="form1">
...
<%
	dim id,jumin,sql1,rs1,jumin1,jumin2
	...
	SQL = "SELECT id,name,email,jumin FROM member where elt_account_number=" & elt_account_number & "AND id='"&id&"' and jumin='"&jumin&"'"
...
%>
<form name="inno" method="POST" action="find_center_ij.asp" ID="Form2">
...
<%
	...
	SQL = SQL & " where id='"&id&"' and jumin='"&jumin&"'"
