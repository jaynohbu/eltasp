...
<body bgcolor="#ffffff" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" onLoad="document.inno.tb_name.focus();">

<div align="center">
<br>
<br>
<table width="95%" border="0" cellpadding="0" cellspacing="0">
<form method="post" name="inno" action="tb_form_ok.asp">
<tr>
	<td colspan="2">
	<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" ID="Table1">
	<tr align="center" bgcolor="#999999">
		<td width="25%" id="box_1_bg" bgcolor="#333333"><a href="javascript:box_1();"><b><font color="#ffffff">기본설정</font></b></a></td>
		<td width="25%" id="box_2_bg"><a href="javascript:box_2();"><b><font color="#ffffff">목록보기설정</font></b></a></td>
		<td width="25%" id="box_3_bg"><a href="javascript:box_3();"><b><font color="#ffffff">글읽기설정</font></b></a></td>
		<td width="25%" id="box_4_bg"><a href="javascript:box_4();"><b><font color="#ffffff">사용권한설정</font></b></a></td>
		</tr>
	</table>
	</td>
</tr>
...
<tr>
	<td colspan="2" height="20" class="font1" align="center" bgcolor="#333333"><font color="#ffffff"><b>기 본 설 정</b></font></td>
</tr>
<tr bgcolor="#F7F7F7" height="25">
	<td width="180" class="form_title" align="right"><b>게시판 이름 &nbsp;</b></td>
...
<tr bgcolor="#F7F7F7" height="25">
	...
	<td class="font1" valign="center"><input type="radio" name="board_type" value="0" onClick="javascript:box_close();"<% if board_type = 0 or mode="" then %> checked<% end if %>>일반게시판 &nbsp; &nbsp; <input type="radio" name="board_type" value="1" onClick="javascript:box_open()"<% if board_type = 1 then %> checked<% end if %> ID="Radio1">자료실 &nbsp; &nbsp; <input type="radio" name="board_type" value="2" onClick="javascript:box_open1()"<% if board_type = 2 then %> checked<% end if %> ID="Radio2">겔러리 &nbsp; &nbsp; <input type="radio" name="board_type" value="3" onClick="javascript:box_open()"<% if board_type = 3 then %> checked<% end if %> ID="Radio3">디지털 다이어리</font></td>
</tr>
<tr id="upload44">
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="F7F7F7" height="25" id="upload4" style="display:<% if board_type < 2 then %>none<% end if%>"> 
	<td width="180" class="form_title" align="right"><b>갤러리 타입 &nbsp;</b></td>
	<td class="font1" valign="center"><input type="radio" name="gallery_type" value="a" <% if gallery_type = "a" or gallery_type="" then %>checked<% end if %>>A형 &nbsp; &nbsp; <input type="radio" name="gallery_type" value="b"<% if gallery_type = "b" then %> checked<% end if %>>B형 &nbsp; &nbsp; <input type="radio" name="gallery_type" value="c"<% if gallery_type = "c" then %> checked<% end if %>>C형 &nbsp; &nbsp; <input type="radio" name="gallery_type" value="d"<% if gallery_type = "d" then %> checked<% end if %>>D형</td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="F7F7F7" height="25" id="upload1" style="display:<% if board_type = 0 then %>none<% end if%>"> 
	<td width="180" class="form_title" align="right"><b>업로드 컴포넌트 &nbsp;</b></td>
	<td class="font1" valign="center"><input type="radio" name="upload_type" value="abc" <% if upload_type = "abc" or mode="" then %>checked<% end if %>>ABC upload &nbsp; &nbsp; <input type="radio" name="upload_type" value="dext"<% if upload_type = "dext" then %> checked<% end if %>>DEXT upload</td>
</tr>
<tr id="upload11" style="display:<% if board_type = 0 then %>none<% end if%>">
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="F7F7F7" height="25" id="upload2" style="display:<% if board_type = 0 then %>none<% end if%>"> 
...
<tr bgcolor="F7F7F7" height="25" id="upload3" style="display:<% if board_type = 0 then %>none<% end if%>"> 
	<td width="180" class="form_title" align="right"><b>업로드 용량제한 &nbsp;</b></td>
	<td class="font1" valign="center"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="50"><input type="text" name="maxsize" size="3" maxlength="7" class="form_input" value="<% if mode<>"edit" then %>200<% else %><%=maxsize%><% end if %>" onkeyPress="numcheck()"></td><td>KByte (1M = 1000)&nbsp; 업로드 파일의 용량제한</td></tr></table></td>
</tr>
...
<tr bgcolor="#F7F7F7" height="25">
	...
	<td class="font1" valign="center"><input type="radio" name="content_type" value="0"<% if content_type = 0 or mode="" then %> checked<% end if %>>일반타입 &nbsp; &nbsp; <input type="radio" name="content_type" value="1"<% if content_type = 1 then %> checked<% end if %>>이지웍 에디터</font></td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="#F7F7F7" height="25">
	...
	<td class="font1" valign="center"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="50"><input type="text" name="board_size" size="1" maxlength="3" class="form_input" value="<% if mode<>"edit" then %>570<% else %><%=board_size%><% end if %>" onkeyPress="numcheck()"></td><td>게시판 가로크기 (100이하이면 %로 설정)</td></tr></table></td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="#F7F7F7" height="25">
	...
	<td class="font1" valign="center"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="65"><input type="text" name="bgcolor" size="5" maxlength="10" class="form_input" value="<% if mode<>"edit" then %>#FFFFFF<% else %><%=bgcolor%><% end if %>"></td><td>페이지 배경색 지정</td></tr></table></td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="#F7F7F7" height="25">
	<td width="180" class="form_title" align="right"><b>게시판 테이블 배경색 &nbsp;</b></td>
	<td class="font1" valign="center"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="65"><input type="text" name="tb_bgcolor" size="5" maxlength="10" class="form_input" value="<% if mode<>"edit" then %>#FFFFFF<% else %><%=tb_bgcolor%><% end if %>"></td><td>게시판 배경색 지정</td></tr></table></td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="#F7F7F7" height="25">
	<td width="180" class="form_title" align="right"><b>Onmouseover TR 배경색 &nbsp;</b></td>
	<td class="font1" valign="center"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="65"><input type="text" name="tr_chcolor" size="5" maxlength="10" class="form_input" value="<% if mode<>"edit" then %>#F4F4F4<% else %><%=tr_chcolor%><% end if %>"></td><td>목록의 제목에 마우스를 올려놓았을때 변하는 배경색</td></tr></table></td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="#F7F7F7" height="25">
	...
	<td class="font1" valign="center"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="140"><input type="text" name="board_title" size="20" maxlength="240" class="form_input" value="<% if mode="edit" then %><%=board_title%><% end if %>"></td><td>브라우저 상단의 타이틀을 지정 </td></tr></table></td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="F7F7F7" height="25"> 
	<td width="180" class="form_title" align="right"><b>게시판 상단에 들어갈 파일 &nbsp;</b></td>
	<td class="font1" valign="center"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="65"><input type="text" name="top_file" size="30" maxlength="240" class="form_input" value="<%=top_file%>"></td><td>&nbsp; 예) /innoboard/board/top.asp</td></tr></table></td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="F7F7F7" height="25"> 
	<td width="180" class="form_title" align="right"><b>게시판 상단에 출력할 내용 &nbsp;</b></td>
...
<tr bgcolor="F7F7F7" height="25"> 
	<td width="180" class="form_title" align="right"><b>게시판 하단에 출력할 내용 &nbsp;</b></td>
...
<tr bgcolor="F7F7F7" height="25"> 
	<td width="180" class="form_title" align="right"><b>게시판 하단에 들어갈 파일 &nbsp;</b></td>
	<td class="font1" valign="center"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="65"><input type="text" name="down_file" size="30" maxlength="240" class="form_input" value="<%=down_file%>"></td><td>&nbsp; 예) /innoboard/board/top.asp</td></tr></table></td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
<tr bgcolor="F7F7F7" height="25"> 
	...
	<td class="font1" valign="center"><input type="checkbox" name="use_smtp" value="1"<% if use_smtp=1 or mode="" then %> checked<% end if %>>SMTP 사용 &nbsp; <input type="checkbox" name="use_reco" value="1"<% if use_reco=1 then %> checked<% end if %> ID="Checkbox3">추천기능 사용 &nbsp; <input type="checkbox" name="use_cookies" value="" ID="Checkbox5" disabled="disabled">
	쿠키 사용<br>
	<input type="checkbox" name="view_upload" value="1"<% if view_upload=1 or mode="" then %> checked<% end if %>>업로드 상태바 표시(ABC & DEXT 용)</td>
</tr>
<tr>
	<td colspan="2" height="1"></td>
</tr>
...
<table width="95%" border="0" cellpadding="0" cellspacing="0">
<tr>
	<td align="right" style="word-break:break-all;padding:5px;"><a href="javascript:submit();"><img src="../img/but_join_ok.gif" border="0"></a> <a href="javascript:history.go(-1);"><img src="../img/but_join_cancel.gif" border="0"></a></td>
</tr>
<% If mode = "edit" Then %>
