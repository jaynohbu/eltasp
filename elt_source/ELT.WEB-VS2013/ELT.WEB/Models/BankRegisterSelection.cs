...
{
    [Serializable]
    public class BankRegisterSelection : AccountingSearchItem
    {
        public BankRegisterSelection(string _EltAccountNumber)
        {
        ...
        public List<SelectListItem> BankAccountList
        {
            get
            {
                List<SelectListItem> items = new List<SelectListItem>();
        ...
        public List<SelectListItem> PaymentMethodList
        {
            get
            {
                List<SelectListItem> items = new List<SelectListItem>();
