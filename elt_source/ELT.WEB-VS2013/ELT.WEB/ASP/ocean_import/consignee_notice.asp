...
<head>
    ...
    If vMode = "search" Then
        ...
        If vBillType = "file" Then
            SQL = "SELECT a.sec,c.invoice_no,a.mawb_num,b.hawb_num,d.owner_email,e.MsgTxt,d.org_account_number as agent_no,d.dba_name as agent_name,b.pieces,b.gross_wt,b.freight_collect+b.oc_collect as col_amt,b.pickup_date " _
                ...
                & "LEFT OUTER JOIN greetMessage e ON (a.elt_account_number=e.AgentID AND e.MsgType='OI/eArrival Notice') " _
    ...
    <script type="text/jscript">
        ...
        function ShowEmailHistory(){
            viewPop("/IFF_MAIN/ASPX/MISC/EmailHistory.aspx?title=EArrival Notice&ao=O&ie=I");
        }
                                                            ...
                                                            <table class="bodycopy" cellpadding="2px" cellspacing="0" border="0" id="tblHouses">
                                                                ...
                                                                <tr style="height: 20px">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="arrival_notice_pdf.asp?iType=O&MAWB=<%=aHouseData(j)("mawb_num")%>&HAWB=<%=aHouseData(j)("hawb_num")%>&SEC=<%=aHouseData(j)("sec") %>&doInvoice=no">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="arrival_notice_pdf.asp?iType=O&MAWB=<%=aHouseData(j)("mawb_num")%>&HAWB=<%=aHouseData(j)("hawb_num")%>&SEC=<%=aHouseData(j)("sec") %>&doInvoice=yes">
                                                                            <%=aHouseData(j)("invoice_no")%>
                                                                        </a>
                                                                    </td>
                                                                </tr>
