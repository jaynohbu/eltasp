...
<head>
    ...
    <%
        ...
        Sub InitializeMail(arg)
            ...
            oMail.FromName = "OCEAN Import Proof of Delivery"
            oMail.IsHTML = True
            ...
            vEmailBody = "<html xmlns='http://www.w3.org/1999/xhtml'><head><meta http-equiv='Content-Type' content='text/html; charset=ISO-88591' />" _
                & "<title>OCEAN IMPORT PROOF OF DELIVERY</title><style type='text/css'><!--.text {font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 0.85em;}--></style></head>" _
                & "<body><p class='text'><font color='#f39003'><strong>OCEAN IMPORT PROOF OF DELIVERY</strong></font></p>" & vBillInfoTable & "<p class='text'>" & Server.HTMLEncode(Request.Form("txtMessage")(arg)) _
        ...
        Function GetBillInfoTable(vMAWB)
            ...
            SQL = "SELECT a.mawb_num,b.hawb_num,d.owner_email,e.MsgTxt,d.org_account_number as agent_no,d.dba_name as agent_name,b.pieces,b.gross_wt,b.freight_collect+b.oc_collect as col_amt,b.pickup_date " _
                ...
                & "WHERE a.elt_account_number=" & elt_account_number & " AND a.mawb_num=N'" & vMAWB & "' AND a.iType='O' AND ISNULL(b.mawb_num,'')<>'' AND c.import_export='I'"
