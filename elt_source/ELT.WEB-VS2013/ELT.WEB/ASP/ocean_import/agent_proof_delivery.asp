...
<head>
    ...
    If vMode = "search" Then
        ...
        If vBillType = "file" Then
            SQL = "SELECT a.mawb_num,b.hawb_num,d.owner_email,e.MsgTxt,d.org_account_number as agent_no,d.dba_name as agent_name,b.pieces,b.gross_wt,b.freight_collect+b.oc_collect as col_amt,b.pickup_date " _
                ...
                & "LEFT OUTER JOIN greetMessage e ON (a.elt_account_number=e.AgentID AND e.MsgType='OI/Proof Of Delivery') " _
                & "WHERE a.elt_account_number=" & elt_account_number & " AND a.file_no=N'" & vBillNum & "' AND a.iType='O' AND ISNULL(b.mawb_num,'')<>'' AND c.import_export='I'"
        Elseif vBillType = "master" Then
            SQL = "SELECT a.mawb_num,b.hawb_num,d.owner_email,e.MsgTxt,d.org_account_number as agent_no,d.dba_name as agent_name,b.pieces,b.gross_wt,b.freight_collect+b.oc_collect as col_amt,b.pickup_date " _
                ...
                & "LEFT OUTER JOIN organization d ON (a.elt_account_number=d.elt_account_number AND a.agent_org_acct=d.org_account_number) " _
                & "LEFT OUTER JOIN greetMessage e ON (a.elt_account_number=e.AgentID AND e.MsgType='OI/Proof Of Delivery') " _
                & "WHERE a.elt_account_number=" & elt_account_number & " AND a.mawb_num=N'" & vBillNum & "' AND a.iType='O' AND ISNULL(b.mawb_num,'')<>'' AND c.import_export='I'"
        Else
    ...
    <script type="text/jscript">
        ...
        function lstSearchNumChange(argV,argL){
	        ...
	        var url = "agent_proof_delivery.asp?mode=search&type=" + typeValue + "&no=" + argV;
        ...
        function searchNumFill(obj,iType,changeFunction,vHeight,event){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                var url = "/ASP/ajaxFunctions/ajax_get_bills.asp?mode=list&import=" + iType + "&qStr=" 
                    + qStr + "&type=" + typeValue;
        ...
        function searchNumFillAll(objName,iType,changeFunction,vHeight){
            ...
            var url = "/ASP/ajaxFunctions/ajax_get_bills.asp?mode=list&import=" + iType + "&type=" + typeValue;

            FillOutJPED(obj,url,changeFunction,vHeight);
        }
        
        function ShowEmailHistory(){
            viewPop("/IFF_MAIN/ASPX/MISC/EmailHistory.aspx?title=Proof of Delivery&ao=O&ie=I");
        }
        ...
        function SendClickFormSubmit(){
            ...
            document.form1.action = "agent_proof_delivery_send.asp?WindowName=MailSend";
...
<body style="margin: 0px 0px 0px 0px;" onload="LoadPage()">
    ...
    <form id="form1" name="form1" accept-charset="UTF-8" action="">
        <table align="center" border="0" bordercolor="#909EB0" cellpadding="0"
            cellspacing="0" class="border1px" width="95%">
            <tr>
                <td height="100%">
                    <table border="0" cellpadding="2" cellspacing="0" width="100%">
                        <tr>
                            <td align="center" bgcolor="#CFD6DF" class="bodyheader" colspan="6" height="24" valign="middle">
                        ...
                        <tr align="center" bgcolor="#edd3cf" valign="middle">
                            <td align="center" bgcolor="#eeeeee" class="bodyheader" colspan="6" height="24">
                                ...
                                <table bgcolor="#edd3cf" border="0" bordercolor="#909EB0" cellpadding="2" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="shorttextfield" size="80" id="txtEmailSubject<%=i %>" name="txtEmailSubject"
                                                                value="Proof of Delivery: <%=vDBA %> MAWB: <%=aOrgData(i)("mawb_num") %>" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table class="bodycopy" cellpadding="2px" cellspacing="0" border="0" id="tblHouses">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a href="javascript:viewPop('ocean_import2.asp?iType=O&Edit=yes&Search=yes&MAWB=<%=aOrgData(i)("mawb_num")%>')">
                                                                            <%=aOrgData(i)("mawb_num")%>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr style="height:20px">
                                                                    <td>
                                                                        <a href="javascript:viewPop('arrival_notice.asp?iType=O&Edit=yes&HAWB=<%=aHouseData(j)("hawb_num")%>&MAWB=<%=aHouseData(j)("mawb_num")%>')">
                                                                    ...
                                                                    <td>
                                                                        <%=aHouseData(j)("gross_wt")%>
                                                                    </td>
                                                                    <td>
                                                                        <%=aHouseData(j)("col_amt")%>
                                                                    </td>
                                                                    <td>
                                                                        <%=aHouseData(j)("pickup_date")%>
                                                                    </td>
                                                                </tr>
                                                                <% Next %>
                                                            </table>
