...
<head>
    ...
    If vMode = "search" Then
        ...
        If vBillType = "house" Then
            ...
            SQL = "SELECT 'N' as isDirect,a.mawb_num,b.hawb_num,b.shipper_account_number,b.shipper_name,ISNULL(c.invoice_no,-1) as invoice_no,d.owner_email,MsgTxt" _
                ...
                & " LEFT OUTER JOIN organization d ON (b.elt_account_number=d.elt_account_number AND b.shipper_account_number=d.org_account_number)" _
                & " LEFT OUTER JOIN greetMessage e ON (b.elt_account_number=e.AgentID AND MsgType='AE/Shipping Notice')" _
                & " WHERE a.elt_account_number=" & elt_account_number & " AND a.mawb_num=(SELECT TOP 1 mawb_num FROM hawb_master" _
                & " WHERE elt_account_number=" & elt_account_number & " AND hawb_num=N'" & vBillNum & "') AND ISNULL(b.hawb_num,'')<>'' ORDER BY b.shipper_name, b.hawb_num"
        ...
        Elseif vBillType = "master" Then
            ...
            SQL = "SELECT 'N' as isDirect,a.mawb_num,b.hawb_num,b.shipper_account_number,b.shipper_name,ISNULL(c.invoice_no,-1) as invoice_no,d.owner_email,MsgTxt" _
                ...
                & " LEFT OUTER JOIN organization d ON (b.elt_account_number=d.elt_account_number AND b.shipper_account_number=d.org_account_number)" _
                & " LEFT OUTER JOIN greetMessage e ON (b.elt_account_number=e.AgentID AND MsgType='AE/Shipping Notice')" _
                & " WHERE a.elt_account_number=" & elt_account_number & " AND a.mawb_num='" & vBillNum & "' AND ISNULL(b.hawb_num,'')<>'' ORDER BY b.shipper_name, b.hawb_num"

            If Not IsDataExist(SQL) Then
                SQL = "SELECT 'Y' as isDirect,a.mawb_num,'' as hawb_num,a.shipper_account_number,a.shipper_name,ISNULL(c.invoice_no,-1) as invoice_no,d.owner_email,MsgTxt" _
                    & " FROM mawb_master a LEFT OUTER JOIN invoice c ON (a.elt_account_number=c.elt_account_number AND a.mawb_num=c.mawb_num AND c.air_ocean='A' AND c.import_export='E')" _
                    & " LEFT OUTER JOIN organization d ON (a.elt_account_number=d.elt_account_number AND a.shipper_account_number=d.org_account_number)" _
                    & " LEFT OUTER JOIN greetMessage e ON (a.elt_account_number=e.AgentID AND MsgType='AE/Shipping Notice')" _
                    & " WHERE a.elt_account_number=" & elt_account_number & " AND a.mawb_num='" & vBillNum & "' AND ISNULL(a.shipper_account_number," & elt_account_number & ")<>" & elt_account_number & " ORDER BY a.shipper_name"
            End If
            
        Elseif vBillType = "file" Then
        
            SQL = "SELECT 'N' as isDirect,a.mawb_num,f.file#,b.hawb_num,b.shipper_account_number,b.shipper_name,ISNULL(c.invoice_no,-1) as invoice_no,d.owner_email,MsgTxt" _
                & " FROM mawb_master a LEFT OUTER JOIN hawb_master b ON (a.elt_account_number=b.elt_account_number AND a.mawb_num=b.mawb_num)" _
                & " LEFT OUTER JOIN invoice c ON (b.elt_account_number=c.elt_account_number AND b.mawb_num=c.mawb_num AND b.hawb_num=c.hawb_num AND c.air_ocean='A' AND c.import_export='E')" _
                & " LEFT OUTER JOIN organization d ON (b.elt_account_number=d.elt_account_number AND b.shipper_account_number=d.org_account_number)" _
                & " LEFT OUTER JOIN greetMessage e ON (b.elt_account_number=e.AgentID AND MsgType='AE/Shipping Notice')" _
                & " LEFT OUTER JOIN mawb_number f ON (b.elt_account_number=f.elt_account_number AND b.mawb_num=f.mawb_no)" _
                & " WHERE a.elt_account_number=" & elt_account_number & " AND f.file#='" & vBillNum & "' AND ISNULL(b.hawb_num,'')<>'' ORDER BY b.shipper_name, b.hawb_num"
            
            If Not IsDataExist(SQL) Then
                SQL = "SELECT 'Y' as isDirect,a.mawb_num,f.file#,'' as hawb_num,a.shipper_account_number,a.shipper_name,ISNULL(c.invoice_no,-1) as invoice_no,d.owner_email,MsgTxt" _
                    & " FROM mawb_master a LEFT OUTER JOIN invoice c ON (a.elt_account_number=c.elt_account_number AND a.mawb_num=c.mawb_num AND c.air_ocean='A' AND c.import_export='E')" _
                    & " LEFT OUTER JOIN organization d ON (a.elt_account_number=d.elt_account_number AND a.shipper_account_number=d.org_account_number)" _
                    & " LEFT OUTER JOIN greetMessage e ON (a.elt_account_number=e.AgentID AND MsgType='AE/Shipping Notice')" _
                    & " LEFT OUTER JOIN mawb_number f ON (a.elt_account_number=f.elt_account_number AND a.mawb_num=f.mawb_no)" _
                    & " WHERE a.elt_account_number=" & elt_account_number & " AND f.file#='" & vBillNum & "' AND ISNULL(a.shipper_account_number," & elt_account_number & ")<>" & elt_account_number & " ORDER BY a.shipper_name"
            End If
        Else
        ...
        Set aOrgData = DataListGroupBy(aAllData,"shipper_account_number")
    ...
    '// Direct shipment with no shipper(or ELT agent being shipper) will not be displayed
    ...
    <script type="text/jscript">
        ...
        function searchNumFillAll(objName,eType,changeFunction,vHeight){
            ...
            if(typeValue != "")
            {
                url = "/ASP/ajaxFunctions/ajax_get_bills.asp?mode=list&type=" 
        ...
        function ShowEmailHistory(){
            viewPop("/IFF_MAIN/ASPX/MISC/EmailHistory.aspx?title=Shipping Notice&ao=A&ie=E");
        }
...
<body style="margin: 0px 0px 0px 0px;" onload="LoadPage()">
    ...
    <form id="form1" name="form1" accept-charset="UTF-8" action="">
        <table align="center" bgcolor="#a0829c" border="0" bordercolor="#a0829c" cellpadding="0"
            cellspacing="0" class="border1px" width="95%">
            <tr>
                <td height="100%">
                    <table border="0" cellpadding="2" cellspacing="0" width="100%">
                        <tr bgcolor="#edd3cf">
                            <td align="center" bgcolor="#e5d4e3" class="bodyheader" colspan="6" height="24" valign="middle">
                        ...
                        <tr align="center" bgcolor="#f0e7ef" valign="middle">
                            <td align="center" bgcolor="#eeeeee" class="bodyheader" colspan="6" height="24">
                                ...
                                <table bgcolor="#edd3cf" border="0" bordercolor="#a0829c" cellpadding="2" cellspacing="0"
                                    class="border1px" width="65%">
                                    <tr align="left" bgcolor="#f0e7ef" valign="middle">
                                        <td align="left" class="bodycopy" valign="middle" width="1">
                                            &nbsp;</td>
                                        <td align="left" bgcolor="#f0e7ef" class="bodyheader" height="20" valign="middle"
                                            width="222">
                                            Your Name</td>
                                                ...
                                                <table id="tblOrg<%=i %>" class="bodycopy" cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="shorttextfield" size="80" id="txtEmailSubject<%=i %>" name="txtEmailSubject"
                                                                value="Shipping Notice: <%=vDBA %> MAWB:<%=aOrgData(i)("mawb_num") %>" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <% Set aHouseData = DataListGroupBy(DataListSelect(aAllData, "shipper_account_number", aOrgData(i)("shipper_account_number")),"hawb_num") %>
                                                            <ul style="display: inline; float: none;">
                                                                <% If aOrgData(i)("isDirect") <> "Y" Then %>
                                                                    ...
                                                                    <li style="display: inline; float: left; list-style: none; width: 200px; overflow: hidden">
                                                                        <input type="checkbox" id="chkHousePDF<%=i %><%=j %>" name="chkHousePDF<%=aOrgData(i)("shipper_account_number") %>"
                                                                            value="<%=aHouseData(j)("hawb_num") %>" checked="checked" />
                                                                        <a href="hawb_pdf.asp?HAWB=<%=aHouseData(j)("hawb_num") %>&Copy=SHIPPER">
                                                                            HAWB:
                                                                            <%=aHouseData(j)("hawb_num") %>
                                                                        </a>&nbsp;&nbsp;&nbsp;</li>
                                                                    <% If aHouseData(j)("invoice_no") <> "-1" Then %>
                                                                    <li style="display: inline; float: left; list-style: none; width: 200px; overflow: hidden">
                                                                        <input type="checkbox" id="chkInvoicePDF<%=i %><%=j %>" name="chkInvoicePDF<%=aOrgData(i)("shipper_account_number") %>"
                                                                ...
                                                                <% Else %>
                                                                <li style="display: inline; float: left; list-style: none; width: 200px; overflow: hidden">
                                                                    <input type="checkbox" id="chkMasterPDF<%=i %>" name="chkMasterPDF<%=aOrgData(i)("shipper_account_number") %>"
                                                                        value="<%=aOrgData(i)("shipper_account_number") %>" checked="checked" />
                                                                    <a href="mawb_pdf.asp?MAWB=<%=aOrgData(i)("mawb_num") %>&Copy=CONSIGNEE">
                                                                        MAWB:
                                                                        <%=aOrgData(i)("mawb_num") %>
                                                                    </a>&nbsp;&nbsp;&nbsp;</li>
                                                                <% if aOrgData(i)("invoice_no") <> "-1" Then %>
                                                                <!-- Direct Master with a invoice created -->
                                                                <li style="display: inline; float: left; list-style: none; width: 200px; overflow: hidden">
                                                                    <input type="checkbox" id="chkInvoicePDF<%=i %>" name="chkInvoicePDF<%=aOrgData(i)("shipper_account_number") %>"
                                                    ...
                                                    <tr>
                                                        <td class="bodyheader">
                                                            ATTACHMENT</td>
                                                        <td>
                                                            <a href="javascript:void(UploadFile('<%=aOrgData(i)("shipper_account_number")%>'));" id="aAttachedFiles<%=aOrgData(i)("shipper_account_number")%>">
                                                                <%=GetUserFileList(aOrgData(i)("shipper_account_number")).Count %>
                                                                Attached File(s) </a>
                                                        </td>
                                                    </tr>
                                                    <tr>
