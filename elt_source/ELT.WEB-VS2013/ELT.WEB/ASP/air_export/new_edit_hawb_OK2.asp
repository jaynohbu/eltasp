...
SUB DELETE_TEMP_HAWB(saved_HAWB_NUM)
	SQL= "delete hawb_master where elt_account_number = " & elt_account_number & " and hawb_num=N'" _
	    & saved_HAWB_NUM & "' and CAST(Agent_Info AS VARCHAR)='Auto Generated No.' and is_dome='N'"	
