...
<body style="margin: 0px 0px 0px 0px;" onload="LoadPage()">
    ...
    <div style="text-align: center">
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="width: 95%; border: solid 1px #a0829c" class="bodycopy">

            <tr style="background-color: #e5d4e3">
                <td class="bodyheader" colspan="10" style="padding:4px;">
                    MAWB NO:
                    <%=vBookingNum %>
                        ...
                        <tr id="trHouse<%=i %>">
                            <td>
                                ...
                                <input id="chkHouse<%=i %>" name="chkHouse" type="checkbox" value="<%=aAllData(i)("hawb_num") %>"
                                    <% If vBillType<>"house" Or (vBillType="house" And vBillNum=aAllData(i)("hawb_num")) Then Response.Write("checked=checked") %> />
                            </td>
                            <td>
            ...
            <tr style="background-color: #e5d4e3">
                <td class="bodyheader"  style="padding:4px;">
                    Total Pieces:
                    <%=vTotalPcs %>
