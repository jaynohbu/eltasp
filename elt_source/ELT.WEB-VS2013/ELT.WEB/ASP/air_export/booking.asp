...
if Save="yes" then
	...
	if Save="yes" then
		...
		if Not rs.EOF then
			...
			'rs("origin_port_aes_code")=isnull(vOriginPortID,0)
'response.end
...
<body link="336699" vlink="336699" topmargin="0" onload="self.focus(); ">
            ...
            <td width="50%" align="right" valign="middle">
                <span class="bodyheader style11">FILE NO.</span><input name="txtJobNum" type="text"
                    ...
                    onfocus="javascript: this.value = ''; this.style.color='#000000'; " tabindex="-1"><img
                        ...
                        onfocus="lookupFile()" onclick="lookupFile()">
            </td>
        </tr>
    </table>
    ...
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="A0829C">
        <tr>
            <td>
                <input type="hidden" name="txtCarrierDesc" id="txtCarrierDesc" value="<%=vCarrierDesc%>">
                <!--// by ig 7/11/2006 -->
                <input type="hidden" name="hFILEPrefix" id="hFILEPrefix" value="<%= vFILEPrefix %>">
                <input type="hidden" name="hNEXTFILENo" id="hNEXTFILENo"  value="<%= vNEXTFILENo %>">
                <input type="hidden" name="FlagChanged" id="FlagChanged" value="">
                <!--// -->
                                        ...
                                        <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td width="13%" align="right" valign="middle">
                                                    <a href="/ASP/air_export/booking.asp" target="_self" tabindex="-1">
                                                        <img src="/ASP/Images/button_new.gif" width="42" height="17" border="0" style="cursor: pointer"></a>
                                                </td>
                                                <td width="13%" align="right" valign="middle">
                                        ...
                                        <table width="75%" border="0" cellpadding="0" cellspacing="0" bordercolor="#A0829C"
                                            ...
                                            <tr bgcolor="#e8d9e6">
                                                ...
                                                <td width="34%" height="20">
                                                    <strong class="bodyheader">Airline Carrier</strong>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td height="20">
                                                    <select name="lstCarrier" id="lstCarrier" size="1" class="bodycopy" style="width: 200px">
                                                        <% for i=0 to aIndex-1 %>
...
{  
    ...
    if (popAddMAWB == '' || typeof(popAddMAWB) == 'undefined')
        popAddMAWB=document.getElementById("output").value;
 ...
 <input type="text" style="width:1px; height:1px; border:none;" id="output"/>
...
<div id="<%=iMoonComboBoxName%>_Container" class="ComboBox" style="width: <%=iMoonComboBoxWidth%>;
                                                    ...
                                                    <div id="<%=iMoonComboBoxName%>_NewDiv" style="display: none; position: absolute;
                                                        ...
                                                        <img id="<%=iMoonComboBoxName%>_AddNewButton" src="/ig_common/Images/combobox_addnew.gif"
                                                            alt="Quick Add MAWB No." border="0" />
                                                    </div>
                                                    <!-- /End of Combobox/ -->
                                                ...
                                                <td valign="top">
                                                    ...
                                                    <select name="lstFILEPrefix" id="lstFILEPrefix" size="1" class="bodyheader" style="width: 80px" onchange="PrefixChange()">
                                                        <% For i=0 To fIndex-1 %>
                                                    ...
                                                    <input name='txtFileNo' id="txtFileNo" class='bodyheader' style='width: 110px' value='<%= vFileNo %>'
                                                        size='20'>
                                                    <% else %>
                                                    <input name='txtFileNo' id="txtFileNo" class='readonlybold' style='width: 90px' value='<%= vFileNo %>'
                                            ...
                                            <tr align="left" valign="middle" bgcolor="#F3f3f3" class="bodycopy">
                                                ...
                                                <td colspan="2">
                                                    <span class="bodyheader">Airport of Destination</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#Ffffff">
                                                ...
                                                <td colspan="3" bgcolor="#FFFFFF">
                                                    <select name="lstOriginPort" size="1" id="lstOriginPort" class="shorttextfield" style="width: 230px">
                                                ...
                                                <td colspan="2" bgcolor="#FFFFFF">
                                                    <select name="lstDestPort" id="lstDestPort" size="1" class="smallselect" style="width: 230px" onchange="DestPortChange()">
                                                        <option value="">Select One</option>
                                                        <% for i= 0 to pIndex-1 %>
                                                ...
                                                <tr bgcolor="#F3f3f3" class="bodyheader">
                                                    ...
                                                    <td bgcolor="#F3f3f3">
                                                        <span class="style9">To</span>
                                                    </td>
                                                    <td colspan="2">
                                                        <span class="style9">By First Carrier</span>
                                                    </td>
                                                    <td>
                                                        &nbsp;
                                                    </td>
                                                    ...
                                                    <tr bgcolor="#Ffffff">
                                                        ...
                                                        <td>
                                                            <input name="txtTo" id="txtTo" class="m_shorttextfield" value="<%= vTo %>" size="8" maxlength="3">
                                                        </td>
                                                        <td colspan="2">
                                                            <input name="txtBy" id="txtBy" class="shorttextfield" value="<%= vBy %>" size="24">
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
                                                        ...
                                                        <tr bgcolor="#F3f3f3">
                                                            ...
                                                            <tr bgcolor="#Ffffff">
                                                                ...
                                                                <td>
                                                                    <input name="txtTo1"  id="txtTo1" class="m_shorttextfield" value="<%= vTo1 %>" size="8" maxlength="3">
                                                                </td>
                                                                <td colspan="2">
                                                                    <input name="txtBy1" id="txtBy1" class="shorttextfield" value="<%= vBy1 %>" size="24">
                                                                </td>
                                                                <td>
                                                                    <input name="txtTo2" id="txtTo2" class="m_shorttextfield" value="<%= vTo2 %>" size="8" maxlength="3">
                                                                </td>
                                                                <td>
                                                                    <input name="txtBy2" id="txtBy2" class="shorttextfield" value="<%= vBy2 %>" size="24">
                                                                </td>
                                                                <tr align="left" valign="middle" bgcolor="#F3f3f3" class="bodycopy">
                                                                    <td>
                                                                        &nbsp;
                                                                    ...
                                                                    <td height="20" colspan="2" class="bodyheader">
                                                                        <img src="/ASP/Images/required.gif" align="absbottom">Departure Date
                                                                    </td>
                                                                    <td class="bodyheader">
                                                                        <img src="/ASP/Images/required.gif" align="absbottom">Arrival Date
                                                                    </td>
                                                                    <td>
                                                                        &nbsp;
                                                                    </td>
                                                                ...
                                                                <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                                                    ...
                                                                    <tr align="left" valign="middle" bgcolor="#F3f3f3" class="bodycopy">
                                                                        ...
                                                                        <td height="20" bgcolor="#F3f3f3" class="bodycopy">
                                                                            <span class="bodycopy">Flight No. 2</span>
                                                                        </td>
                                                                        ...
                                                                        <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                                                            ...
                                                                            <tr align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                                                                ...
                                                                                <td class="bodycopy">
                                                                                    <input name="txtWeightReserved" data-="txtWeightReserved" class="shorttextfield" value="<%= vWeightReserved %>"
                                                                                        size="14" style="behavior: url(../include/igNumChkRight.htc)">
                                                                                </td>
                                                                                <td colspan="2">
                                                                                    <select name="lstWeightScale" id="lstWeightScale" size="1" class="smallselect">
                                                                                        <option>LB</option>
                                                                                ...
                                                                                <td>
                                                                                    <input name="txtAirLineStaff" id="txtAirLineStaff"  type="text" class="shorttextfield" value="<%= vAirLineStaff %>"
                                                                                        size="20">
                                                                                </td>
                                                                                <td>
                                                                                    &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td width="48%" align="center" valign="middle">
                                        <input type="image" src="../images/button_save_medium.gif" width="46" height="18"
                                            name="bSave" onclick="bsaveclick(); return false;" style="cursor: pointer" />
                                    </td>
                                    <td width="13%" align="right" valign="middle">
                                    ...
                                    <td width="13%" align="right" valign="middle">
                                        <input type="image" src="../images/button_closebooking.gif" width="48" height="18"
                                            name="bClose" onclick="bCloseClick(); return false;" style="cursor: pointer" />
                                    </td>
                                </tr>
                            </table>
                        </td>
...
<script type="text/jscript">
    function newBookingNumberAdded(){
                                                         
        var   popAddMAWB=document.getElementById("output").value;                                                          
                                                            
        var oSelect = $("#lstCarrier").get(0);
        if (popAddMAWB != '' && typeof(popAddMAWB) != 'undefined')
        {    
            var sMAWB = popAddMAWB.substring(0,popAddMAWB.indexOf("-"));
            ...
            for( var i = 0; i < items.length; i++ ) {
                var item = items[i];
                if( item.text.toLowerCase() == popAddMAWB.toLowerCase() ) {
                    oSelect.selectedIndex = i;
                    break;
                }
            }
                                                               
            $("#lstMAWB_Text").val(sMAWB);
            <%=iMoonComboBoxName%>_OnChangePlus();	                                                            
    ...
    function goToMAWB() {
        if(!$('#lstMAWB_Text').val()){
            alert('Please select or add a new MAWB!');
            return;
        }
        ...
        var fileNo = document.getElementsByName("txtFileNo").value;
    ...
    function MAWBChange() {
        ...
        if (chkObj == null || !chkObj.checked) {
            ...
            document.getElementsByName("txtBy").value = document.getElementById("lstMAWB").value;
        }
    }
    ...
    function Lookup()    //never used
    {
        var MAWB = document.frmMAWBNO.txtsMAWB.value.trim();
...
--->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#txtDeptDate1").datepicker();            
                $("#txtDeptDate2").datepicker();  
                $("#txtArrivalDate1").datepicker(); 
                $("#txtArrivalDate2").datepicker();  
            });
        </script>
<!-- //for Tooltip// -->
