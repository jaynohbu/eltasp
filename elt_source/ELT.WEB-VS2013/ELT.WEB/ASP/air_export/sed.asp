...
<body link="336699" vlink="336699" style="margin: 0px 0px 0px 0px" onload="self.focus()">
            ...
            <td width="64%" align="right" valign="middle" class="bodycopy">
                <div id="print">
                    <img src="/ASP/Images/icon_submit.gif" align="absbottom"><a href="javascript:;"
                        onclick="AESClick();return false;">Submit to AES Weblink</a><img src="/ASP/Images/button_devider.gif"
                            alt="" /><a href="/IFF_MAIN/ASPX/Misc/ManageSED.aspx">Manage AES</a><img src="/ASP/Images/button_devider.gif"
                                alt="" /><a href="javascript:void(viewPop2('PopWin','http://www.aesdirect.gov'));">AES
                                    Direct Homepage</a><img src="/ASP/Images/button_devider.gif" alt="" /><a
                                ...
                                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="13%" align="right" valign="middle">
                                            <a href="/ASP/air_export/sed.asp" target="_self">
    ...
    End If
                                    ...
                                    <tr align="left" valign="middle">
                                        ...
                                        <td bgcolor="#f0e7ef">
                                            <img src="/ASP/Images/required.gif" align="absbottom"><strong>15. Shipment
                            ...
                            <td colspan="2" bgcolor="#FFFFFF">
                                <table width="100%" border="0" cellpadding="1" cellspacing="2" bgcolor="#FFFFFF"
                                    ...
                                    <tr align="left" valign="top" bgcolor="#f0e7ef">
                                        ...
                                        <td>
                                            <strong><a href="javascript:void(viewPop2('PopWin','/ASP/Code/export_code.htm'));">
                                                Export Code</a></strong></td>
                                        <td>
                                            <strong><a href="javascript:void(viewPop2('PopWin','/ASP/Code/type_code.html'));">License
                                                Type</a></strong></td>
                                        <td>
                                            &nbsp;</td>
                                        <td width="89">
                    ...
                    <div id="print">
                        <img src="/ASP/Images/icon_submit.gif" align="absbottom"><a href="javascript:;"
                            onclick="AESClick();return false;">Submit to AES Weblink</a><img src="/ASP/Images/button_devider.gif"><a
                                href="/IFF_MAIN/ASPX/Misc/ManageSED.aspx">Manage AES</a><img src="/ASP/Images/button_devider.gif"><a
                                    href="javascript:void(viewPop2('PopWin','http://www.aesdirect.gov'));">AES Direct
                                    Homepage</a><img src="/ASP/Images/button_devider.gif"><a href="javascript:;"
...
var tIndex = '<%=tIndex%>';
	...
	try
	{
		...
		xmlHTTP.open("get","/ASP/include/get_schedule_b.asp?" + param ,false); 
...
Sub newScheduleB()
		...
		window.open "/IFF_MAIN/ASPX/Onlines/ScheduleB/ScheduleBCreate.aspx?ff="& ShipperAcct & "&nn=" & encodeURIComponent(ShipperName), "Dimension_Calculation", props
		GET_SCHEDULE_B_AJAX()
End Sub
...
ShipperInfo= get_organization_info_sed ( "/ASP/ajaxFunctions/ajax_get_org_address_info.asp?org=" _
...
ConsigneeInfo= get_organization_info_sed ( "/ASP/ajaxFunctions/ajax_get_org_address_info.asp?org=" _
