            ...
            <td>
                <table class="bodycopy" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        ...
                        <td>
                            <input type="text" id="txtSearchNum" value="" class="bodyheader" size="20" disabled="disabled" />
                        </td>
                        <td style="width: 10px">
                        </td>
                        <td style="width: 10px">
                        ...
                        <td>
                            <input type="button" id="btnPDF" value="PDF" onclick="findBillPDF2();" class="bodycopy"
                                style="width: 40px" />
                        </td>
                        <td style="width: 5px">
                        </td>
                        <td>
                            <input type="button" id="btnDOT" value="Dot" onclick="findBillDot();" class="bodycopy"
                                style="width: 40px" />
                        </td>
                        <td style="width: 5px">
                        </td>
                        <td>
                            <input type="button" id="btnRider" value="Rider" onclick="findBillRider();" class="bodycopy"
                                style="width: 40px; visibility: hidden" />
                        </td>
                        <td style="width: 5px">
                        </td>
                        <td>
                            <input type="button" id="btnManifest" value="Manifest" onclick="findBillManifest();"
                                class="bodycopy" style="width: 60px; visibility: hidden" />
                        </td>
                        <td style="width: 5px">
                        </td>
                        <td>
                            <input type="button" id="btnIAC" value="IAC" onclick="findBillIAC();" class="bodycopy"
                                style="width: 40px; visibility: hidden" />
                        </td>
                    </tr>
                </table>
            ...
            <td align="right">
                <table cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        ...
                        <td>
                            <input type="button" id="btnPrint" value="Print" class="bodycopy" style="width: 40px"
                                onclick="printWindowM();" />
                        </td>
                    </tr>
                </table>
            </td>
