...
DIM ff_shipper_acct,ff_consignee_acct,vAESText,Copy
Dim IATA
...
PDF.SetFormFieldData "preparedby",session_lname,0
...
If Copy = "CARRIER" Then
    PDF.SetFormFieldData "Copy","Original for Issuing Carrier", 0
Elseif Copy = "COPY" Then
    PDF.SetFormFieldData "Copy","COPY", 0
Elseif Copy = "SHIPPER" Or Copy = "CONSIGNEE" Then
