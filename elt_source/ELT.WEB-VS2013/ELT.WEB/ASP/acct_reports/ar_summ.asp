...
if Not Branch=0 then
	SQL= "select customer_name,(sum(debit_amount)+sum(credit_amount)) as total from all_accounts_journal where elt_account_number = " & Branch & " and gl_account_number in (" & vARAcct & ") and (tran_date between " & DM & FromDate & DM & " and " & DM & ToDate+1 & DM & " or tran_type='INIT') and customer_name<>'' group by customer_name order by customer_name"
else
...
<table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
  <tr> 
    <td height="20" align="left" valign="bottom" class="pageheader">Accounts Receivable 
      Summary </td>
  </tr>
</table>
...
<!--
Sub BranchChange()
	document.form1.action="ar_summ.asp" & "?WindowName=" & window.name
...
Sub PrintReport()
	jPopUpNormal()
	document.form1.action="ar_summPrint.asp" & "?WindowName=" & window.name
