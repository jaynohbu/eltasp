...
<% 
    Dim itemNum
    itemNum = checkBlank(Request.QueryString("ItemNum"),"")
%>
...
<head>
    ...
    function closeAndUpdate(){
        ...
        if(totalDimension == ""){
            ...
            if(vPieces != parseInt(self.opener.document.frmMAWB.txtPiece<%=itemNum %>.value)){
                alert("Please, verify the number of pieces!");
                return false;
            }
            
            self.opener.document.frmMAWB.txtCubicInches<%=itemNum %>.value=totalCInch.toFixed(2);
            self.opener.document.frmMAWB.hDimDetail.value = document.getElementById("txtDimDetail").value;
            self.opener.document.frmMAWB.hDimFactor.value = vFactor;
            self.opener.document.frmMAWB.txtCubicWeight.value = totalDimension;
            self.opener.setChargeableWeight();
            self.opener.setTotalWeightCharge();
    ...
    function initDimDetail(){
        ...
        var detail = document.getElementById("txtDimDetail");
        var tmpDetail = self.opener.document.frmMAWB.hDimDetail.value;
        ...
        if (tmpDetail != null && tmpDetail != ""){
            ...
            var vFactor = self.opener.document.frmMAWB.hDimFactor.value;
