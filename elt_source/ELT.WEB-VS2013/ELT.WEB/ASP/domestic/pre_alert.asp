...
' get agent attached files
	for i=0 to aIndex-1
		...
		Do while Not rs.EOF
			...
			aAgentFileURL(i,afIndex)="/ASP/include/viewfile.asp?OrgNo=" & aAgentNo(i) & "&FileName=" & vFileName
          ...
          <tr align="center" valign="middle" bgcolor="f3d9a8">
            <td height="24" colspan="6" align="center" bgcolor="#f3f3f3" class="bodyheader"><br>
                    <table width="65%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="50%" align="left" valign="middle"><span class="goto"><img src="/ASP/Images/icon_email_history.gif" align="absbottom"><a href="javascript:;" onClick="ShowEmailHistory()">View Email History</a></span></td>
                            <td width="50%" height="28" align="right" class="bodyheader"><img src="/ASP/Images/required.gif" align="absbottom">Required field</td>
                        </tr>
                    </table>
...
Sub ShowEmailHistory
    ...
    jPopUpNormal()
	document.form1.action= "/IFF_MAIN/ASPX/MISC/EmailHistory.aspx?title=Agent Pre-Alert&ao=A&ie=E"
	document.form1.method="post"
	document.form1.target="popUpWindow"
