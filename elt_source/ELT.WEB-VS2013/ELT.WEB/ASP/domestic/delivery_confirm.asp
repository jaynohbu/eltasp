...
// -->
   ...
   function cleartext()
   {
    ...
    function selectSearchType(argV,argL)
    {
        ...
        var url = "/ASP/ajaxFunctions/ajax_domestic_delivery_confirmation.asp?mode=view&type=" + typeValue
            + "&export=A&no=" + argV;
     ...
     function searchNumFill(obj,eType,changeFunction,vHeight,event){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                url = "/ASP/ajaxFunctions/ajax_domestic_delivery_confirmation.asp?mode=list&export=" + eType 
         ...
         function searchNumFillAll(objName,eType,changeFunction,vHeight){
            ...
            var url = "/ASP/ajaxFunctions/ajax_domestic_delivery_confirmation.asp?mode=list&type=" + typeValue 
                + "&export=" + eType;
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                            <tr>
                                                                <td style="height: 18px"><input type="text" autocomplete="off" id="lstSearchNum" name="lstSearchNum" value="<%=vlstSearchNum%>" tabindex="-1"
                                                                        class="shorttextfield" style="width: 140px; border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onKeyUp=" searchNumFill(this,'A','selectSearchType',200);" onFocus="initializeJPEDField(this,event);" /></td>
...
<table width="65%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="50%" height="28" align="left" valign="middle"><span class="goto"><img src="/ASP/Images/icon_email_history.gif" align="absbottom"><a href="javascript:;" onClick="ShowEmailHistory()">View Email History</a></span></td>
                    <td width="50%" align="right" class="bodyheader"><img src="/ASP/Images/required.gif" align="absbottom">Required field</td>
                </tr>
            </table>
...
<!-- End of modified by Joon on Dec-8-2006 --->    
	    ...
	    <td>
          ...
          <tr align="left" bgcolor="#F3f3f3">
              <td valign="middle">&nbsp;</td>
              <td align="left" valign="middle" bgcolor="#F3f3f3" class="bodyheader"><img src="/ASP/Images/required.gif" align="absbottom">TO</td>
...
Sub ShowEmailHistory
    ...
    jPopUpNormal()
	document.form1.action= "/IFF_MAIN/ASPX/MISC/EmailHistory.aspx?title=Shipping Noticey&ao=A&ie=E"
	document.form1.method="post"
	document.form1.target="popUpWindow"
	form1.submit()
