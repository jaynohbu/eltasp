        ...
        */
        ...
        function saveForm()
        {
            try{
                ...
                var url = "/ASP/ajaxFunctions/ajax_dock_receipt.asp?mode=update&uid=" + noValue;
    ...
    <script type="text/javascript">
        ...
        function searchNumFill(obj,changeFunction,vHeight,event){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                url = "/ASP/ajaxFunctions/ajax_dock_receipt.asp?mode=list&qStr=" + qStr;
        ...
        function searchNumFillAll(objName,changeFunction,vHeight){
            ...
            url = "/ASP/ajaxFunctions/ajax_dock_receipt.asp?mode=list";
            FillOutJPED(obj,url,changeFunction,vHeight);
        }
        ...
        function lstSearchNumChange(argV,argL){
            ...
            var url = "/ASP/ajaxFunctions/ajax_dock_receipt.asp?mode=view&uid=" + argV;
                                            ...
                                            <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="13%" align="right" valign="middle">
                                                        <a href="/ASP/pre_shipment/dock_receipt.asp" target="_self">
                                                    ...
                                                    <td width="57%" height="28" align="left" valign="middle">
                                                        <label id="txtFileNameLabel">
                                                            <strong><span class="bodyheader">
                                                                <img src="/ASP/Images/required.gif" align="absmiddle"></span>Dock Receipt
                                                                No.&nbsp;
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="32" align="right" valign="bottom">
                    <div id="PrintBottom">
                        <img src="/ASP/Images/icon_printer.gif" width="44" height="27" align="absbottom"><b
