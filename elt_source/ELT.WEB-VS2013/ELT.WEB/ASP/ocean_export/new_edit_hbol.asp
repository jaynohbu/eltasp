...
<head>
    ...
    <script type="text/jscript">
        var vVN,vLoadingPort,vScale,vGWLB,vMCFT,vManifestDesc,vDemDetail;
        ...
        function lstFFAgentChange(orgNum, orgName) {
            ...
            var infoObj = document.getElementsByName("hFFAgentInfo");
            ...
            divObj.style.visibility = "hidden";
            divObj.style.height = "0px";
            document.getElementsByName("txtExportInstr").value = infoObj.value;
        }
        ...
        function searchNumFill(obj, eType, changeFunction, vHeight) {
            ...
            if (qStr != "" && keyCode != 229 && keyCode != 27) {
                url = "/ASP/ajaxFunctions/ajax_get_bills.asp?mode=list&export=O&qStr="
                    + qStr + "&type=master";
        ...
        function searchNumFillAll(objName, eType, changeFunction, vHeight) {
            ...
            url = "/ASP/ajaxFunctions/ajax_get_bills.asp?mode=list&type=master&export=O";
            FillOutJPED(obj, url, changeFunction, vHeight);
        }
...
<script type="text/javascript">
    ...
    function SetCreditNote() {
        var vWinArg = "dialogWidth:600px; dialogHeight:400px; help:no; status:no; scroll:yes; center:yes";
        vWinArg="";
        if(document.getElementById("txtHBOL").value=="")
        {
            alert("House Bill of Ladding No. is required!");
            return;
        }
        var vReturn = showModalDialog("/ASP/acct_tasks/credit_note_list.asp?TYPE=O&MAWB=" + encodeURIComponent(document.getElementById("hSearchNum").value) + "&HAWB=" + encodeURIComponent(document.getElementById("txtHBOL").value), "popWindow", vWinArg);
        ...
        if (vReturn >= 0) {
            ...
            if (vReturn == 0) {
                ...
                +
                    "new=yes&MoveType=OCEAN&MasterOnly=N&InvType=Agent&AgentID="
                    + document.getElementById("hFFAgentAcct").value
                    + "&BookingNum="
                    + document.getElementById("hSearchNum").value
                    + "&HBOL="
                    + document.getElementById("txtHBOL").value
                ;
...
'/////////////////////////			
			...
			rs.Close
%>
<script language='JavaScript'>    alert('Could not find the B/L Number '); location.href = 'hbol.asp'; </script>
<%
		end if
            ...
            <td width="51%" align="right" valign="middle">
                ...
                <input type="text" name="txtqHBOL" class="Lookup" value="<%=CheckBlank(vqHBOL,"Search Here")%>"
                    ...
                    size="24" tabindex="-1" /><img src="../images/icon_search.gif" name="B1" width="33"
                        height="27" align="absmiddle" style="cursor: hand" onclick="Lookup()" />
            </td>
        </tr>
    </table>
                ...
                <td width="55%" align="right" valign="bottom">
                    ...
                    <div id="print">
                        ...
                        <a href="javascript:;" onclick="SetCreditNote(); return false;" tabindex="-1">Credit
                            Note</a>
                        <img src="/ASP/Images/button_devider.gif" alt="" />
                        <a href="javascript:EditClick('<%=vHBOL %>','<%=vBookingNum %>');" tabindex="-1">
                            ...
                            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="48%" align="center" valign="middle">
                                        <img src="../images/button_save_medium.gif" width="46" height="18" onclick="javascript:SaveClick_Before('<%=vCheckSH%>','<%= TranNo %>')"
                                            style="cursor: hand">
                                    </td>
                                    <td width="13%" align="right" valign="middle">
                                        <a href="/ASP/ocean_export/new_edit_hbol.asp" tabindex="-1">
                                    ...
                                    <td width="13%" align="right" valign="middle">
                                        <img src="../images/button_delete_medium.gif" width="51" height="17" name="bDelete"
                                            onclick="DeleteHBOL()" style="cursor: hand">
                                    </td>
                                </tr>
                            </table>
                        </td>
                                        ...
                                        <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#6D8C80"
                                            ...
                                            <tr bgcolor="#E0EDE8">
                                                <td width="62%" height="20">
                                                    <span class="style2">House B/L No.</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td height="24" align="left" valign="middle">
                                                    ...
                                                    <input name="txtHBOL" id ="txtHBOL" class="readonlybold" value="<%= vHBOL %>" size="17" readonly="true"
                                                        tabindex="-1">
                                                </td>
                                                <td>
                                                    &nbsp;
                                            ...
                                            <tr bgcolor="#F3F3F3">
                                                <td height="20">
                                                    <strong><span class="bodyheader">
                                                        <img src="/ASP/Images/required.gif" align="absbottom"></span>Agent</strong>
                                                </td>
                                                <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <img src="/ig_common/Images/combobox_addnew.gif" alt="" border="0" style="cursor: hand"
                                                                    onclick="quickAddClient('hFFAgentAcct','lstFFAgent','hFFAgentInfo')" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- End JPED -->
                                            ...
                                            <tr>
                                                ...
                                                <td height="32" valign="middle">
                                                    <a href="javascript:vopid(0);" onclick="MBOLEditClick(); return false;" class="goto">
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy" style="padding-left: 10px">
                                                        <tr>
                                                            <td height="18" bgcolor="#E0EDE8">
                                                                <strong><span class="bodyheader">
                                                                    <img src="/ASP/Images/required.gif" align="absbottom"></span>Exporter</strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                ...
                                                <td colspan="3" valign="top" bgcolor="#FFFFFF">
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                        ...
                                                        <tr style="padding-bottom: 45px">
                                                            <td>
                                                                <textarea wrap="hard" name="txtExportRef" cols="45" rows="3" class="monotextarea"><%= vExportRef %></textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="18" bgcolor="#f3f3f3">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <textarea name="txtForwardAgentInfo" wrap="hard" cols="45" rows="3" class="monotextarea"><%= vForwardAgentInfo %></textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="18" bgcolor="#f3f3f3">
                                                                <strong>Point (State) of Origin or FTZ No.</strong>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding-bottom: 9px">
                                                                <input name="txtOriginCountry" class="shorttextfield" maxlength="32" value="<%= vOriginCountry %>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="18" bgcolor="#f3f3f3">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <textarea name="txtExportInstr" wrap="hard" cols="45" rows="5" class="monotextarea"><%= vExportInstr %></textarea>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="bodycopy">
                                            ...
                                            <tr id="tr_wc_list" align="left" valign="middle" <%if vCheckMH="Y" then response.Write("style='visibility:visible'")%>>
                                                ...
                                                <td>
                                                    ...
                                                    <image alt="" src="../images/measure.gif" onclick="DimCalClick('CBM')"
                                                        align="absbottom" style="cursor: hand" />
                                                </td>
                                                <td>
                                                    <input name="txtMCFT"  class="numberfield readonly" readonly="readonly" maxlength="10" value="<%= vMCFT %>" size="15"  /> <input name="hMCFT" type="hidden"
                                                     value="<%= vMCFT %>"  />
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                        ...
                                                        <tr>
                                                            <td height="20" bgcolor="#FFFFFF">
                                                                <input class="d_shorttextfield" readonly value="<%=vectAVHAWBs(i)%>" size="22" />
                                                            </td>
                                                            <td bgcolor="#FFFFFF">
                                                                <input class="d_shorttextfield" readonly value="<%= vectAVShippers(i) %>" size="24" />
                                                            </td>
                                                            <td bgcolor="#FFFFFF">
                                                                <input class="d_shorttextfield" readonly value="<%= vectAVConsignees(i)%>" size="24" />
                                                            </td>
                                                            <td height="20">
                                                                <input class="d_shorttextfield" readonly value="<%= vectAVAgents(i)  %>" size="24" />
                                                            </td>
                                                            <td bgcolor="#FFFFFF">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td bgcolor="#FFFFFF">
                                                                <input type="text" class="d_numberfield" style="width: 50px" readonly value="" size="7" />
                                                            </td>
                                                            <td bgcolor="#FFFFFF">
                                                                <input type="text" class="d_numberfield" style="width: 58px" readonly value="" size="7" />
                                                            </td>
                                                            <td bgcolor="#FFFFFF">
                                                                <input type="text" class="d_numberfield" style="width: 58px" readonly value="" size="7" />
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="d_shorttextfield" readonly value="<%= aShippers(i) %>" size="24" />
                                                            </td>
                                                            <td>
                                                                <input class="d_shorttextfield" readonly value="<%= aConsignees(i) %>" size="24" />
                                                            </td>
                                                            <td>
                                                                <input class="d_shorttextfield" readonly value="<%= aAgents(i) %>" size="24" />
                                                            </td>
                                                            <td>
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellpadding="1" cellspacing="2" class="bodycopy">
                                            ...
                                            <tr align="left" valign="top">
                                                <td rowspan="2">
                                                    <textarea name="txtDesc1" cols="14" rows="17" wrap="hard" class="monotextarea"><%= vDesc1 %></textarea>
                                                </td>
                                                <td rowspan="2">
                                                    <textarea name="txtDesc2" cols="8" rows="17" wrap="hard" class="monotextarea"><%= vDesc2 %></textarea>
                                                </td>
                                                <td rowspan="2">
                                                    <textarea name="txtDesc3" cols="60" rows="17" wrap="hard" class="monotextarea"><%= vDesc3 %></textarea>
                                                </td>
                                                <td colspan="2">
                                                    <textarea name="txtDesc4" cols="33" rows="11" wrap="hard" class="monotextarea" readonly="readonly"
                                                        tabindex="-1"><%= vDesc4 %></textarea>
                                                </td>
                                            </tr>
                                            <tr align="left" valign="top">
                                                <td colspan="2">
                                                    <textarea name="txtDesc5" cols="25" rows="5" wrap="hard" class="monotextarea"><%= vDesc5 %></textarea>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="5" style="text-align: right">
                                                    <table cellpadding="2" cellspacing="2" border="0" class="bodycopy" style="width: 50%">
                                                        ...
                                                        <tr align="left" valign="top">
                                                            <td rowspan="2">
                                                                <textarea name="txtManifestDesc" cols="22" rows="4" wrap="hard" class="monotextarea"><%= vManifestDesc %></textarea>
                                                            </td>
                                                            <td>
                                                                LC No.
                                                                    ...
                                                                    <tr align="left" valign="top">
                                                                        ...
                                                                        <td>
                                                                            <input type="text" class="m_shorttextfield" name="txtSEDStatement" value="<%=vSEDStmt %>"
                                                                                maxlength="128" style="width: 200px" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                    ...
                                    <td>
                                        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="bodycopy">
                                            ...
                                            <tr id="oc_tr_<%=i%>" align="left" valign="middle" bgcolor="#FFFFFF">
                                                <td height="20">
                                                    <input type="hidden" class="ItemName" id="ItemName" name="hItemName<%= i %>" value="<%= aChargeItemName(i) %>">
                                                ...
                                                <td>
                                                    <input name="txtChargeAmt<%= i %>" style="behavior: url(../include/igNumDotChkLeft.htc)"
                                                        maxlength="15" class="numberalign ChargeAmt<%= i %>" id="ChargeAmt" value="<%=ConvertAnyValue(aChargeAmt(i),"Amount",0)%>"
                                                        size="26" />
                                                </td>
                                                <td>
                                                    &nbsp;
                                            ...
                                            <tr align="left" valign="middle" bgcolor="#F3f3f3">
                                                ...
                                                <td id="td_AddItem" <%if vCheckMH="Y" then response.Write("style='visibility:visible'") %>>
                                                    <input type="image" src="../images/button_additem.gif" width="64" height="18" name="bAdd"
                                                        onclick="AddItem(); return false;" style="cursor: hand" />
                                                </td>
                                            </tr>
                                            <tr align="left" valign="middle">
                                                <td height="1" colspan="5" bgcolor="ffffff">
                                            ...
                                            <tr align="left" valign="middle" bgcolor="#FFFFFF">
                                                <td height="20" colspan="5">
                                                    <%=GetSQLResult("SELECT stmt from form_stmt where form_name='bol' AND country='" & company_country_code & "' and stmt_name='stmt4'", null) %>
                                                </td>
                                            </tr>
                                            <tr align="left" valign="middle" bgcolor="#FFFFFF">
                                                        ...
                                                        <tr align="left" valign="middle">
                                                            <td>
                                                                <input name="txtOtherChargeDesc<%= i %>" class="readonly" value="<%= aChargeItemName(i) %>"
                                                                    size="45" readonly tabindex="-1" />
                                                            </td>
                                                            <td>
                                                                <input name="txtPOtherCharge<%= i %>" class="readonlyright POtherCharge" id="POtherCharge" value="<% if aChargeCP(i)="P" then if (IsNumeric(aChargeAmt(i)) )then response.write(FormatNumberPlus(aChargeAmt(i),2)) else response.Write(aChargeAmt(i))end if  %>"
                                                                    style="width: 70px" readonly tabindex="-1" />
                                                            </td>
                                                            <td>
                                                                <input name="txtCOtherCharge<%= i %>" class="readonlyright COtherCharge" id="COtherCharge" value="<% if aChargeCP(i)="C" then if (IsNumeric(aChargeAmt(i))  )then response.write(FormatNumberPlus(aChargeAmt(i),2)) else response.Write(aChargeAmt(i))end if  %>"
                                                                    style="width: 70px" readonly tabindex="-1" />
                                                            </td>
                                                        </tr>
                                                        <% next %>
                        ...
                        <td height="24" colspan="2" align="center" valign="middle" bgcolor="#BFD0C9">
                            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="13%" align="right" valign="middle">
                                        <a href="/ASP/ocean_export/new_edit_hbol.asp">
                                            <img src="/ASP/Images/button_new.gif" width="42" height="17" border="0" style="cursor: hand"></a>
                                    </td>
                                    <td width="13%" align="right" valign="middle">
                                        <input type="image" src="../images/button_delete_medium.gif" width="51" height="17"
                                            name="bDelete" onclick="DeleteHBOL(); return false;" style="cursor: pointer">
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <div id="print">
                    ...
                    <a href="javascript:EditClick('<%=vHBOL %>','<%=vBookingNum %>');" tabindex="-1">
                        <img src="/ASP/Images/icon_createhouse.gif" alt="Click here to create SED" width="25"
                            height="26" style="margin-right: 10px" />Create AES</a>
                    <img src="/ASP/Images/button_devider.gif" alt="" />
                    <a href="javascript:void(0);" id="NewPrintVeiw2"return false;">
                        <img src="/ASP/Images/icon_printer_preview.gif" align="absbottom" alt="" />House
                        B/L</a></div>
                <% End If %>
            </td>
...
{ 
	...
	try
	{
	    ...
	    var url = "/ASP/ajaxFunctions/ajax_updateAdjustedWeight.asp?MAWB="+ MAWB+ "&HAWB=" 
...
{ 
	...
	try
	{
		xmlHTTP.open("get",encodeURI("/ASP/ajaxFunctions/ajax_checkIfMasterHasSameMAWB.asp?MAWB="+ MAWB + "&HAWB=" + HAWB+"&AO=O"),false); 
        xmlHTTP.send(); 
...
function CHECK_IV_STATUS( tvHAWB ){ //converted from vbscript
    ...
    if  (IVstrMSG != "" ){
	    ok=confirm("Invoice No. " + IVstrMSG + " for HBOL#:" + tvHAWB + " was processed already." + '\n' 
...
function CheckNullToZero(FormValue){ //converted from vbscript
    if (IsNull(FormValue) || FormValue.trim()=="" )
        return 0;
...
function FormatNumberPlus(argStrVal,decim) {//converted from vbscript
    var returnVal;
    returnVal = 0;
	if ( !IsNull(argStrVal) && argStrVal != "" ){
		argStrVal = argStrVal;
		if (IsNumeric(argStrVal) &&  !IsEmpty(argStrVal) )
		    returnVal = parseFloat(argStrVal).toFixed(decim);
    }
	return returnVal;
}
function SaveClick_Before(vCheckSH,TranNo)
{
    if(vCheckSH=='Y')
        {
        CheckIfMasterHasSameMAWB();
        }
        else
        {
        SaveClick(TranNo,'no');
...
function SaveClick(TranNo,SaveAsNew)
{ //converted from vbscript
    

    var is_copied = "no";
    if (SaveAsNew == "yes" && document.getElementsByName("hM_HAWB").value != "" )
        is_copied = "yes";
    ...
    if( document.form1.hFFAgentAcct.value =="" || document.form1.hFFAgentAcct.value == "0" ){
    ...
    for (var i=0 ;i< OC; i++){
	    ...
	    pos=oItem.indexOf("-");
	    if (pos>0 )
		    oItem=FormatNumberPlus(CheckBlank(oItem.substring(0,pos),0),0);
	    else
		    oItem=FormatNumberPlus(CheckBlank(oItem,0),0);

	    oAmt = $("input.ChargeAmt" + i).get(0).value;
	    if (oAmt=="" )
	        oAmt = 0;
	    var oCost = 0;
	    if (oCost=="" ) 
	...
	if (SaveAsNew=="yes" ){
		...
		var vSalesPerson = "<%=vSalesPerson %>";
		tmpUrl = "new_edit_hbol_OK.asp?SaveAsNew=yes&prefix=" + HBOLPrefix 
		    + "&NEXTPREFIX=" + NEXTPrefix + "&salesPerson="
            + vSalesPerson + "&IsCopied="+ is_copied;
		var NewNum = new Object();
		var sharedObject = new Object();
    //if (window.showModalDialog) {
       // NewNum = showModalDialog(encodeURI("hbol_Dialog.asp?" + tmpUrl), sharedObject, "dialogWidth:400px; dialogHeight:170px; help:no; status:no; scroll:no;center:yes");
       // console.log(NewNum);
//SaveNewHBOL(NewNum);
   // }else
{
        ModalHandle.CallBack=SaveNewHBOL;    
        showModalDialogJN(encodeURI("hbol_Dialog.asp?" + tmpUrl), sharedObject, "dialogWidth:400px; dialogHeight:170px; help:no; status:no; scroll:no;center:yes",ModalHandle);
...
function SaveNewHBOL(NewNum){
   // if (NewNum.copyOption == "RemoveMasterhouse"){
    //    document.getElementsByName("hCheckSH").value = "N";
   //     document.getElementsByName("hM_HAWB").value = "";
     //   lstSearchNumChange("","");
   // }
console.log(NewNum);
//alert('a');
...
function AddItem(){
    var NoItem=FormatNumberPlus(CheckBlank(document.form1.hNoItem.value,0),0);
    if (NoItem >= 10)
        alert("Can't have more than 10 Charge Items!");
    else {
            document.form1.hNoItem.value = parseInt(NoItem) + 1;
...
function DeleteItem(ItemNo){
	if (document.form1.hNoItem.value>0 
        && FormatNumberPlus(CheckBlank(document.form1.hNoItem.value,0),0)!=ItemNo ){
...
function ConYes(){
    if (document.form1.cConYes.checked) 
...
function ConNo(){
    if (document.form1.cConNo.checked) 
...
function CalClick(arg) {    //converted from vbscript
    var WeightCP = document.form1.lstWeightCP.value.trim();
    var GWKG = CheckNullToZero(document.form1.txtGrossWeight.value.trim());
    var GWLB = CheckNullToZero(document.form1.txtGWLB.value.trim());
    var Pieces = CheckNullToZero(document.form1.txtPieces.value.trim());
    var Rate = CheckNullToZero(document.form1.txtChargeRate.value.trim());
    var MCBM = CheckNullToZero(document.form1.txtMeasurement.value.trim());
   // var MCFT = CheckNullToZero(document.form1.txtMCFT.value.trim());
    var MCFT = CheckNullToZero(document.form1.txtMCFT.value.trim());
 
    var TotalDem=0;

    if (!IsNumeric(Pieces) )
	    alert( "Please enter a numeric value for No. of Pieces!");
//    else if (!IsNumeric(GrossWeight))
//	    alert( "Please enter a numeric value for Gross Weight!");
    else if ( Rate!="" && IsNumeric(Rate)==false )
	    alert( "Please enter a numeric value for Rate!");
//    else if ( Measuremnet!="" && IsNumeric(Measurement)==false )
//	    alert( "Please enter a numeric value for MEASUREMENT!");
//    else if (TotalPieces>0 &&  TotalPieces!=Pieces )
//	    alert( "Pieces mismatch!");
    else{
	    if  (MCBM!="" ){
		    if (MCBM>0)
			    TotalDem=MCBM;
...
//		    return;
//	    }
	    var GrossWeight=GWKG/1000;
	    if (cw < GrossWeight ) 
            cw=GrossWeight;

	    tc = Math.round(Rate) * cw;
	    tc=tc.toFixed(2);
    ...
    string1 = parseFloat(GWKG).toFixed(2)+ " KG";
    string2 = parseFloat(MCBM).toFixed(2)+ " CBM";
    string3 = parseFloat(GWLB).toFixed(2)+ " LB";
    string4 = parseFloat(MCFT).toFixed(2)+ " CFT";
...
function ItemChange(k,sIndex){
   ...
   // var sIndex = $("select[name='lstChargeItem"+k+"']>option").selectedIndex;
    ...
    if (pos>=0 )
	    ItemDesc=ItemDesc.substring(pos+3,200);

    $("input.ItemName").get(k).value = ItemDesc.trim();
    ItemName = $("select.ChargeItem>option").get(sIndex).value;
    pos=ItemName.indexOf("-");
    var ItemUnitPrice = GET_ITEM_UNIT_PRICE(ItemName);

	if (sIndex > 0) {
	    // Unit_Price by ig 10/21/2006
	    SET_UNIT_PRICE($("input.ChargeAmt"+k).get(0), ItemUnitPrice)
        
	    ///////////////////////////////	
    }
    else{
        $("input.ItemName").get(k).value = "";
    }
...
function BookingChange() {  //converted from vbscript

    var vBookingNumber = document.getElementById("hSearchNum").value;
    if (vBookingNumber == "") 
        return;
	...
	var FileNo="";
	if (pos >= 0) {
	    FileNo=bInfo.substring(0,pos);
	    bInfo = bInfo.substring(pos + 1, 200);
    }
	pos = bInfo.indexOf('\n');
	var DestCountry="";
	if (pos >= 0) {
	    DestCountry=bInfo.substring(0,pos);
	    bInfo = bInfo.substring(pos + 1, 200);
    }
    ...
    document.form1.hVesselName.value=vVN;
...
function WeightCPChange(){
    try{
	    lstSearchNumChange(document.form1.hSearchNum.value, document.form1.lstSearchNum.value);
    }catch (e) {
...
function CheckData3(){
    ...
    if (MCBM!="" ){
	    ...
	    document.form1.hMCFT.value=Math.round(MCFT * 100) / 100;
    }
}
...
function DeleteHBOL(){
    var HBOL=document.form1.txtHBOL.value;

    if (confirm ("Are you sure you want to delete HBOL " + HBOL + "? \r\nContinue?")) 	
    {
	    ////////////////////////////////////////	
	    if (! CHECK_IV_STATUS( HBOL ) )
		    return;
	    ////////////////////////////////////////
...
function Lookup(){
/////////////////////////////
    var HBOL = document.form1.txtqHBOL.value.toUpperCase();
    var HBOLCopy = HBOL;
    document.form1.txtqHBOL.value = "";
    HBOL = HBOL.replace(" ","");
    if (HBOL != "" && HBOLCopy != "Search Here") {
        ...
        alert("Please enter a House B/L No!");
}
...
<script type="text/javascript">
function COLOClick(){
	if (document.form1.cCOLO.checked=false)
...
function PrefixChange() {
    var sindex = document.form1.lstHBOLPrefix.selectedIndex;
    var Prefix = document.form1.lstHBOLPrefix.item(sindex).text;
    document.form1.hHBOLPrefix.value = Prefix;
}


function MBOLEditClick() //converted from vbscript
{
    if (document.form1.hSearchNum.value != "" && document.form1.hSearchNum.value!="0" ){
	    BookingNum = document.form1.hSearchNum.value;
	    window.top.location.href = encodeURI("/OceanExport/MBOL/BookingNum=" 
            + BookingNum + "&NotifyAcct=" + "<%= vNotifyAcct %>");
    }
...
<script type="text/javascript">
    function AddToMaster(addSUB, addELTAcct) {  //converted from vbscript
        document.form1.action = encodeURI("new_edit_hbol.asp?addSUB=yes&Edit=yes&addSUBNo="
        + addSUB + "&addELTAcct=" + addELTAcct + "&hbol="
        + "<%=vHBOL%>" + "&MBOL=" 
        + "<%=vMBOL%>" + "&tNo=" + "<%=TranNo%>"+ "&WindowName="+ window.name)
        document.form1.method = "POST";
        document.form1.target = "_self";
        document.form1.submit();
    }
function EditHBOL(HBOL){
    window.open(encodeURI("new_edit_hbol.asp?HBOL=" + HBOL + "&tNo=" + "<%=TranNo%>"));
}
...
function NewPrintVeiw(){
    var props,HAWB;
    var HAWB=document.getElementsByName("txtHBOL").value ;
    if (HAWB != "") {
...
function MakeMasterHouse(){   //converted from vbscript
    ...
    {    
        $("#NewPrintVeiw1").click(
           function () { 
               ...
               {
                   opener.top.location.href="/OceanExport/HBOL/"+window.location.href.split("?")[1];
                   window.close();
               }
               else
               { 
