...
<%
    Dim vHBOL, costItemList, i, vMode
    ...
    Sub UpdateTotalOtherCost
        ...
        SQL = "UPDATE hbol_master SET total_other_cost=" _
            & "(SELECT SUM(cost_amt) FROM hbol_other_cost WHERE elt_account_number=" _
            & elt_account_number & " AND hbol_num=N'" & vHBOL & "') WHERE elt_account_number=" _
            & elt_account_number & " AND hbol_num=N'" & vHBOL & "'"
    ...
    Sub GetAllCostItems
        ...
        SQL = "SELECT * FROM hbol_other_cost a LEFT OUTER JOIN organization b ON " _
            ...
            & " AND a.hbol_num=N'" & vHBOL & "' ORDER BY a.auto_uid"
    ...
    Sub AddCostItem
        ...
        SQL = "INSERT INTO hbol_other_cost(elt_account_number,hbol_num,vendor_no,cost_amt,item_no,cost_desc) " _
            & " VALUES(" &  elt_account_number & ",N'" & Request.Form("hHBOLNum") _
    ...
    Sub DeleteCostItem
        ...
        SQL = "DELETE FROM hbol_other_cost WHERE elt_account_number=" & elt_account_number _
    ...
    <script type="text/javascript">
        ...
        function addNewItem(){
            if(document.getElementById("hAgentAcct").value == "" 
                ...
                document.getElementById("form1").action = "new_edit_hbol_cost_items.asp?mode=add";
        ...
        function removeItem(arg){
            document.getElementById("form1").action = "new_edit_hbol_cost_items.asp?mode=delete&did=" + arg;
            document.getElementById("form1").method = "post";
            document.getElementById("form1").submit();
        }
    </script>
...
<body style="margin: 0px 0px 0px 0px">
    <form id="form1" runat="server">
        <input type="hidden" id="hHBOLNum" name="hHBOLNum" value="<%=vHBOL %>" />
        <br />
