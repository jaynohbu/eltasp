...
<head>
    ...
    <%
        ...
        Sub InitializeMail(arg)
            ...
            oMail.FromName = "Ocean Export Shipping Notice"
            oMail.IsHTML = True
            ...
            vEmailBody = "<html xmlns='http://www.w3.org/1999/xhtml'><head><meta http-equiv='Content-Type' content='text/html; charset=ISO-88591' />" _
                & "<title>OCEAN EXPORT SHIPPING NOTICE</title><style type='text/css'><!--.text {font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 0.85em;}--></style></head>" _
                & "<body><p class='text'><font color='#f39003'><strong>OCEAN EXPORT SHIPPING NOTICE</strong></font></p><p class='text'>" & Server.HTMLEncode(Request.Form("txtMessage")(arg)) _
