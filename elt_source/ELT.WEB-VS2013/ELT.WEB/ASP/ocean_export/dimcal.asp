...
<head>
    ...
    function getDimensionTotal(){
        ...
        try{
            ...
            for(var i=0;i<dimArray.length-1;i++){
                ...
                for (var d = 0 ;d<dimInfo.length; d++)
                {
                    if (dimInfo[d] == "" || dimInfo[d] == undefined)
                        dimInfo[d] = "0";
                } 
    ...
    function ClearBox() {        
        document.getElementById("txtDimDetail").value = "";
        document.getElementById("txtCBM").value = "";
        document.getElementById("txtCFT").value = "";      
    }
    </script>
...
<body bgcolor="#efeace" onload="initDimDetail();">
    <table class="bodycopy" cellpadding="1" cellspacing="1" border="0">
        ...
        <tr>
            <td colspan="6">
                <table><tr><td>  <textarea wrap="hard" name="txtDimDetail" id="txtDimDetail" readonly class="multilinetextfield" style="width: 250px;
                    height: 150px"></textarea></td><td style="vertical-align:top">   <input type="button" value="Clear"  onclick="ClearBox()"/></td></tr></table>
