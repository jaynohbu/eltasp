...
function <%=iMoonComboBoxName%>_Change()
{
    ...
    try {
        var url="/ASP/ajaxFunctions/ajax_get_org_address_info.asp?type=B&org="+ acctNumber;
        if("<%=iMoonType %>" == "Carrier")
        {
            url="/ASP/ajaxFunctions/ajax_get_org_address_info.asp?type=C&org="+ acctNumber;
        }
