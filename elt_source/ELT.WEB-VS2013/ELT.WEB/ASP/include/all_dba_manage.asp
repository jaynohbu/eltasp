...
<body leftmargin="0" link="336699" marginheight="0" marginwidth="0" topmargin="0"
    ...
    <table align="center" border="0" bordercolor="#73beb6" cellpadding="3" cellspacing="0"
        class="border1px" width="450">
        <tr bgcolor="D5E8CB">
            <td align="left" bgcolor="#f3f3f3" class="bodyheader" valign="top" colspan="2">
            </td>
        </tr>
        <tr bgcolor="D5E8CB">
            <td align="left" bgcolor="#f3f3f3" class="bodyheader" valign="middle" colspan="2">
                        ...
                        <td class="font" align="left">
                            <table border="0" bordercolor="#ffffff" cellpadding="0" cellspacing="0" class="border1px"
                                ...
                                <tr>
                                    ...
                                    <td align="left" colspan="3" valign="middle" class="bodyheader">
                                        <input id="txt_dba_name" class="shorttextfield" name="txt_dba_name" style="width: 250px;"
                                            value="<%= v_dba_name%>">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" width="120" class="bodycopy" valign="middle">
                                        &nbsp;
                                    </td>
                                    <td width="200" align="left" valign="middle" class="bodyheader">
                                        Main Category
                                    </td>
                                    <td width="63" align="left" valign="middle" class="bodyheader">
                                        &nbsp;
                                    </td>
                                    <td width="200" align="left" valign="middle" class="bodyheader">
                                        &nbsp;
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="bodycopy" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_class_code'>
                                                    <input id="txt_class_code" class="shorttextfield" name="txt_class_code" style="width: 150px;"
                                                        type="text" value="<%= v_class_code%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_class_code_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('class_code','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=class_code','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td height="22" align="left" valign="middle" class="bodycopy">
                                        <input id="chk_is_consignee" <% if v_is_consignee="Y" then response.write("checked") %>=""
                                            name="chk_is_consignee" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_is_consignee">Consignee</label>
                                    </td>
                                    <td align="left" class="bodycopy" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubConsignee'>
                                                    <input id="txt_SubConsignee" class="shorttextfield" name="txt_SubConsignee" style="width: 150px;"
                                                        type="text" value="<%= v_SubConsignee%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubConsignee_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubConsignee','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubConsignee','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                ...
                                                <td id='td_business_city_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('business_city','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=business_city','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="left" class="bodycopy" valign="middle">
                                        <input id="chk_is_shipper" <% if v_is_shipper="Y" then response.write("checked") %>=""
                                            name="chk_is_shipper" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_is_shipper">Shipper</label>
                                    </td>
                                    <td align="left" class="bodycopy" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubShipper'>
                                                    <input id="txt_SubShipper" class="shorttextfield" name="txt_SubShipper" style="width: 150px;"
                                                        type="text" value="<%= v_SubShipper%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubShipper_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubShipper','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubShipper','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                ...
                                                <td id='td_business_state_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('business_state','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=business_state','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="left" class="bodycopy" valign="middle">
                                        <input id="chk_is_agent" <% if v_is_agent="Y" then response.write("checked") %>=""
                                            name="chk_is_agent" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_is_agent">Agent</label>
                                    </td>
                                    <td align="left" class="bodycopy" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubAgent'>
                                                    <input id="txt_SubAgent" class="shorttextfield" name="txt_SubAgent" style="width: 150px;"
                                                        type="text" value="<%= v_SubAgent%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubAgent_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubAgent','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubAgent','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_business_zip'>
                                                    <input id="txt_business_zip" class="shorttextfield" name="txt_business_zip" style="width: 150px;"
                                                        type="text" value="<%= v_business_zip%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_business_zip_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('business_zip','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=business_zip','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <input id="chk_is_carrier" <% if v_is_carrier="Y" then response.write("checked") %>=""
                                            name="chk_is_carrier" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_is_carrier">Carrier</label>
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubCarrier'>
                                                    <input id="txt_SubCarrier" class="shorttextfield" name="txt_SubCarrier" style="width: 150px;"
                                                        type="text" value="<%= v_SubCarrier%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubCarrier_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubCarrier','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubCarrier','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td align="right" class="bodyheader" style="height: 20px" valign="middle">
                                        Country&nbsp;&nbsp;
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_business_country'>
                                                    <input id="txt_business_country" class="shorttextfield" name="txt_business_country"
                                                        style="width: 150px;" type="text" value="<%= v_b_country_codeName %>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_business_country_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('business_country','/ASP/ajaxFunctions/ajax_get_country_code.asp','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <input id="chk_z_is_trucker" <% if v_z_is_trucker="Y" then response.write("checked") %>=""
                                            name="chk_z_is_trucker" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_z_is_trucker">Trucker</label>
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubTrucker'>
                                                    <input id="txt_SubTrucker" class="shorttextfield" name="txt_SubTrucker" style="width: 150px;"
                                                        type="text" value="<%= v_SubTrucker%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubTrucker_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubTrucker','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubTrucker','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <input id="chk_z_is_warehousing" <% if v_z_is_warehousing="Y" then response.write("checked") %>=""
                                            ...
                                            value="Y" /><label for="chk_z_is_warehousing">Warehouse</label>
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubWarehousing'>
                                                    <input id="txt_SubWarehousing" class="shorttextfield" name="txt_SubWarehousing" style="width: 150px;"
                                                        type="text" value="<%= v_SubWarehousing%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubWarehousing_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubWarehousing','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubWarehousing','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <span class="bodyheader" style="height: 20px">* Other Option </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <input id="chk_z_is_cfs" <% if v_z_is_cfs="Y" then response.write("checked") %>=""
                                            name="chk_z_is_cfs" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_z_is_cfs">Terminal/CFS</label>
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubCFS'>
                                                    <input id="txt_SubCFS" class="shorttextfield" name="txt_SubCFS" style="width: 150px;"
                                                        type="text" value="<%= v_SubCFS%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubCFS_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubCFS','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubCFS','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle" colspan="2">
                                        <select class="smallselect" name="lst_other_options" onchange="javascript:lst_other_options_change(this)"
                                ...
                                <tr>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <input id="chk_z_is_broker" <% if v_z_is_broker="Y" then response.write("checked") %>=""
                                            name="chk_z_is_broker" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_z_is_broker">CHB</label>
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubBroker'>
                                                    <input id="txt_SubBroker" class="shorttextfield" name="txt_SubBroker" style="width: 150px;"
                                                        type="text" value="<%= v_SubBroker%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubBroker_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubBroker','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubBroker','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <input id="chk_z_is_govt" <% if v_z_is_govt="Y" then response.write("checked") %>=""
                                            name="chk_z_is_govt" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_z_is_govt">Gov't</label>
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubGovt'>
                                                    <input id="txt_SubGovt" class="shorttextfield" name="txt_SubGovt" style="width: 150px;"
                                                        type="text" value="<%= v_SubGovt%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubGovt_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubGovt','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubGovt','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <input id="chk_is_vendor" <% if v_is_vendor="Y" then response.write("checked") %>=""
                                            name="chk_is_vendor" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_is_vendor">Vendor</label>
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubVendor'>
                                                    <input id="txt_SubVendor" class="shorttextfield" name="txt_SubVendor" style="width: 150px;"
                                                        type="text" value="<%= v_SubVendor%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubVendor_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubVendor','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubVendor','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <input id="chk_z_is_special" <% if v_z_is_special="Y" then response.write("checked") %>=""
                                            name="chk_z_is_special" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_z_is_special">Other</label>
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px; width: 200px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubSpecial'>
                                                    <input id="txt_SubSpecial" class="shorttextfield" name="txt_SubSpecial" style="width: 150px;"
                                                        type="text" value="<%= v_SubSpecial%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubSpecial_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubSpecial','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubSpecial','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td align="left" class="bodycopy" style="height: 20px; width: 200px" valign="middle"
                                        colspan="2">
                                        <div align="left">
                                            <img src="../images/button_NEWsearch.gif" id="bGo" width="25" height="18" align="absmiddle"
                                                style="cursor: hand" onclick="javascript:doBtn(this);"><input id="txt_status" class="bodycopy"
                                                    name="txt_status" style="width: 100px; text-align: left; border-style: none;
                                                    background-color: #f3f3f3" type="text" readonly="true" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <input id="chk_is_customer" <% if v_is_customer="Y" then response.write("checked") %>=""
                                            name="chk_is_customer" onclick="javascript:cClick(this);" type="checkbox" value="Y" /><label
                                                for="chk_is_customer">Customer</label>
                                    </td>
                                    <td align="left" class="bodycopy" style="height: 20px" valign="middle">
                                        <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                            <tr>
                                                <td id='td_SubCustomer'>
                                                    <input id="txt_SubCustomer" class="shorttextfield" name="txt_SubCustomer" style="width: 150px;"
                                                        type="text" value="<%= v_SubCustomer%>" />
                                                </td>
                                                <td>
                                                </td>
                                                <td id='td_SubCustomer_href'>
                                                    <a href="#" onclick="javascript:actionRequestForAll('SubCustomer','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubCustomer','150px');">
                                                        [List]</a>
                                                </td>
                                            </tr>
                                        </table>
        ...
        <tr bgcolor="D5E8CB">
            <td align="right" bgcolor="#f3f3f3" class="bodycopy" valign="top">
            ...
            <td align="left" bgcolor="#f3f3f3" class="bodyheader" valign="middle">
                (Filtered / Total)
            </td>
        </tr>
        <tr bgcolor="D5E8CB">
            <td align="left" bgcolor="#f3f3f3" class="bodyheader" valign="top" width="29%" id="td_result">
                <select class="smallselect" id="lst_code" name="lst_code" size="4" style="height: 300px;
                    width: 325px; font-size: 11px; font-family: 'Courier New', Courier, monospace;"
                    ...
                    <option <% 
                        ...
                        <%= code_list(i)("code_description") %></option>
                    <% next %>
            ...
            <td align="left" bgcolor="#f3f3f3" class="bodyheader" valign="middle" width="71%">
                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                    <tr>
                        <td>
                            <input class="bodycopy" id="bOK" style="width: 110px; height: 25px" type="button"
                                value="SELECT" onclick="javascript:doBtn(this);">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <input class="bodycopy" id="bCANCEL" style="width: 110px; height: 25px" type="button"
                                value="Cancel" onclick="javascript:doBtn(this);">
                        </td>
                    </tr>
                    <tr align="left" valign="middle" bgcolor="#f3f3f3">
                    ...
                    <tr>
                        <td>
                            <input class="bodycopy" id="bADD" style="width: 110px; height: 25px" type="button"
                                value="Add..." onclick="javascript:doBtn(this);">
                        </td>
                    </tr>
                    <tr align="left" valign="middle" bgcolor="#f3f3f3">
                        <td height="4" align="left">
                    ...
                    <tr>
                        <td>
                            <input class="bodycopy" id="bACTIVATE" style="width: 110px; height: 25px" type="button"
                                value="Activate" onclick="javascript:doBtn(this);">
                        </td>
                    </tr>
                    <tr align="left" valign="middle" bgcolor="#f3f3f3">
                        <td height="4" align="left">
                    ...
                    <tr>
                        <td>
                            <input class="bodycopy" id="bDEACTIVATE" style="width: 110px; height: 25px" type="button"
                                value="Deactivate" onclick="javascript:doBtn(this);">
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr bgcolor="D5E8CB">
            <td align="left" bgcolor="#f3f3f3" class="bodyheader" valign="top" colspan="2">
                <table border="0" bordercolor="#A0829C" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr align="left" bgcolor="#f3f3f3" valign="middle">
                        <td height="22" align="center" id="td_page_break">
                            <% call page_tag %>
                        </td>
                    </tr>
                    <tr align="left" bgcolor="#f3f3f3" valign="middle">
...
<script language="javascript">
    ...
    function goPage(p) {
        ...
        submit_page("/ASP/ajaxFunctions/ajax_get_dba_result.asp?PostBack=true&Action=Page&Page="
        ...
        try {
            ...
            switch (o.id) {
                case 'bGo':
                    ...
                    submit_page("/ASP/ajaxFunctions/ajax_get_dba_result.asp?PostBack=true&Action=Search&WindowName="
							 + window.name, '');
                    break;
                case 'bOK':
                    s = '';
                ...
                case 'bADD':
                    ...
                    if (retVal != '' && typeof (retVal) != 'undefined') {
                        ...
                        if (goStop) {
                            document.getElementById('filter_string').value = '';
                            submit_page("/ASP/ajaxFunctions/ajax_get_dba_result.asp?PostBack=true&Action=save&retVal="
                ...
                case 'bDEACTIVATE':
                    if (confirm('Are you sure you want to deactivate the selected item(s)?')) {
                        submit_page("/ASP/ajaxFunctions/ajax_get_dba_result.asp?PostBack=true&Action=delete&WindowName="
									 + window.name,
									 o.id)
                    }
                    break;
                case 'bACTIVATE':
                    ...
                    submit_page("/ASP/ajaxFunctions/ajax_get_dba_result.asp?PostBack=true&Action=activate&WindowName="
								+ window.name,
								o.id)
                    break;
                default:
