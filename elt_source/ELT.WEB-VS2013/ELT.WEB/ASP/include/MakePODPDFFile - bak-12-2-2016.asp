...
'if Not vHAWB="" then
    if true  then
	   ...
	   if  InvoiceNo="" then  
	        SQL="select a.it_number as itno,a.it_date as itdate,a.it_entry_port as itentryport,a.cargo_location as cl,a.sec as sec,a.*,a.process_dt as process_dt_h,a.mawb_num as mawb_num,b.*,isnull(a.dep_port,'') as dep_port_h,isnull(a.arr_port,'') as arr_port_h,a.eta as eta_h,a.etd as etd_h from import_hawb a,import_mawb b where a.elt_account_number=b.elt_account_number and a.elt_account_number=" & elt_account_number &" and a.mawb_num='"&vMAWB&"'"& " and a.iType=b.iType and a.iType='A' and a.mawb_num=b.mawb_num and a.hawb_num='" & vHAWB & "' and a.sec=b.sec order by a.sec desc"	        
	   else
