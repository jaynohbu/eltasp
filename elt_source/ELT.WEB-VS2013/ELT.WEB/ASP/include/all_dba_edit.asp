...
<body leftmargin="0" link="336699" marginheight="0" marginwidth="0" topmargin="0"
    ...
    <form action="all_dba_edit.asp" method="post" name="form1">
      <table align="center" border="0" bordercolor="#73beb6" cellpadding="3" cellspacing="0" class="border1px" width="95%">
        <tr bgcolor="D5E8CB">
        ...
        <tr bgcolor="D5E8CB">
          <td align="center" bgcolor="#f3f3f3" class="bodyheader" valign="middle" colspan="2"><table border="0" cellpadding="0" cellspacing="0" class="bodycopy" >
              <tr>
                <td><input class="bodycopy" id="bOK" style="width: 100px;height:20px " type="button" value="OK" onClick="javascript:doBtn(this);"></td>
                <td>&nbsp;</td>
                <td><input class="bodycopy" id="bCANCEL" style="width: 100px;height:20px" type="button" value="Cancel" onClick="javascript:doBtn(this);"></td>
              </tr>
          </table></td>
        </tr>
