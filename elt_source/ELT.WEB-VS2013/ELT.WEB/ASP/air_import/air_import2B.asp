...
<head>
    ...
    If vMode = "save" Then
        ...
        Response.Redirect("arrival_notice.asp?iType=A&Edit=yes&MAWB=" & Server.URLEncode(vMAWB) & "&HAWB=" & Server.URLEncode(vHAWB) & "&Sec=" & vSec)
    Else
        Call GET_ALL_DATA
    End If
    ...
    Sub CREATE_INVOICE_HEADER
        ...
        SQL = "SELECT * FROM import_mawb WHERE iType='A' AND mawb_num=N'" & Request.Form("txtMAWB").Item _
        ...
        rs("Carrier") = tmpMAWBTable("flt_no")
    ...
    Sub GET_ALL_DATA
        Dim SQL, feData
        Set feData = new DataManager
        SQL = "SELECT * FROM import_hawb WHERE iType='A' AND agent_elt_acct<>0 AND processed='N' AND mawb_num=N'" _
    ...
    <script type="text/jscript">
        ...
        function btnSaveClick(){
            ...
            if(vConsigneeAcct != "" && vConsigneeAcct != "0"){
                ...
                oForm.action = "air_import2B.asp?mode=save";
                oForm.target = "_self";
                oForm.method = "post";
                oForm.submit();
            }
                                    ...
                                    <table width="75%" border="0" cellpadding="2" cellspacing="0" style="border: solid 1px #ba9590">
                                        ...
                                        <tr style="background-color: #efe1df" class="bodyheader">
                                            ...
                                            <td>
                                                Consignee</td>
                                            <td>
                                                <img src="/ASP/Images/required.gif" align="absbottom" alt=""/>Consignee
                                            </td>
                                            <td style="width: 5px">
                                            </td>
                                        </tr>
