...
<head>
    ...
    If vMode = "save" Then
        ...
        eltConn.Close()
        Set eltConn = Nothing
        Response.Redirect("./air_import2.asp?edit=yes&MAWB=" & vMAWB & "&SEC=" & vSec)
    Else 
        Call GET_PORT_LIST
        Call GET_ALL_DATA
    End If
    ...
    Sub UPDATE_EDT_MAWB
        ...
        SQL = "SELECT * FROM import_mawb WHERE iType='A' AND mawb_num=N'" & vMAWB & "' AND sec=" & vSec _
    ...
    Sub UPDATE_EDT_HAWB
        Dim SQL, rs
        Set rs = Server.CreateObject("ADODB.RecordSet")
        SQL = "SELECT * FROM import_hawb WHERE iType='A' AND mawb_num=N'" & vMAWB & "' AND sec=" & vSec _
            & " AND elt_account_number=" & elt_account_number
    ...
    Sub GET_ALL_DATA
        ...
        SQL = "SELECT * FROM import_mawb WHERE iType='A' AND agent_elt_acct<>0 AND processed='N' " _
    ...
    <script type="text/jscript">
        ...
        function btnSaveClick(){
            ...
            oForm.action = "air_import2A.asp?mode=save&MAWB=<%=Server.URLEncode(vMAWB) %>&SEC=<%=vSec %>";
            oForm.target = "_self";
            oForm.method = "post";
            oForm.submit();
        }
...
<body>
    <form id="form1" action="">
        <div style="text-align: center">
            ...
            <br />
            <table width="95%" border="0" cellpadding="0" cellspacing="0" style="border: solid 1px #ba9590">
                <tr style="background-color: #edd3cf">
                    <td align="center" valign="middle" class="bodyheader" style="height: 24px">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr style="height: 1px; background-color: #ba9590">
                                <td>
                                </td>
                            </tr>
                            <tr>
                                <td style="background-color: #f3f3f3; text-align: center" class="bodyheader">
                                    ...
                                    <table width="75%" border="0" cellpadding="2" cellspacing="0" style="border: solid 1px #ba9590">
                                        <tr style="background-color: #efe1df" class="bodyheader">
                                            <td style="width: 5px">
                                            </td>
                                            <td>
                                                <img src="/ASP/Images/required.gif" align="absbottom" alt="" />Master B/L
                                                No.</td>
                                            <td>
                                                File No.</td>
                                            <td>
                                        ...
                                        <tr style="background-color: #ffffff" class="bodyheader">
                                            ...
                                            <td colspan="2">
                                                Carrier</td>
                                            <td>
                                                <img src="/ASP/Images/required.gif" align="absbottom" alt="" />Agent
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
