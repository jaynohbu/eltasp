                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-right: #ba9590 solid 1px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="78%" height="18" bgcolor="#f3f3f3" class="bodyheader">
                                                                    <img src="/ASP/Images/required.gif" align="absbottom">Pickup From
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="18" bgcolor="#f3f3f3" class="bodyheader">
                                                                    <img src="/ASP/Images/required.gif" align="absbottom">Consignee
                                                                </td>
                                                                <td bgcolor="#f3f3f3">
                                                                    &nbsp;
                                                                </td>
                                                    ...
                                                    <td width="48%" valign="top" bgcolor="#FFFFFF" class="bodycopy">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <input name="txtDeliveryRefNum" id="txtDeliveryRefNum" maxlength="32" type="text" class="shorttextfieldBold"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input name="txtMAWB" id="txtMAWB" type="text" class="shorttextfieldBold" 
                                                                        value="" style="width: 140px" checked="txtMAWB" /></td>
                                                                <td>
                                                                    <input name="txtHAWB"  id="txtHAWB" type="text" class="shorttextfieldBold" 
                                                                        value="" style="width: 140px" checked="txtHAWB" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="#f3f3f3">
                                                                    &nbsp;
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="bodylistheader">
                                                                        <input name="txtEntryBilling" id="txtEntryBilling" maxlength="32" 
                                                                        type="text" class="shorttextfield" value=""
                                                                            style="width: 140px" checked="txtEntryBilling" />
                                                                    </span>
                                                                </td>
                                                                <td>
                                                                    <span class="bodylistheader">
                                                                        <input name="txtSubHAWB" id="txtSubHAWB" maxlength="32" type="text" class="shorttextfield" value=""
                                                                            style="width: 140px" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text" autocomplete="off" id="lstCarrierName" name="lstCarrierName" value=""
                                                                                    ...
                                                                                    onfocus="initializeJPEDField(this,event);" checked="lstCarrierName" /></td>
                                                                            <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <select id="lstCargoLocation" name="lstCargoLocation" class="smallselect">
                                                                        ...
                                                                        <option value="<%=cargo_list(i)("cargo_code") %>"><%= cargo_list(i)("cargo_info")%></option>
                                                                        <% Next %>
                                                                    </select>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <span class="bodylistheader">
                                                                        <input name="txtCustomerRef" id="txtCustomerRef" maxlength="32" type="text" class="shorttextfield" value=""
                                                                            style="width: 140px" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        ...
                                                        <input name="txtGrossWt" type="text" class="shorttextfield" style="behavior: url(../include/igNumDotChkLeft.htc)"
                                                            onkeydown="resetWeight();" value="" size="13" id="txtGrossWt" /></td>
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                ...
                                                <tr bgcolor="#FFFFFF">
                                                    ...
                                                    <td colspan="2" align="left" valign="top">
                                                        <input type="radio" name="chInlandChargeType" value="P" 
                                                            onclick="chInlandChargeType_click('P');" checked="chInlandChargeType" />
                                                        PREPAID &nbsp;
    ...
    <script type="text/javascript" language="javascript">
        ...
        function formatDouble(fieldID) {
            ...
            try {
                if ($("[name="+fieldID+"]").value != "") {
                    tmpVal = parseFloat($("[name=" + fieldID + "]").value);
                    $("[name=" + fieldID + "]").value = tmpVal.toFixed(2);
                }
            } catch (error) {
                alert(error.message);
            }
            ...
            if (xmlObj.getElementsByTagName(xmlTag)[0] != null
                ...
                for (var i = 0; i < htmlObj.children(0).length; i++) {
                    if (htmlObj.children(0).get(i).value.substring(0, compareLen) == xmlObj.getElementsByTagName(xmlTag)[0].childNodes[0].nodeValue.substring(0, compareLen)) {
                        ...
                        htmlObj.children(0).get(i).selected = true;
        ...
        function saveForm() {
            try {
                ...
                var url = "/ASP/ajaxFunctions/ajax_delivery_order.asp?mode=update&type=" + typeValue + "&import=A&" + noValue;
