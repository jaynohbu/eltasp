    ...
    <%
        ...
        Sub MakeEmailPDFSub(arg)
			...
			For i=1 To Request.Form("chkAN").Count
			    Call InsertArrivalNoticeIntoPDF("no",vMAWB,"","A",Request.Form("chkAN")(i),"","")
			    aHAWB.Add Request.Form("chkAN")(i)
			Next
			
			For i=1 To Request.Form("chkANFC").Count
			    Call InsertArrivalNoticeIntoPDF("yes",vMAWB,"","A",Request.Form("chkANFC")(i),"","")
        ...
        Sub InitializeMail(arg)
            ...
            oMail.FromName = "Air Import EArrival Notice"
            oMail.IsHTML = True
            ...
            vEmailBody = "<html xmlns='http://www.w3.org/1999/xhtml'><head><meta http-equiv='Content-Type' content='text/html; charset=ISO-88591' />" _
                & "<title>AIR IMPORT EArrival NOTICE</title><style type='text/css'><!--.text {font-family: Verdana, Arial, Helvetica, sans-serif;	font-size: 0.85em;}--></style></head>" _
                & "<body><p class='text'><font color='#f39003'><strong>AIR IMPORT EARRIVAL NOTICE</strong></font></p><p class='text'>" & Server.HTMLEncode(Request.Form("txtMessage")(arg)) _
