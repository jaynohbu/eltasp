...
Dim aLocation(2000),aFirmCode(2000),aPhone(2000),aFax(2000),aAddress(2000),aCity(2000),aState(2000),aCountry(2000)
...
SQL= "select top 201 * from freight_location where elt_account_number = " & elt_account_number & " order by location"
                    ...
                    <table width="100%" border="0" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td bgcolor="f3f3f3">
                                <input name="txtFirmCode" type="text" class="shorttextfield" maxlength="8" value="<%= aFirmCode(i) %>"
                                    size="7"></td>
                            <td bgcolor="f3f3f3">
                                <input name="txtPhoneCode" type="text" class="m_shorttextfield phone" 
                                    value="<%= aPhone(i) %>" size="14"></td>
                            <td bgcolor="f3f3f3">
                                <input name="txtFax" type="text" class="m_shorttextfield phone" 
                        ...
                        <tr align="left" valign="middle" class="bodycopy">
                            <td bgcolor="#FFFFFF">
                                ...
                                <td bgcolor="#FFFFFF">
                                    <input name="txtFirmCode<%= i %>" type="text" class="d_shorttextfield FirmCode" maxlength="8"
...
function AddPort(TranNo){
    var AddOK=false;
    var FirmCode=document.form1.txtFirmCode.value;
    ...
    if (AddOK ){
	    for (var j=0 ; j<tIndex;j++){
		    if ($("input.FirmCode").get(j).value==FirmCode ){
			    AddOK=false;
			    alert( "The Firm Code is existed!");
		    }
	    }
    }
    if (AddOK) {
