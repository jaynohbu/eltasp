...
<body leftmargin="0" link="336699" marginheight="0" marginwidth="0" topmargin="0"
    ...
    <form method="post" name="form1">
        <input type="hidden" id="txt_carrier_type"  name="txt_carrier_type" value="<%= v_carrier_type%>">
        <input type="hidden" id="txt_orginal_dba_name" name="txt_orginal_dba_name">
        <input type="hidden" id="txt_date_opened" name="txt_date_opened">
        <input type="hidden" id="txt_last_update" name="txt_last_update">
        <input type="hidden" id="txt_attn_name" name="txt_attn_name">
        <input type="hidden" id="txt_notify_name" name="txt_notify_name">
        <input type="hidden" id="txt_z_bond_number" name="txt_z_bond_number">
        <input type="hidden" id="txt_z_bond_exp_date" name="txt_z_bond_exp_date">
        <input type="hidden" id="txt_z_bond_amount" name="txt_z_bond_amount">
        <input type="hidden" id="txt_iata_code" name="txt_iata_code">
        <input type="hidden" id="txt_z_bond_surety" name="txt_z_bond_surety">
        <input type="hidden" id="txt_z_carrier_prefix" name="txt_z_carrier_prefix">
        <input type="hidden" id="txt_business_st_taxid" name="txt_business_st_taxid">
        <input type="hidden" id="txt_owner_ssn" name="txt_owner_ssn">
        <input type="hidden" id="txt_z_carrier_code" name="txt_z_carrier_code">
        <input type="hidden" id="txt_acct_name" name="txt_acct_name">
        <!-- phone mask -->
        <input type="hidden" id="txt_business_phone_mask" name="txt_business_phone_mask" value="<%= v_business_phone_mask%>">
        <input type="hidden" id="txt_business_phone2_mask" name="txt_business_phone2_mask" value="<%= v_business_phone2_mask%>">
        <input type="hidden" id="txt_owner_phone_mask" name="txt_owner_phone_mask" value="<%= v_owner_phone_mask%>">
        <input type="hidden" id="txt_business_fax_mask" name="txt_business_fax_mask" value="<%= v_business_fax_mask%>">
        <input type="hidden" id="txt_c2Phone_mask" name="txt_c2Phone_mask" value="<%= v_c2Phone_mask%>">
        <input type="hidden" id="txt_c2Cell_mask" name="txt_c2Cell_mask" value="<%= v_c2Cell_mask%>">
        <input type="hidden" id="txt_c2Fax_mask" name="txt_c2Fax_mask" value="<%= v_c2Fax_mask%>">
        <input type="hidden" id="txt_c3Phone_mask" name="txt_c3Phone_mask" value="<%= v_c3Phone_mask%>">
        <input type="hidden" id="txt_c3Cell_mask" name="txt_c3Cell_mask" value="<%= v_c3Cell_mask%>">
        <input type="hidden" id="txt_c3Fax_mask" name="txt_c3Fax_mask" value="<%= v_c3Fax_mask%>">
        <input type="hidden" id="txt_business_phone_mask_exp" name="txt_business_phone_mask_exp" value="<%= v_business_phone_mask_exp%>">
        <input type="hidden" id="txt_business_phone2_mask_exp" name="txt_business_phone2_mask_exp" value="<%= v_business_phone2_mask_exp%>">
        <input type="hidden" id="txt_owner_phone_mask_exp"  name="txt_owner_phone_mask_exp" value="<%= v_owner_phone_mask_exp%>">
        <input type="hidden" id="txt_business_fax_mask_exp" name="txt_business_fax_mask_exp" value="<%= v_business_fax_mask_exp%>">
        <input type="hidden" id="txt_c2Phone_mask_exp" name="txt_c2Phone_mask_exp" value="<%= v_c2Phone_mask_exp%>">
        <input type="hidden" id="txt_c2Cell_mask_exp" name="txt_c2Cell_mask_exp" value="<%= v_c2Cell_mask_exp%>">
        <input type="hidden" id="txt_c2Fax_mask_exp" name="txt_c2Fax_mask_exp" value="<%= v_c2Fax_mask_exp%>">
        <input type="hidden" id="txt_c3Phone_mask_exp" name="txt_c3Phone_mask_exp" value="<%= v_c3Phone_mask_exp%>">
        <input type="hidden" id="txt_c3Cell_mask_exp" name="txt_c3Cell_mask_exp" value="<%= v_c3Cell_mask_exp%>">
        <input type="hidden" id="txt_c3Fax_mask_exp" name="txt_c3Fax_mask_exp" value="<%= v_c3Fax_mask_exp%>">
        <input type="hidden" id="txt_business_phone_mask_pre" name="txt_business_phone_mask_pre" value="<%= v_business_phone_mask_pre%>">
        <input type="hidden" id="txt_business_phone2_mask_pre" name="txt_business_phone2_mask_pre" value="<%= v_business_phone2_mask_pre%>">
        <input type="hidden" id="txt_owner_phone_mask_pre" name="txt_owner_phone_mask_pre" value="<%= v_owner_phone_mask_pre%>">
        <input type="hidden" id="txt_business_fax_mask_pre" name="txt_business_fax_mask_pre" value="<%= v_business_fax_mask_pre%>">
        <input type="hidden" id="txt_c2Phone_mask_pre" name="txt_c2Phone_mask_pre" value="<%= v_c2Phone_mask_pre%>">
        <input type="hidden" id="txt_c2Cell_mask_pre" name="txt_c2Cell_mask_pre" value="<%= v_c2Cell_mask_pre%>">
        <input type="hidden" id="txt_c2Fax_mask_pre" name="txt_c2Fax_mask_pre" value="<%= v_c2Fax_mask_pre%>">
        <input type="hidden" id="txt_c3Phone_mask_pre" name="txt_c3Phone_mask_pre" value="<%= v_c3Phone_mask_pre%>">
        <input type="hidden" id="txt_c3Cell_mask_pre" name="txt_c3Cell_mask_pre" value="<%= v_c3Cell_mask_pre%>">
        <input type="hidden" id="txt_c3Fax_mask_pre" name="txt_c3Fax_mask_pre" value="<%= v_c3Fax_mask_pre%>">
        <!-- end of phone mask -->
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="50%" align="right" valign="top">
                    <div id="print">
                        <img src="/ASP/Images/icon_printer_preview.gif" align="absbottom"><a href="javascript:;"
                    ...
                    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="48%" align="center">
                                <img height="18" name="bSave" onclick="saveOrganization(1);" src="/asp/images/button_save_medium.gif"
                            ...
                            <td width="13%" align="right" valign="middle">
                                <img src="/ASP/images/button_delete_medium.gif" width="51" height="17" id="bDelete"
                    ...
                    <table width="68%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr align="left" bgcolor="#f3f3f3" valign="middle">
                            ...
                            <td width="28%" height="30" align="right" valign="middle" bgcolor="#f3f3f3">
                                <span class="bodyheader">
                                    <img height="9" name="bNext" onclick="javascript:PrevNext(0);" src='/ASP/images/left_arrow_end.gif'
                                        style="cursor: hand" width="7">
                                    &nbsp;&nbsp;
                                    <img height="9" name="bNext" onclick="javascript:PrevNext(1);" src='/ASP/images/left_arrow.gif'
                                        style="cursor: hand" width="7">
                                    ...
                                    <img height="9" name="bNext" onclick="javascript:PrevNext(2);" src='/ASP/images/right_arrow.gif'
                                        style="cursor: hand" width="7">
                                    &nbsp;&nbsp;
                                    <img height="9" name="bNext" onclick="javascript:PrevNext(3);" src='/ASP/images/right_arrow_end.gif'
                    ...
                    <table width="68%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#73beb6"
                        ...
                        <tr>
                            ...
                            <td height="20" align="left" valign="middle" bgcolor="#ecf7f8" class="bodyheader">
                                <img src="/ASP/Images/required.gif" align="absbottom"><span class="style7">Company
                                    Name (DBA)</span></td>
                        ...
                        <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="38%" align="left" valign="middle" class="bodycopy" id="td_dba_name_href">
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('dba_name','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=dba_name','250px','128');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <tr>
                                ...
                                <td width="61%" align="left" valign="middle" class="bodycopy" id="td_class_code_href">
                                    <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('class_code','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=class_code','140px','32');">[List]</a></td>
                            </tr>
                    </table>
                </td>
                <td align="center" valign="middle" bgcolor="#FFFFFF">
                    <span class="bodyheader"><a href="javascript:;" onclick="javascript:goSearch('dba_name');">
                        <img src="/ASP/Images/icon_quicksearch.gif" width="32" height="25" style="cursor: pointer"></a></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="46%" height="24" align="left" valign="middle" bgcolor="#f3f3f3">
                    ...
                    <div style="width: 21px; display: inline; vertical-align: text-bottom" onmouseover="showtip('Checking this box will make the business show up in the initial list when you load the C/P Profile page, allowing for quick access.');"
                        onmouseout="hidetip()">
                        <img src="/ASP/images/button_info.gif" align="absmiddle" class="bodylistheader">
                    </div>
                    <% end if %>
                </td>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="bodycopy">
            <tr>
                <td style="width: 150px">
                    <a href="javascript:;" onclick="edit_scheduleB(); ">
                        <img src="/ASP/Images/icon_edit.gif" align="absmiddle" alt="" />Edit Schedule
                                    B</a>
                </td>
                <td style="width: 150px; <% if UserRight <> 9 then response.write "visibility:hidden" %>">
                    <a href="javascript:;" onclick="edit_Rate(); return false;">
                        <img src="/ASP/Images/icon_edit.gif" align="absmiddle" alt="" />Edit Rate
                                    Manager</a>
                </td>
                <td style="text-align: right; <% if UserRight <> 9 then response.write "visibility:hidden" %>">
                    <input class="bodycopy" id="bList" style="width: 80px" type="button" value="Back to List"
                        onclick="javascript: location = '/ASP/Master_Data/client_profile_list.asp'" />
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td id='td_business_city_href'>
                                <a href="javascript:" class="list" onclick="actionRequestForAll('business_city','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=business_city','150px','32');return false;">[List]</a></td>
                        </tr>
                    </table>
                </td>
                <td align="left" bgcolor="#FFFFFF">
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td id='td_business_state_href'>
                                <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('business_state','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=business_state','150px','32');return false;">[List]</a></td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td id="td_business_zip_href">
                                <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('business_zip','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=business_zip','100px','32');return false;">[List]</a></td>
                        </tr>
                    </table>
                </td>
                <td align="left" bgcolor="#FFFFFF">
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td id='td_business_country_href'>
                                <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('business_country','/ASP/ajaxFunctions/ajax_get_country_code.asp','150px','64');return false;">[List]</a>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td class="bodyheader">
                                <a href="javascript:;" onclick="javascript:adjustMask('txt_business_phone');" style="cursor: pointer;display:none">
                                    <img src="/ASP/Images/icon_format.gif" alt="Phone number format"></a></td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td align="left" valign="middle" class="bodyheader">
                                <a href="javascript:;"  onclick="javascript:adjustMask('txt_business_phone2');" style="cursor: hand;display:none">
                                    <img src="/ASP/Images/icon_format.gif" alt="Phone number format"></a></td>
                ...
                <td align="left" valign="middle" bgcolor="#FFFFFF">
                    <span class="bodyheader">
                        <input id="txt_business_fax" class="shorttextfield" name="txt_business_fax" style="width: 110px;"
                            type="text" value="<%= v_business_fax%>" /><a style="display:none; cursor: pointer" href="javascript:;"
                                onclick="javascript:adjustMask('txt_business_fax');"><img src="/ASP/Images/icon_format.gif"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td id='td_owner_mail_city_href'>
                                <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('owner_mail_city','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=owner_mail_city','150px','32');return false;">[List]</a></td>
                        </tr>
                    </table>
                </td>
                <td align="left" bgcolor="#FFFFFF">
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td id='td_owner_mail_state_href'>
                                <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('owner_mail_state','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=owner_mail_state','150px','32');return false;">[List]</a></td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td id='td_owner_mail_zip_href'>
                                <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('owner_mail_zip','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=owner_mail_zip','100px','32');return false;">[List]</a></td>
                        </tr>
                    </table>
                </td>
                <td align="left" bgcolor="#FFFFFF">
                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            ...
                            <td id='td_owner_mail_country_href'>
                                <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('owner_mail_country','/ASP/ajaxFunctions/ajax_get_country_code.asp','150px','64');return false;">[List]</a></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr align="left" bgcolor="#f3f3f3" valign="middle">
                ...
                <td rowspan="3" align="left" valign="top" bgcolor="#FFFFFF" class="bodycopy">
                    ...
                    <br>
                    <span class="bodyheader">
                        <input type="hidden" name="txt_add_remarks" id="txt_add_remarks">
                        <a href="javascript:;" onclick="goRemarks(); return false;" id="btnRemark">
                            <img src="/ASP/Images/icon_edit.gif" align="absmiddle" />
                ...
                <td align="left" valign="middle" bgcolor="#FFFFFF">
                    <span class="bodyheader">
                        ...
                        <a href="javascript:;" onclick="javascript:goWeb('txt_business_url');" style="cursor: pointer"
                            id="bWebSite">
                            <img src="/ASP/Images/icon_go.gif" alt="Go to website" width="26" height="16"
            ...
            <tr align="left" bgcolor="#f3f3f3" valign="middle">
                ...
                <td align="left" bgcolor="#FFFFFF">
                    <span class="bodyheader">
                        ...
                        <a href="javascript:;" style="cursor: pointer;display:none" onclick="javascript:adjustMask('txt_owner_phone');"
                            alt="Phone number format">
                            <img src="/ASP/Images/icon_format.gif" align="absmiddle">
                        </a></span>
                </td>
                <td align="left" bgcolor="#FFFFFF">
                    <span class="bodyheader">
                        ...
                        <a href="javascript:;" onclick="javascript:goMail('txt_owner_email');" style="cursor: pointer"
                            id="button1">
                            <img src="/ASP/Images/icon_go.gif" alt="Send email" width="26" height="16"
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                <tr>
                                                    ...
                                                    <td class="bodyheader">
                                                        <a href="javascript:;" style="cursor: pointer;display:none" onclick="javascript:adjustMask('txt_c2Phone');">
                                                            <img src="/ASP/Images/icon_format.gif" align="absmiddle"></a></td>
                                                    <td class="bodyheader">&nbsp;Ext.&nbsp;</td>
                                                    <td>
                                        ...
                                        <td>
                                            <input id="txt_c2Fax" class="shorttextfield" name="txt_c2Fax" style="width: 110px;"
                                                type="text" value="<%= v_c2Fax%>" maxlength="32" /><a href="javascript:;" style="cursor: pointer;display:none"
                                                    onclick="javascript:adjustMask('txt_c2Fax');" id="bC2Fax"><img src="/ASP/Images/icon_format.gif"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="javascript:;" style="cursor: pointer;display:none" onclick="javascript:adjustMask('txt_c2Cell');"
                                                id="bC2Cell">
                                                <img src="/ASP/Images/icon_format.gif" align="absmiddle" alt="Phone number format"></a></td>
                                        <td>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                <tr>
                                                    ...
                                                    <td class="bodyheader">
                                                        <a href="javascript:;" style="cursor: pointer;display:none" onclick="javascript:adjustMask('txt_c3Phone');"
                                                            id="bC3Phone">
                                                            <img src="/ASP/Images/icon_format.gif" align="absmiddle" alt=""></a></td>
                                                    <td class="bodyheader">&nbsp;Ext.&nbsp;</td>
                                                    <td>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:;" style="cursor: pointer;display:none" onclick="javascript:adjustMask('txt_c3Fax');"
                                                id="bC3Fax">
                                                <img src="/ASP/Images/icon_format.gif" align="absmiddle" alt="Phone number format"></a></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td height="18" bgcolor="#FFFFFF" class="bodyheader">
                                            <input id="txt_c3Cell" class="shorttextfield" name="txt_c3Cell" style="width: 110px;"
                                                type="text" value="<%= v_c3Cell%>" maxlength="32" /><a href="javascript:;" onclick="javascript:adjustMask('txt_c3Cell');"
                                                    style="cursor: hand;display:none" id="bC3Cell"><img src="/ASP/Images/icon_format.gif"
            ...
            <tr align="left" bgcolor="#f3f3f3" valign="middle">
                ...
                <td height="22" align="left" bgcolor="#f3f3f3" class="bodyheader">
                    <input type="hidden" name="txt_add_contact" id="txt_add_contact">
                    <span class="bodyheader"><a href="javascript:;" onclick="return goAddContact(); return false;"
                        id="btnContact">
                        <img src="/ASP/Images/icon_edit.gif" align="absmiddle">More Contacts</a></td>
                <td align="left" bgcolor="#f3f3f3">
                    <!--	
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td width="59%" id='td_SubConsignee_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubConsignee','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubConsignee','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td id='td_SubShipper_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubShipper','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubShipper','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td width="59%" id='td_SubAgent_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubAgent','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubAgent','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                            <td align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td id='td_SubCarrier_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubCarrier','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubCarrier','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td width="59%" id='td_SubTrucker_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubTrucker','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubTrucker','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                            <td align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td id='td_SubWarehousing_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubWarehousing','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubWarehousing','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td width="59%" id='td_SubCFS_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubCFS','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubCFS','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                            <td align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td id='td_SubBroker_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubBroker','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubBroker','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td width="59%" id='td_SubGovt_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubGovt','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubGovt','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                            <td align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td id='td_SubVendor_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubVendor','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubVendor','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    <tr>
                                        ...
                                        <td width="59%" id='td_SubSpecial_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubSpecial','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubSpecial','120px'); return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                            <td align="left" valign="middle" bgcolor="#FFFFFF" class="bodycopy">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="bodycopy" style="visibility: hidden">
                                    <tr>
                                        ...
                                        <td id='td_SubCustomer_href'>
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('SubCustomer','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubCustomer','120px');return false;">[List]</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="61%" align="left" valign="middle" class="bodycopy" id="td_defaultBrokerName_href">
                                            <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('defaultBrokerName','/ASP/ajaxFunctions/ajax_get_organization_list.asp?t=defaultBrokerName','220px','128');return false;">[List]</a></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <span class="bodycopy" style="height: 20px">
            ...
            <tr>
                ...
                <td width="18%" align="left" bgcolor="#f3f3f3">
                    ...
                    <div style="width: 21px; display: inline;" onmouseover="showtip('This is typically two to four alphabetic letters to identify freight carriers.');"
                        onmouseout="hidetip()">
                        <img src="/ASP/images/button_info.gif">
                    </div>
                    <% end if %>
                </td>
            ...
            <tr>
                ...
                <td align="left" valign="top" bgcolor="#FFFFFF">
                    <span class="bodycopy" style="height: 20px"><span class="bodycopy" style="height: 20px">
                        <input id="txt_FF_account" class="shorttextfield" name="txt_FF_account" style="width: 100px"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td bgcolor="#f3f3f3" class="bodyheader">Agent Account No.
                                                <input type="hidden" id="txt_coloader_elt_acct" name="txt_coloader_elt_acct" value="<%= v_coloader_elt_acct%>"></td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                        <tr>
                                            <td align="left" valign="middle" id='td_coloader_elt_acct_name_href'>
                                                <!--<a href="javascript:" onClick="javascript:actionRequestForAll('coloader_elt_acct_name','/ASP/ajaxFunctions/ajax_get_organization_list.asp?t=coloader_elt_acct_name','150px','64');return false;">[List]</a>-->
                                                <span class="bodycopy" style="height: 20px">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                        <tr>
                                            ...
                                            <td id='td_salesperson_href'>
                                                <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('salesperson','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=salesperson','150px','32');return false;">[List]</a></td>
                                        </tr>
                                    </table>
                                </td>
                                <td align="left" valign="top" bgcolor="#FFFFFF">
                                    <table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                        <tr>
                                            ...
                                            <td id='td_refferedBy_href'>
                                                <a href="javascript:" class="list" onclick="javascript:actionRequestForAll('refferedBy','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=refferedBy','150px','32');return false;">[List]</a></td>
                                        </tr>
                                    </table>
                                </td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <!--
                                                ...
                                                src='/ASP/images/left_arrow_end.gif' style="cursor: hand" width="7">
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <img height="9" name="bNext" onClick="javascript:PrevNext(1);" src='/ASP/images/left_arrow.gif'
                                                    style="cursor: hand" width="7">
            ...
            <tr>
                ...
                <td width="48%" align="center">
                    <a href="javascript:;" onclick="saveOrganization(1);" style="cursor: pointer">
                        <img height="18" name="bSave" src="/ASP/images/button_save_medium.gif" width="46" /></a></td>
                <td width="13%" align="right" valign="middle">
...
<script language="javascript" type="text/javascript" src="/ASP/include/edit_mask.js"></script>
...
'txt_owner_departm',
'txt_business_phone',
'txt_business_phone_ext',
'txt_business_phone_mask',
'txt_business_phone_mask_exp',
'txt_business_phone_mask_pre',
'txt_business_phone2',
'txt_business_phone2_ext',
'txt_business_phone2_mask',
'txt_business_phone2_mask_exp',
'txt_business_phone2_mask_pre',
'txt_owner_phone',
'txt_owner_phone_mask',
'txt_owner_phone_mask_exp',
'txt_owner_phone_mask_pre',
'txt_business_fax',
'txt_business_fax_mask',
'txt_business_fax_mask_exp',
'txt_business_fax_mask_pre',
'txt_owner_email',
'txt_business_url',
'txt_web_login_id',
'txt_web_login_pin',
'txt_business_address',
'txt_business_address2',
'txt_business_city',
'txt_business_state',
'txt_business_country',
'txt_business_zip',
'txt_business_legal_name',
'txt_business_fed_taxid',
'txt_c2FirstName',
'txt_c2MiddleName',
'txt_c2LastName',
'txt_c2Title',
...
'txt_c2Ext',
'txt_c2Phone_mask',
'txt_c2Phone_mask_exp',
'txt_c2Phone_mask_pre',
'txt_c2Cell',
'txt_c2Cell_mask',
'txt_c2Cell_mask_exp',
'txt_c2Cell_mask_pre',
...
'txt_c3Ext',
'txt_c3Phone_mask',
'txt_c3Phone_mask_exp',
'txt_c3Phone_mask_pre',
'txt_c3Cell',
'txt_c3Cell_mask',
'txt_c3Cell_mask_exp',
'txt_c3Cell_mask_pre',
...
'txt_z_chl_no',
'txt_z_firm_code',
'txt_owner_mail_address',
'txt_owner_mail_address2',
'txt_owner_mail_city',
'txt_owner_mail_state',
'txt_owner_mail_zip',
'txt_owner_mail_country',
'txt_bill_term',
'txt_z_attn_txt',
'txt_credit_amt',
'txt_z_bank_name',
'txt_z_bank_account_no',
'txt_agent_elt_acct',
'txt_refferedBy',
'txt_coloader_elt_acct',
'txt_coloader_elt_acct_name',
'chk_is_coloader',
'chk_edt',
'txt_SalesPerson',
'txt_print_check_as',
'txt_print_check_as_info',
'txt_FF_account'];



    function get_post_parameters(actType) {
     
        var str = '';

        for (i = 0; i < RequestArray.length; i++) {

            var tagType = $("#" + RequestArray[i]).attr("type");
            if (tagType == "checkbox") {
                if ($("#" + RequestArray[i]).is(':checked')) {
                    str += $("#" + RequestArray[i]).attr("id") + "=Y&";
                } else {
                    str += $("#" + RequestArray[i]).attr("id") + "=&";
                }
            } else {
                str += $("#" + RequestArray[i]).attr("id") + "=" + escape($("#" + RequestArray[i]).val()) + "&";
            }
    ...
    function reset_dba_field() {
        var url = '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=dba_name';
    ...
    function saveOrganization(actType) {
        ...
        if (actType == 1) { // save
            if (org_validation()) {
                var post_parameter = get_post_parameters(actType);
              
               // document.write(post_parameter);
                var url = '/ASP/ajaxFunctions/ajax_modify_dba.asp?Action=save&' ;
                //document.getElementById("txt_owner_phone").value = url;
                //return;
            ...
            if (iOrg > 0) {
                ...
                if (record_list == null) {
                    if (confirm('Do you really want to delete this Client profile?')) {
                        var url = '/ASP/ajaxFunctions/ajax_modify_dba.asp?Action=del&org=' + iOrg;
    ...
    function recheck_org_for_delete(org, str) {
        ...
        if (trim(sourceCode) != '') {
            ...
            if (confirm(sourceCode)) {
                ...
                if (record_list == null) {
                    if (confirm('Do you really want to delete this Client profile?')) {
                        var url = '/ASP/ajaxFunctions/ajax_modify_dba.asp?Action=del&org=' + org;
                        new ajax.xhr.Request('POST', '', url, showResponseDelResult, '', '', '');
                    }
                } else {
    ...
    function check_transaction_with_org(org) {
       // alert('check_transaction_with_org');
       
        var xmlHTTP = create_direct_xmlHTTP();
        alert(xmlHTTP);
        if (!xmlHTTP) { return false; }
        	try {    
        xmlHTTP.open("get", "/ASP/ajaxFunctions/ajax_check_transaction_client.asp?src=" + org, false);
        xmlHTTP.send();
    ...
    function adjust_data(src, msg) {
        ...
        if (!xmlHTTP) { return false; }
        try {
            xmlHTTP.open("get", "/ASP/ajaxFunctions/ajax_transfer_client.asp?src=" + src + "&target=" + src, false);
            xmlHTTP.send();
            var sourceCode = xmlHTTP.responseText;
            if (sourceCode) {
                if (sourceCode == 'ok') {
    ...
    function actionRequestForPrevNext(i) {
        ...
        var url = "/ASP/ajaxFunctions/ajax_get_organization_PrevNext.asp"
					+ "?s=" + encodeURIComponent(strDbaName)
    ...
    function get_dba_by_filter(retVal) {
        ...
        try {
            if (retVal.indexOf(':') > 0) {
                ...
                var url = "/ASP/ajaxFunctions/ajax_get_organization_PrevNext.asp?c=" + encodeURIComponent(retVal) + "&f=''&Action=" + strAction;
                new ajax.xhr.Request('GET', '', url, showResponsePrevNext, '', '', '');
    ...
    function edit_Rate() {
        ...
        viewPop("/MasterData/RateManagerPopup?acct_no=" + acc_num + "&type=4");
        return false;
    }
    ...
    function txt_business_stateChange(o) {
        var oCountry = document.getElementById("txt_business_country");
    ...
    function goAddContact() {
        ...
        try {
            var url = "/ASP/ajaxFunctions/ajax_check_add_info.asp?a=" + acc_num + "&t=contact";
    ...
    function goRemarks() {
        ...
        try {
            var url = "/ASP/ajaxFunctions/ajax_check_add_info.asp?a=" + acc_num + "&t=remarks";
    ...
    function make_default_lists() {
        actionRequestForAll('SubConsignee', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubConsignee', '120px');

        actionRequestForAll('SubAgent', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubAgent', '120px');
        actionRequestForAll('SubShipper', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubShipper', '120px');
        actionRequestForAll('SubCarrier', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubCarrier', '120px');
        actionRequestForAll('SubTrucker', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubTrucker', '120px');
        actionRequestForAll('SubWarehousing', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubWarehousing', '120px');
        actionRequestForAll('SubCFS', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubCFS', '120px');
        actionRequestForAll('SubBroker', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubBroker', '120px');
        actionRequestForAll('SubCustomer', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubCustomer', '120px');
        actionRequestForAll('SubGovt', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubGovt', '120px');
        //	actionRequestForAll('SubBroker','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubBroker','120px');
        //	actionRequestForAll('SubGovt','/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubGovt','120px');
        actionRequestForAll('SubVendor', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubVendor', '120px');

        actionRequestForAll('SubSpecial', '/ASP/ajaxFunctions/ajax_get_all_code.asp?t=SubSpecial', '120px');
