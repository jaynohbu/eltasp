...
<head>
    ...
    <script type="text/jscript">
        ...
        function searchNumFill(obj,eType,changeFunction,vHeight,event){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                if(oSearchType == "air_master"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=IBY-DIRECT&qStr=" + qStr;
                    FillOutJPED(obj,url,changeFunction,vHeight);
                }
                if(oSearchType == "ocean_master"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=OBY-DIRECT&qStr=" + qStr;
                    FillOutJPED(obj,url,changeFunction,vHeight);
                }
                if(oSearchType == "air_house"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&htype=AECON&qStr=" + qStr;
                    FillOutJPED(obj,url,changeFunction,vHeight);
                }
                if(oSearchType == "ocean_house"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&htype=OECON&qStr=" + qStr;
                    FillOutJPED(obj,url,changeFunction,vHeight);
                }
                if(oSearchType == "domestic_house"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&htype=DOCON&qStr=" + qStr;
                    FillOutJPED(obj,url,changeFunction,vHeight);
                }
            }
        }
        ...
        function searchNumFillAll(objName,eType,changeFunction,vHeight){
            ...
            if(oSearchType == "air_master"){
                var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=IBY-DIRECT";
                FillOutJPED(obj,url,changeFunction,vHeight);
            }
            if(oSearchType == "ocean_master"){
                var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=OBY-DIRECT";
                FillOutJPED(obj,url,changeFunction,vHeight);
            }
            if(oSearchType == "air_house"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&htype=AECON&qStr=";
                    FillOutJPED(obj,url,changeFunction,vHeight);
            }
            if(oSearchType == "ocean_house"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&htype=OECON&qStr=";
                    FillOutJPED(obj,url,changeFunction,vHeight);
            }
            if(oSearchType == "domestic_house"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&htype=DOCON&qStr=";
                    FillOutJPED(obj,url,changeFunction,vHeight);
            }
        }
                        ...
                        <tr>
                            <td>
                                <input type="text" autocomplete="off" id="lstSearchNum" name="lstSearchNum" value=""
                                    ...
                                    border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="searchNumFill(this,'A','lstSearchNumChange',130,event);"
