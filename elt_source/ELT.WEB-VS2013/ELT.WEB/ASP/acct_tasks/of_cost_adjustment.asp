...
<% for i=0 to tIndex-1 %>
                <tr bgcolor="#FFFFFF"> 
                  ...
                  <td><input name="txtADJCost<%= i %>" type="text" class="numberfield ADJCost" id="ADJCost" OnChange="CostChange(<%= i+1 %>)" value="<%= aAdjCost(i) %>" size="12"></td>
                  <td><input name="txtPS<%= i %>" type="text" class="d_shorttextfield" value="<%= aPS(i) %>" size="12" ReadOnly></td>
                  <td><input name="txtADJPS<%= i %>" type="text" class="numberfield ADJPS" id="ADJPS" value="<%= aADJPS(i) %>" size="12"></td>
                  <td><input name="txtOCarrier<%= i %>" type="text" class="numberfield OCarrier" id="OCarrier" value="<%= aOCarrier(i) %>" size="12"></td>
                  <td><input name="txtOAgent<%= i %>" type="text" class="numberfield OAgent" id="OAgent" value="<%= aOAgent(i) %>" size="12"></td>
