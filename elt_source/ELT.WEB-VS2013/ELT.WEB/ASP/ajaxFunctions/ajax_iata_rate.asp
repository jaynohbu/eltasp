...
'Customer Selling Rate	: '4' in Oiginal table
 ...
 if vAirline <>"" and vTo<>"" and vOriginPortID<>"" and vUnit<>"" and vWeight <>"" then   
...
Sub PREPARE_QUERY_STRING
    ...
    SQL=SQL & " and (airline=" & vAirline & " or airline=-1) and origin_port=N'" & vOriginPortID & "'"
    SQL=SQL & " and dest_port=N'" & vTo &"'" 
    SQL=SQL & " and weight_break = ( select max (weight_break) from all_rate_table "
    SQL=SQL & " where elt_account_number =" & elt_account_number & " and rate_type=5 and kg_lb =N'" & vUnit &"'" 
    SQL=SQL & " and weight_break <=" & tWeight
    SQL=SQL & " and (airline=" & vAirline & " or airline=-1) and origin_port=N'" & vOriginPortID & "'"
    SQL=SQL & " and dest_port=N'" & vTo &"')" 
End Sub 
...
Sub CHECK_MINIMUM
    ...
    SQL=SQL & " where elt_account_number =" & elt_account_number & " and rate_type=5 and kg_lb =N'" & vUnit &"'" 
    SQL=SQL & " and weight_break >= 0" 
    SQL=SQL & " and (airline=" & vAirline & " or airline=-1) and origin_port=N'" & vOriginPortID & "'"
    SQL=SQL & " and dest_port=N'" & vTo &"' order by weight_break" 
...
Sub GET_UNIT
    ...
    SQL=SQL & " where elt_account_number =" & elt_account_number & " and rate_type=5 " 
    SQL=SQL & " and (airline=" & vAirline & " or airline=-1) and origin_port=N'" & vOriginPortID & "'"
    SQL=SQL & " and dest_port=N'" & vTo &"'" 
