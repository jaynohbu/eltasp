...
Sub PREPARE_QUERY_STRING
    ...
    SQL=SQL & " where elt_account_number =" & elt_account_number & " and rate_type=4 and kg_lb =N'" & vUnit &"'" 
    ...
    SQL=SQL & " and dest_port=N'" & vTo &"') order by airline desc" 
...
Sub CHECK_MINIMUM
    ...
    SQL=SQL & " where elt_account_number =" & elt_account_number _
		& " and rate_type=4 and kg_lb =N'" & vUnit &"'" 
    SQL=SQL & " and customer_no="& vConsigneeAcct&" and weight_break >= 0" 
    SQL=SQL & " and (airline=" & vAirline & " or airline=-1) and origin_port=N'" & vOriginPortID & "'"
    SQL=SQL & " and dest_port=N'" & vTo &"' order by weight_break, airline desc" 
