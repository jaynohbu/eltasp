    ...
    <script type="text/javascript">
        ...
        function enableTxtPiece(chkObj,row_id) {
            ...
            if(!txtObj.readOnly){
                ...
                txtObj.class="numberfield";
            }
            else{
                txtObj.style.backgroundColor = "#cccccc";
                txtObj.value="";
                txtObj.class="readyonly";
            }
        }
        ...
        function checkPieceLimit(txtObj,availablePCS,shippedOutPCS) {
            ...
            var idRemined=id.replace("txtPiece","remainedPiece");
            var idReceived=id.replace("txtPiece","receivedPiece");

            availablePCS=   parseInt(document.getElementById(idRemined).value);
            shippedOutPCS=  parseInt(txtObj.value);

            var newPCS = availablePCS-shippedOutPCS;
         
            
            if(availablePCS < shippedOutPCS){
                alert("Cannot shipout more than avaialbe quantity of " + availablePCS);
                txtObj.value = 0;
            }else{
                document.getElementById(idRemined).value=newPCS;
            }
        }
            ...
            for(var i=0;i<objPCS.length;i++){
               // alert(updateHTML);
                ...
                if (chkObj[i].checked == true){
                    ...
                    var inp = '<input name="txtPiece" class="readonlybold" id="' + id + '" style="width: 50px; text-align: right; -ms-behavior: url(../include/igNumDotChkLeft.htc); background-color: rgb(204, 204, 204);" onchange="checkPieceLimit(this);" type="text" readonly="" value="' + objPCS[i].value + '" autocomplete="off"></td>';
                    parent.html(inp);

                    var id2 =$(tmpTableObj).find('input[name="remainedPiece"]').attr('id');
                   
                    var parent2 = $(tmpTableObj).find('input[name="remainedPiece"]').parent();
                    var inp2 = '<input name="remainedPiece" class="readonlybold" id="' + id + '" style="width: 50px; text-align: right; -ms-behavior: url(../include/igNumDotChkLeft.htc); background-color: rgb(204, 204, 204);" onchange="checkPieceLimit(this);" type="text" readonly="" value="' + document.getElementById(id2).value + '" autocomplete="off"></td>';
                    parent2.html(inp2);
        ...
        <form id="form1" name="form1">
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#9e816e"
                ...
                <tr id='Row<%=WRTableList(i)("auto_uid") %>' align="left">
                    ...
                    <td width="7%" align="right" style="padding-right: 0px">
                        <input style="width:60px" type="text" name="receivedPiece" id="receivedPiece<%=WRTableList(i)("auto_uid") %>" value="<%=WRTableList(i)("item_piece_origin")%>"  class="readonlybold" readonly="readonly" />
                    </td>
                    <td width="7%" align="right" style="padding-right: 0px">
                         <input style="width:60px" type="text" name="remainedPiece" id="remainedPiece<%=WRTableList(i)("auto_uid") %>" value="<%=WRTableList(i)("item_piece_remain")%>"  class="readonlybold" readonly="readonly" />
                    ...
                    <td width="7%" align="right" style="padding-right: 10px">
                        <input type="text" name="txtPiece" id="txtPiece<%=WRTableList(i)("auto_uid") %>"
                            ...
                            onchange="checkPieceLimit(this,<%=WRTableList(i)("item_piece_available") %>,<%=WRTableList(i)("item_piece_shipout") %>);"
            ...
            <table width="95%" height="20" border="0" cellpadding="0" cellspacing="0" bordercolor="#9e816e"
                ...
                <tr>
                    <td width="155" align="left" valign="middle" style="padding-left: 3px">
                        <img src="/ASP/Images/button_selectall.gif" alt="Select all" width="61"
                            height="17" style="margin-right: 28px; cursor: hand" onClick="javascript:checkAllWRs();" />
                        <img src="/ASP/Images/button_clear.gif" alt="Clear all" width="56" height="17"
                            style="cursor: hand" onClick="javascript:clearAll();" /></td>
                    <td height="24" align="center" valign="middle">
                        <img src="/ASP/Images/button_shipout.gif" alt="Ship out" width="74" height="18"
