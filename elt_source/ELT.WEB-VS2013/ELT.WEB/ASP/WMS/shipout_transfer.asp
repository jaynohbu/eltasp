...
<head>
    ...
    <script type="text/jscript">
        function SaveExportType(){
            ...
            if(vSearchType != ""){
                ...
                if((vSearchType == "air_master" || vSearchType == "ocean_master") && vSearchNum == ""){
                    ...
                    window.opener.redirectToBill(returnArray);
                    window.close();
                }
            }
            else{
        ...
        function searchNumFill(obj,eType,changeFunction,vHeight){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                if(oSearchType == "air_master"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=IBN&qStr=" + qStr;
                    FillOutJPED(obj,url,changeFunction,vHeight);
                }
                if(oSearchType == "ocean_master"){
                    var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=OBN&qStr=" + qStr;
                    FillOutJPED(obj,url,changeFunction,vHeight);
                }
            }
        ...
        function searchNumFillAll(objName,eType,changeFunction,vHeight){
            ...
            if(oSearchType == "air_master"){
                var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=IBN";
                FillOutJPED(obj,url,changeFunction,vHeight);
            }
            
            if(oSearchType == "ocean_master"){
                var url = "/ASP/ajaxFunctions/ajax2_mawb_header.asp?mode=list&mtype=OBN";
                FillOutJPED(obj,url,changeFunction,vHeight);
            }
        }
    </script>
...
<body style="margin: 5px">
    <form id="form1" action="">
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <tr>
                <td class="bodyheader">
                    <div style="font-size:13px">SHIP OUT DATA TRANSFER</div>
                </td>
            </tr>
