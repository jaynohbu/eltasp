...
namespace ELT.DA
{ 
    public class OceanImportDA:DABase
    {  
        
        public List<OceanImportDocument> GetOceanImportDocumentList(int ELT_ACCOUNT_NUMBER, string BillNum, string BillType)
        {
            ...
            List<OceanImportDocument> list = new List<OceanImportDocument>();
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@iType", "O"));
                conn.Open();
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        OceanImportDocument item = new OceanImportDocument()
                        {
                            ...
                            hbol_num = Convert.ToString(reader["hawb_num"]),
                            mbol_num = Convert.ToString(reader["mawb_num"]),                        
