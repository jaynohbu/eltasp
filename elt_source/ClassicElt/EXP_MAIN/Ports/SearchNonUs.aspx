<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchNonUs.aspx.cs" Inherits="Ports_SearchNonUs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ConfirmNext(){
            var resVal = true;
            if(document.getElementById("lstScheK").value == ""){
                            ...
                            <table cellpadding="2" cellspacing="0" border="0" style="width: 100%">
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <asp:ListBox runat="server" ID="lstScheK" Width="330px" CssClass="bodycopy" Rows="10"></asp:ListBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
