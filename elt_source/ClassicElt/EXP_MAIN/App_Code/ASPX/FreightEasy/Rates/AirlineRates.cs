...
{
    public class AirlineRates : FreightEasyData
    {
        public AirlineRates()
        {
        }

        public AirlineRates GetAllRecords(string elt_account_number, string rate_type)
        {
            string RoutesSQL = @"select distinct elt_account_number,rate_type,origin_port,
            dest_port,kg_lb from all_rate_table where elt_account_number="
                + elt_account_number + " and rate_type='" + rate_type + "'";
            string AirlineSQL = @"select distinct a.elt_account_number,a.rate_type,a.origin_port,
            ...
            string WeightSQL = @"select a.elt_account_number,a.rate_type,a.origin_port,
            a.dest_port,a.kg_lb,a.airline,a.share,a.fl_rate,a.sec_rate,a.include_fl_rate,a.include_sec_rate,
            ...
            this.AddRelation("Rate31", "Routes", "origin_port,dest_port,kg_lb", "airline", 
                "origin_port,dest_port,kg_lb");
            this.AddRelation("Rate32", "Airline", "origin_port,dest_port,kg_lb,airline", 
                "weight breaks", "origin_port,dest_port,kg_lb,airline");
        ...
        public void InsertRecord(RateEntity re)
        {
                ...
                re.item_no != null && re.weight_break != null)
            {
                    ...
                    //IF NOT EXISTS (SELECT * FROM all_rate_table WHERE elt_account_number=" 
