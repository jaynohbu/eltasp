<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchPort.aspx.cs" Inherits="Common_SearchPort" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ConfirmNext(){
            var resVal = true;
            if(document.getElementById("lstScheD").value == "" &&
                document.getElementById("lstScheK").value == "" &&
                document.getElementById("lstPortCode").value == ""){
                            ...
                            <table cellpadding="2" cellspacing="0" border="0" style="width: 100%">
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <asp:ListBox runat="server" ID="lstScheD" Width="330px" CssClass="bodycopy" Rows="5" OnSelectedIndexChanged="lstScheD_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table cellpadding="2" cellspacing="0" border="0" style="width: 100%">
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <asp:ListBox runat="server" ID="lstScheK" Width="330px" CssClass="bodycopy" Rows="5" OnSelectedIndexChanged="lstScheK_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table cellpadding="2" cellspacing="0" border="0" style="width: 100%">
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <asp:ListBox runat="server" ID="lstPortCode" Width="330px" CssClass="bodycopy"  Rows="5"></asp:ListBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
