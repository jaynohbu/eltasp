<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageAES.aspx.cs" Inherits="ASPX_Misc_ManageAES" %>

<%@ Register Assembly="Infragistics2.WebUI.UltraWebGrid.ExcelExport.v6.2, Version=6.2.20062.34, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb"
...
<head runat="server">
    ...
    <script type="text/jscript">
        ...
        {
            var vURL = "./tran_get_itn_no.asp?WindowName=AESDIRECT&AESID=" + aesNo;
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width: 95%">
                ...
                <tr>
                    <td style="text-align: left; vertical-align: bottom">
                        ...
                        <img src="../Images/button_devider.gif" alt="" />
                    ...
                    <igtbl:UltraGridBand>
                        ...
                        <Columns>
                            <igtbl:TemplatedColumn Width="41" AllowGroupBy="No" SortIndicator="Disabled">
                                ...
                                <CellTemplate>
                                    <asp:ImageButton ID="btnEdit" ImageUrl="../Images/button_edit.gif" runat="server"
