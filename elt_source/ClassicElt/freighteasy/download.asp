...
.style4 {line-height: 130%; font-family: Arial, Helvetica, sans-serif; font-size: 70%;}
.style5 {color: #363535; font-family: Arial, Helvetica, sans-serif;}
-->
</style>
    ...
    <td width="624" height="55" align="left" valign="top"><table width="624" height="60" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="600" height="16" align="left" valign="bottom" class="breadcrumb">
          <a href="../index.aspx">ELT Home /</a> <a href="../support.asp">Support /</a> Download </td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="623" align="left" valign="top"><table width="623" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF" class="pageheader">Download</td>
            <td bgcolor="#FFFFFF">&nbsp;</td>
          </tr>
          <tr>
            <td bgcolor="#FFFFFF">&nbsp;</td>
            <td width="590" align="left" valign="top" bgcolor="#FFFFFF"><br />
             <p class="bodycopy"><a href="../manual.html" target="_blank"><img src="images/download_icon.gif" alt="Will open in a new window" width="17" height="14" border="0"  align="bottom" /></a>&nbsp; &nbsp;<a href="../manual.html" target="_blank">Download FreightEasy User's Manual </a>(will open in a new window)<br />                
                <br /></p></td>
            <td bgcolor="#FFFFFF">&nbsp;</td>
          </tr>
          <tr>
            <td bgcolor="#FFFFFF">&nbsp;</td>
            <td height="42" align="left" valign="top" bgcolor="#FFFFFF"><p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
          ...
          <tr>
            <td><table width="169" height="216" border="0" cellpadding="0" cellspacing="0" background="images/back_sidetab.gif">
              ...
              <tr>
                ...
                <td height="24">&nbsp;</td>
                <td align="left" valign="middle" class="navi"><a href="account_setup.asp">Account Request</a> </td>
                <td align="left" valign="middle" class="navi">&nbsp;</td>
              </tr>
              <tr>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr>
         <td><table width="793" border="0" cellspacing="0" cellpadding="0">
             <tr>
               <td width="17">&nbsp;</td>
               <td width="313"><img src="images/spacer.gif" width="313" height="13" /><a href="../index.aspx"><img src="images/footer_home.gif" width="47" height="17" border="0" /></a><img src="images/footer_middle.gif" width="13" height="17" /><a href="../legal.asp"><img src="images/footer_legal.gif" width="75" height="17" border="0" /></a><img src="images/footer_middle.gif" width="13" height="17" /><a href="../contact.asp"><img src="images/footer_contact.gif" width="42" height="17" border="0" /></a><img src="images/spacer.gif" width="123" height="17" /><img src="images/footer.gif" width="281" height="15" /><img src="images/spacer.gif" width="313" height="10" /></td>
               <td width="463">&nbsp;</td>
             </tr>
         </table></td>
       </tr>
