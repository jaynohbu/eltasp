...
DIM SQL,dVal,MyArray,iCnt,i,tmpStr
	...
	SQL = "delete all_code where elt_account_number="& elt_account_number & " and type=" & code_type &" and replace(code,',','^^^') in  ('"& tmpStr & "')"
	eltConn.Execute(SQL)		
end sub
%>
...
DIM rs,SQL,tmpCode,tmpDesc,pos
	...
	SQL = "select * from all_code where elt_account_number="& elt_account_number & " and type=" & code_type &" and code='"&tmpCode&"'"
...
DIM tmpTable
	...
	Do While Not rs.EOF
		...
		tmpTable.Add "code_description", rs("code").value & fill_space(rs("code").value,32) & rs("description").value
...
<body leftmargin="0" link="336699" marginheight="0" marginwidth="0" topmargin="0"
    ...
    <form action="all_code_manage.asp" method="post" name="form1">
        <table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" bordercolor="#73beb6" bgcolor="#FFFFFF"
            class="maskwindow">
            <tr bgcolor="D5E8CB">
                <td height="8" colspan="3" align="left" valign="top" bgcolor="#FFFFFF" class="bodyheader"></td>
            </tr>
            <tr bgcolor="D5E8CB">
                <td width="3%" align="left" valign="top" bgcolor="#FFFFFF" class="bodyheader">&nbsp;</td>
                <td width="44%" align="left" valign="top" bgcolor="#FFFFFF" class="bodyheader"><select class="smallselect" id="lst_code" name="lst_code" size="4" style="height: 300px; width: 300px; font-size: 11px; font-family: 'Courier New', Courier, monospace;" multiple="multiple" onChange="lst_code_on_change(this)">
                ...
                <td width="53%" align="left" valign="middle" bgcolor="#FFFFFF" class="bodyheader"><table border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                        <tr>
                            <td><input class="bodycopy" id="bOK" style="width: 120px; height:25px" type="button" value="OK" onClick="javascript:doBtn(this);"></td>
                        </tr>
                        <tr align="left" valign="middle" bgcolor="#f3f3f3">
                            <td height="4" align="left"></td>
                        </tr>
                        <tr>
                            <td><input class="bodycopy" id="bCANCEL" style="width: 120px; height:25px" type="button" value="Cancel" onClick="javascript:doBtn(this);"></td>
                        </tr>
                        <tr align="left" valign="middle" bgcolor="#f3f3f3">
                            <td height="32" align="left" bgcolor="#FFFFFF"></td>
                        </tr>
                        <tr>
                            <td><input class="bodycopy" id="bADD" style="width: 120px; height:25px" type="button" value="Add..." onClick="javascript:doBtn(this);"></td>
                        </tr>
                        <tr align="left" valign="middle" bgcolor="#f3f3f3">
                            <td height="4" align="left"></td>
                        </tr>
                        <tr>
                            <td><input class="bodycopy" id="bMODIFY" style="width: 120px; height:25px" type="button" value="Modify..." onClick="javascript:doBtn(this);"></td>
                        </tr>
                        <tr align="left" valign="middle" bgcolor="#f3f3f3">
                            <td height="4" align="left"></td>
                        </tr>
                        <tr>
                            <td><input class="bodycopy" id="bDELETE" style="width: 120px; height:25px" type="button" value="Delete" onClick="javascript:doBtn(this);"></td>
                        </tr>
                </table></td>
            </tr>
            <tr bgcolor="D5E8CB">
