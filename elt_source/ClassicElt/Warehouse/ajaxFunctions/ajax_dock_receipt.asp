...
<%    
    ...
    Sub get_all_info()
        ...
        SQL = "SELECT TOP 1 * FROM warehouse_manager WHERE elt_account_number=" & elt_account_number _
    ...
    Sub get_search_list()
        ...
        SQL = "SELECT DISTINCT " & topNum & " auto_uid,dock_no FROM warehouse_manager WHERE elt_account_number=" _
            & elt_account_number & " AND dock_no like '" & qStr & "%' " _
            & "AND CAST(dock_no as VARCHAR)>='" & cursorStr & "' order by dock_no"
    ...
    Sub save_to_table()
        ...
        SQL = "SELECT * FROM warehouse_manager where elt_account_number=" _
            & elt_account_number & " AND auto_uid=" & uid
        
        Dim cursorFinder 
        cursorFinder = "SELECT TOP 1 auto_uid FROM warehouse_manager where elt_account_number=" _
            & elt_account_number & " order by auto_uid desc"   
        dataObj.SetColumnKeys("warehouse_manager")
    ...
    Sub delete_from_table()
        ...
        SQL = "DELETE FROM warehouse_manager WHERE auto_uid=" & uid & " AND " _
