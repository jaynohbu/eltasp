========================================================================
		ActiveX Control DLL : FREIGHTEASYNET
========================================================================

ControlWizard has created this project for your FREIGHTEASYNET ActiveX Control
...
that make up your FREIGHTEASYNET ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
FreightEasyNet control:

FreightEasyNetCtl.h
	This file contains the declaration of the CFreightEasyNetCtrl C++ class.

FreightEasyNetCtl.cpp
	This file contains the implementation of the CFreightEasyNetCtrl C++ class.

FreightEasyNetPpg.h
	This file contains the declaration of the CFreightEasyNetPropPage C++ class.

FreightEasyNetPpg.cpp
	This file contains the implementation of the CFreightEasyNetPropPage C++ class.

FreightEasyNetCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CFreightEasyNetCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file FreightEasyNet.rc.
