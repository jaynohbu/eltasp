    ...
    <script type="text/jscript">
       ...
       function CheckDate() {
		   ...
		   function lstSearchNumChange(argV,argL){
            ...
            //var url = "/IFF_MAIN/ASP/ajaxFunctions/ajax_warehouse_receipt.asp?mode=view&uid=" + argV;
    ...
    // End of list change effect ///////////////////////////////////////////////////////////////////  
       ...
       function searchNumFill(obj,changeFunction,vHeight){
        ...
        function searchNumFillAll(objName,changeFunction,vHeight){
            ...
            url = "/IFF_MAIN/ASP/ajaxFunctions/ajax_warehouse_receipt.asp?mode=list2";
            FillOutJPED(obj,url,changeFunction,vHeight);
        }
        ...
        function goWRScreen(orgnum,orgname) {
               url ="/IFF_MAIN/ASP/WMS/warehouse_receipt.asp?o="+orgname+"&n="+orgnum+ "&WindowName=popUpWindow";
...
<body>
    <form id="form1" runat="server" class="bodycopy">
        ...
        <igsch:WebCalendar ID="CustomDropDownCalendar" runat="server" Width="180px">
            <Layout TitleFormat="Month" ShowYearDropDown="False" ShowMonthDropDown="False" CellPadding="0"
                NextMonthText="&gt;&gt;" PrevMonthText="&lt;&lt;" FooterFormat="" ShowFooter="False">
                <DayStyle BackColor="White" CssClass="CalDay"></DayStyle>
