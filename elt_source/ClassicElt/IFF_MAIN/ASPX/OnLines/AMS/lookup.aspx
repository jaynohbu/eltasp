<%@ Page language="c#" CodeFile="lookup.aspx.cs" AutoEventWireup="false" Inherits="IFF_MAIN.ASPX.OnLines.AMS.lookup" %>
...
var strCode = row.getCell(2).getValue();
				
var strFieldText = "<%=strField%>";
var strFieldCode = strFieldText.substring(0,strFieldText.length-2);

var ultraTab = window.opener.igtab_getTabById("UltraWebTab1");
var htmlText = ultraTab.findControl(strFieldText);
var codeText = ultraTab.findControl(strFieldCode);

htmlText.value=strText;
...
function myClose() {
//window.opener.document.CompanyCreate.drSearch.selectedIndex = 0;
window.close();
}
