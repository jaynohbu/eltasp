...
//		}
        ...
        protected void UltraWebGrid1_InitializeRow1(object sender, RowEventArgs e)
        {
            ...
            {
                /* 
                 * change by stanley on 12/13/2007
                string InvPage = e.Row.Cells.FromKey("air_ocean").Value.ToString();
                if (InvPage == "A")
                {
                    s = "javascript:; " + "void(viewPop('../../AccountingTasks/air_arrival_notice.aspx?edit=yes&invoice_no="; 
                }
                else if (InvPage == "O")
                {
                    s = "javascript:; " + "void(viewPop('../../AccountingTasks/ocean_arrival_notice.aspx?edit=yes&invoice_no=";
                }
                else
                {
                    s = "javascript:; " + "void(viewPop('../../AccountingTasks/edit_invoi.aspx?edit=yes&invoice_no=";
                }
                */
