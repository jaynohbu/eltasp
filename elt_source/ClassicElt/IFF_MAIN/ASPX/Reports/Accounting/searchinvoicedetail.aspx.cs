...
namespace IFF_MAIN.ASPX.Reports.Accounting
{
	...
	/// </summary>
	public partial class SearchInvoiceDetail : System.Web.UI.Page
	{
...
//***********************************************************//
		...
		private void PerformSearch()
		{
            ...
            str[4] = Session["str4"].ToString();
            str[5] = Session["str5"].ToString();
		...
		{    
			this.UltraWebGrid1.InitializeRow += new Infragistics.WebUI.UltraWebGrid.InitializeRowEventHandler(this.UltraWebGrid1_InitializeRow_1);
...
//		}
		...
		private void UltraWebGrid1_InitializeRow_1(object sender, Infragistics.WebUI.UltraWebGrid.RowEventArgs e)
		{
			string s = "";
        ...
        protected void radMulti_CheckedChanged(object sender, EventArgs e)
        {
        ...
        protected void UltraWebGrid1_InitializeLayout(object sender, LayoutEventArgs e)
        {
            ...
            e.Layout.Bands[0].Columns.FromKey("invoice_date").Format = "MM/dd/yyyy";
