        ...
        <table id="Table2" cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff"
            ...
            <tr>
                ...
                <td valign="top" align="left" style="height: 360px">
                    <igtbl:UltraWebGrid ID="ug1" runat="server" OnInitializeLayout="ug1_InitializeLayout1"
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
            ...
            <tr>
                ...
                <table cellpadding="0" cellspacing="1" border="0"><tr><td style="width:725px">
                    <asp:RadioButton
                            ID="radSingle" runat="server" Text="Single Page" Width="100px" Checked="True"
                            AutoPostBack="True" GroupName="SingleMulti" OnCheckedChanged="radSingle_CheckedChanged" Visible="false">
                        </asp:RadioButton><asp:RadioButton ID="radMulti" runat="server" Text="Multi Page"
                            Width="100px" AutoPostBack="True" GroupName="SingleMulti" OnCheckedChanged="radMulti_CheckedChanged" Visible="false">
                    ...
                    <input id="ExpandAll" style="width: 80px; height: 20px; background-color: #e0e0e0; visibility:hidden"
                        onclick="javascript:ExpandAllRows(this);" type="button" value="Expand All" name="ExpandAll">
                </td>
                <td align="left" style="height: 17px" valign="top">
                    <asp:CheckBox runat="server" id="sendItemsAll" Text="Check/Uncheck All" Visible="false" onClick="doCheckAll();" />
        ...
        <asp:Button ID="btnEMAIL" runat="server" Text="EMAIL" Width="60px" Visible="False" OnClick="btnEMAIL_Click">
        </asp:Button>
