<%@ Control Language="c#" Inherits="IFF_MAIN.ASPX.Reports.SelectionControls.rdSelectDateControl2" CodeFile="rdSelectDateControl2.ascx.cs" %>


<asp:dropdownlist id="rdDateSet2" Width="99%" runat="server" BackColor="#FFFFC0" ForeColor="#000040">
