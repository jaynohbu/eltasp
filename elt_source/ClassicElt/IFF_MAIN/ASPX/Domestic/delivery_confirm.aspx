...
<head runat="server">
    ...
    <script type="text/jscript">
      ...
      function CheckboxCheck(obj,fileName, orgNO  )
      {
            ...
            url = "/IFF_MAIN/ASP/ajaxFunctions/ajax_get_Domestic_EMAIL_list.asp?mode=checkbox &OrgNo=" + orgNO + "&Value=" + value +" &Filename=" + fileName ;
      ...
      function UpDateUserMail(obj )
      {
          ...
          var url = "/IFF_MAIN/ASP/ajaxFunctions/ajax_get_Domestic_EMAIL_list.asp?mode=Usermailupdate &Email=" + EmailAddress;
          new ajax.xhr.Request('GET','',url,UpDateChange,'','','','');
       ...
       function UpDateMail(EmailAddress, orgNo )
      {
          if( orgNo != "" && orgNo != "0")
          {
               var url = "/IFF_MAIN/ASP/ajaxFunctions/ajax_get_Domestic_EMAIL_list.asp?mode=UPDATE &OrgNO=" + orgNo + "&Email=" + EmailAddress;
                new ajax.xhr.Request('GET','',url,UpDateChange,'','','','');
           }
           else
           {
                                                                    ...
                                                                    <tr align="left" valign="middle" bgcolor="#ffffff">
                                                                     ...
                                                                     <tr align="left" valign="middle" bgcolor="#ffffff">
                                                                        ...
                                                                        <td width="90" align="left" valign="middle" class="bodycopy">
                                                                            <img src="/iff_main/ASP/Images/required.gif" align="absbottom"><span class="bodyheader">Shipper Email:</span></td>
                                                                        <td width="928" align="left" valign="middle" class="bodycopy">
