<%@ Page Language="C#" AutoEventWireup="true" CodeFile="modalAdd.aspx.cs" Inherits="ASPX_modalAddClient" %>
...
<script language="javascript" type="text/javascript" src="/IFF_MAIN/ASP/include/modalAddNewJN.js"></script>
<script type="text/javascript" language ="javascript" > 

function upper_click(){

//document.forms[0]["txtDbaName"].focus();
  document.getElementById("txtDbaName").focus();
...
<body onload="divOverlap('upper','bottom','0','0');">
    ...
    <form id="form1" runat="server">
       ...
       <div id="upper"  onmouseover= "upper_click()" style="left: 0px; width: 400px; position: absolute; top: 0px; height: 96px"> 
        ...
        <div id="bottom" style="left: 0px; width: 400px; position: absolute; top: 116px; height: 76px">
            <asp:Panel ID="pnlNext" runat="server" Height="76px" Width="400px"  Visible="false">
                ...
                <asp:Label ID="lblType" runat="server" Visible="False"></asp:Label></asp:Panel>
        </div>
