<%@ Control Language="c#" Inherits="IFF_MAIN.ASPX.Reports.SelectionControls.rdSelectDateControl1" CodeFile="rdselectdatecontrol1_m.ascx.cs" %>


<asp:dropdownlist id="rdDateSet1" runat="server" CssClass="smallselect">
