...
<head>
    ...
    <script type="text/javascript">
        ...
        function getDefaultBrokerInfo(orgNum)
        {
            ...
            var url="../ajaxFunctions/ajax_get_org_address_info.asp?type=DB&org="+ orgNum;
    ...
    <script type="text/jscript" src="../ajaxFunctions/ajax_ig_call_db.js"></script>
    ...
    Function CofirmDFA()
        RET=makeMsgBox("Check Default Ocean Freight Charge is set","Default Ocean Freight Charge Item is not set in your Company Profile, would you like to set it before you move on?",48,4,0,4096)
        if RET = 6 THEN window.location="/IFF_MAIN/ASP/SITE_ADMIN/co_config.asp?DOF=Y"  end if
    End Function
    </script>
            ...
            <tr>
                ...
                <td width="65%" align="right" valign="middle">
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="62%" height="27" align="right" valign="middle">
                            ...
                            <td width="38%" align="right" valign="middle">
                                <div id="searcharrival">
                                    <span class="bodyheader style4">
                                        <input name="txtFindIV" type="text" class="lookup" style="width: 120px" value="Arrival No. Here"
                                ...
                                <div id="searchhouse" style="display: none">
                                    <span class="bodyheader style4">
                                        <input name="txtFindByHAWB" type="text" class="lookup" style="width: 120px" value="House No. Here"
                                ...
                                <div id="searchmaster" style="display: none">
                                    <span class="bodyheader style4">
                                        <input name="txtFindByMAWB" type="text" class="lookup" style="width: 120px" value="Master No. Here"
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="63%" align="right" valign="bottom">
                        <div id="div">
                            <div id="print">
                                <img src="/iff_main/ASP/Images/icon_printer.gif" align="absbottom"><a href="javascript:;"
                                    onclick="if(CheckIfANExist()==true) { SaveClick('<%= TranNo %>','yes') };return false;">Arrival
                                    Notice</a><img src="/iff_main/ASP/Images/button_devider.gif"><a href="javascript:;"
                                        onclick="if(CheckIfANExist()==true) {SaveClick2('<%= TranNo %>','yes')};return false;">Arrival
                                        Notice & Freight Invoice</a><img src="/iff_main/ASP/Images/button_devider.gif"><a
                                            href="javascript:;" onclick="SaveClick3('<%= TranNo %>');return false;">Release
                                            Order</a></div>
                        </div>
                    </td>
                </tr>
                                ...
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="48%" align="center">
                                            ...
                                            <input type="hidden" name="hDoInvoice" id="hDoInvoice" value='yes' /></td>
                                        <td width="13%" align="right">
                                            <img style="cursor: hand" src="/iff_main/ASP/Images/button_new.gif" width="42" height="17"
                                                onclick="AddHAWB()"></td>
                                        <td width="13%" align="right">
                                ...
                                <table width="90%" border="0" cellpadding="2" cellspacing="0" bordercolor="909EB0"
                                    ...
                                    <tr align="left" valign="middle" bgcolor="DFE1E6">
                                        ...
                                        <td height="20" align="left" valign="middle" bgcolor="DFE1E6">
                                            &nbsp;</td>
                                        <td>
                                            <strong><span class="style5">Arrival Notice No.</span>&nbsp;&nbsp;</strong></td>
                                        <td>
                                            <strong>File No.&nbsp;&nbsp;</strong></td>
                                    </tr>
                                    <tr align="left" valign="middle" bgcolor="#ffffff">
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <br>
                                            <%if InvoiceNo<>"" then response.Write("<img src='/iff_main/ASP/Images/icon_goto.gif'><span class='goto'><a href='javascript:void(goInvoice());'>Go to Invoice</a></span>") end if %>
                                        </td>
                                        <td valign="top" bgcolor="#ffffff">
                                            <strong>
                                                <input name="txtRefNo" type="text" class="readonlybold" value="<%= vFileNo %>" size="24"
                                                    readonly="true">
                                            </strong>
                                        </td>
                                    </tr>
                                    ...
                                    <tr bgcolor="#DFE1E6">
                                        ...
                                        <td width="24%" align="left" valign="middle" bgcolor="#DFE1E6">
                                            <strong class="bodyheader style3">
                                                <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Master B/L No.<span
                                                    class="style8"><strong>
                                                        <% if mode_begin then %>
                                                    </strong></span></strong>
                                        ...
                                        <td align="left" valign="middle" bgcolor="DFE1E6">
                                            <span class="style3"><strong>House B/L No.</strong></span></td>
                                    </tr>
                                    <tr bgcolor="#FFFFFF">
                                        ...
                                        <td height="20" align="left" valign="top" bgcolor="#FFFFFF">
                                            ...
                                            <%  iMoonComboBoxWidth =  "110px" %>

                                            <script language="javascript"> 
function <%=iMoonComboBoxName%>_OnChangePlus() 
{ 
  var slt=document.getElementById("lstMAWB");
  var index=document.getElementById("lstMAWB").selectedIndex; 
  document.getElementById("txtMAWB").value=slt(index).text;
...
function trim(sourceString) { return sourceString.replace(/(?:^\s+|\s+$)/ig, ""); }
    ...
    function goDeconsol() {
        try {
	        ...
	        var url = 'ocean_import2.asp?iType=O&Edit=yes&MAWB=' + mawb +'&Sec='+sec+'&AgentOrgAcct='+ document.form1.hAgentOrgAcct.value;
    ...
    function goInvoice() {
	    try {
		    ...
		    var url = '../acct_tasks/edit_invoice.asp?edit=yes&InvoiceNo=' +invoice;
		    ...
		    if(opener){
			    ...
			    self.location = encodeURI(url);	
                                            ...
                                            <br>
                                            <span class="goto">
                                                <img src="/iff_main/ASP/Images/icon_goto.gif" width="36" height="21" align="absbottom"><a
                                                    href="javascript:void(goDeconsol());">Go to Deconsolidation</a></span></td>
                       ...
                       response.Write(" <input class='readonlybold' name='txtHAWB' id='txtHAWB' readonly size='30' type='text' value='"& vHAWB&"'/>")
                                    ...
                                    <tr bgcolor="#F3f3f3">
                                        <td height="20" align="left" valign="top" bgcolor="#FFFFFF">
                                            <input name="txtSubMAWB" type="text" maxlength="32" class="shorttextfield" value="<%= vSubMAWB %>"
                                                size="24"></td>
                                        <td align="left" valign="top" bgcolor="#FFFFFF">
                                            <input name="txtSubMAWB2" type="text" maxlength="32" class="shorttextfield" value="<%= vSubMAWB2 %>"
                                                size="24"></td>
                                    </tr>
                                    <tr bgcolor="DFE1E6">
                                        <td align="left" valign="middle">
                                        ...
                                        <td height="20" align="left" valign="middle">
                                            <strong>
                                                <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Consignee</strong></td>
                                        <td align="left" valign="middle">
                                    ...
                                    <tr bgcolor="#F3f3f3">
                                        ...
                                        <td height="20" align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtDate" type="text" class="m_shorttextfield" preset="shortdate" value="<%= vProcessDT %>"
                                                size="24"></td>
                                        <td align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtPickupDate" type="text" class="m_shorttextfield" preset="shortdate"
                                                value="<%= vPickupDate %>" size="24"></td>
                                    </tr>
                                    <tr bgcolor="#F3f3f3">
                                        <td height="20" align="left" valign="middle" bgcolor="#f3f3f3">
                                            <strong>Customer Reference No.</strong></td>
                                        <td align="left" valign="middle" bgcolor="#f3f3f3">
                                            &nbsp;</td>
                                    </tr>
                                    <tr bgcolor="#F3f3f3">
                                    ...
                                    <tr bgcolor="DFE1E6">
                                        ...
                                        <td align="left" valign="middle">
                                            <strong>Vessel Name</strong></td>
                                        <td align="left" valign="middle">
                                            <strong>Voyage No.</strong></td>
                                    </tr>
                                    <tr bgcolor="#FFFFFF">
                                        ...
                                        <td height="20" align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtVessel" type="text" class="d_shorttextfield" value="<%= vVessel %>"
                                                size="30" readonly="true"></td>
                                        <td align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtVoyageNo" type="text" class="d_shorttextfield" value="<%= vVoyageNo %>"
                                                size="24" readonly="true"></td>
                                    </tr>
                                    <tr bgcolor="#F3f3f3">
                                        <td height="20" align="left" valign="middle" bgcolor="#f3f3f3">
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="text" autocomplete="off" id="lstBrokerName" name="lstBrokerName" value="<%=vBrokerName %>"
                                                            class="shorttextfield" style="width: 285px; border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9;
                                                            border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="organizationFill(this,'Broker','lstBrokerNameChange')"
                                                            onfocus="initializeJPEDField(this);" /></td>
                                                    <td>
                                                        <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstBrokerName','Broker','lstBrokerNameChange')"
                                                            style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                                            border-left: 0px solid #7F9DB9; cursor: hand;" /></td>
                                                    <td>
                                                        <img src="/ig_common/Images/combobox_addnew.gif" alt="" border="0" style="cursor: hand"
 ...
 if vArrCode=port_list(i)("port_code") then response.write(" selected")%>>
                                        ...
                                        <td align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtETA" type="text" preset="shortdate" class="m_shorttextfield" value="<%= vETA %>"
                                                size="24"></td>
                                    </tr>
                                    <tr bgcolor="#F3f3f3">
                                        <td height="20" align="left" valign="middle" bgcolor="#f3f3f3">
                                    ...
                                    <tr bgcolor="#F3f3f3">
                                        <td height="20" align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtDeliveryPlace" type="text" maxlength="64" class="shorttextfield"
                                                value="<%= vDeliveryPlace %>" size="30"></td>
                                        <td align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtETD2" type="text" class="m_shorttextfield" preset="shortdate" value="<%= vETD2 %>"
                                                size="24"></td>
                                    </tr>
                                    <tr bgcolor="#F3f3f3">
                                        <td height="20" align="left" valign="middle" bgcolor="#f3f3f3">
                                    ...
                                    <tr bgcolor="#F3f3f3">
                                        <td height="20" align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtDestination" type="text" class="shorttextfield" value="<%= vDestination %>"
                                                size="30"></td>
                                        <td align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtETA2" type="text" class="m_shorttextfield" preset="shortdate" value="<%= vETA2 %>"
                                                size="24"></td>
                                    </tr>
                                    <tr bgcolor="DFE1E6">
                                        <td>
                                    ...
                                    <tr bgcolor="#F3f3f3">
                                        ...
                                        <td align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtFreeDate" type="text" class="m_shorttextfield" preset="shortdate"
                                                value="<%= vFreeDate %>" size="30"></td>
                                        <td align="left" valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtGODate" type="text" class="m_shorttextfield" preset="shortdate" value="<%= vGODate %>"
                                                size="24"></td>
                                    </tr>
                                    <tr bgcolor="DFE1E6">
                                        <td align="left" valign="middle">
                                    ...
                                    <tr bgcolor="#FFFFFF">
                                        <td align="left" valign="middle">
                                            &nbsp;</td>
                                        <td height="20" align="left" valign="middle">
                                            <input name="txtITNumber" type="text" class="shorttextfield" maxlength="64" value="<%= vITNumber %>"
                                                size="60"></td>
                                        <td align="left" valign="middle">
                                            <input name="txtITDate" type="text" class="m_shorttextfield" preset="shortdate" value="<%= vITDate %>"
                                                size="30"></td>
                                        <td align="left" valign="middle">
                                            <input class="shorttextfield" name="txtITEntryPort" type="text" value="<%= vITEntryPort %>"
                                                size="29"></td>
                                    </tr>
                                </table>
                                <table width="90%" border="0" cellpadding="2" cellspacing="0" bordercolor="909EB0"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6" bgcolor="CFD6DF">
                                            <span class="style1">PARTICULARS FURNISHED BY SHIPPER</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="4" align="left" valign="top" bgcolor="#FFFFFF" class="bodycopy">
                                            <textarea name="txtDesc1" cols="30" rows="5" class="multilinetextfield"><%= vDesc1 %></textarea></td>
                                        ...
                                        <td align="left" valign="top" bgcolor="#FFFFFF" class="bodycopy" style="height: 24px">
                                            ...
                                            <select name="lstScale2" class="smallselect">
                                                <option <% if vScale2="LB" Or vScale2="L" or vScale2="CFT" then response.write("selected") %>>CFT</option>
                                                <option <% if vScale2="KG" Or vScale2="K" or vScale2="CBM" then response.write("selected") %>>CBM</option>
                                        ...
                                        <td align="left" valign="top" bgcolor="#FFFFFF" class="bodycopy" style="height: 24px">
                                            <input size="10" onblur="AmountChange(1000)" id="txtTotalFC" name="txtTotalFC" class="numberaligh"
                                                value="<%=formatNumberPlus(vOFTotal,2)%>" type="text" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td height="20" colspan="6" align="left" valign="top" bgcolor="#FFFFFF">
                                            <textarea name="txtDesc3" cols="65" rows="5" class="multilinetextfield" onkeyup="textLimit(this,230);"><%= vDesc3 %></textarea></td>
                                    </tr>
                                </table>
                                <table width="90%" border="0" cellpadding="2" cellspacing="0" bordercolor="909EB0"
                                    class="border1px">
                                    <tr bgcolor="DFE1E6" class="bodycopy">
                                        ...
                                        <td height="20" colspan="7">
                                            <strong>Remark </strong>( Maximum of 220 characters or 2 lines please)</td>
                                    </tr>
                      ...
                      for j=0 to ARIndex-1 %>
                                    ...
                                    <tr bgcolor="DFE1E6" class="bodycopy">
                                        ...
                                        <td width="199" height="20">
                                            <span class="style3"><strong>Other Charge Item</strong></span></td>
                                        <td width="146">
                                    ...
                                    <tr>
                                        <td bgcolor="#FFFFFF" class="bodycopy" style="height: 22px">
                                            &nbsp;</td>
                                        <td bgcolor="#FFFFFF" class="bodycopy" style="height: 22px">
                                            <select name="lstItem<%= i %>" size="1" class="smallselect" id="InvoiceItem" style="width: 180"
                                                onchange="ItemChange(<%= i+1 %>); AmountChange(<%= i+1 %>)">
                                        ...
                                        <td bgcolor="#FFFFFF" class="bodycopy" style="height: 22px">
                                            <input name="txtChargeDesc<%= i %>" type="text" class="shorttextfield" id="ItemDesc"
                                                value="<%= aChargeDesc(i) %>" size="24"></td>
                                        <td bgcolor="#FFFFFF" class="bodycopy" style="height: 22px">
                                            <input id="ItemAmount" class="numberaligh" name="txtAmount<%= i %>" onchange="AmountChange(<%= i+1 %>); "
...
%> style="cursor: hand"></td>
	 ...
	 if UserRight<5 Or Not Branch="" then response.write("disabled") %> style="cursor: hand"></td>
                                        <td bgcolor="#FFFFFF" class="bodycopy">
                                            &nbsp;</td>
							...
							response.write "..."
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="DFE1E6" class="bodycopy">
                                            <span class="style3"><strong>Cost Item</strong></span></td>
                                        <td bgcolor="DFE1E6" class="bodycopy">
                                            <strong>Description</strong></td>
                                        <td bgcolor="DFE1E6" class="bodycopy">
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                            <select name="lstCostItem<%= i %>" size="1" class="smallselect" id="InvoiceCostItem"
                                                style="width: 180" onchange="ItemCostChange(<%= i+1 %>); CostChange(<%= i+1 %>)">
                                                <option>Select One</option>
                                                <option>Add New Item</option>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                            <input name="txtCostDesc<%= i %>" type="text" class="shorttextfield" id="ItemCostDesc"
                                                value="<%= aCostDesc(i) %>" size="24"></td>
                                        <td bgcolor="#FFFFFF">
                                            <input name="txtCost<%= i %>" type="text" class="numberalign" id="ItemCost" onchange="CostChange(<%= i+1 %>)"
                                                value="<%= formatNumberPlus(CheckBlank(aRealCost(i),0),2) %>" size="12" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                        <td bgcolor="#FFFFFF">
                                            <select name="lstVendor<%= i %>" size="1" class="smallselect" id="ItemVendor" style="width: 130">
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                            <input name="txtCostDesc<%= i %>" type="text" class="d_shorttextfield" id="ItemCostDesc"
                                    ...
                                    <tr bgcolor="#F3f3f3">
                                        ...
                                        <td>
                                            <input name="txtTotalAmount" type="text" class="numberaligh" value="<%= formatNumberPlus(vTotalAmount,2) %>"
                                                size="12" style="behavior: url(../include/igNumDotChkLeft.htc)" /></td>
                                        <td>
                                    ...
                                    <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="48%" align="center" valign="middle">
                                                <img height="18" name="bSave" onclick="if(CheckIfANExist()==true) {SaveClick('<%= TranNo %>','no')}"
                                                    src="../images/button_save_medium.gif" style="cursor: hand" width="46"></td>
                                            <td width="13%" align="right" valign="middle">
                                                <img style="cursor: hand" onclick="AddHAWB()" src="/iff_main/ASP/Images/button_new.gif"
                                                    width="42" height="17"></td>
                                            <td width="13%" align="right" valign="middle">
                                                <img style="cursor: hand; visibility: <%=vArApLock %>" src="/iff_main/Images/button_delete_medium.gif"
                                                    onclick="DeleteHAWB()"></td>
                                        </tr>
        ...
        <table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr>
                <td colspan="4" width="40%" height="32" align="right" valign="bottom">
                    <div id="print">
                        <img src="/iff_main/ASP/Images/icon_printer.gif"><a href="javascript:;" onclick="if(CheckIfANExist()==true) { SaveClick('<%= TranNo %>','yes') };return false;">Arrival
                            Notice</a><img src="/iff_main/ASP/Images/button_devider.gif"><a href="javascript:;"
                                onclick="if(CheckIfANExist()==true) {SaveClick2('<%= TranNo %>','yes')};return false;">Arrival
                                Notice & Freight Invoice</a><img src="/iff_main/ASP/Images/button_devider.gif"><a
                                    href="javascript:;" onclick="SaveClick3('<%= TranNo %>');return false;">Release
...
<script type="text/vbscript">
    ...
    Sub lstMAWBChange_ocean(mawb)   

	    Dim aVal
	    tmpInfo=get_arrival_mawb_info( mawb,"O" ) 
	    aVal=split(tmpInfo,"^")
    ...
    // Consignee Assignement disabled by Joon July 22 2008
    //ConsigneeExist="<%= ConsigneeExist %>"
    //if ConsigneeExist="N" then
	//    ok=MsgBox ("The CONSIGNEE doesn't exist. Would you like to create it?" & chr(13) & "Yes?",36,"Message")
	//    if ok=6 then	
    ...
    if "<%= Save %>"="yes" then
        ItemNo=document.form1.hItemNo.Value
    if Not ItemNo="" then
	    ItemNo=cInt(ItemNo)
    else
	    ItemNo=0
    ...
    HAWBChgWT=1
    HAWBFreight=1
    Shipper=document.form1.txtShipperInfo.Value
    pos=0
    pos=instr(Shipper,chr(10))
    if pos>0 then Shipper=Mid(Shipper,1,pos-1)
        Consignee=document.form1.txtConsigneeInfo.Value
        pos=0
        pos=instr(Consignee,chr(10))
    if pos>0 then Consignee=Mid(Consignee,1,pos-1)
        Notify=document.form1.txtNotifyInfo.Value
        pos=0
        pos=instr(Notify,chr(10))
    if pos>0 then Notify=Mid(Notify,1,pos-1)
        Pieces=document.form1.txtPCS.Value
        Desc=document.form1.txtDesc3.Value
        GrossWT=document.form1.txtGrossWT.Value
        ChgWT=document.form1.txtChgWT.Value
        OFTotal=document.form1.txtTotalFC.Value
        if Not self.opener.closed then
...
// modified by Joon on 10-12-2007 yes -> no requested by jonathan
	dim apLock
	apLock = "<%=vApLock %>"
    if apLock and PrintOK="yes" then
        PrintClick2("no")
	    exit sub 
    end if 

    lock="<%=vArApLock %>"
    if lock <> "Visible" and PrintOK="yes" then
    ...
    If document.form1.hConsigneeAcct.Value = "" Or document.form1.hConsigneeAcct.Value = "0" Then
    ...
    if MAWB="" then 
	    MsgBox "Please select a Master Bill of Lading!"
	    exit Sub
    end if


    PickupDate=document.form1.txtPickupDate.Value

    if Not PickupDate="" then

	    if Not IsDate(PickupDate) then
		    MsgBox "Please enter a correct Date for Pickup (MM/DD/YYYY)"
		    exit Sub
	    end if
    ...
    if NoItem ="" then 
     ...
     NoCostItem=document.form1.hNoCostItem.Value
    if NoCostItem ="" then 
        NoCostItem=0
    ...
    for j=1 to NoItem
	    ...
	    oAmt=document.all("ItemAmount").item(j).value
	    if oAmt="" then oAmt=0
	    oItem=document.all("InvoiceItem").item(j).Value
	    if Not IsNumeric(oAmt) then
		    MsgBox "Please enter a Numeric Value for AMOUNT!"
		    exit Sub
	    end if
	    if not oAmt=0 and oItem="" then
		    MsgBox "Please select an Charge Item!"
		    Exit Sub
	    end if
    next
    ...
    for j=1 to NoCostItem
	    oCost=document.all("ItemCost").item(j).value
	    if oCost="" then oCost=0
	    oItem=document.all("InvoiceCostItem").item(j).Value
	    oVendor=document.all("ItemVendor").item(j).value
	    if Not IsNumeric(oCost) then
		    MsgBox "Please enter a Numeric Value for COST!"
		    exit Sub
	    end if
	    if not oCost=0 and oItem="" then
		    MsgBox "Please select an Cost Item!"
		    Exit Sub
	    end if
	...
	document.form1.action = encodeURI("arrival_notice.asp?"&"NoItem="&NoItem&"&NoCostItem="&NoCostItem&"&iType=O&tNo=" & "<%=TranNo%>" & "&Save=yes&Print=" & PrintOK)
...
Sub SaveClick3(TranNo)
	...
	document.form1.action=encodeURI("arrival_notice.asp?"&"NoItem="&NoItem&"&NoCostItem="&NoCostItem&"&iType=O&tNo=" & "<%=TranNo%>" & "&Save=yes&Auth=yes")
	document.form1.method="POST"
	document.form1.target="_self"
...
iType="<%= iType %>"
ok=MsgBox ("Do you really want to delete this item?" & chr(13) & "Continue?",36,"Message")
if ok=6 then	
...
if sIndex=1 then
	window.open "../acct_tasks/edit_ch_items.asp" ,"PopupWin", "<%=StrWindow %>"
else
	pos=0
...
Sub AmountChange(ItemNo)
	NoItem=Cint(document.form1.hNoItem.Value)
	
	//-------------------------------------------------------
	dim tAmount
	tAmount=0
	FCAmount=document.form1.txtTotalFC.Value
	if FCAmount="" or IsNumeric(FCAmount)=false  then 
		document.form1.txtTotalFC.Value=0
	else 
		FCAmount=cdbl(FCAmount)
	end if 
	//---------------------------------------------------------
	if cInt(NoItem)>0 then
		if (ItemNo<>1000)then 
			if IsNumeric(tAmount)=false then
				MsgBox "Please enter a numeric number!"
				document.all("ItemAmount").item(ItemNo).Value=0
				exit Sub
			end if
			tAmount=document.all("ItemAmount").item(ItemNo).Value
		else
			
		end if 
		TotalAmount=0
		for j=0 to NoItem
			Amount=document.all("ItemAmount").item(j).Value
			if Amount="" then
				Amount=0
			else
				Amount=cdbl(Amount)
		...
		next
			collect=document.form1.hIsCollect.Value
		if (collect="Y")then 	
		document.form1.txtTotalAmount.Value=formatNumber(TotalAmount+FCAmount,2,,,0)
		else 
		document.form1.txtTotalAmount.Value=formatNumber(TotalAmount+0,2,,,0)
		end if
	
	end if
End Sub

Sub FindByInvoiceNo(txtBox)
	iType="O"
	InvoiceNo=document.getElementById(txtBox).value
	if InvoiceNo="" or not IsNumeric(InvoiceNo) then 
	    msgbox "Please enter a numeric value!"
        exit sub
    end if 
	//if Window.event.Keycode=13 then
		document.form1.action=encodeURI("arrival_notice.asp?iType=" & "O" & "&tNo=" & "<%=TranNo%>" & "&Search=yes&InvoiceNo=" & InvoiceNo)
		document.form1.method="POST"
		document.form1.target="_self"
		form1.Submit()
	//end if
...
AgentOrgAcct=document.form1.hAgentOrgAcct.Value
	...
	document.form1.action=encodeURI("AuthorityMakeEntry_pdf.asp?iType=" & iType & "&HAWB=" & HAWB&"&invoice_no=<%=InvoiceNo%>"& "&Sec=" & Sec & "&AgentOrgAcct=" & AgentOrgAcct)
	document.form1.method="POST"
	document.form1.target="_self"
	form1.Submit()
...
Sub PrePaidSelected()
    ...
    document.form1.rdPrepaid.Checked="Checked"  
	document.form1.hIsCollect.Value="N"
End Sub

Sub FCCollected()
    document.form1.rdCollect.Checked="Checked"
...
Sub DeleteHAWB()
    dim InvoiceNo, HAWB, MAWB
    InvoiceNo="<%=InvoiceNo%>"
    HAWB="<%=vHAWB %>"
    MAWB="<%=vMAWB %>"
	ok=MsgBox ("Are you sure you want to delete this Arrival Notice?" & chr(13) & "Continue?",36,"Message")
	if ok=6 then      
...
function CheckIfANExist(){ 
	 ...
	 {     
            ...
            req.open("get",encodeURI("../ajaxFunctions/ajax_CheckIfANExist.asp?MAWB="+MAWB+"&HAWB="+HAWB+"&Sec="+vSec+"&iType="+iType+"&elt_account_number="+"<%=elt_account_number%>"),false);
	        req.send(); 
