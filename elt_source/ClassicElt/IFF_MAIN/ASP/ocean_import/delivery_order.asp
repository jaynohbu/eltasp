    ...
    <script type="text/javascript" language="javascript">
        ...
        function saveForm(){
            try{
                ...
                var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_delivery_order.asp?mode=update&type=" + typeValue
                    + "&import=O&" + noValue;
        ...
        <div class="selectarea">
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="36%" rowspan="2" align="right" valign="bottom"><div id="print"> <img src="/iff_main/ASP/Images/icon_printer.gif" align="absbottom"><a href="javascript:;"
                                    ...
                                    <tr align="center">
                                        <td valign="middle" bgcolor="#f3f3f3" class="bodycopy">
                                            ...
                                            <table class="bodycopy" width="86%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="57%" height="28" align="left" valign="middle"><label id="txtFileNameLabel"> <strong><span class="bodyheader"><img src="/iff_main/ASP/Images/required.gif" align="absmiddle"></span>File Name&nbsp;<span class="bodyheader style6 style12">
                                                    <input type="text" id="txtFileName" name="txtFileName" size="32" class="bodyheader"
                                                            value="" />
                                                    </span></strong></label></td>
                                                    <td width="43%" align="right" valign="middle"><span class="bodyheader"><img src="/iff_main/ASP/Images/required.gif" align="absbottom">Required field</span></td>
                                                </tr>
                                            </table>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-right: #909EB0 solid 1px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="78%" height="18" bgcolor="#f3f3f3" class="bodyheader">
                                                                    <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Pickup From                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td height="18" bgcolor="#f3f3f3" class="bodyheader">
                                                                    <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Consignee                                                                </td>
                                                                <td bgcolor="#f3f3f3">&nbsp;                                                                    </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="#FFFFFF">&nbsp;                                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td height="8" bgcolor="#FFFFFF"></td>
                                                                <td colspan="2" bgcolor="#FFFFFF"><textarea name="txtHandling" wrap="hard" cols="50" rows="3" style="width: 280px"
                                                    ...
                                                    <td width="48%" valign="top" bgcolor="#FFFFFF" class="bodycopy">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td bgcolor="#FFFFFF">
                                                                    <input name="txtRefNoOur" type="text" class="m_shorttextfield" maxlength="32" value="" style="width: 140px" /></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td bgcolor="#FFFFFF">
                                                                    <span class="bodylistheader">
                                                                        <input name="txtEntryBilling" type="text" maxlength="32" class="shorttextfield" value="" style="width: 140px" />
                                                                    </span>                                                                </td>
                                                                <td bgcolor="#FFFFFF">
                                                                    <span class="bodylistheader">
                                                                        <input name="txtSubHAWB" type="text" maxlength="32" class="shorttextfield" value="" style="width: 140px" />
                                                                    </span>                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td bgcolor="#f3f3f3">&nbsp;                                                                    </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2" bgcolor="#FFFFFF"><span class="bodylistheader">
                                                                    <input name="txtCustomerRef" type="text" maxlength="32" class="shorttextfield" value="" style="width: 140px" />
                                                                </span></td>
                                                            </tr>
															<tr>
                                                                <td height="8px" colspan="3"></td>
                                            ...
                                            <table width="86%" border="0" cellpadding="2" cellspacing="0" bordercolor="#909EB0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        ...
                                                        <input name="txtGrossWt" type="text" class="shorttextfield" style="behavior: url(../include/igNumDotChkLeft.htc)" onkeydown="resetWeight()"
                                                            value="" size="13" /></td>
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
