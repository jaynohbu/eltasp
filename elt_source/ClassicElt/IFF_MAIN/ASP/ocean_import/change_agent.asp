...
<head>
    <title>Change Ocean Import Agent</title>
                    ...
                    <tr>
                        <td>
                            <input type="text" autocomplete="off" id="lstAgentName" name="lstAgentName" value=""
                                ...
                                border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="organizationFill(this,'Agent','lstAgentNameChange',130)"
                                onfocus="initializeJPEDField(this,'fixed');" /></td>
                        <td>
                            <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstAgentName','Agent','lstAgentNameChange',130)"
