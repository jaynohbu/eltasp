                            ...
                            <td height="24" colspan="14" align="center" valign="middle" bgcolor="#CFD6DF" class="bodyheader">
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="26%">
                                            <span class="bodycopy">
                                                <img src="/iff_main/ASP/Images/spacer.gif" width="75" height="5"></span>
                                        </td>
                                        ...
                                        <td width="13%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/ocean_import/ocean_import2.asp" target="_self">
                                ...
                                <table width="75%" border="0" cellpadding="2" cellspacing="0" bordercolor="909EB0"
                                    ...
                                    <tr bgcolor="#CFD6DF">
                                        ...
                                        <td height="20" align="left" valign="middle" class="bodyheader style5">
                                            <span class="bodyheader style1">
                                                <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Master B/L No.</span></td>
                                        <td>
                                    ...
                                    <tr bgcolor="#F3f3f3">
                                        ...
                                        <td width="201" align="left" valign="middle" bgcolor="#F3f3f3" class="bodyheader style5">
                                            <img src="/iff_main/ASP/Images/required.gif" align="absbottom">Agent</td>
                                        <td align="left" valign="middle">
                                        </td>
                                    </tr>
                                    <tr bgcolor="#FFFFFF">
                                    ...
                                    <table id="tblChargeCost" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr bgcolor="#FFFFFF">
                                            <td height="20" class="bodycopy">
                                                &nbsp;</td>
                                            <td class="bodycopy">
                                                <input name="txtAgentDebitNo" type="text" maxlength="32" class='shorttextfield' value="<%= vAgentDebitNo %>"
                                                    size="16"></td>
                                            <td class="bodycopy">
                                                &nbsp;</td>
                                            <td class="bodycopy">
                            ...
                            <tr align="center" bgcolor="CFD6DF">
                                <td height="22" colspan="14" valign="middle" class="bodycopy">
                                    <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="26%">
                                                <img src="/iff_main/ASP/Images/spacer.gif" width="75" height="5">
                                            </td>
                                            <td width="48%" align="center" valign="middle">
                                                <img height="18" style="cursor: hand" onclick="if(CheckIfMBExist()){ SaveClick();}"
...
// ----------------------------------------------------
	...
	If Document.form1.hFFAgentAcct.value = "0" Or Document.form1.hFFAgentAcct.value = "" Then
...
Sub DeleteHAWB(Invoice_no,ItemNo)
    ok=MsgBox ("Are you sure you want to delete this HBOL?" & chr(13) & "Continue?",36,"Message")
...
//	document.form1.txtAgentDebitAmt.Value=formatNumber(TotalCost,2,,,0)
End Sub
//------------------------------------------------------------------------------------
...
function CheckIfMBExist(){ 
    ...
    {   
        ...
        req.open("get", encodeURI("../ajaxFunctions/ajax_CheckIfMBExist.asp?MAWB="+MAWB+"&iType="+iType), false);
        req.send(); 
