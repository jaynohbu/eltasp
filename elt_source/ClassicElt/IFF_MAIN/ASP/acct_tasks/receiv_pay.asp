                                        ...
                                        <td height="20" bgcolor="#FFFFFF" class="bodyheader">
                                            ...
                                            <div id="CustomerContainer">
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td>
                                                            <input type="text" autocomplete="off" id="lstThirdParty" name="lstThirdParty"
                                                                value="<%=ThirdPartyName %>" class="shorttextfield" style="width: 285px; border-top: 1px solid #7F9DB9;
                                                                border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;"
                                                                onkeyup="organizationFill(this,'Customer','lstThirdPartyChange')" onfocus="initializeJPEDField(this);" /></td>
                                                        <td>
                                                            <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstThirdParty','Customer','lstThirdPartyChange')"
                                                                style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                                                border-left: 0px solid #7F9DB9; cursor: hand;" /></td>
                                                    </tr>
                                                </table>
				...
				<% End If %>
                        ...
                        <tr align="left" valign="middle" bgcolor="#FFFFFF">
                            <td align="center" valign="middle" bgcolor="#E7F0E2" class="bodycopy">
                                <input type="checkbox" name="cApplyCredit" value="N" onclick="ApplyCredit()" <% if PaymentNo <> 0 then %>disabled="disabled"<% End If %> />
                                </td>
