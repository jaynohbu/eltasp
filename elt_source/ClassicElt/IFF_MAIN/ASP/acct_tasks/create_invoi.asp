...
<%
    ...
    Do While Not rs.EOF And tIndex<1024
	    ...
	    If vAirOcean="AIR" Then
		    aHAWBLink(tIndex)="../air_export/new_edit_hawb.asp?Edit=yes&HAWB=" & aHAWB(tIndex)
		    If aHAWB(tIndex)="CONSOLIDATION" Then
			    aHAWBLink(tIndex)=""			
		    End if 	
		    aMAWBLink(tIndex)="../air_export/new_edit_mawb.asp?Edit=yes&MAWB=" & aMAWB(tIndex)
	    Elseif vAirOcean="Ocean" Then
		    If aHAWB(tIndex)="CONSOLIDATION" Then
			    aHAWBLink(tIndex)=""
			    aHAWB(tIndex)="CONSOLIDATION"
		    End If	
		    aMAWBLink(tIndex)="../ocean_export/new_edit_mbol.asp?Edit=yes&BookingNum=" & aMAWB(tIndex)
		    aHAWBLink(tIndex)="../ocean_export/new_edit_hbol.asp?Edit=yes&hbol=" & aHAWB(tIndex)
	    Elseif vAirOcean = "Domestic" Then
	        If aHAWB(tIndex)="CONSOLIDATION" Then
			    aHAWBLink(tIndex)=""
			    aHAWB(tIndex)="CONSOLIDATION"
		    End If 
	        aHAWBLink(tIndex)="../domestic/new_edit_hawb.asp?mode=search&HAWB=" & aHAWB(tIndex)
		    aMAWBLink(tIndex)="../domestic/new_edit_mawb.asp?mode=search&MAWB=" & aMAWB(tIndex)
	    End If
...
<body link="#336699" vlink="#336699" style="margin: 0px 0px 0px 0px;" onload="self.focus()">
    ...
    <form id="form1" name="form1" method="post" action="">
        ...
        <div style="text-align: center">
            <table width="95%" border="0" cellpadding="0" cellspacing="0" style="background-color: #89A979;
                text-align: left">
                <tr>
                    <td>
                        <table border="0" cellpadding="2" cellspacing="1" class="gridViewTable">
                            ...
                            <tr align="left" valign="middle" style="background-color: #E7F0E2; height: 22px"
                                class="bodyheader">
                                <td>
                                    <span class="style1">HAWB </span>/ <span class="style1">House B/L</span></td>
                                <td class="bodyheader">
