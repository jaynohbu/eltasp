...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function saveForm(){
            ...
            var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_pickup_order.asp?mode=update&type=" + typeValue
        ...
        function deleteThis()
        {
            ...
            if(noValue > 0){
                ...
                try{
                    ...
                    var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_pickup_order.asp?mode=delete&type=" 
    ...
    <script type="text/javascript">
        ...
        function searchNumFill(obj,changeFunction,vHeight){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                url = "/IFF_MAIN/asp/ajaxFunctions/ajax_pickup_order.asp?mode=list&qStr=" + qStr;
        ...
        function searchNumFillAll(objName,changeFunction,vHeight){
            ...
            url = "/IFF_MAIN/asp/ajaxFunctions/ajax_pickup_order.asp?mode=list&qStr=";
            FillOutJPED(obj,url,changeFunction,vHeight);
        }
        ...
        function lstSearchNumChange(argV,argL){
            ...
            var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_pickup_order.asp?mode=view&no=" + encodeURIComponent(argV);
        ...
        function getOrganizationInfo(orgNum,infoFormat){
            ...
            var url="../ajaxFunctions/ajax_get_org_address_info.asp?type=" + infoFormat + "&org=" + encodeURIComponent(orgNum);
        ...
        function CreateBill(){
            ...
            if(resVal){
                if(resVal[0] == "air_house"){
                    ...
                    window.location.href = "../air_export/new_edit_hawb.asp?DataTransfer=PO&PONum=" + document.getElementById("txtPickupNumber").value;
                }
                if(resVal[0] == "air_master"){
                    parent.document.frames['topFrame'].changeTopModule("International");
                    window.location.href = "../air_export/new_edit_mawb.asp?fBook=yes&Edit=yes&MAWB=" + resVal[1] + "&DataTransfer=PO&PONum=" + document.getElementById("txtPickupNumber").value;
                }
                if(resVal[0] == "ocean_house"){
                    parent.document.frames['topFrame'].changeTopModule("International");
                    window.location.href = "../ocean_export/new_edit_hbol.asp?DataTransfer=PO&PONum=" + document.getElementById("txtPickupNumber").value;
                }
                if(resVal[0] == "ocean_master"){
                    parent.document.frames['topFrame'].changeTopModule("International");
                    window.location.href = "../ocean_export/new_edit_mbol.asp?ChangeBookingNum=yes&Edit=yes&BookingNum=" + resVal[1] + "&DataTransfer=PO&PONum=" + document.getElementById("txtPickupNumber").value;
                }
                if(resVal[0] == "domestic_house"){
                    parent.document.frames['topFrame'].changeTopModule("Domestic");
                    window.location.href = "../domestic/new_edit_hawb.asp?mode=transfer&PONum=" + document.getElementById("txtPickupNumber").value;
                }
            }
        }
...
<body onbeforeunload="navigateAway();" onload="bodyLoad();">
                    ...
                    <td width="55%" rowspan="2" align="right" valign="bottom">
                        <div id="print">
                            <a href="javascript:CreateBill();">
                                <img src="/iff_main/ASP/Images/icon_createhouse.gif" alt="" width="25" height="26"
                            ...
                            <a href="/IFF_MAIN/ASPX/WMS/PickupOrderManager.aspx">
                                <img src="/iff_main/ASP/Images/icon_detailwindow.gif" alt="" style="margin-right: 10px" />Pickup
                                Order List</a>
                            <img src="/iff_main/ASP/Images/button_devider.gif" alt="" />
                            <a href="javascript:;" onclick="viewPDF(); return false;" style="cursor: pointer;">
                                <img src="/iff_main/ASP/Images/icon_printer.gif" alt="" />Pickup Order</a>
                        </div>
                    </td>
                </tr>
                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="13%" align="right" valign="middle">
                                                        <a href="pickup_order.asp" tabindex="-1">
                                                            <img src="/iff_main/ASP/Images/button_new.gif" border="0" style="cursor: pointer"></a></td>
                                                    <td width="13%" align="right" valign="middle">
                                        ...
                                        <td valign="middle" class="bodycopy">
                                                    ...
                                                    <td width="47%" height="19" colspan="2" valign="top">
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-right: #9e816e solid 1px">
                                                            <tr>
                                                                ...
                                                                <td height="20" colspan="2" align="center" valign="middle" bgcolor="#f4e9e0">
                                                                    <span class="bodyheader style6 style12">
                                                                        <img src="/iff_main/ASP/Images/required.gif" align="absbottom">PICKUP FROM </span>
                                                                </td>
                                                            </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text" autocomplete="off" id="lstPickupName" name="lstPickupName" value=""
                                                                                    ...
                                                                                    border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="organizationFill(this,'Pickup','lstPickupNameChange')"
                                                                                    onfocus="initializeJPEDField(this);" /></td>
                                                                            <td>
                                                                                <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstPickupName','Pickup','lstPickupNameChange')"
                                                                                    style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                                                                    border-left: 0px solid #7F9DB9; cursor: hand;" /></td>
                                                                            <td>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <input type="text" autocomplete="off" id="lstCarrierName" name="lstCarrierName" value=""
                                                                                    class="shorttextfield" style="width: 285px; border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9;
                                                                                    border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="organizationFill(this,'','lstCarrierNameChange')"
                                                                                    onfocus="initializeJPEDField(this);" /></td>
                                                                            <td>
                                                                                <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstCarrierName','','lstCarrierNameChange')"
                                                                                    style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                                                                    border-left: 0px solid #7F9DB9; cursor: hand;" /></td>
                                                                            <td>
                                                                                <img src="/ig_common/Images/combobox_addnew.gif" alt="" border="0" style="cursor: hand"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="bodycopy">
                                                                    <input name="txtMAWB" type="text" maxlength="32" class="shorttextfield" value=""
                                                                        style="width: 140px" /></td>
                                                                <td class="bodycopy">
                                                                    <input name="txtHAWB" type="text" maxlength="32" class="shorttextfield" value=""
                                                                        style="width: 140px" /></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="bodycopy">
                                                                    <span class="bodylistheader">
                                                                        <input name="txtEntryBilling" type="text" maxlength="32" class="shorttextfield" value=""
                                                                            style="width: 140px" />
                                                                    </span>
                                                                </td>
                                                                <td height="8" class="bodycopy">
                                                                    <span class="bodylistheader">
                                                                        <input name="txtSubHAWB" type="text" maxlength="32" class="shorttextfield" value=""
                                                                            style="width: 140px" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="bodycopy">
                                                                    ...
                                                                    <span style="width: 100px">
                                                                        <input name="txtDepDate" type="hidden" class="m_shorttextfield" value="" size="13"
                                                                            preset="shortdate" />
                                                                    </span>
                                                                </td>
                                                                <td height="8" class="bodycopy">
                                                    ...
                                                    <td width="53%" valign="top">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="bodyheader">
                                                                        <input name="txtPickupNumber" type="text" class="readonlybold" value="" size="20"
                                                                            readonly="readonly" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="bodyheader" style="height: 20px">
                                                                    <span class="bodylistheader">
                                                                        <input name="txtCustomerRef" type="text" maxlength="32" class="shorttextfield" value=""
                                            ...
                                            <table width="86%" border="0" cellpadding="2" cellspacing="0" bordercolor="#9e816e"
                                                ...
                                                <tr bgcolor="#f4e9e0">
                                                    ...
                                                    <td bgcolor="#f4e9e0">
                                                        <img src="/iff_main/ASP/Images/required.gif" align="absbottom">
                                            ...
                                            <table width="86%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="30" align="right" valign="middle">
                                                        ...
                                                        <input name="txtEmployee" type="text" class="shorttextfield" value="" size="32" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                ...
                <td height="32" align="right" valign="bottom">
                    <div id="print">
                        <a href="javascript:;" onclick="viewPDF();" style="cursor: hand;">
                            <img src="/iff_main/ASP/Images/icon_printer.gif" align="absbottom">Pickup Order
                            Form</a></div>
                </td>
            </tr>
        </table>
