        ...
        <table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr>
                ...
                <td width="67%" height="20" align="right" valign="bottom" class="bodycopy">
                    <a href="../Code/DOMESTIC_PORT_CODE.xls" target='mainFrame' class="style1">Domestic
                        Port ID Lookup</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                            href="../Code/FOREIGN_PORT_CODE.xls" target='mainFrame' class="style1">Foreign Port
                            ID Lookup</a></td>
            </tr>
        </table>
                        ...
                        <tr>
                            ...
                            <td bgcolor="f3f3f3">
                                <input type="text" class="shorttextfield" id="txtPortDesc" maxlength="50" name="txtPortDesc"
                                    size="35" value=""></td>
                            <td bgcolor="f3f3f3">
                                <input type="text" class="shorttextfield" id="txtPortID" maxlength="50" name="txtPortID"
