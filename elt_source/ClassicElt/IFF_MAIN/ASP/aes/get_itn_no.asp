...
<%
    ...
    returnURL = "http://" & server_name & "/IFF_MAIN/ASP/aes/set_itn_no.asp"
    '// Remove this before publishing
    Dim server_port
    server_port = request.ServerVariables("SERVER_PORT")
    If server_port <> "80" Then
        returnURL = "http://" & server_name & ":" & server_port & "/IFF_MAIN/ASP/aes/set_itn_no.asp"
    End If
    ...
    Function  GetSEDTable(uid)
        ...
        SQL = "SELECT * FROM sed_master WHERE elt_account_number=" & elt_account_number & " AND auto_uid=" & uid
