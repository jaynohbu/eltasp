...
<%
	...
	Sub SELECT_LOGO
        If vTopModule = "Domestic" Then
            vLogoURL = "/iff_main/ASP/Images/logo_FEdomestic.gif"
        Elseif vTopModule = "International" Then
            vLogoURL = "/iff_main/ASP/Images/logo_FEintl.gif"
        Else
            vLogoURL = "/iff_main/ASP/Images/logo_FE.gif"
        End If
	End Sub
...
<body onload="makePageLabels(); PageLevelChange('<%=vPageURL %>',null,'load'); MM_preloadImages('../Images/button_refresh_type_over.gif','../Images/button_logout_type_over.gif'); "
    ...
    <div id="bodyDiv">
        <!-- // MODULE SELECTION // -->
        <div id="moduleSelect">
            <!--<img src="/iff_main/ASP/Images/icon_smodulechange.png" width="29" height="50" />-->
        ...
        <div class="middleLeft" style="text-align: right">
            <img src="/iff_main/ASP/Images/mainnav_back2.gif" alt="" /></div>
        <!-- -------------------------------- -->
