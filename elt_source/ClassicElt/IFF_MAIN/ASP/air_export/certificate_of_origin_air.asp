...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function lstSearchNumChange(argV,argL){
            ...
            var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_certificate_origin.asp?mode=view&type=" 
        ...
        function saveForm()
        {
            try{
                ...
                var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_certificate_origin.asp?mode=update&type=" 
        ...
        function deleteThis()
        {
            ...
            if(typeValue == "none" && noValue != "" && noValue != "Select One")
            {
                ...
                try{
                    ...
                    var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_certificate_origin.asp?mode=delete&type=" 
                        + encodeURIComponent(typeValue) + "&export=A&no=" + encodeURIComponent(noValue);
    ...
    <script type="text/javascript">
        ...
        function searchNumFill(obj,eType,changeFunction,vHeight){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                url = "/IFF_MAIN/asp/ajaxFunctions/ajax_certificate_origin.asp?mode=list&export=" 
        ...
        function searchNumFillAll(objName,eType,changeFunction,vHeight){
            ...
            var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_certificate_origin.asp?mode=list&type=" 
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="36%" rowspan="2" align="right" valign="bottom">
                        <div id="print">
                            <img src="/iff_main/ASP/Images/icon_printer.gif" align="absbottom"><a href="javascript:viewPDF();"
                                            ...
                                            <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="13%" align="right" valign="middle">
                                                        <a href="/iff_main/ASP/air_export/certificate_of_origin_air.asp" target="_self">
                                            ...
                                            <table class="bodycopy" width="82%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="57%" height="28" align="left" valign="middle">
                                                        ...
                                                        <input type="text" name="txtFileName" class="bodyheader" value="" size="28" style="visibility: hidden" /></td>
                                            ...
                                            <table width="82%" border="0" cellpadding="2" cellspacing="0" bordercolor="#A0829C"
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    ...
                                                    <td valign="top" class="bodycopy">
                                                        <input name="txtUpdatedDate" type="text" class="m_shorttextfield" value="" size="20"
                                                            preset="shortdate" /></td>
                                                    <td valign="top">
                                                        <input name="txtDocNum" type="text" class="m_shorttextfield" value="" size="20" /></td>
                                                </tr>
                                                <tr align="left" valign="middle" bgcolor="#f2ecf1" class="bodycopy">
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#f2ecf1" class="bodycopy">
                                                    ...
                                                    <td height="19" bgcolor="#FFFFFF" class="bodycopy">
                                                        <input name="txtMAWBNum" type="text" class="m_shorttextfield" value="" size="20" /></td>
                                                    <td bgcolor="#FFFFFF">
                                                        <input name="txtHAWBNum" type="text" class="m_shorttextfield" value="" size="20" /></td>
                                                </tr>
                                                <tr align="left" valign="middle" bgcolor="#f2ecf1" class="bodycopy">
                                                    <td height="19" bgcolor="#FFFFFF">
                                                        &nbsp;</td>
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    ...
                                                    <td colspan="2" valign="middle" bgcolor="#ffffff">
                                                        <input type="text" name="txtUsState" class="shorttextfield" maxlength="64" value="" />
                                                        <%=agent_country %>
                                                    </td>
                                                </tr>
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    ...
                                                    <td colspan="2" rowspan="3" valign="top" bgcolor="#ffffff">
                                                        <textarea wrap="hard" name="txtExportInstr" cols="50" rows="8" class="multilinetextfield"></textarea></td>
                                                </tr>
                                                <tr align="left" valign="middle" bgcolor="#f2ecf1" class="bodycopy">
                                                    <td height="19">
                                                        &nbsp;
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    ...
                                                    <td class="bodycopy">
                                                        <input type="text" name="txtPreCarriage" class="shorttextfield" maxlength="32" style="width: 150px"
                                                            value="" /></td>
                                                    <td class="bodycopy">
                                                        <input type="text" name="txtPreReceiptPlace" class="shorttextfield" maxlength="32"
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    ...
                                                    <td class="bodycopy">
                                                        <input type="text" name="txtExportCarrier" class="shorttextfield" maxlength="32"
                                                            style="width: 150px" value="" /></td>
                                                    <td class="bodycopy">
                                                        <input type="text" name="txtLoadingPort" class="shorttextfield" maxlength="64" style="width: 200px"
                                                            value="" /></td>
                                                    <td colspan="2" valign="middle">
                                                        <input type="text" name="txtLoadingTerminal" class="m_shorttextfield" preset="maxsize"
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    ...
                                                    <td class="bodycopy">
                                                        <input type="text" name="txtUnloadingPort" class="shorttextfield" maxlength="64"
                                                            style="width: 150px" value="" /></td>
                                                    <td class="bodycopy">
                                                        <input type="text" name="txtDeliveryPlace" class="shorttextfield" maxlength="64"
                                                            style="width: 200px" value="" /></td>
                                                    <td colspan="2" valign="middle">
                                                        <input type="text" name="txtMoveType" style="width: 267px" class="shorttextfield"
                                            ...
                                            <table width="82%" border="0" cellpadding="0" cellspacing="0" bordercolor="#A0829C"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        ...
                                                        <input type="text" name="txtGrossWeight" class="shorttextfield" style="behavior: url(../include/igNumDotChkLeft.htc)"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        ...
                                                        <input type="text" name="txtMeasurement" class="shorttextfield" style="behavior: url(../include/igNumDotChkLeft.htc)"
                                ...
                                <table width="82%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#A0829C"
                                    ...
                                    <tr>
                                        ...
                                        <td width="98%" class="statement">
                                            ...
                                            <input name="txtOriginCountry" value="" type="text" class="shorttextfield" preset="maxsize"
                                                size="42">
                                            dated at
                                                ...
                                                <tr>
                                                    <td width="52%" rowspan="2" class="bodycopy">
                                                        ...
                                                        <input name="txtSwornDate" value="" type="text" class="m_shorttextfield" preset="shortdate"
                                                            size="32">
                                                        <br>
                                                        <input name="txtPrepareBy" type="text" value="" class="m_shorttextfield" preset="maxsize"
                                                            size="59"></td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" autocomplete="off" id="lstFFCounty" name="lstFFCounty" value=""
                                                                        class="shorttextfield" style="width: 285px; border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9;
                                                                        border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;" onkeyup="organizationFill(this,'Government','lstFFCountyChange',100)"
                                                                        onfocus="initializeJPEDField(this);" /></td>
                                                                <td>
                                                                    <img src="/ig_common/Images/combobox_drop.gif" alt="" onclick="organizationFillAll('lstFFCounty','Government','lstFFCountyChange',100)"
                                                                        style="border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-right: 1px solid #7F9DB9;
                                                                        border-left: 0px solid #7F9DB9; cursor: hand" /></td>
                                                                <td>
                                                                    <img src="/ig_common/Images/combobox_addnew.gif" alt="" border="0" style="cursor: hand"
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="32" align="right" valign="bottom">
                    <div id="print">
                        <img src="/iff_main/ASP/Images/icon_printer.gif" width="44" height="27" align="absbottom"><a
