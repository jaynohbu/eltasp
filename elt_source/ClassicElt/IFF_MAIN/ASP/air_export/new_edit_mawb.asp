...
<script type="text/javascript" language="javascript">
    ...
    {
        var url="../../ASPX/AccountingTasks/setDefaultFreight.aspx?air_ocean=air";
    ...
    function GetOtherCurrency(thisObj,objID){
        ...
        var vURL = "/IFF_MAIN/ASP/site_admin/select_currency.asp?code=" + thisObj.value + "&ccode=" + vCountry;
    ...
    Else
        ...
        If NOT rs.EOF AND NOT rs.BOF Then
            If rs("is_inbound") = "Y" Then
                Response.Write("<script> window.location.href='/IFF_MAIN/ASP/domestic/inbound_alert.asp?mode=edit&MAWB=" & Server.URLEncode(vMAWB) & "'; </script>")    
            Else
                If rs(0).value = "DG" Then
                    Response.Write("<script> window.location.href='/IFF_MAIN/ASP/domestic/new_mawb_ground.asp?mode=edit&MAWB=" & Server.URLEncode(vMAWB) & "'; </script>")    
                Elseif rs(0).value = "DA" Then
                    Response.Write("<script> window.location.href='/IFF_MAIN/ASP/domestic/new_edit_mawb.asp?Edit=yes&MAWB=" & Server.URLEncode(vMAWB) & "'; </script>")    
                End If
            End If
            rs.close()
            Response.End()
...
<script type="text/jscript"> alert('Could not find the MAWB'); history.go(-1); </script>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function lstShipperNameChange(orgNum,orgName)
        {
            ...
            document.getElementById("txtSignature").value = "AS AGENT FOR " + orgName ;
        ...
        function getIATARate(index ){
            ...
            if (req) {
                ...
                req.open("GET","../ajaxFunctions/ajax_iata_rate.asp?Unit=" 
		...
		try {    
				xmlHTTP.open("GET","../ajaxFunctions/ajax_iata_rate.asp?Unit="+ Unit+ "&airline="+ airline+"&arp="+arp+"&dep="+dep+"&wgt="+wgt, false);	
				xmlHTTP.send(); 		
		...
		*/
        ...
        function getAirLineBuyingRate(){
            ...
            var xmlHTTP;		
                ...
                try {    
                        xmlHTTP.open("GET","../ajaxFunctions/ajax_airline_rate.asp?Unit="+ Unit+ "&airline="+ airline+"&arp="+arp+"&dep="+dep+"&wgt="+wgt, false);	
                        xmlHTTP.send(); 		
                        var result = xmlHTTP.responseText;	
                        var numericVar=parseFloat(result);
        ...
        function SetCostItems(){
            var vURL = "./new_edit_mawb_cost_items.asp?MAWB=" + encodeURIComponent(document.getElementById("hmawb_num").value);
        ...
        function SetCreditNote(){
            ...
            var vWinArg = "dialogWidth:600px; dialogHeight:400px; help:no; status:no; scroll:yes; center:yes";
            var vReturn = showModalDialog("../acct_tasks/credit_note_list.asp?TYPE=A&MAWB=" + encodeURIComponent(document.getElementById("hmawb_num").value) + "&HAWB=");

            if(vReturn >= 0){
                try{parent.document.frames['topFrame'].changeTopModule("Accounting");}catch(err){}
                if(vReturn == 0){
                    window.location.href = "../acct_tasks/edit_credit_note.asp?new=yes&MoveType=AIR&MasterOnly=Y&InvType=Agent&AgentID=" + document.getElementById("hShipperAcct").value + "&MAWB=" + encodeURIComponent(document.getElementById("hmawb_num").value) + "&HAWB=";
                }
                else{
...
<body link="336699" vlink="336699" leftmargin="0" topmargin="0" onload="initCollapsingRows(); <% If NOT chkAvailTab Then Response.write("toggleVisibility('nothing')") ELSE Response.write("expanded('toggleButton')")%>; self.focus(); scrollToObj('<%=Request.QueryString.Item("focus") %>');">
    ...
    <form method="post" name="frmMAWB">
        ...
        <table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
            <tr>
                <td width="46%" height="32" align="left" valign="middle" class="pageheader">New/Edit MASTER AIR WAYBILL (MAWB)</td>
                <td width="54%" align="right" valign="middle">
                    <span class="bodyheader style5">FILE NO.</span><input name="txtJobNum" type="text"
                        ...
                        onclick="javascript: this.value = ''; this.style.color='#000000'; "><img src="../images/icon_search.gif"
                            name="B1" width="33" height="27" align="absmiddle" style="cursor: hand" onclick="lookupFile()"></td>
            </tr>
        </table>
        <div class="selectarea">
            <table width="95%" height="40" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="45%" class="select">Select Master AWB No.
                    </td>
                    <td width="55%" rowspan="2" align="right" valign="bottom">
                        ...
                        <div id="print">
                            ...
                            <img src="/iff_main/ASP/Images/button_devider.gif" alt="" />
                            <img src="/iff_main/ASP/Images/icon_printer_preview.gif" align="absbottom" alt="" /><a
                                href="javascript:;" onclick="NewPrintVeiw();return false;">Master Air Waybill</a>
                        </div>
                        <% End If %>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <script language="javascript"> function <%=iMoonComboBoxName%>_OnChangePlus() {	MAWBChange("new"); } </script>
                        ...
                        <div id="<%=iMoonComboBoxName%>_Container" class="ComboBox" style="width: <%=iMoonComboBoxWidth%>; position: ; top: ; left: ; z-index: ;">
                            ...
                            <div id="<%=iMoonComboBoxName%>_Div" style="display: none; position: absolute; top: 0; left: 0; width: 17px">
                                <img id="<%=iMoonComboBoxName%>_Button" src="/ig_common/Images/combobox_drop.gif"
                                    border="0" />
                            </div>
                        </div>
                        <div id="<%=iMoonComboBoxName%>_NewDiv" style="display: none; position: absolute; top: 0; left: 0; width: 17px">
                            <img id="<%=iMoonComboBoxName%>_AddNewButton" src="/ig_common/Images/combobox_addnew.gif"
                                border="0" />
                        </div>
                        <!-- /End of Combobox/ -->
                        <select name="lstMAWB" id="lstMAWB" class="ComboBox" listsize="20" style="width: 160px; height: 200px; display: none"
                            onchange="ComboBox_SimpleAttach(this, this.form['<%=iMoonComboBoxName%>_Text'])">
                            <% For i=0 to mIndex %>
                ...
                <td>
                                ...
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="10%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/air_export/new_edit_mawb.asp">
                                    ...
                                    <tr>
                                        <td width="52%" align="left" valign="top">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
                                                ...
                                                <tr bgcolor="#f0e7ef">
                                                    <td width="66%" height="18" class="bodyheader">Shipper's Name and Address</td>
                                                    <td width="34%">Shipper's Account No.</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <!-- Start JPED -->
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" autocomplete="off" id="lstShipperName" name="lstShipperName" value="<%=vShipperName %>"
                                                                        class="shorttextfield" style="width: 285px; border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;"
                                                                        onkeyup="organizationFill(this,'Shipper','lstShipperNameChange')"
                                                    ...
                                                    <td valign="top">
                                                        <input name="txtShipperAcct" class="m_shorttextfield" value="<%= vFFShipperAcct %>"
                                                            size="20" preset="maxsize"></td>
                                                </tr>
                                                <tr bgcolor="#f3f3f3">
                                                    <td height="18" class="bodyheader">Consignee's Name</td>
                                                    <td>Consignee's Account No.</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <!-- Start JPED -->
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" autocomplete="off" id="lstConsigneeName" name="lstConsigneeName"
                                                                        value="<%=vConsigneeName %>" class="shorttextfield" style="width: 285px; border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;"
                                                ...
                                                <tr bgcolor="#f3f3f3" class="bodyheader">
                                                    <td height="18">Issuing Carrier's Agent Name and City</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <textarea name="txtAgentInfo" cols="40" rows="3" wrap="hard" class="monotextarea"
                                                            onkeypress="return checkMaxRows(this);"><%= vAgentInfo %></textarea></td>
                                                    <td valign="top">&nbsp;</td>
                                                </tr>
                                                <tr bgcolor="#f3f3f3" class="bodyheader">
                                                    <td height="18">Agent's IATA Code</td>
                                                    <td>Account No.</td>
                                                </tr>
                                                <tr bgcolor="#f3f3f3">
                                                ...
                                                <tr bgcolor="#f3f3f3" class="bodyheader">
                                                    <td height="18" colspan="2">Airport of Departure (Addr. of First Carrier) and Requested Routing</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="bodycopy" style="padding-left: 10px">
                                                            <tr align="left" valign="middle" bgcolor="#f0e7ef">
                                                                <td>&nbsp;</td>
                                                                <td align="center" class="bodycopy">Routing and Destination</td>
                                                                <td colspan="4">&nbsp;</td>
                                                            </tr>
                                                            <tr align="left" valign="middle" bgcolor="#f0e7ef">
                                                                <td width="15%" height="20">&nbsp;<strong>To</strong></td>
                                                                <td width="41%" bgcolor="#f0e7ef">&nbsp;<strong>By First Carrier</strong></td>
                                                                <td width="11%">To</td>
                                                                <td width="11%">By</td>
                                                                <td width="11%">To</td>
                                                                <td width="11%" bgcolor="#f0e7ef">By</td>
                                                            </tr>
                                                            <tr align="left" valign="middle">
                                                                <td>
                                                                    <input name="txtTo" class="shorttextfield" value="<%= vTo %>" size="12" maxlength="8"></td>
                                                                <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="bodycopy" style="padding-left: 10px">
                                                            <tr align="left" valign="middle" bgcolor="#f0e7ef">
                                                                <td>&nbsp;</td>
                                                                <td colspan="2" align="center" bgcolor="#f0e7ef">For Carrier Only</td>
                                                            </tr>
                                                            <tr align="left" valign="middle" bgcolor="#f0e7ef">
                                                                <td height="20">&nbsp;<strong>Airport of Destination</strong><strong></strong></td>
                                        ...
                                        <td width="48%" valign="top">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                                <tr bgcolor="#f0e7ef">
                                                    <td width="50%" height="18" class="bodycopy">Not Negotiable</td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" autocomplete="off" id="lstNotifyName" name="lstNotifyName" value="<%= GetBusinessName(checkBlank(vNotifyAcct,0)) %>"
                                                                        class="shorttextfield" style="width: 285px; border-top: 1px solid #7F9DB9; border-bottom: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px solid #7F9DB9;"
                                                                        onkeyup="organizationFill(this,'Notify','lstNotifyNameChange')"
                                                                        onfocus="initializeJPEDField(this);" /></td>
                                                                <td>
                                                ...
                                                <tr>
                                                    <td height="18" bgcolor="#f3f3f3">
                                                        <strong class="bodyheader">Reference Number</strong></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input type="text" name="txtReferenceNumber" class="shorttextfield" size="27" maxlength="32"
                                                            value="<%=checkBlank(vReferenceNumber,GetFileNumber(vMAWB))%>" /></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                                ...
                                                                <td>
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="bodycopy">
                                                                        <tr align="center" valign="middle">
                                                                            <td bgcolor="#f0e7ef" class="bodycopy">&nbsp;</td>
                                                                            <td bgcolor="#f0e7ef">&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                                        <tr>
                                                                            <td height="20" align="left" valign="middle" bgcolor="#f0e7ef">&nbsp;<strong>Amount of Insurance</strong></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left" valign="middle">
                                                                                <input name="txtInsuranceAmt" class="shorttextfield" value="<%= vInsuranceAMT %>"
                                                                                    size="17" maxlength="16"></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td valign="top">
                            ...
                            <td bgcolor="#FFFFFF">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
                                    ...
                                    <tr>
                                        ...
                                        <td width="35%" bgcolor="#f3f3f3">&nbsp;</td>
                                        <td width="2%" bgcolor="#f3f3f3">&nbsp;</td>
                                        <td width="13%" bgcolor="#f3f3f3">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" align="left" valign="middle">
                                            <textarea name="txtHandlingInfo" id="txtHandlingInfo" cols="70" rows="2" class="monotextarea"
                                                onkeyup="textLimit(this,127);" wrap="HARD"><%= vHandlingInfo %></textarea></td>
                                        <td align="left" valign="top">&nbsp;</td>
                                        <td align="left" valign="top">&nbsp;</td>
                                        <td align="left" valign="bottom">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                                <tr>
                                                    <td height="20" bgcolor="#FFFFFF" class="bodycopy">&nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" rowspan="2" align="left" valign="bottom">These commodities, technology or software exported from
                                            <%=GetAgentCountry() %>
                                            ...
                                            <input name="txtDestCountry" class="m_shorttextfield" value="<%= vDestCountry %>"
                                                size="20" preset="maxsize"></td>
                                        <td rowspan="2" align="right" valign="bottom">Diversion contrary to<br>
                                            U.S. law prohibited.
                                        </td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
                        ...
                        <thead>
                            ...
                            <tr align="left" valign="middle">
                                <th height="1" colspan="13" bgcolor="#FFFFFF"></th>
                            </tr>
                            <tr align="left" bgcolor="#f0e7ef" class="bodyheader">
                                <th width="1"></th>
                                <th width="125" height="20" bgcolor="#f3f3f3">House AWB No.</th>
                                <th width="84" bgcolor="#f3f3f3">Coloadee</th>
                                <th width="196" bgcolor="#f3f3f3">Agent</th>
                                <th width="172" bgcolor="#f3f3f3">Shipper</th>
                                <th width="144" bgcolor="#f3f3f3">Consignee</th>
                                <th width="35" bgcolor="#f3f3f3">Pieces</th>
                                <th width="37" bgcolor="#f3f3f3">GW</th>
                                <th width="39" bgcolor="#f3f3f3">AW</th>
                                <th width="37" bgcolor="#f3f3f3">DW</th>
                                <th width="37" bgcolor="#f3f3f3">CW</th>
                                ...
                                <td width="252" align="left">
                                    <input type="image" src="../images/button_add.gif" width="37" height="17" onclick="AddToHAWB('<%= aHAWB(j) %>',<%= AddELTAcct(j) %>); return false;"
                                        style="cursor: pointer" /><input type="image" src="../images/button_edit.gif" width="37"
                                            ...
                                            style="cursor: pointer; margin-left: 20px" /></td>
                                <% end if %>
                            </tr>
                            <% next %>
                        </tbody>
                    ...
                    <table id="selected_hawb" width="100%" border="0" cellpadding="1" cellspacing="0"
                        ...
                        <tr align="left" valign="middle">
                            <td height="1" colspan="12" bgcolor="#FFFFFF"></td>
                        </tr>
                        <tr>
                            <td width="106" height="20" bgcolor="#f0e7ef">
                                <strong>House AWB No.</strong></td>
                            <td width="19" bgcolor="#f0e7ef">&nbsp;</td>
                            <td width="84" bgcolor="#f0e7ef">
                                <strong>Coloadee</strong></td>
                            ...
                            <td width="79" bgcolor="#f0e7ef">
                                <strong>CW</strong></td>
                            <td width="213" bgcolor="#f0e7ef">&nbsp;</td>
                        </tr>
                        <% for i=0 to sCount-1 %>
                        <tr align="left" valign="middle">
                            <td>
                            ...
                            <td align="center" <% if sIsMaster(i)="Y" then response.Write("style='visibility:visible'") else response.Write("style='visibility:hidden'") end if %>>
                                <img src="../Images/Expand.gif" width="10" height="7" border="0" <% if sHsCount > 0 then response.Write(" style='cursor:hand;visibility:visible'") else response.Write(" style='cursor:hand;visibility:hidden'") end if%>
                                    onclick='toggleSub(this,"<%=sHAWB(i)%>")' /></td>
                            <td>
                            ...
                            <td>
                                <input name="txtsConsignee<%= i %>" type="text" class="d_shorttextfield" value="<%= sConsignee(i) %>"
                                    size="21" readonly="readonly" />
                                <input name="txtWeightTran<%= i %>" type="hidden" value="<%= aWeightTran(i) %>"></td>
                            <td>
                        ...
                        <tr align="left" valign="middle">
                            <td height="1" colspan="12" bgcolor="A0829C"></td>
                        </tr>
                    </table>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
                        ...
                        <tr align="left" valign="middle" bgcolor="#f0e7ef">
                            ...
                            <td height="22" colspan="10" align="center" valign="middle" bgcolor="#E5D4E3">
                                <span class="style6"><strong><font color="c16b42">WEIGHT CHARGE</font></strong></span></td>
                        </tr>
                        <tr align="left" valign="middle">
                            <td height="1" colspan="12" bgcolor="#FFFFFF"></td>
                        </tr>
                        <tr align="left" valign="middle" bgcolor="#f0e7ef" class="bodyheader">
                            <td width="114" height="20" bgcolor="#f3f3f3">No of pieces</td>
                            <td width="114" bgcolor="#f3f3f3">Gross Weight</td>
                            <td width="91" bgcolor="#f3f3f3">KG/LB</td>
                            <td width="114" bgcolor="#f3f3f3">Rate Class</td>
                            <td width="161" bgcolor="#f3f3f3">Commodity Item No.</td>
                            <td width="105" bgcolor="#f3f3f3">Chargeable Weight</td>
                            <td width="117" bgcolor="#f3f3f3">Fetch Rate</td>
                            <td width="102" bgcolor="#f3f3f3">Rate/Charge</td>
                            <td width="62" bgcolor="#f3f3f3">&nbsp;</td>
                            <td width="171" align="left" bgcolor="#f3f3f3">Total</td>
                        </tr>
                        <% for i=0 to wCount-1 %>
                        <tr align="left" valign="middle">
                            <td>
                                <input name="txtPiece<%= i %>" class="shorttextfield" id="Pieces" value="<%= aPiece(i) %>"
                                    size="5" style="behavior: url(../include/igNumDotChkLeft.htc)" maxlength="4">
                            </td>
                            <td>
                                <input name="txtGrossWeight<%= i %>" class="shorttextfield" id="GrossWeight" value="<%=aGrossWeight(i)%>"
                                    size="10" style="behavior: url(../include/igNumDotChkLeft.htc)" maxlength="7">
                            </td>
                            <td>
                                <select id="KgLb" size="1" class="smallselect" name="lstKgLb<%= i %>" onchange="ScaleChange(<%= i %>);">
                            ...
                            <td>
                                <input name="txtChargeableWeight<%= i %>" class="shorttextfield" id="ChargeableWeight"
                                    style="behavior: url(../include/igNumDotChkLeft.htc)" value="<%= aChargeableWeight(i) %>"
                                    size="12" maxlength="7"></td>
                            <td>
                            ...
                            <td>
                                <input name="txtRateCharge<%= i %>" class="shorttextfield" id="RateCharge" style="behavior: url(../include/igNumDotChkLeft.htc)"
                                    value="<% if aRateCharge(i)="0" then response.Write("N/A")else response.Write(aRateCharge(i))end if  %>"
                                    size="12" maxlength="8">
                            </td>
                            <td>
                                <input type="image" src="../images/button_cal.gif" width="37" height="18" name="bCal<%= i %>"
                                    onclick="bCalClick(<%= i %>); return false;" value="Cal" style="cursor: hand"></td>
                            <td width="171" align="left">
                                <input name="txtTotal<%= i %>" style="behavior: url(../include/igNumDotChkLeft.htc)"
                                    class="shorttextfield" id="TotalCharge" value="<%=formatNumber(aTotal(i),2) %>"
                    ...
                    <table id="add_oc" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
                        class="bodycopy">
                        <tr align="left" valign="middle">
                            <td height="1" colspan="10" bgcolor="A0829C"></td>
                        </tr>
                                    ...
                                    <tr id="aRow<%=i %>">
                                        ...
                                        <td>
                                            <select id="ChargeItem" size="1" name="lstChargeCode<%= i %>" onchange="ChargeItemChange(<%= i %>)"
                                                class="smallselect" style="width: 270px">
                        ...
                        <tr align="center" valign="middle">
                            <td width="43%" height="22" align="left" valign="top" bgcolor="#FFFFFF">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                    ...
                                    <tr align="center" valign="middle">
                                        <td colspan="2" bgcolor="#f3f3f3">Weight Charge</td>
                                    </tr>
                                    <tr align="center">
                                        <td>
                                    ...
                                    <tr align="center" valign="middle">
                                        <td colspan="2" bgcolor="#f3f3f3">Valuation Charge</td>
                                    </tr>
                                    <tr align="center">
                                        <td>
                                            <input name="txtPrepaidValuationCharge" class="numberfield" style="behavior: url(../include/igNumDotChkLeft.htc); width: 70px"
                                                value="<%if isnumeric(vPrepaidValuationCharge) then response.Write(formatnumber(vPrepaidValuationCharge,2))else response.Write(vPrepaidValuationCharge) end if   %>"
                                                size="14" maxlength="14"></td>
                                        <td>
                                            <input name="txtCollectValuationCharge" class="numberfield" style="behavior: url(../include/igNumDotChkLeft.htc); width: 70px"
                                                value="<%if isnumeric(vCollectValuationCharge) then response.Write(formatnumber(vCollectValuationCharge,2))else response.Write(vCollectValuationCharge) end if   %>"
                                                size="14" maxlength="14"></td>
                                    </tr>
                                    <tr align="center" valign="middle">
                                        <td colspan="2" bgcolor="#f3f3f3">Tax</td>
                                    </tr>
                                    <tr align="center">
                                        <td>
                                            <input name="txtPrepaidTax" class="numberfield" style="behavior: url(../include/igNumDotChkLeft.htc); width: 70px"
                                                value="<%if isnumeric(vPrepaidTax) then response.Write(formatnumber(vPrepaidTax,2))else response.Write(vPrepaidTax) end if   %>"
                                                size="14" maxlength="14"></td>
                                        <td>
                                            <input name="txtCollectTax" class="numberfield" style="behavior: url(../include/igNumDotChkLeft.htc); width: 70px"
                                                value="<%if isnumeric(vCollectTax) then response.Write(formatnumber(vCollectTax,2))else response.Write(vCollectTax) end if   %>"
                                                size="14" maxlength="14"></td>
                                    </tr>
                                    <tr align="center" valign="middle">
                                        <td colspan="2" bgcolor="#f3f3f3">Total Other Charges Due Agent</td>
                                    </tr>
                                    <tr align="center">
                                        <td>
                                    ...
                                    <tr align="center" valign="middle">
                                        <td colspan="2" bgcolor="#f3f3f3">Total Other Charges Due Carrier</td>
                                    </tr>
                                    <tr align="center">
                                        <td>
                                    ...
                                    <tr align="center">
                                        <td height="20" bgcolor="#f0e7ef">
                                            <strong>Total Prepaid</strong></td>
                                        <td bgcolor="#f0e7ef">
                                    ...
                                    <tr align="center">
                                        <td height="20" bgcolor="#f3f3f3" class="bodyheader">Currency Conversion Rates</td>
                                        <td height="20" align="center" bgcolor="#f3f3f3" class="bodyheader">CC Charges in Dest. Currency</td>
                                    </tr>
                                    <tr align="center">
                                        <td>
                                            <input name="txtConversionRate" class="numberfield" style="behavior: url(../include/igNumDotChkLeft.htc); width: 70px"
                                                value="<%=vConversionRate %>" size="14" maxlength="14"></td>
                                        <td>
                                            <input name="txtCCCharge" class="numberfield" style="behavior: url(../include/igNumDotChkLeft.htc); width: 70px"
                                    ...
                                    <tr align="center">
                                        <td>For Carriers Use only at Destination</td>
                                        <td>
                                            <input name="txtChargeDestination" class="numberfield" style="behavior: url(../include/igNumDotChkLeft.htc); width: 70px"
                                                value="<%if isnumeric(vChargeDestination) then response.Write(formatnumber(vChargeDestination,2))else response.Write(vChargeDestination) end if  %>"
                                                size="14" maxlength="14"></td>
                                    </tr>
                                    <tr align="center">
                                        <td height="18">&nbsp;</td>
                            ...
                            <td width="57%" valign="top" bgcolor="ffffff">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <input name="txtOtherCharge1" class="readonly" value="<%if isnumeric(aOtherCharge(0)) then response.Write(formatnumber(aOtherCharge(0),2))else response.Write(aOtherCharge(0)) end if   %>"
                                                size="75" maxlength="45" readonly="readonly"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td>
                                            <textarea name="txtSignature" cols="50" rows="2" wrap="hard" class="monotextarea"><%= vSignature %></textarea></td>
                                        <td align="left" valign="bottom">
                                            <input type="text" name="txtEmpolyee" class="readonly" readonly="readonly" value="<%=GetUserFLName(user_id) %>" /></td>
                                    </tr>
                                    <tr>
                                        <td>Signature of Shipper or Agent</td>
                                        <td>Prepared by</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <textarea name="txtExecute" cols="50" rows="3" wrap="hard" class="monotextarea"><%= vExecute %></textarea></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" height="1" bgcolor="A0829C"></td>
                        </tr>
                        <tr align="left" valign="middle">
                                    ...
                                    <tr>
                                        ...
                                        <td width="12%" align="right" valign="middle">
                                            <input type="image" src='../images/button_delete_medium.gif' width='51' height='17'
                                                name='bDeleteMAWB' onclick='DeleteMAWB(); return false;' style="cursor: hand"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
...
<script type="text/jscript">
    ...
    function close_mawb(mawb) {
        ...
        var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_mawb_close.asp?n=" + encodeURIComponent(mawb);
...
<script type="text/javascript" src="../ajaxFunctions/ajax_ig_call_db.js"></script>
...
<script type="text/jscript">
    function search_mawb(jobNo) {
        ...
        var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_mawb_search.asp?j=" + encodeURIComponent(jobNo);
...
Sub LookupFile()
/////////////////////////////
DIM mIndex, existMJob, JobNo, mFile,last_Chr10_Index,MAWB,fileno
	JobNo=UCase(document.frmMAWB.txtJobNum.value)
    fileno=document.frmMAWB.txtJobNum.value
	if NOT TRIM(JobNo) = "" and NOT fileno ="Search Here" then
		...
		if existMJob then
				...
				// MAWB = document.frmMAWB.lstMAWB.item(i).text
				document.frmMAWB.action="new_edit_mawb.asp?Edit=yes&mawb=" _
...
Sub bsaveclick()
/////////////////////////////
To0=document.frmMAWB.txtTo.Value
To1=document.frmMAWB.txtTo1.Value
To2=document.frmMAWB.txtTo2.Value
...
if sindex = 0 then
   msgbox "Please select a MAWB"
exit sub	
end if

OK=True

if not document.frmMAWB.hNoItemWC.Value = "" then

WC=cInt(document.frmMAWB.hNoItemWC.Value)
OC=cInt(document.frmMAWB.hNoItemOC.Value)
dim i 
if sindex>0 then
	for i=1 to WC
		if Not IsNumeric(document.all("Pieces").item(i).Value) then
			MsgBox "Please enter a Numeric Value for PIECEs!"
			OK=False
			exit for
		elseif Not IsNumeric(document.all("GrossWeight").item(i).Value) then
			MsgBox "Please enter a Numeric Value for GROSS WEIGHT!"
			OK=False
			exit for
		elseif Not IsNumeric(document.all("ChargeableWeight").item(i).Value) then
			MsgBox "Please enter a Numeric Value for CHARGEABLE WEIGHT!"
			OK=False
			exit for
		elseif not document.all("RateCharge").item(i).Value="" and Not IsNumeric(document.all("RateCharge").item(i).Value) then
		
			if document.all("RateCharge").item(i).Value="N/A"  then
				document.all("RateCharge").item(i).Value=0
			else
				MsgBox "Please enter a Numeric Value for RATE/CHARGE!"
				OK=False
				exit for
			end if 
			//MsgBox "Please enter a Numeric Value for RATE/CHARGE!"
			//OK=False
			//exit for
		elseif Not document.all("TotalCharge").item(i).Value="" And Not IsNumeric(document.all("TotalCharge").item(i).Value) then
			MsgBox "Please enter a Numeric Value for TOTAL CHARGE!"
			OK=False
			exit for
		end if
		Scale=document.all("KgLb").item(i).Value
		if Not Scale=document.all("KgLb").item(1).Value then
			MsgBox "UOM mismatch!"
			OK=False
			exit for
		end if
	...
	if OK=True then
		for i=1 to OC
			cAmt=document.all("ChargeAmt").item(i).Value
//			'cCost=document.all("ChargeCost").item(i).Value
			if Not cAmt="" And Not IsNumeric(cAmt) then
				MsgBox "Please enter a Numeric Value for CHARGE AMT!"
				OK=False
				exit for
//			'elseif Not cCosr="" And Not IsNumeric(cCost) then
...
//			'	exit for	
	...
	if OK=True then
		if Not document.frmMAWB.txtPrepaidValuationCharge.Value="" And Not IsNumeric(document.frmMAWB.txtPrepaidValuationCharge.Value) then
			MsgBox "Please enter a Numeric Value for VALUATION CHARGE!"
			OK=False
		end if
	end if
	if OK=True then
		if Not document.frmMAWB.txtCollectValuationCharge.Value="" And Not IsNumeric(document.frmMAWB.txtCollectValuationCharge.Value) then
			MsgBox "Please enter a Numeric Value for VALUATION CHARGE!"
			OK=False
		end if
	end if
	if OK=True then
		if Not document.frmMAWB.txtPrepaidTax.Value="" And Not IsNumeric(document.frmMAWB.txtPrepaidTax.Value) then
			MsgBox "Please enter a Numeric Value for TAX!"
			OK=False
		end if
	end if
	if OK=True then
		if Not document.frmMAWB.txtCollectTax.Value="" And Not IsNumeric(document.frmMAWB.txtCollectTax.Value) then
			MsgBox "Please enter a Numeric Value for TAX!"
			OK=False
		end if
	end if
	if OK=True then
		if Not document.frmMAWB.txtConversionRate.Value="" And Not IsNumeric(document.frmMAWB.txtConversionRate.Value) then
			MsgBox "Please enter a Numeric Value for CONVERSION RATE!"
			OK=False
		end if
	end if
	if OK=True then
		if Not document.frmMAWB.txtCCCharge.Value="" And Not IsNumeric(document.frmMAWB.txtCCCharge.Value) then
			MsgBox "Please enter a Numeric Value for CC CHARGE!"
			OK=False
		end if
	end if
	if OK=True then
		if Not document.frmMAWB.txtChargeDestination.Value="" And Not IsNumeric(document.frmMAWB.txtChargeDestination.Value) then
			MsgBox "Please enter a Numeric Value for DESTINATION CHARGE!"
			OK=False
		end if
	end if
	if OK=True Then

sss=Document.frmMAWB.lstMAWB.Selectedindex
vMAWB=Document.frmMAWB.lstMAWB.item(sss).text

////////////////////////////////////////	
IF NOT CHECK_IV_STATUS( vMAWB ) THEN
	EXIT SUB
END IF
////////////////////////////////////////	

		document.frmMAWB.action="new_edit_mawb.asp?Save=yes&MAWB=" _
	...
	MsgBox "Please select a MAWB number!"
end if
...
Dim sindex,mInfo,pos
Dim mDepartureAirportCode,mDepartureAirport, mTo, mBy, mTo1, mBy1, mTo2, mBy2,mDestAirport
Dim mFlightDate1,mFlightDate2,IssuedBy,AccountInfo
...
mInfo = get_mawb_booking_info( vMAWB ) 
...
'// Commented out by Joon on Jan/15/2007
'//	pos=0
'//	pos=instr(AccountInfo,"FILE#")
'//	if pos>0 then
'//	pos=instr(AccountInfo,chr(10))
...
'// Commented out by Joon on Mar/12/2007
'//If arg <> "new" Then
'//    AccountInfo = "FILE# " & "<%=Request.QueryString("FILE") %>"
'//    document.frmMAWB.txtBillToInfo.Value=AccountInfo
'//else
'//    document.frmMAWB.txtBillToInfo.Value=""
'//End If
...
if Mid(Agent,1,11) = "AS AGENT OF" then
	document.frmMAWB.txtExecute.Value= "AS AGENT OF " & Carrier & chr(10) & "<%= vExecutionDatePlace %>"
else
	document.frmMAWB.txtExecute.Value= Agent & chr(10) & "AS AGENT OF " & Carrier & ", CARRIER" & chr(10) & "<%= vExecutionDatePlace %>"
end if
...
Sub cPPO2Click()
If document.frmMAWB.cPPO2.checked=false then
...
Sub cCOLL2Click()
If document.frmMAWB.cCOLL2.checked=false then
	document.frmMAWB.cCOLL2.VALUE=""
...
Sub cPPO1Click()
Dim DescArray,k
If document.frmMAWB.cPPO1.checked=false then
    ...
    DescArray = Split(Desc2,chr(10))
    Desc2 = ""
    For k=0 To Ubound(DescArray)
        If InStr(UCase(DescArray(k)),"FREIGHT") Then
            Desc2 = Desc2 & "FREIGHT COLLECT"
        Else
            Desc2 = Desc2 & DescArray(k)
        End If
        If k <> Ubound(DescArray) Then
            Desc2 = Desc2 & chr(10)
        End If
    Next
    
    If InStr(1,Desc2,"FREIGHT") = 0 Then
        Desc2 = Desc2 & "FREIGHT COLLECT"
    End If
ELSE
...
Sub cCOLL1Click()
Dim DescArray,k
If document.frmMAWB.cCOLL1.checked=FAlse then
	document.frmMAWB.cCOLL1.VALUE=""
...
Sub AddToHAWB(addHAWB,addELTAcct)
document.frmMAWB.action="new_edit_mawb.asp?addHAWB=yes&addHAWBNo=" & encodeURIComponent(addHAWB) & "&addELTAcct=" & addELTAcct & "&focus=selected_hawb"  & "&WindowName=" & window.name
document.frmMAWB.method="POST"
document.frmMAWB.target = window.name
frmMAWB.submit()
End Sub
...
Sub Desc2KeyUp()
Info=document.frmMAWB.txtDesc2.Value
MyArray = Split(Info, chr(13), -1, 1)
dd=UBound(MyArray,1)
if dd>13 then
	MsgBox "Please go to Other Description session to continue!"
	Info=""
	for i=0 to 13
		Info=Info & MyArray(i)
	next
...
Sub DeleteHAWB(HAWB,delELTAcct)
	document.frmMAWB.action="new_edit_mawb.asp?DeleteHAWB=yes&dHAWB=" & encodeURIComponent(HAWB) & "&delELTAcct=" & delELTAcct & "&focus=selected_hawb"  & "&WindowName=" & window.name
	document.frmMAWB.method="POST"
	document.frmMAWB.target = window.name
...
Sub UpdateHouseChange(sCount)
	MsgBox "Please, save the Master AWB after updating."
...
Sub bCalClick(i)
	ItemNo=i
	Pieces=document.all("Pieces").item(ItemNo+1).Value	
	if Pieces="" then Pieces=0
	ChargeableWeight=document.all("ChargeableWeight").item(ItemNo+1).Value
	GrossWeight=document.all("GrossWeight").item(ItemNo+1).Value
	if ChargeableWeight="" then ChargeableWeight=0
	RateCharge=document.all("RateCharge").item(ItemNo+1).Value
	...
	elseif IsNumeric(RateCharge)=false then
		...
		document.all("RateCharge").item(ItemNo+1).Value=""
	
	else
		TotalCharge=cDbl(RateCharge)*cDbl(ChargeableWeight)
		document.all("TotalCharge").item(ItemNo+1).Value=formatNumber(Round(TotalCharge,2))
	end if
End Sub

Sub bCalRealCostClick()
...
Sub AddOC()
	NoItem=Cint(document.frmMAWB.hNoItemOC.Value)
...
Sub DeleteOC(ItemNo)
if document.frmMAWB.hNoItemOC.Value>0 and not cint(document.frmMAWB.hNoItemOC.Value)=ItemNo then
	ok=MsgBox ("Are you sure you want to delete this Other Charge?" & chr(13) & "Continue?",36,"Message")
	if ok=6 then	
...
Sub ChargeItemChange(index)
Dim sindex,AgentName
sindex=Document.all("ChargeItem").item(index+1).Selectedindex
ItemInfo=Document.all("ChargeItem").item(index+1).Value

pos=Instr(ItemInfo,"-")
if pos>0 then
	ItemDesc=Mid(ItemInfo,pos+1,200)
end if

///////////////////////////////
// Unit_Price by ig 10/21/2006
DIM ItemUnitPrice
ItemUnitPrice = GET_ITEM_UNIT_PRICE ( ItemDesc )

pos=Instr(ItemDesc,"-")
if pos > 0 then
	ItemDesc=Mid(ItemDesc,1,pos-1)
end if
///////////////////////////////
if ItemDesc = "-0" then ItemDesc = ""

if sindex>0 then
	Document.all("ItemDesc").item(index+1).Value=LTRIM(ItemDesc)
	// Unit_Price by ig 10/21/2006
	CALL SET_UNIT_PRICE ( Document.all("ChargeAmt").item(index+1) , ItemUnitPrice )
	///////////////////////////////	
else
	Document.all("ItemDesc").item(index+1).Value=""
end if
...
IF NOT IVstrMSG = "" THEN
	ok=MsgBox ("Invoice No. " & IVstrMSG & " for MAWB#:" & tvMAWB & " was processed already." & chr(10) & "Do you want to continue?",36,"Warning!")
	if ok=6 then
		CHECK_IV_STATUS = true
		exit function
	else
...
if sindex>0 then
	MAWB=document.frmMAWB.lstMAWB.item(sindex).text
	ok=MsgBox ("Do you really want to delete MAWB " & MAWB & "?" & chr(13) & "Continue?",36,"Message")
	if ok=6 then	
		////////////////////////////////////////	
		IF NOT CHECK_IV_STATUS( MAWB ) THEN
			EXIT SUB
		END IF
		////////////////////////////////////////	
...
Sub ScaleChange(ItemNo)

	Scale=document.all("KgLb").item(ItemNo+1).Value
	GW=document.all("GrossWeight").item(ItemNo+1).Value
	CW=document.all("ChargeableWeight").item(ItemNo+1).Value
	RateCharge = document.all("RateCharge").item(ItemNo+1).Value
	...
	If Scale = "K" then
		GW = GW / 2.20462262
		CW = CW / 2.20462262
		//reverse for rate, dont convert when ratecharge is "N/A"
		If IsNumeric(RateCharge) Then
			RateCharge = Round(RateCharge * 2.20462262, 2)
		End If
	else
		GW = GW * 2.20462262
		CW = CW * 2.20462262
	...
	If IsNumeric(RateCharge) Then
		document.all("RateCharge").item(ItemNo+1).Value = RateCharge
		document.all("TotalCharge").item(ItemNo+1).Value = Round(CW * RateCharge)
	End If 

	document.all("GrossWeight").item(ItemNo+1).Value = FormatNumber(GW, 2)
	document.all("ChargeableWeight").item(ItemNo+1).Value = FormatNumber(CW, 2)
...
Sub NewPrintVeiw()
    Dim props,HAWB,sindex,MAWB
    sindex = document.frmMAWB.lstMAWB.selectedindex
    MAWB = document.frmMAWB.lstMAWB.item(sindex).text
    cMAWB= frmMAWB.hmawb_num.Value

    If MAWB <> ""  And MAWB <> "Select One" Then
...
Function setDefaultFreight()
    ...
    if RET = 6 THEN window.location="/IFF_MAIN/ASP/SITE_ADMIN/co_config.asp?DAFCost=Y"  end if
End Function
