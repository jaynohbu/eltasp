...
<%
    ...
    Do While Not rs.EOF And Not rs.BOF 
        Set AgentTable = Server.CreateObject("System.Collections.HashTable")
        AgentTable.Add "value", "MAWB=" & Server.URLEncode(master_num) _
            & "&Agent=" & rs("agent_no").value & "&MasterAgentNo=0"
...
<script language="javascript" type="text/javascript">
    function getAnswer()
    {
	    ...
	    //alert(returnValue + "&AddInfo=" + document.getElementById("hAddInfo").value);
...
<option value="MAWB=<%=master_num %>" selected="selected">Consolidated Manifest</option>
