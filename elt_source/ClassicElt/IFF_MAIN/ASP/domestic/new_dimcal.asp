...
<head>
    ...
    function closeAndUpdate(){
        ...
        if(totalDimension == ""){
            ...
            if(vPieces != parseInt(self.opener.document.form1.txtPiece<%=itemNum %>.value)){
                alert("Please, verify the number of pieces!");
                return false;
            }
            
            self.opener.document.form1.txtCubicInches<%=itemNum %>.value=totalCInch.toFixed(2);
            self.opener.document.form1.hDimDetail.value = document.getElementById("txtDimDetail").value;
            self.opener.document.form1.hDimFactor.value = vFactor;
            self.opener.document.form1.txtCubicWeight.value = totalDimension;
    ...
    function initDimDetail(){
        ...
        var detail = document.getElementById("txtDimDetail");
        var tmpDetail = self.opener.document.form1.hDimDetail.value;
        ...
        if (tmpDetail != null && tmpDetail != ""){
            ...
            var vFactor = self.opener.document.form1.hDimFactor.value;
