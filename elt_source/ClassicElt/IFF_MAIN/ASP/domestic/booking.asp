...
<body link="336699" vlink="336699" topmargin="0" onLoad="self.focus(); ">
    ...
    <!-- placeholder ends -->
    <form name="frmMAWBNO" method="post" action="" onKeyDown="javascript:setChangeFlag();">
                                ...
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="13%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/domestic/booking.asp" target="_self">
...
popAddMAWB = showModalDialog("../Include/AddMAWB.asp?"+param,"AddMAWB","dialogWidth:450px; dialogHeight:180px; help:0; status:0; scroll:0;center:1;Sunken;");    
	...
	return true;	
                                    ...
                                    <tr bgcolor="#Ffffff" style="color: #000000">
                                        ...
                                        <td colspan="1">
                                            <input name="txtServiceLevel2" type="text" class="shorttextfield" id="txtServiceLevel2"
...
DIM FILENO
	...
	if NOT TRIM(FILENO) = "" and not FILENO="Search Here" then
		...
		document.frmMAWBNO.action="booking.asp?Edit=yes&FILENO=" & FILENO
		document.frmMAWBNO.method="POST"
		document.frmMAWBNO.target = "_self"
		frmMAWBNO.submit()
	else
...
If document.frmMAWBNO.txtFileNo.value = "" Then
    MsgBox "Please, preset file numbers and prefixes in prefix manager." & chr(13) & "You can also manual enter a file number in this page."
    Exit Sub
End If
...
if pos>0 then MAWB=Mid(MAWB,1,pos-1)
if sindex>0 then
    ok=MsgBox ("Do you really want to close Airline Booking No. '" & MAWB & "' ?" & chr(13) & "Continue?",36,"Message")
    if not ok=6 then
    EXIT SUB
		END IF
	document.frmMAWBNO.action="booking.asp?Close=yes&MAWB=" & MAWB
	document.frmMAWBNO.method="POST"
	document.frmMAWBNO.target="_self"
	frmMAWBNO.submit()
else
