...
Dim hRateCharge(3),hTotal(3),hCollectWeightCharge
Dim vDesc1,vDesc2
...
Dim vPrepaidOtherChargeCarrier,vCollectOtherChargeCarrier1
...
Dim Copy,AirportCode,vDestCountry,vPrepaidTotal,vCollectTotal,vCollectOtherChargeCarrier
Dim hTotalWeightCharge,hPrepaidWeightCharge,hPrepaidValuationCharge,hCollectTax
...
If Not rsHAWB.EOF Then
	...
	If IsNull(rsHAWB("Total_Gross_Weight")) = False Then
		vTotalGrossWeight = FormatAmount(rsHAWB("Total_Gross_Weight"))
	End If
...
'	End If
	...
	If IsNull(rsHAWB("Charge_at_Dest")) = False Then
		vChargeDestination = FormatAmount(rsHAWB("Charge_at_Dest"))
	End If
	...
	Do While Not rsHAWB.EOF
		...
		if (CP="P" and vShowPrepaidOtherChargeShipper="Y" and Copy="SHIPPER") or (CP="C" and vShowCollectOtherChargeShipper="Y" and Copy="SHIPPER") or (CP="P" and vShowPrepaidOtherChargeConsignee="Y" and Copy="CONSIGNEE") or (CP="C" and vShowCollectOtherChargeConsignee="Y" and Copy="CONSIGNEE")then
			If IsNull(rsHAWB("Amt_MAWB")) = False Then
				aChargeAmt(tIndex) = rsHAWB("Amt_MAWB")
			End If
		...
		if (CP="P" and vShowPrepaidOtherChargeConsignee="Y") or (CP="C" and vShowCollectOtherChargeConsignee="Y") then
			hChargeAmt(tIndex1) = rsHAWB("Amt_MAWB")
...
Function GetFileNumber()
    ...
    SQL = "SELECT File# from mawb_number where elt_account_number=" & elt_account_number _
        & " AND mawb_no='" & vMAWB & "' and is_dome='Y'"
    resVal = ""    
...
<OBJECT ID="FreightEasy"
CLASSID="CLSID:B38256C8-D8AE-42FF-8B14-B6FAB132E440"
CODEBASE="../include/ELTAuth.CAB#version=2,2,0,0">
</OBJECT>
...
//			oInterval = setInterval("printWindowDelay()",2000);
...
<div id="PageDiv">
<div id="txtMAWB" class="pagehead"><%= mid(vMAWB,1,3) & " " & AirportCode & " " & mid(vMAWB,5,30) %></div>
<div id="txtHAWBTop" align="right" class="pagehead"><%=vMAWB %></div>
...
<div id="txtDesc2">
  <textarea name="txtDesc2" wrap="hard" cols="23" style="height:196px" rows="14" class="monotextarea" readonly="readonly"><%= vDesc2 %></textarea></div>
<div id="txtDesc2Add">
...
<div id="txtHAWBBottom" align="right" class="pagehead"><%=vMAWB %></div>
</div>
