    ...
    function GLItemFill(obj,glType,changeFunction,vHeight)
    {
        var qStr = obj.value;
        ...
        {
            url = "/IFF_MAIN/asp/ajaxFunctions/ajax_account_payable.asp?mode=list&filter="
                + glType + "&qStr=" + qStr;
    ...
    function GLItemFillAll(objName,glType,changeFunction,vHeight)
    {
        ...
        var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_account_payable.asp?mode=list&filter=" 
            + glType + "&qStr="; 
    ...
    function quickAddClient(acctFN,nameFN,infoFN)
    {
        ...
        var popAddClient = showModalDialog("/IFF_MAIN/ASP/Include/quickAddClient.asp?orgNum=" + orgNum, 
    ...
    function quickAddClientNew(acctFN,nameFN,infoFN,funcName)
    {
        ...
        var arrayResult = showModalDialog("/IFF_MAIN/ASPX/Include/quickAddClientNew.aspx?orgID=" + orgNum, 
