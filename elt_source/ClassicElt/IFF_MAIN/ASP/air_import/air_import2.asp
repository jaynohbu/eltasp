                                ...
                                <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="13%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/air_import/air_import2.asp" target="_self">
                        ...
                        <tr align="center" valign="middle" bgcolor="efe1df">
                                ...
                                <table width="75%" border="0" cellpadding="2" cellspacing="0" bordercolor="ba9590"
                                    ...
                                    <tr bgcolor="#efe1df">
                                        ...
                                        <td height="20" align="left" valign="middle" class="bodyheader">
                                            <span class="bodyheader style3"><span class="bodycopy">
                                                <img src="/iff_main/ASP/Images/required.gif" align="absbottom"></span>Master AWB
                                                No. </span>
                                        </td>
                                    ...
                                    <tr bgcolor="#Ffffff">
                                        ...
                                        <td height="20" align="left" valign="middle" class="bodyheader">
                                            <table cellpadding="0" cellspacing="0" border="0" width="220">
                                                <tr>
                                                    <td width="165">
                                                        <input name="txtMAWB" type="text" value="<%= vMAWB %>" size="29" <% if vmawb <>"" then response.write("class='readonlybold' readonly") else response.write("class='bodyheader'") end if %> /></td>
                                                    <td class="bodyheader">
                                                        <% If vMAWB <> "" Then %>
                                    ...
                                    <tr bgcolor="#F3f3f3">
                                        ...
                                        <td width="173" align="left" valign="middle" class="bodyheader">
                                            <span class="bodycopy">
                                                <img src="/iff_main/ASP/Images/required.gif" align="absbottom"></span>Agent</td>
                                        <td align="left" valign="middle">
                                        </td>
                                    </tr>
                                    <tr bgcolor="#FFFFFF">
                                ...
                                <td height="22" colspan="14" align="center" valign="middle" class="bodyheader">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tblChargeCost">
                                        ...
                                        <tr bgcolor="#FFFFFF">
                                            ...
                                            <td class="bodycopy">
                                                <input name="txtAgentDebitNo" type="text" class='shorttextfield' value="<%= vAgentDebitNo %>"
                                                    size="16"></td>
                                            <td class="bodycopy">
                                                &nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="#FFFFFF">
                                                ...
                                                <% if aLock_ap(i) ="Y" then %>
                                                <select id="InvoiceCostItem" name="lstCostItem<%= i %>" style="visibility: hidden;
                                                    width: 1px">
                                                    <option></option>
                                                ...
                                                <input id="txtItemCostDesc" class="d_shorttextfield" size="30" type="text" value="<%= tmpigDefaultCostItem %>"
                                                    readonly="true">
                                                <% else %>
                                                <select id="InvoiceCostItem" class="smallselect" name="lstCostItem<%= i %>" onchange="ItemCostChange(<%= i+1 %>);CostChange(<%= i+1 %>)"
                                            ...
                                            <td bgcolor="#FFFFFF">
                                                <input id="ItemCostDesc" class="shorttextfield" name="txtCostDesc<%= i %>" size="39"
                                                    type="text" value="<%= aCostDesc(i) %>" <%if aLock_ap(i) ="Y" then response.write "readonly='true'"%>></td>
                                            <td bgcolor="#FFFFFF">
                                                <input id="ItemCost" class="numberalign" name="txtCost<%= i %>" onchange="CostChange(<%= i+1 %>)"
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td height="22" align="left" valign="middle" class="bodycopy">
                                    <input readonly="readonly" name="txtHAWB<%= i %>" type="text" class="d_shorttextfield"
                                        id="HAWB" value="<%= aHAWB(i) %>"></td>
                                <td align="left" valign="middle" class="bodycopy">
                                    <input readonly="readonly" name="txtShipper<%= i %>" type="text" class="d_shorttextfield"
                                        id="HAWBShipper" value="<%= aShipper(i) %>"></td>
                                <td align="left" valign="middle" class="bodycopy">
                                    <input readonly="readonly" name="txtConsignee<%= i %>" type="text" class="d_shorttextfield"
                                        id="HAWBConsignee" value="<%= aConsignee(i) %>"></td>
                                <td align="left" valign="middle" class="bodycopy">
                                    <input readonly="readonly" name="txtNotify<%= i %>" type="text" class="d_shorttextfield"
                                        id="HAWBNotify" value="<%= aNotify(i) %>"></td>
                                <td align="left" valign="middle" class="bodycopy">
                                    <input readonly="readonly" style="behavior: url(../include/igNumChkRight.htc)" name="txtPieces<%= i %>"
                                        type="text" class="d_shorttextfield" id="HAWBPieces" value="<%= aPieces(i) %>"
                                        size="6"></td>
                                <td align="left" valign="middle" class="bodycopy">
                                    <input readonly="readonly" style="behavior: url(../include/igNumChkRight.htc)" name="txtGrossWT<%= i %>"
                                        type="text" class="d_shorttextfield" id="HAWBGrossWT" value="<%= aGrossWT(i) %>"
                                        size="6"></td>
                                <td align="left" valign="middle" class="bodycopy">
                                    <input readonly="readonly" style="behavior: url(../include/igNumChkRight.htc)" name="txtChgWT<%= i %>"
                                        type="text" class="d_shorttextfield" id="HAWBChgWT" value="<%= aChgWT(i) %>"
                                        size="6"></td>
                                <td align="left" valign="middle" class="bodycopy">
...
document.form1.isDocBeingModified.value = "false"
MAWB=document.form1.txtSMAWB.value
if not MAWB = "" and not MAWB = "Master No. Here" then
...
form1.submit()
 ...
 MsgBox "Please enter a Master No!"
end if
End Sub
...
/////////////////////////////
document.form1.isDocBeingModified.value = "false"
JobNum=document.form1.txtJobNum.value
if not JobNum = "" and not JobNum = "File No. Here" then
...
Sub SaveClick()
    If document.form1.txtFileNo.value = "" Then
  ...
  // --------------------------for cost item 11/29/06
	...
	for j=1 to NoCostItem
		...
		if not oCost=0 and oItem="" then
			MsgBox "Please select a Cost Item!"
			Exit Sub
		end if

		if Not oCost=0 and trim(document.all.txtAgentDebitNo.value) = "" then
			msgbox "Please enter the Agent Debit No."
			document.all.txtAgentDebitNo.focus()
			exit sub
		end if		
	next
...
// ----------------------------------------------------
    ...
    MAWB=document.form1.txtMAWB.Value
    ETD=document.form1.txtETD.Value
    ETA=document.form1.txtETA.Value
    fDate=document.form1.txtLastFreeDate.Value
    ITDate=document.form1.txtITDate.Value
    AgentDebit=document.form1.txtTotalCost.Value
    
	If MAWB="" then
		MsgBox "Please enter a MAWB Number!"
		exit Sub		
    Elseif Document.form1.hFFAgentAcct.Value = "" Or Document.form1.hFFAgentAcct.Value = "0" Then
	    // If Document.form1.hExportAgentELTAcct.value <> "" And Document.form1.hExportAgentELTAcct.value > 0  Then
	    // Else
	        MsgBox "Please select an Export Agent!"
	        Exit Sub
	    // End If
	Else
	End If
	if Not ETD="" and Not IsDate(ETD) then
		MsgBox "Please enter correct Date for ETD (MM/DD/YY)"
		Exit Sub
	end if
	if Not ETA="" and Not IsDate(ETA) then
		MsgBox "Please enter correct Date for ETA (MM/DD/YY)"
		Exit Sub
	end if
	if Not fDAte="" and Not IsDate(fDAte) then
		MsgBox "Please enter correct Date for Last Free Date (MM/DD/YY)"
		Exit Sub
	end if
	if Not ITDate="" and Not IsDate(ITDate) then
		MsgBox "Please enter correct Date for IT Date (MM/DD/YY)"
		Exit Sub
	end if

    document.form1.isDocBeingSubmitted.value = "true"
	document.form1.action=encodeURI("air_import2.asp?iType=A&Save=yes" & "&WindowName=" & window.name &"&AgentOrgAcct=" & AgentOrgAcct& "&tNo=" & "<%=TranNo%>")
	document.form1.target="_self"
	document.form1.method="POST"
	form1.submit()
End Sub
...
Sub AddHAWB()
    ...
    isConfirmYes = True
    isDocBeingSubmitted = document.form1.isDocBeingSubmitted.value
    isDocBeingModified = document.form1.isDocBeingModified.value
    
    If isDocBeingSubmitted = "false" And isDocBeingModified = "true" Then
        isConfirmYes = confirmGoAway()
    End If
    
    If isConfirmYes = True Then
	    MAWB=document.form1.txtMAWB.Value
...
Sub DeleteHAWB(Invoice_no,ItemNo)
    ok=MsgBox ("Are you sure you want to delete this HAWB?" & chr(13) & "Continue?",36,"Message")
    document.form1.isDocBeingModified.value = "false"
    If ok=6 Then
...
Sub ViewClick(HAWB)
    ...
    If isConfirmYes = True Then
	    ...
	    ExportAgentELTAcct=cLng(document.form1.hExportAgentELTAcct.Value)
	    AgentOrgAcct=document.form1.hAgentOrgAcct.Value
        MAWB=document.form1.txtMAWB.Value
        
        if  ExportAgentELTAcct > 0 then
...
Sub EditANClick(Sec,ItemNo,InvoiceNo)
    ...
    If isConfirmYes = True Then
	    ...
	    MAWB=document.form1.txtMAWB.VAlue
	    if MAWB="" then
		    MsgBox "Please enter a MAWB first!"
		    exit Sub
	    end if
	    MAWBNotExist=document.form1.hMAWBNotExist.VAlue
	    if MAWBNotExist="yes" then
		    MsgBox "Please SAVE the MAWB first!"
		    exit sub
	    end if
	    if Sec=0 then Sec=1
	    HAWB=document.all("HAWB").Item(ItemNo).Value
...
Sub DeleteMAWBClick()
    ok=MsgBox ("Are you sure you want to delete this MAWB?" & chr(13) & "Continue?",36,"Message")
    if ok=6 then
	    document.form1.isDocBeingModified.value = "false"
...
function CheckIfMBExist(){ 
	 ...
	 {   
        ...
        req.open("get",encodeURI("../ajaxFunctions/ajax_CheckIfMBExist.asp?MAWB="+MAWB+"&iType="+iType+"&elt_account_number="+"<%=elt_account_number%>") ,false);
        req.send(); 
