...
Function CofirmDFA()
    RET=makeMsgBox("Check Air Freight Charge is set","Default Air Freight Charge Item is not set in your Company Profile, would you like to set it before you move on?",48,4,0,4096)
    if RET = 6 THEN window.location="/IFF_MAIN/ASP/SITE_ADMIN/co_config.asp?DAF=Y"  end if
End Function
                                ...
                                <table width="90%" border="0" cellpadding="2" cellspacing="0" bordercolor="ba9590"
                                    ...
                                    <tr align="left" valign="middle" bgcolor="ffffff">
                                        ...
                                        <td>
                                            ...
                                            <%if InvoiceNo<>"" And agent_status="A" then response.Write("<img src='/iff_main/ASP/Images/icon_goto.gif'><span class='goto'><a href='javascript:void(goInvoice());'>Go to Invoice</a></span>") end if %>
                                        </td>
                                        <td valign="top">
                                            <input name="txtRefNo" type="text" class="readonlybold" value="<%= vFileNo %>" readonly
                                                size="24"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr bgcolor="efe1df">
                                        ...
                                        <td width="28%" align="left" valign="middle" bgcolor="efe1df">
                                            <span class="style1"><strong><span class="bodycopy">
                                                <img src="/iff_main/ASP/Images/required.gif" align="middle"></span>Master AWB No.
                                                <% if mode_begin then %>
                                            </strong></span>
...
= aMAWB(i) %>
					...
					function goDeconsol() {
					    try {
						    ...
						    var url = 'air_import2.asp?iType=A&Edit=yes&MAWB=' + mawb +'&Sec='+sec+'&AgentOrgAcct='+ document.form1.hAgentOrgAcct.value;
    // branch
					...
					function goInvoice() {
					    try {
							...
							if(opener){
								...
								self.location = encodeURI(url);	
                                            ...
                                            <img src="/iff_main/ASP/Images/icon_goto.gif" width="36" height="21" align="absbottom"><span
                       ...
                       response.Write(" <input class='readonlybold' name='txtHAWB' id='txtHAWB' readonly size='30' type='text' value='"& vHAWB&"'/>")
                                    ...
                                    <tr bgcolor="efe1df">
                                        ...
                                        <td height="20" align="left" valign="middle">
                                            <strong><span class="bodycopy">
                                                <img src="/iff_main/ASP/Images/required.gif" align="absbottom"></span>Consignee</strong></td>
                                        <td align="left" valign="middle" bgcolor="efe1df">
                                    ...
                                    <tr bgcolor="#F3f3f3">
                                        <td height="20" align="left" valign="top" bgcolor="#FFFFFF">
                                            <strong>
                                                <input name="txtCustomerRef" type="text" class="shorttextfield" maxlength="64" value="<%= vCustomerRef %>"
                                                    size="30">
                                            </strong>
                                        </td>
                                        <td align="left" valign="top" bgcolor="#FFFFFF">
                                    ...
                                    <tr bgcolor="#FFFFFF">
                                        ...
                                        <td height="20" align="left" valign="top" bgcolor="#FFFFFF">
                                            <input name="txtVessel" type="text" class="shorttextfield" maxlength="32" value="<%= vVessel %>"
                                                size="30"></td>
                                        <td align="left" valign="top" bgcolor="#FFFFFF">
                                            &nbsp;</td>
                                    </tr>
                                ...
                                <table width="90%" border="0" cellpadding="2" cellspacing="0" bordercolor="ba9590"
                                    ...
                                    <tr align="left" valign="top" class="bodycopy">
                                        ...
                                        <td valign="middle" bgcolor="#FFFFFF">
                                            <input name="txtChgWT" type="text" class="shorttextfield" value="<%= vChgWT %>" onblur="getCustomerSellingRate()"
                                                size="10" style="behavior: url(../include/igNumDotChkLeft.htc)" />
                                            <select name="lstScale1" class="smallselect" onchange="scaleChange(this);  ">
                                    ...
                                    <tr id='chargeItemRow<%=i%>' bgcolor="#FFFFFF">
                                        ...
                                        <td bgcolor="#FFFFFF" class="bodycopy">
                                            <select name="lstItem<%= i %>" size="1" <% 'if flag  and i=0 then response.Write("") end if%>
                                                class="smallselect" id="InvoiceItem" style="width: 180" onchange="ItemChange(<%= i+1 %>);ItemCostChange2(<%= i+1 %>)">
                                        ...
                                        <td bgcolor="#FFFFFF" class="bodycopy">
                                            <input name="txtAmount<%= i %>" type="text" class="numberalign" id="ItemAmount" onchange="AmountChange(<%= i+1 %>)"
						...
						if arPayMentNoIndex > 10 then
							response.write "..."
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                            <select name="lstCostItem<%= i %>" size="1" class="smallselect" id="InvoiceCostItem"
                                                style="width: 180" onchange="ItemCostChange(<%= i+1 %>); CostChange2(<%= i+1 %>)">
                                                <option>Select One</option>
                                                <option>Add New Item</option>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                            <input name="txtCost<%= i %>" type="text" class="numberalign1" id="ItemCost" onchange="CostChange(this)"
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                            <select name="lstCostItem<%= i %>" size="1" class="smallselect" id="InvoiceCostItem"
                                                style="width: 180" onchange="ItemCostChange(<%= i+1 %>)">
                                                <% for j=0 to CostItemIndex-1 %>
                                        ...
                                        <td bgcolor="#FFFFFF">
                                            <input name="txtCost<%= i %>" type="text" class="numberalign" id="ItemCost" onchange="CostChange(this)"
...
Sub lstMAWBChange_air(mawb)   
    dim aVal,tmpInfo

	tmpInfo=get_arrival_mawb_info( mawb,"A" ) 
	aVal=split(tmpInfo,"^")
...
End Sub 
    ...
    if "<%= Save %>"="yes" then
        ...
        AFTotal = document.form1.txtTotalFC.Value
...
// modified by Joon on 10-12-2007 yes -> no requested by jonathan
    ...
    if MAWB="" then
         MsgBox "Please select a Master Airway Bill!"
        exit Sub
    end if
...
//    end if
    ...
    for j=1 to NoCostItem
        oCost=document.all.item("ItemCost").item(j).value
...
Sub CostChange2(ItemNo)
	...
	for j=0 to NoItem
		...
		TotalCost=formatNumber(TotalCost+Cost,2,,,0)
	next
	document.form1.txtTotalCost.Value=TotalCost
End Sub

Sub ItemCostChange2(ItemNo)
	tCost=document.all("ItemAmount").item(ItemNo).Value
	if not tCost="" then
		if IsNumeric(tCost)=false then
			MsgBox "Please enter a numeric number!"
	...
	TotalCost=0
	for j=0 to NoItem
		Cost=document.all("ItemAmount").item(j).Value
		if Cost="" then
			Cost=0
		else
			Cost=cdbl(Cost)
	...
	next
	document.form1.txtTotalAmount.Value=formatNumber(TotalCost,2,,,0)
End Sub
/////////////////////////////////
...
if sIndex=1 then
	window.open encodeURI("../acct_tasks/edit_co_items.asp") ,"PopupWin", "<%=StrWindow %>"	
else
	pos=0
	pos=instr(itemInfo,chr(10))
	if pos>0 then
...
TotalCost=0
for j=0 to NoItem
    Cost = document.all.item("ItemCost").item(j).value
	if Cost="" then
		Cost=0
	else
		Cost=cdbl(Cost)
   ...
   getCustomerSellingRate();
    ...
    function getCustomerSellingRate(){  
		...
		if (req) {	
			...
			req.open("GET",encodeURI("../ajaxFunctions/ajax_cus_rate.asp?cusAcc=" + cusAcc + "&Unit=" + Unit+ "&airline=" + airline + "&arp=" + arp + "&dep=" + dep + "&wgt=" + wgt), true);		
			req.send();		
		}
    }
