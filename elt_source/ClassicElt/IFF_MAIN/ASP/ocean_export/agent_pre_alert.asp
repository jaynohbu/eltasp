...
<head>
    ...
    If vMode = "search" Then
        ...
        If vBillType = "house" Then
            ...
            SQL = "select 'N' as isDirect,b.booking_num,b.mbol_num,b.hbol_num,b.agent_no,b.agent_name,a.consignee_acct_num as master_agent,ISNULL(c.invoice_no,-1) as invoice_no,d.owner_email,d.edt,d.agent_elt_acct,e.MsgTxt " _
                ...
                & "LEFT OUTER JOIN greetMessage e ON (b.elt_account_number=e.AgentID AND MsgType='OE/Agent Pre-Alert') " _
        ...
        Elseif vBillType = "master" Then
            ...
            If Not IsDataExist(SQL) Then
                SQL = "select 'Y' as isDirect,a.booking_num,a.mbol_num,'' AS hbol_num,a.consignee_acct_num as agent_no,a.consignee_name as agent_name,a.consignee_acct_num as master_agent,ISNULL(c.invoice_no,-1) as invoice_no,d.owner_email,d.edt,d.agent_elt_acct,e.MsgTxt " _
                    ...
                    & "LEFT OUTER JOIN greetMessage e ON (a.elt_account_number=e.AgentID AND MsgType='OE/Agent Pre-Alert') " _
    ...
    <script type="text/jscript">
        ...
        function searchNumFillAll(objName,eType,changeFunction,vHeight){
            ...
            if(typeValue != "")
            {
                var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_get_bills.asp?mode=list&type=" 
        ...
        function ShowEmailHistory(){
            viewPop("../../ASPX/MISC/EmailHistory.aspx?title=Pre-Alert&ao=O&ie=E");
        }
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="shorttextfield" size="80" id="txtEmailSubject<%=i %>" name="txtEmailSubject"
                                                                value="Pre-Alert: <%=vDBA %> Booking No:<%=aOrgData(i)("booking_num") %>" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <ul style="display: inline; float: none;">
                                                                <li style="display: inline; float: left; list-style: none; width: 200px; overflow: hidden">
                                                                    ...
                                                                    <a href="manifest_pdf.asp?MBOL=<%=aOrgData(i)("booking_num") %>&Agent=<%=aOrgData(i)("agent_no") %>&MasterAgentNo=<%=aOrgData(i)("master_agent") %>">
                                                                        Manifest:
                                                                        <%=aOrgData(i)("booking_num") %>
                                                                    </a>&nbsp;&nbsp;&nbsp;</li>
