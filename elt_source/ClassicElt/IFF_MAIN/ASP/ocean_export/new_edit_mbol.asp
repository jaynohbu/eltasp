...
<head>
    ...
    <script type="text/vbscript">
        ...
        Function setDefaultFreight()
            ...
            if RET = 6 THEN window.location="/IFF_MAIN/ASP/SITE_ADMIN/co_config.asp?DOFCost=Y"  end if
        End Function
    </script>
    ...
    function SetCostItems(){
        var vURL = "./new_edit_mbol_cost_items.asp?BookingNum=" + encodeURIComponent(document.getElementById("hBookingNum").value);
    ...
    function SetCreditNote(){
        var vWinArg = "dialogWidth:600px; dialogHeight:400px; help:no; status:no; scroll:yes; center:yes";
        var vReturn = showModalDialog("../acct_tasks/credit_note_list.asp?TYPE=O&BOOK=" + encodeURIComponent(document.getElementById("txtMBOL").value)+ "&HBOL=", "popWindow", vWinArg);
        
        if(vReturn >= 0){
            try{parent.document.frames['topFrame'].changeTopModule("Accounting");}catch(err){}
            if(vReturn == 0){
                window.location.href = "../acct_tasks/edit_credit_note.asp?new=yes&MoveType=OCEAN&MasterOnly=Y&InvType=Agent&AgentID=" + document.getElementById("hShipperAcct").value + "&BookingNum=" + encodeURIComponent(document.getElementById("txtMBOL").value)+ "&HBOL=";
            }
            else{
    ...
    <style type="text/css">
        ...
        .style5 {color: #cc6600}
        .style8 {font-size: 10px; font-weight: bold; color: #cc6600; }
        .style9 {
	        color: #CC3333;
	        font-weight: bold;
	        font-size: 10px;
...
<script type="text/vbscript">
        props = "scrollBars=yes,resizable=yes,toolbar=no,menubar=no,location=no,directories=no,width=500,height=450"			
            ...
            <tr>
                ...
                <td width="42%" align="right" valign="middle">
                    ...
                    <img src="../images/icon_search.gif" name="B1" width="33" height="27" align="absmiddle"
                        style="cursor: hand" onclick="lookupFile()"></td>
            </tr>
        </table>
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <td width="55%" rowspan="2" align="right" valign="bottom">
                        ...
                        <div id="print">
                            ...
                            <a href="javascript:;" onclick="NewPrintVeiw();return false;">
                                <img src="/iff_main/ASP/Images/icon_printer.gif" width="40" height="27" align="absbottom"
                ...
                <tr>
                    <td width="45%" valign="bottom">
                        ...
                        <script type="text/jscript"> function <%=iMoonComboBoxName%>_OnChangePlus() { BookingChange(); } </script>
                                ...
                                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="13%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/ocean_export/new_edit_mbol.asp">
                                        ...
                                        <td width="12%" align="right" valign="middle">
                                            <img src="../images/button_delete_medium.gif" width="51" height="17" name="bDeleteMBOL"
                                                onclick="DeleteMBOL()" style="cursor: hand"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy" style="padding-left: 10px">
                                                <tr bgcolor="#E0EDE8">
                                                    <td width="285" height="20">
                                                        <span class="style1">Master B/L No.</span></td>
                                                    <td width="265">
                                                        &nbsp;</td>
                                                    <td width="229">
                                                        &nbsp;</td>
                                                ...
                                                <tr bgcolor="#FFFFFF">
                                                    <td height="24" valign="middle" bgcolor="#FFFFFF">
                                                        <input name="txtMBOL" class="readonlybold" value="<%= vMBOL %>" size="28" readonly>
                                                    </td>
                                                            ...
                                                            <tr align="left" valign="middle" bgcolor="E0EDE8">
                                                                <td height="20" bgcolor="#f3f3f3">
                                                                    <strong><span class="bodyheader">
                                                                        <img src="/iff_main/ASP/Images/required.gif" align="absbottom"></span>Consigned
                                                                        to</strong></td>
                                                            </tr>
                                                            <tr align="left" valign="middle">
                                                                <td valign="top">
                                                        ...
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy">
                                                            ...
                                                            <tr align="left" valign="middle">
                                                                <td colspan="3" valign="top" style="padding-bottom: 54px">
                                                                    <textarea name="txtExportRef" cols="60" rows="3" class="multilinetextfield"><%= vExportRef %></textarea></td>
                                                            </tr>
                                                            <tr align="left" valign="middle" bgcolor="E0EDE8">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <textarea wrap="hard" name="txtAgentInfo" cols="60" rows="3" class="multilinetextfield"><%= vAgentInfo %></textarea></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="20" bgcolor="#f3f3f3">
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="collapsible"
                                                ...
                                                <thead>
                                                    ...
                                                    <tr align="left" valign="middle" bgcolor="#f3f3f3">
                                                        ...
                                                        <th bgcolor="#f3f3f3">
                                                            <strong>Exporter</strong></th>
                                                        <th>
                                                            <strong>Consignee</strong></th>
                                                        <th>
                                                            <strong>Pieces</strong></th>
                                                        <th>
                                                            <strong>Gross Weight (KG)</strong></th>
                                                        <th>
                                                            <strong>Measure (CBM)</strong></th>
                                                        <th>
                                                            &nbsp;</th>
                                                        <th>
                                                            &nbsp;</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr align="left" valign="middle" bgcolor="#FFFFFF">
                                                        <td height="20">
                                                            <input name="txtaHBOL<%= i %>" type="text" class="bodyheader" id="aHBOL" value="<%= aHBOL(i) %>"
                                                                size="11">
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="image" src="../images/button_add.gif" width="37" height="17" name="bAdd<%= i %>"
                                                                onclick="AddItem(<%= i %>); return false;" style="cursor: hand" /></td>
                                                        <td>
                                                            <input type="image" src="../images/button_edit.gif" width="37" height="18" value="Edit"
                                                                onclick="EditMBOL('<%= aHBOL(i) %>'); return false;" style="cursor: hand"></td>
                                                    </tr>
                                                    <% next %>
                                                </tbody>
                                            </table>
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy" style="padding-left: 10px">
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#f3f3f3">
                                                    ...
                                                    <td>
                                                        &nbsp;</td>
                                                    <td>
                                                        <strong>Gross Weight (KG)</strong></td>
                                                    <td colspan="2">
                                                        <strong>Measure (CBM)</strong></td>
                                                    <td>
                                                        &nbsp;</td>
                                                    <td>
                                                        &nbsp;</td>
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#FFFFFF">
                                                    <td height="20">
                                                        <input name="txtsHBOL<%= i %>" type="text" class="bodyheader" id="dHBOL" value="<%= sHBOL(i) %>"
                                                            size="11">
                                                    </td>
                                                    <td colspan="2">
                                                    ...
                                                    <td>
                                                        <input name="txtsPieces<%= i %>" type="text" class="shorttextfield" value="<%= sPieces(i) %>"
                                                            size="6" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                                                    <td>
                                                        &nbsp;</td>
                                                    <td>
                                                        <input name="txtsGrossWeight<%= i %>" type="text" class="shorttextfield" value="<%= ConvertAnyValue(sGrossWeight(i),"Amount",0) %>"
                                                            size="8" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                                                    <td colspan="2">
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#FFFFFF">
                                                    ...
                                                    <td>
                                                        <input name="txtTotalPieces" type="text" class="shorttextfield" value="<%= ConvertAnyValue(TotalPieces,"Long",0) %>"
                                                            size="6" onkeyup="checkDecimalTextMax(this,5);" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                                                    <td>
                                                        &nbsp;</td>
                                                    <td>
                                                        <input name="txtTotalGrossWeight" type="text" class="shorttextfield" value="<%= FormatNumberPlus(ConvertAnyValue(TotalGrossWeight,"Amount",0),2) %>"
                                                            size="8" onkeyup="checkDecimalTextMax(this,5);" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                                                    <td colspan="2">
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#f3f3f3">
                                                    ...
                                                    <td>
                                                        <strong>Unit of Qty</strong>.</td>
                                                    <td>
                                                        <strong>Gross Weight (KG)</strong></td>
                                                    <td>
                                                        <strong>Gross Weight (LB)</strong></td>
                                                    <td colspan="2">
                                                        <strong>Dimension (CBM)</strong></td>
                                                    <td>
                                                        <strong>Dimension(CFT)</strong></td>
                                                    <td>
                                                ...
                                                <tr align="left" valign="middle">
                                                    ...
                                                    <td>
                                                        <input name="txtPieces" class="numberfield" onblur="CheckData()" value="<%= CheckBlank(vPieces,0) %>"
                                                            size="8" onkeyup="checkDecimalTextMax(this,7);" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input name="txtGrossWeight" class="shorttextfield" onblur="CheckData1()" value="<%=ConvertAnyValue(vGrossWeight,"Amount",0) %>"
                                                            size="15" style="behavior: url(../include/igNumDotChkLeft.htc)" onkeyup="checkDecimalTextMax(this,10);"></td>
                                                    <td>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <input type="image" src="../images/measure.gif" height="16" align="absbottom" onclick="DimCalClick('CBM'); return false;"
                                                            style="cursor: hand"></td>
                                                    <td>
                                                        <input name="txtMCFT" class="shorttextfield" onblur="CheckData4()" value="<%=ConvertAnyValue(vMCFT,"Amount",0) %>"
                                                            size="7" onkeyup="checkDecimalTextMax(this,6);" style="behavior: url(../include/igNumDotChkLeft.htc)">
                                                    ...
                                                    <td>
                                                        <input name="txtChargeRate" class="shorttextfield" value="<%=ConvertAnyValue(vChargeRate,"Amount",0) %>"
                                                            size="8" onkeyup="checkDecimalTextMax(this,6);" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                                                    <td colspan="3">
                                                        ...
                                                        <input type="image" src="../images/button_cal.gif" width="37" height="18" align="absbottom"
                                                            onclick="CalClick('cal'); return false;" style="cursor: hand; margin-left: 6px"></td>
                                                </tr>
                                                <tr align="left" valign="middle" style="visibility: hidden">
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        <input type="image" src="../images/button_cal.gif" width="37" height="18" align="absbottom"
                                                            ...
                                                            style="cursor: hand; margin-left: 6px" /></td>
                                                </tr>
                                                <!-- -->
                                            </table>
                                        </td>
                                        ...
                                        <td colspan="2">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy" style="padding-left: 10px">
                                                ...
                                                <tr align="left" valign="top">
                                                    <td rowspan="6">
                                                        <textarea name="txtDesc1" cols="24" rows="17" wrap="hard" class="multilinetextfield"><%= vDesc1 %></textarea></td>
                                                    <td rowspan="6">
                                                        <textarea name="txtDesc2" cols="24" rows="17" wrap="hard" class="multilinetextfield"><%= vDesc2 %></textarea></td>
                                                    <td rowspan="6">
                                                        <textarea name="txtDesc3" cols="60" rows="17" wrap="hard" class="multilinetextfield"><%= vDesc3 %></textarea></td>
                                                    <td>
                                                        <textarea name="txtDesc4" cols="35" rows="9" wrap="hard" class="multilinetextfield"
                                                            readonly="readonly" style="font-size: 11px; font-family: monospace;"><%= vDesc4 %></textarea></td>
                                                </tr>
                                                <tr align="left" valign="top">
                                                ...
                                                <tr align="left" valign="top">
                                                    <td>
                                                        <textarea name="txtDesc5" cols="35" rows="4" wrap="hard" class="multilinetextfield"><%= vDesc5 %></textarea></td>
                                                </tr>
                                                <tr align="left" valign="top">
                                                    <td height="20" valign="middle" bgcolor="#FFFFFF" class="bodyheader">
                                                        &nbsp;</td>
                                                    ...
                                                    <td width="100%" align="left" valign="top">
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy" style="padding-left: 10px">
                                                            ...
                                                            <tr align="left" valign="middle" bgcolor="#FFFFFF">
                                                                ...
                                                                <td>
                                                                    <input name="txtChargeAmt<%= i %>" class="numberalign" id="ChargeAmt" value="<%=FormatNumberPlus(ConvertAnyValue(aChargeAmt(i),"Amount",0),2) %>"
                                                                        size="26" onkeyup="checkDecimalTextMax(this,12);" style="behavior: url(../include/igNumDotChkLeft.htc)"></td>
                                                                <td>
                                                                    &nbsp;</td>
                                                                <td width="90">
                                                            ...
                                                            <tr align="left" valign="middle" bgcolor="#F3f3f3">
                                                                ...
                                                                <td>
                                                                    <input type="image" src="../images/button_add.gif" width="37" height="17" name="bAdd"
                                                                        onclick="AddItemOC(); return false;" style="cursor: hand"></td>
                                                            </tr>
                                                            <tr align="left" valign="middle">
                                                                <td height="1" colspan="5" bgcolor="ffffff">
                                                                </td>
                                    ...
                                    <tr>
                                        <td width="50%" align="left" valign="top">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodycopy" style="padding-left: 10px">
                                                ...
                                                <tr align="left" valign="middle">
                                                    <td>
                                                        <input name="txtOceanFreight" class="readonly" value="Ocean Freight" size="45" readonly="readonly"></td>
                                                    <td>
                                                ...
                                                <tr align="left" valign="middle">
                                                    <td>
                                                        <input name="txtOtherChargeDesc<%= i %>" class="readonly" value="<%= aChargeItemName(i) %>"
                                                            size="45" readonly></td>
                                                    <td>
                                                        <input name="txtPOtherCharge<%= i %>" class="readonlyright" id="POtherCharge" value="<% if aChargeCP(i)="P" Then Response.Write(aChargeAmt(i)) %>"
                                                            style="width: 70px" readonly="readonly">
                                                    </td>
                                                    <td>
                                                        <input name="txtCOtherCharge<%= i %>" class="readonlyright" id="COtherCharge" value="<% if aChargeCP(i)="C" Then Response.Write(aChargeAmt(i)) %>"
                                                            style="width: 70px" readonly="readonly">
                                                    </td>
                                                </tr>
                                                <% next %>
                                    ...
                                    <tr>
                                        ...
                                        <td width="49%" align="center" valign="middle">
                                            <input type="image" src="../images/button_save_medium.gif" width="46" height="18"
                                                name="bSave" onclick="SaveClick(); return false;" style="cursor: hand"></td>
                                        <td width="13%" align="right" valign="middle">
                                            <a href="/iff_main/ASP/ocean_export/new_edit_mbol.asp">
                                                <img src="/iff_main/ASP/Images/button_new.gif" width="42" height="17" border="0"
                                                    style="cursor: hand"></a></td>
                                        <td width="12%" align="right" valign="middle">
                                            <input type="image" src="../images/button_delete_medium.gif" width="51" height="17"
                                                name="bDeleteMBOL" onclick="DeleteMBOL(); return false;" style="cursor: hand"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
...
Sub CalClick(arg)
    ...
    cw = FormatNumberPlus(TotalDem,2)
    if TRIM(GWKG) = "" then
	    msgbox "Please enter a Gross Weight"
	    exit sub
    end if

    GrossWeight = FormatNumberPlus(GWKG,2) / 1000
    if cw < FormatNumberPlus(GrossWeight,2) then cw=GrossWeight
    tc = FormatNumberPlus(CDbl(Rate) * cw,2)
...
Sub ItemChange(k)
    ...
    if sindex>0 then
        Document.all("ChargeAmt").item(k+1).value = FormatNumber(ItemUnitPrice,2,,,0)
    else
    ...
    if Not WeightCharge="" then
	    if IsNumeric(WeightCharge)=false then
		    ...
		    If document.form1.lstWeightCP.value = "P" Then
			    document.form1.txtPOceanFreight.Value = WeightCharge
			    document.form1.txtCOceanFreight.Value = ""
			    TotalPCharge = FormatNumber(WeightCharge,2,,,0)
		    Else
			    document.form1.txtCOceanFreight.Value = WeightCharge
			    document.form1.txtPOceanFreight.Value = ""
			    TotalCCharge = FormatNumber(WeightCharge,2,,,0)
		    End If
		    For k=1 To 10
			    pc = document.all("POtherCharge").item(k).Value
			    If pc = "" Then
...
Sub LookupFile()
/////////////////////////////
DIM bIndex, existMJob, JobNo, mFile,last_Chr10_Index,fileno
...
Sub SaveClick()
    ...
    elseif document.form1.lstBookingNum.Value="" Or document.form1.lstBookingNum.Value="Select One" then
	    MsgBox "Please select a Booking Number!"
    else

	    ////////////////////////////////////////	
	    IF NOT CHECK_IV_STATUS( "<%=vMBOL%>" ) THEN
		    EXIT SUB
	    END IF
	    ////////////////////////////////////////	
...
Sub DeleteItemOC(ItemNo)
	if document.form1.hNoItem.Value>0 and not document.form1.hNoItem.Value=ItemNo then
...
Sub AddItem(p)
ItemNo=p
    HBOL=document.all("aHBOL").item(p+1).Value
...
Sub DeleteItem(q)
    ItemNo=q
    HBOL=document.all("dHBOL").item(q+1).Value
...
Sub BookingChange()
    ...
    // bInfo=document.form1.lstBookingNum.value
    BookingNum=document.form1.lstBookingNum.item(sindex).Text
    call adjust_screen_book( BookingNum )
...
Sub adjust_screen_book( BookingNum )
    bInfo = get_mbol_booking_info(BookingNum)
    ...
    aExportRef=document.form1.txtExportRef.Value
    if aExportRef ="" then 
...
if MBOL="" and BookingNum = "" then
	MsgBox "The Master B/L No. is not assigned!"
else
	ok=MsgBox ("Do you really want to delete this Booking No.?" & chr(13) & "Continue?",36,"Message")
	if ok=6 then	
		////////////////////////////////////////	
		IF NOT CHECK_IV_STATUS( MBOL ) THEN
			EXIT SUB
		END IF
		////////////////////////////////////////
		document.form1.action="new_edit_mbol.asp?DeleteMBOL=yes&MBOL=" & encodeURIComponent(MBOL) _
...
IF NOT IVstrMSG = "" THEN
	ok=MsgBox ("Invoice No. " & IVstrMSG & " for MBOL #:" & tvMAWB & " was processed already." & chr(10) & "Do you want to continue?",36,"Warning!")
	if ok=6 then
		CHECK_IV_STATUS = true
		exit function
	else
...
Sub NewPrintVeiw()
    Dim props,Booking,sIndex
    sIndex = document.form1.lstBookingNum.selectedindex
    BookingNum = document.form1.lstBookingNum.item(sindex).Text
			//change by stanley on 6/19/2007
    If BookingNum <> "" And BookingNum <> "Select One" Then
        props = "scrollBars=no,resizable=yes,toolbar=no,menubar=no,location=no,directories=no,status=yes,width=880,height=650"
        window.open encodeURI("view_print.asp?WindowName=" & window.name & "&sType=booking&booking=" & BookingNum), "popUpWindow", props
	else
...
<script type="text/jscript">
    ...
    function search_booking(jobNo) {
	    ...
	    var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_booking_search.asp" + "?j=" + encodeURIComponent(jobNo);
