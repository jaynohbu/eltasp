        ...
        */
        ...
        function saveForm()
        {
            try{
                ...
                var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_certificate_origin.asp?mode=update&type=" + typeValue
                    + "&export=O&no=" + noValue;
    ...
    <script type="text/javascript">
        ...
        function searchNumFill(obj,eType,changeFunction,vHeight){
            ...
            if(qStr != "" && keyCode != 229 && keyCode != 27){
                url = "/IFF_MAIN/asp/ajaxFunctions/ajax_certificate_origin.asp?mode=list&export=" + eType 
        ...
        function searchNumFillAll(objName,eType,changeFunction,vHeight){
            ...
            var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_certificate_origin.asp?mode=list&type=" + typeValue 
                + "&export=" + eType;
...
// Start of list change effect //////////////////////////////////////////////////////////////////
        ...
        function lstSearchNumChange(argV,argL){
            ...
            var url = "/IFF_MAIN/asp/ajaxFunctions/ajax_certificate_origin.asp?mode=view&type=" + typeValue
                + "&export=O&no=" + argV;
                                            ...
                                            <table width="98%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="13%" align="right" valign="middle">
                                                        <a href="/iff_main/ASP/ocean_export/certificate_of_origin_ocean.asp" target="_self">
                                                    ...
                                                    <td width="57%" align="left" valign="middle">
                                                        <label id="txtFileNameLabel">
                                                            <strong><span class="bodyheader">
                                                                <img src="/iff_main/ASP/Images/required.gif" align="absmiddle"></span>File Name</strong></label>
                                            ...
                                            <table width="82%" border="0" cellpadding="2" cellspacing="0" bordercolor="#6D8C80"
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    ...
                                                    <td valign="top" class="bodycopy">
                                                        <input name="txtUpdatedDate" type="text" class="m_shorttextfield" value="<%=Date() %>"
                                                            size="20" preset="shortdate" /></td>
                                                    <td valign="top">
                                                        <input name="txtBookingNum" type="text" class="m_shorttextfield" value="" size="20" /></td>
                                                </tr>
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    <td height="19">
                                                        &nbsp;</td>
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    <td height="19">
                                                        &nbsp;</td>
                                                    <td valign="top" class="bodycopy">
                                                        <input name="txtMBOLNum" type="text" class="m_shorttextfield" value="" size="20" /></td>
                                                    <td valign="top">
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    ...
                                                    <td valign="middle" bgcolor="#ffffff" colspan="2">
                                                        <input type="text" name="txtUsState" maxlength="64" class="shorttextfield" value="" />
                                                        <%=agent_country %>
                                                    </td>
                                                </tr>
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                ...
                                                <tr align="left" valign="middle" bgcolor="#ffffff" class="bodycopy">
                                                    ...
                                                    <td class="bodycopy">
                                                        <input type="text" name="txtDeliveryPlace" maxlength="64" class="shorttextfield"
                                                            style="width: 200px" value="" /></td>
                                                    <td valign="middle">
                                                        <input type="text" name="txtMoveType" maxlength="32" class="shorttextfield" value="" /></td>
                                                    <td>
                                            ...
                                            <table width="82%" border="0" cellpadding="0" cellspacing="0" bordercolor="#6D8C80"
                                                ...
                                                <tr>
                                                    ...
                                                    <td rowspan="3" bgcolor="#FFFFFF">
                                                        <textarea wrap="hard" name="txtDesc2" cols="24" rows="5" class="multilinetextfield"></textarea></td>
                                                    <td rowspan="3" bgcolor="#FFFFFF">
                                                        <textarea wrap="hard" name="txtDesc3" cols="48" rows="5" class="multilinetextfield"></textarea></td>
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        ...
                                                        <input type="text" name="txtGrossWeight" class="shorttextfield" value="" style="behavior: url(../include/igNumDotChkLeft.htc);
                                                            width: 80px" onkeydown="resetWeight(0)" /></td>
                                                </tr>
                                                <tr>
                                                    <td bgcolor="#FFFFFF">
                                                        &nbsp;</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" bgcolor="#FFFFFF">
                                                        ...
                                                        <input type="text" name="txtMeasurement" class="shorttextfield" value="" style="behavior: url(../include/igNumDotChkLeft.htc);
                                                            width: 80px" onkeydown="resetMeasure(0)" /></td>
                                                </tr>
                                                <tr bgcolor="#FFFFFF">
                                                    <td height="8">
                                                        &nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td width="52%" rowspan="2" class="bodycopy">
                                                                    ...
                                                                    <input name="txtSwornDate" value="" type="text" class="m_shorttextfield" preset="shortdate"
                                                                        size="32">
                                                                    <br>
                                                                    <input name="txtPrepareBy" type="text" value="" class="shorttextfield" size="59"></td>
