...
'	writeday = yy & "-" & mm & "-" & dd & " " & hh & ":" & mi & ":" & se
	...
	if Request.Form("sw") <> "" then
		Response.Redirect "/IFF_MAIN/Board/board/listRemarks.asp?tb="&tb&"&page="&page&"&st="&Request.Form("st")&"&sc="&Request.Form("sc")&"&sn="&Request.Form("sn")&"&sw="&Request.Form("sw")
	else
		Response.Redirect "/IFF_MAIN/Board/board/listRemarks.asp?tb="&tb&"&page="&page
	end if
