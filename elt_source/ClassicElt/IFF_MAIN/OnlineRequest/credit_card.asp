...
<%
    ...
    payment_id = checkBlank(Request.QueryString("pid"),0)
    relayURL = ""
    footerHTML = ""
    ...
    Sub GetCompanyContactInfo
        ...
        SQL = "SELECT * FROM account_request WHERE payment_id=" & payment_id
...
<body onload="javascript:SubmitToAuthorizeNet()" >
    <form id="form1" action="https://secure.authorize.net/gateway/transact.dll" method="post">
        ...
        <input type="hidden" name="x_cust_id" value="<%=dataTable("auto_uid") %>" />
